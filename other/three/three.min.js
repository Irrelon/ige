		...
		o = function (i, l, j) {
			...
			if (i instanceof a.Particle) {
				...
				for (A = y.faces.length; q < A; q++)
					if (
						((o = y.faces[q]),
						(m = !0 === H ? G[o.materialIndex] : i.material),
						void 0 !== m &&
							((J = m.side),
							e.sub(o.centroid, c),
							(f = o.normal),
							...
							!(Math.abs(m) < M) &&
								((v = f.dot(e) / m),
								!(0 > v) && (J === a.DoubleSide || (J === a.FrontSide ? 0 > m : 0 < m)))))
					)
						if ((g.add(c, d.multiplyScalar(v)), o instanceof a.Face3))
							(m = C[o.a]),
								...
								(J = C[o.c]),
								p(g, m, v, J) &&
									((v = i.matrixWorld.multiplyVector3(g.clone())),
									(m = b.distanceTo(v)),
									m < l.near ||
										m > l.far ||
										((o = { distance: m, point: v, face: o, faceIndex: q, object: i }), j.push(o)));
						else if (
							o instanceof a.Face4 &&
							((m = C[o.a]), (v = C[o.b]), (J = C[o.c]), (E = C[o.d]), p(g, m, v, E) || p(g, v, J, E))
						)
							(v = i.matrixWorld.multiplyVector3(g.clone())),
								(m = b.distanceTo(v)),
								m < l.near ||
...
THREE.Rectangle = function () {
	...
	this.addPoint = function (f, g) {
		!0 === h
			? ((h = !1), (b = f), (c = g), (d = f), (e = g))
			: ((b = b < f ? b : f), (c = c < g ? c : g), (d = d > f ? d : f), (e = e > g ? e : g));
		a();
	};
	...
	this.addRectangle = function (f) {
		!0 === h
			? ((h = !1), (b = f.getLeft()), (c = f.getTop()), (d = f.getRight()), (e = f.getBottom()))
					...
					if (f instanceof THREE.Light) H.lights.push(f);
						...
						if (!1 === f.frustumCulled || !0 === F.contains(f))
							(e = a()),
								...
								null !== f.renderDepth
									? (e.z = f.renderDepth)
									: (J.copy(f.matrixWorld.getPosition()), M.multiplyVector3(J), (e.z = J.z)),
								H.objects.push(e);
					} else
		...
		for (m = H.objects.length; g < m; g++)
			if (((ca = H.objects[g].object), (Ga = ca.matrixWorld), (j = 0), ca instanceof THREE.Mesh)) {
				...
				for (O = fa.length; la < O; la++)
					(i = b()),
						i.positionWorld.copy(fa[la]),
						Ga.multiplyVector3(i.positionWorld),
						i.positionScreen.copy(i.positionWorld),
						M.multiplyVector4(i.positionScreen),
					...
					if (((O = Ua[fa]), (Ra = !0 === ib ? Ia[O.materialIndex] : ca.material), void 0 !== Ra)) {
						...
						if (O instanceof THREE.Face3)
							if (
								...
								(V = l[O.b]),
								(Z = l[O.c]),
								!0 === W.visible && !0 === V.visible && !0 === Z.visible)
							)
								if (
									((qa =
										0 >
										(Z.positionScreen.x - W.positionScreen.x) *
											(V.positionScreen.y - W.positionScreen.y) -
											(Z.positionScreen.y - W.positionScreen.y) *
												(V.positionScreen.x - W.positionScreen.x)),
									ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide))
								)
									p === q
										? ((na = new THREE.RenderableFace3()), o.push(na), q++, p++, (n = na))
										: (n = o[p++]),
										n.v1.copy(W),
										n.v2.copy(V),
										n.v3.copy(Z);
							...
							if (
								...
								(Z = l[O.c]),
								(na = l[O.d]),
								!0 === W.visible && !0 === V.visible && !0 === Z.visible && !0 === na.visible)
							)
								if (
									((qa =
										0 >
											(na.positionScreen.x - W.positionScreen.x) *
												(V.positionScreen.y - W.positionScreen.y) -
												(na.positionScreen.y - W.positionScreen.y) *
													(V.positionScreen.x - W.positionScreen.x) ||
										0 >
											(V.positionScreen.x - Z.positionScreen.x) *
												(na.positionScreen.y - Z.positionScreen.y) -
												(V.positionScreen.y - Z.positionScreen.y) *
													(na.positionScreen.x - Z.positionScreen.x)),
									ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide))
								) {
									if (r === B) {
						...
						for (V = Z.length; W < V; W++)
							(na = n.vertexNormalsWorld[W]),
								na.copy(Z[W]),
								!1 === qa && (ia === THREE.BackSide || ia === THREE.DoubleSide) && na.negate(),
								Pa.multiplyVector3(na);
				...
				for (O = fa.length; la < O; la++)
					(W = b()),
						W.positionScreen.copy(fa[la]),
						K.multiplyVector4(W.positionScreen),
						0 < (la + 1) % Ga ||
							((V = l[j - 2]),
							I.copy(W.positionScreen),
							L.copy(V.positionScreen),
							!0 === d(I, L) &&
								(I.multiplyScalar(1 / I.w),
								L.multiplyScalar(1 / L.w),
								s === A
									? ((Ia = new THREE.RenderableLine()), z.push(Ia), A++, s++, (u = Ia))
									: (u = z[s++]),
								u.v1.positionScreen.copy(I),
								u.v2.positionScreen.copy(L),
								(u.z = Math.max(I.z, L.z)),
								(u.material = ca.material),
								H.elements.push(u)));
			}
		g = 0;
		for (m = H.sprites.length; g < m; g++)
			(ca = H.sprites[g].object),
				(Ga = ca.matrixWorld),
				ca instanceof THREE.Particle &&
					(E.set(Ga.elements[12], Ga.elements[13], Ga.elements[14], 1),
					M.multiplyVector4(E),
					(E.z /= E.w),
					0 < E.z &&
						1 > E.z &&
						(y === G
							? ((ea = new THREE.RenderableParticle()), C.push(ea), G++, y++, (v = ea))
							: (v = C[y++]),
						(v.object = ca),
						(v.x = E.x / E.w),
						(v.y = E.y / E.w),
						(v.z = E.z),
						(v.rotation = ca.rotation.z),
						(v.scale.x =
							ca.scale.x *
							Math.abs(
								v.x - (E.x + h.projectionMatrix.elements[0]) / (E.w + h.projectionMatrix.elements[12])
							)),
						(v.scale.y =
							ca.scale.y *
							Math.abs(
								v.y - (E.y + h.projectionMatrix.elements[5]) / (E.w + h.projectionMatrix.elements[13])
							)),
						(v.material = ca.material),
						H.elements.push(v)));
...
THREE.Geometry.prototype = {
		...
		for (b = this.morphTargets.length; a < b; a++) {
			...
			for (d = this.faces.length; c < d; c++)
				(e = this.faces[c]),
					...
					i.copy(e.normal),
					e instanceof THREE.Face3
						? (j.a.copy(e.vertexNormals[0]), j.b.copy(e.vertexNormals[1]), j.c.copy(e.vertexNormals[2]))
	...
	computeTangents: function () {
		...
		var b,
			...
			K = new THREE.Vector3();
		b = 0;
		for (c = this.vertices.length; b < c; b++) (C[b] = new THREE.Vector3()), (G[b] = new THREE.Vector3());
		b = 0;
		...
		for (c = this.faces.length; b < c; b++) {
			...
			for (d = 0; d < f.vertexNormals.length; d++)
				K.copy(f.vertexNormals[d]),
					(e = f[F[d]]),
					(y = C[e]),
					E.copy(y),
					E.subSelf(K.multiplyScalar(K.dot(y))).normalize(),
					M.cross(f.vertexNormals[d], y),
					(e = M.dot(G[e])),
					(e = 0 > e ? -1 : 1),
					(f.vertexTangents[d] = new THREE.Vector4(E.x, E.y, E.z, e));
		}
		this.hasTangents = !0;
	},
...
THREE.BufferGeometry.prototype = {
	...
	applyMatrix: function (a) {
		...
		void 0 !== c &&
			((b = new THREE.Matrix4()), b.extractRotation(a), b.multiplyVector3Array(c), (this.normalsNeedUpdate = !0));
	},
	computeBoundingBox: function () {
		this.boundingBox ||
			(this.boundingBox = {
	...
	computeTangents: function () {
		...
		if (
			...
			for (var h = this.attributes.tangent.array, i = [], j = [], g = 0; g < f; g++)
			...
			for (J = F.length; H < J; ++H) {
				...
				for (G += E; C < G; C += 3)
					(E = I + b[C]),
						...
						(s = y - s),
						(y = 1 / (z * s - u * A)),
						f.set((s * p - A * l) * y, (s * o - A * m) * y, (s * q - A * n) * y),
						g.set((z * l - u * p) * y, (z * m - u * o) * y, (z * n - u * q) * y),
						i[E].addSelf(f),
						i[M].addSelf(f),
						i[K].addSelf(f),
						j[E].addSelf(g),
...
THREE.Loader.prototype = {
	...
	createMaterial: function (a, b) {
		...
		a.mapBump &&
			b &&
			e(i, "bumpMap", a.mapBump, a.mapBumpRepeat, a.mapBumpOffset, a.mapBumpWrap, a.mapBumpAnisotropy);
		a.mapNormal &&
			b &&
			e(
				i,
...
THREE.BinaryLoader.prototype.createBinModel = function (a, b, c, d) {
	var e = function (b) {
		...
		function H(b, c, d) {
			for (var e, f, g, h, i, c = new Uint32Array(a, c, 4 * b), j = new Uint16Array(a, d, b), d = 0; d < b; d++)
				(e = c[4 * d]),
					...
					(h = c[4 * d + 3]),
					(i = j[d]),
					M.faces.push(new THREE.Face4(e, f, g, h, null, null, i));
		}
		function J(b, c, d, e) {
			for (
				var f,
				...
				M.faces.push(
					new THREE.Face3(
						...
						h,
						[
							new THREE.Vector3(F[3 * j], F[3 * j + 1], F[3 * j + 2]),
							new THREE.Vector3(o, p, l),
							new THREE.Vector3(q, r, m)
						],
						null,
						i
					)
			...
			for (
				...
				M.faces.push(
					new THREE.Face4(
						...
						i,
						[
							new THREE.Vector3(F[3 * l], F[3 * l + 1], F[3 * l + 2]),
							new THREE.Vector3(q, r, m),
							new THREE.Vector3(s, t, n),
		...
		i = l + j + z(2 * u);
		r &&
			((j = n + 3 * r * Uint32Array.BYTES_PER_ELEMENT),
			G(r, n, j + 3 * r * Uint32Array.BYTES_PER_ELEMENT),
			y(r, j));
		t &&
			((r = c + 3 * t * Uint32Array.BYTES_PER_ELEMENT),
			(j = r + 3 * t * Uint32Array.BYTES_PER_ELEMENT),
			J(t, c, r, j + 3 * t * Uint32Array.BYTES_PER_ELEMENT),
			y(t, j));
		u &&
			((t = l + 4 * u * Uint32Array.BYTES_PER_ELEMENT),
			H(u, l, t + 4 * u * Uint32Array.BYTES_PER_ELEMENT),
			C(u, t));
		s &&
			((u = i + 4 * s * Uint32Array.BYTES_PER_ELEMENT),
			(t = u + 4 * s * Uint32Array.BYTES_PER_ELEMENT),
			E(s, i, u, t + 4 * s * Uint32Array.BYTES_PER_ELEMENT),
			C(s, t));
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
	...
	c = 0;
	for (i = p.length; c < i; )
		(j = new THREE.Vector3()), (j.x = p[c++] * e), (j.y = p[c++] * e), (j.z = p[c++] * e), d.vertices.push(j);
	c = 0;
	for (i = u.length; c < i; ) {
		p = u[c++];
		j = p & 1;
		...
		p &= 128;
		j
			? ((q = new THREE.Face4()), (q.a = u[c++]), (q.b = u[c++]), (q.c = u[c++]), (q.d = u[c++]), (j = 4))
			: ((q = new THREE.Face3()), (q.a = u[c++]), (q.b = u[c++]), (q.c = u[c++]), (j = 3));
		...
		if (f)
			for (f = 0; f < A; f++)
				(r = a.uvs[f]),
					...
					(B = r[2 * n]),
					(n = r[2 * n + 1]),
					(d.faceUvs[f][h] = new THREE.UV(B, n));
		if (g)
			for (f = 0; f < A; f++) {
				r = a.uvs[f];
				t = [];
		...
		m &&
			((m = 3 * u[c++]), (g = new THREE.Vector3()), (g.x = s[m++]), (g.y = s[m++]), (g.z = s[m]), (q.normal = g));
		if (l)
			for (f = 0; f < j; f++)
				(m = 3 * u[c++]),
					(g = new THREE.Vector3()),
	...
	if (a.skinWeights) {
		...
		for (i = a.skinWeights.length; c < i; c += 2)
			(u = a.skinWeights[c]), (s = a.skinWeights[c + 1]), d.skinWeights.push(new THREE.Vector4(u, s, 0, 0));
	}
	if (a.skinIndices) {
		c = 0;
		for (i = a.skinIndices.length; c < i; c += 2)
			(u = a.skinIndices[c]), (s = a.skinIndices[c + 1]), d.skinIndices.push(new THREE.Vector4(u, s, 0, 0));
	}
	d.bones = a.bones;
	...
	if (void 0 !== a.morphTargets) {
		...
		for (i = a.morphTargets.length; c < i; c++) {
			...
			u = 0;
			for (s = A.length; u < s; u += 3)
				(p = new THREE.Vector3()), (p.x = A[u] * e), (p.y = A[u + 1] * e), (p.z = A[u + 2] * e), z.push(p);
		}
	}
	if (void 0 !== a.morphColors) {
		...
		for (i = a.morphColors.length; c < i; c++) {
			...
			e = 0;
			for (u = z.length; e < u; e += 3)
				(A = new THREE.Color(16755200)), A.setRGB(z[e], z[e + 1], z[e + 2]), s.push(A);
		}
	}
	d.computeCentroids();
		...
		d.addEventListener(
			...
			function (d) {
				d.target.responseText
					...
					: b.dispatchEvent({ type: "error", message: "Invalid file [" + a + "]" });
			},
			!1
		);
		d.addEventListener(
			...
			for (var f = 0; f < a.materials.length; ++f) {
				var g = a.materials[f],
					...
					j = function (a, d, e, f, g, l) {
						...
						if (
							f &&
							(a[d].repeat.set(f[0], f[1]), 1 !== f[0] && (a[d].wrapS = THREE.RepeatWrapping), 1 !== f[1])
						)
				...
				void 0 !== g.vertexColors &&
					("face" == g.vertexColors
						? (n.vertexColors = THREE.FaceColors)
						: g.vertexColors && (n.vertexColors = THREE.VertexColors));
				...
				g.mapBump && j(n, "bumpMap", g.mapBump, g.mapBumpRepeat, g.mapBumpOffset, g.mapBumpWrap);
				g.mapNormal && j(n, "normalMap", g.mapNormal, g.mapNormalRepeat, g.mapNormalOffset, g.mapNormalWrap);
				g.mapSpecular &&
					j(n, "specularMap", g.mapSpecular, g.mapSpecularRepeat, g.mapSpecularOffset, g.mapSpecularWrap);
				g.mapNormal
					? ((j = THREE.ShaderUtils.lib.normal),
					  (l = THREE.UniformsUtils.clone(j.uniforms)),
					  (l.tNormal.value = n.normalMap),
					  g.mapNormalFactor && l.uNormalScale.value.set(g.mapNormalFactor, g.mapNormalFactor),
					  n.map && ((l.tDiffuse.value = n.map), (l.enableDiffuse.value = !0)),
					  n.specularMap && ((l.tSpecular.value = n.specularMap), (l.enableSpecular.value = !0)),
					  n.lightMap && ((l.tAO.value = n.lightMap), (l.enableAO.value = !0)),
					  ...
					  void 0 !== n.opacity && (l.uOpacity.value = n.opacity),
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
			...
			if (void 0 === I.objects[c]) {
				...
				if (void 0 !== d.geometry) {
					if ((y = I.geometries[d.geometry]))
						(f = !1),
							(C = I.materials[d.materials[0]]),
							(f = C instanceof THREE.ShaderMaterial) && y.computeTangents(),
							(B = d.position),
							(u = d.rotation),
							(s = d.quaternion),
							(z = d.scale),
							(r = d.matrix),
							(s = 0),
							0 === d.materials.length && (C = new THREE.MeshFaceMaterial()),
							1 < d.materials.length && (C = new THREE.MeshFaceMaterial()),
							d.morph
								? ((f = new THREE.MorphAnimMesh(y, C)),
								  void 0 !== d.duration && (f.duration = d.duration),
								  void 0 !== d.time && (f.time = d.time),
								  void 0 !== d.mirroredLoop && (f.mirroredLoop = d.mirroredLoop),
								  C.morphNormals && y.computeMorphNormals())
								: (f = new THREE.Mesh(y, C)),
							(f.name = c),
							r
								...
								: (f.position.set(B[0], B[1], B[2]),
								  s
										? (f.quaternion.set(s[0], s[1], s[2], s[3]), (f.useQuaternion = !0))
										: f.rotation.set(u[0], u[1], u[2]),
								  f.scale.set(z[0], z[1], z[2])),
							(f.visible = d.visible),
							(f.castShadow = d.castShadow),
							(f.receiveShadow = d.receiveShadow),
							a.add(f),
							(I.objects[c] = f);
				} else
					(B = d.position),
						...
						s
							...
							: f.rotation.set(u[0], u[1], u[2]),
						f.scale.set(z[0], z[1], z[2]),
						(f.visible = void 0 !== d.visible ? d.visible : !1),
						a.add(f),
						(I.objects[c] = f),
						(I.empties[c] = f);
				if (f) {
	...
	for (A in this.geometryHandlerMap)
		this.geometryHandlerMap[A].loaderObject = new this.geometryHandlerMap[A].loaderClass();
	M = E = 0;
	I = {
	...
	for (p in L.cameras)
		(A = L.cameras[p]),
			"perspective" === A.type
				? (G = new THREE.PerspectiveCamera(A.fov, A.aspect, A.near, A.far))
				: "ortho" === A.type &&
				  (G = new THREE.OrthographicCamera(A.left, A.right, A.top, A.bottom, A.near, A.far)),
			(B = A.position),
			(c = A.target),
			(A = A.up),
			G.position.set(B[0], B[1], B[2]),
			(G.target = new THREE.Vector3(c[0], c[1], c[2])),
			A && G.up.set(A[0], A[1], A[2]),
			(I.cameras[p] = G);
	for (n in L.lights)
		(c = L.lights[n]),
			(p = void 0 !== c.color ? c.color : 16777215),
			(G = void 0 !== c.intensity ? c.intensity : 1),
			"directional" === c.type
				? ((B = c.direction),
				  (t = new THREE.DirectionalLight(p, G)),
				  t.position.set(B[0], B[1], B[2]),
				  t.position.normalize())
				: "point" === c.type
				? ((B = c.position),
				  (t = c.distance),
				  (t = new THREE.PointLight(p, G, t)),
				  t.position.set(B[0], B[1], B[2]))
				: "ambient" === c.type && (t = new THREE.AmbientLight(p)),
			I.scene.add(t),
			(I.lights[n] = t);
	for (o in L.fogs)
		(n = L.fogs[o]),
			"linear" === n.type
				? (H = new THREE.Fog(0, n.near, n.far))
				: "exp2" === n.type && (H = new THREE.FogExp2(0, n.density)),
			(A = n.color),
			H.color.setRGB(A[0], A[1], A[2]),
			(I.fogs[o] = H);
	...
	for (l in L.geometries)
		if (((o = L.geometries[l]), "cube" === o.type))
			...
			(y = new THREE.PlaneGeometry(o.width, o.height, o.segmentsWidth, o.segmentsHeight)), (I.geometries[l] = y);
			...
			(y = new THREE.CylinderGeometry(o.topRad, o.botRad, o.height, o.radSegs, o.heightSegs)),
				(I.geometries[l] = y);
			...
			(y = new THREE.IcosahedronGeometry(o.radius, o.subdivisions)), (I.geometries[l] = y);
			...
			"embedded" === o.type &&
				((o = L.embeds[o.id]),
				(o.metadata = L.metadata),
				o && this.geometryHandlerMap.ascii.loaderObject.createModel(o, g(l), ""));
	for (q in L.textures)
	...
	for (q in L.textures) {
		...
		if (l.url instanceof Array) {
			...
			J = (J = H[0].endsWith(".dds"))
				? THREE.ImageUtils.loadCompressedTextureCube(H, l.mapping, a(o))
				: THREE.ImageUtils.loadTextureCube(H, l.mapping, a(o));
		} else {
			J = l.url.toLowerCase().endsWith(".dds");
			o = d(l.url, L.urlBaseType);
			H = a(1);
			J = J
				? THREE.ImageUtils.loadCompressedTexture(o, l.mapping, H)
				: THREE.ImageUtils.loadTexture(o, l.mapping, H);
			...
			if (
				l.repeat &&
				(J.repeat.set(l.repeat[0], l.repeat[1]),
				1 !== l.repeat[0] && (J.wrapS = THREE.RepeatWrapping),
				1 !== l.repeat[1])
			)
			...
			if (
				l.wrap &&
				((o = { repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping }),
				void 0 !== o[l.wrap[0]] && (J.wrapS = o[l.wrap[0]]),
				void 0 !== o[l.wrap[1]])
			)
				J.wrapT = o[l.wrap[1]];
		}
	...
	for (m in L.materials) {
		...
		for (v in r.parameters)
			"envMap" === v || "map" === v || "lightMap" === v || "bumpMap" === v
				? (r.parameters[v] = I.textures[r.parameters[v]])
				: "shading" === v
				? (r.parameters[v] = "flat" === r.parameters[v] ? THREE.FlatShading : THREE.SmoothShading)
				: "side" === v
				? (r.parameters[v] =
						"double" == r.parameters[v]
							? THREE.DoubleSide
							: "back" == r.parameters[v]
							? THREE.BackSide
							: THREE.FrontSide)
				: "blending" === v
				? (r.parameters[v] = r.parameters[v] in THREE ? THREE[r.parameters[v]] : THREE.NormalBlending)
				: "combine" === v
				? (r.parameters[v] = "MixOperation" == r.parameters[v] ? THREE.MixOperation : THREE.MultiplyOperation)
				: "vertexColors" === v
				? "face" == r.parameters[v]
					? (r.parameters[v] = THREE.FaceColors)
					: r.parameters[v] && (r.parameters[v] = THREE.VertexColors)
				: "wrapRGB" === v && ((q = r.parameters[v]), (r.parameters[v] = new THREE.Vector3(q[0], q[1], q[2])));
		...
		r.parameters.normalMap
			? ((q = THREE.ShaderUtils.lib.normal),
			  ...
			  (J = r.parameters.specular),
			  (o = r.parameters.ambient),
			  (H = r.parameters.shininess),
			  (a.tNormal.value = I.textures[r.parameters.normalMap]),
			  r.parameters.normalScale &&
					a.uNormalScale.value.set(r.parameters.normalScale[0], r.parameters.normalScale[1]),
			  r.parameters.map && ((a.tDiffuse.value = r.parameters.map), (a.enableDiffuse.value = !0)),
			  r.parameters.envMap &&
					((a.tCube.value = r.parameters.envMap),
					(a.enableReflection.value = !0),
					(a.uReflectivity.value = r.parameters.reflectivity)),
			  r.parameters.lightMap && ((a.tAO.value = r.parameters.lightMap), (a.enableAO.value = !0)),
			  r.parameters.specularMap &&
					((a.tSpecular.value = I.textures[r.parameters.specularMap]), (a.enableSpecular.value = !0)),
			  ...
			  a.uSpecularColor.value.setHex(J),
			  a.uAmbientColor.value.setHex(o),
			  (a.uShininess.value = H),
			  r.parameters.opacity && (a.uOpacity.value = r.parameters.opacity),
...
THREE.SkinnedMesh.prototype.updateMatrixWorld = function (a) {
	...
	a = 0;
	for (b = this.bones.length; a < b; a++)
		THREE.SkinnedMesh.offsetMatrix.multiply(this.bones[a].skinMatrix, this.boneInverses[a]),
	...
	function c(a) {
		u !== a &&
			(a === THREE.NormalBlending
				...
				: a === THREE.SubtractiveBlending && (q.globalCompositeOperation = "darker"),
			(u = a));
	}
	function d(a) {
		...
		!1 === Ja.isEmpty() &&
			...
			1 > t &&
				q.clearRect(
					Math.floor(Ja.getX()),
					Math.floor(Ja.getY()),
					Math.floor(Ja.getWidth()),
					Math.floor(Ja.getHeight())
				),
			0 < t &&
	...
	this.render = function (a, l) {
			...
			for (var d = 0, e = i.length; d < e; d++) {
				...
				if (f instanceof THREE.DirectionalLight) {
					...
					f instanceof THREE.PointLight &&
						...
						(k = b.dot(ra.sub(h, a).normalize())),
						0 >= k ||
							((k *= 0 == f.distance ? 1 : 1 - Math.min(a.distanceTo(h) / f.distance, 1)),
							0 != k && ((k *= f.intensity), (c.r += g.r * k), (c.g += g.g * k), (c.b += g.b * k))));
			}
		}
		function n(a, d, e, g, h, k, i, j) {
			...
			null === j.map
				? (Z.copy(j.color),
				  ca.copy(j.emissive),
				  j.vertexColors === THREE.FaceColors && ((Z.r *= i.color.r), (Z.g *= i.color.g), (Z.b *= i.color.b)),
				  !0 === wb)
					? !1 === j.wireframe && j.shading == THREE.SmoothShading && 3 == i.vertexNormalsLength
						? ((fa.r = W.r = V.r = Da.r),
						  (fa.g = W.g = V.g = Da.g),
						  (fa.b = W.b = V.b = Da.b),
						  m(i.v1.positionWorld, i.vertexNormalsWorld[0], fa),
						  m(i.v2.positionWorld, i.vertexNormalsWorld[1], W),
						  m(i.v3.positionWorld, i.vertexNormalsWorld[2], V),
						  (fa.r = fa.r * Z.r + ca.r),
						  (fa.g = fa.g * Z.g + ca.g),
						  (fa.b = fa.b * Z.b + ca.b),
						  (W.r = W.r * Z.r + ca.r),
						  ...
						  (ia.b = 0.5 * (W.b + V.b)),
						  (na = Dc(fa, W, V, ia)),
						  gc(K, F, I, L, R, $, 0, 0, 1, 0, 0, 1, na))
						: ((O.r = Da.r),
						  (O.g = Da.g),
						  (O.b = Da.b),
						  m(i.centroidWorld, i.normalWorld, O),
						  (O.r = O.r * Z.r + ca.r),
						  (O.g = O.g * Z.g + ca.g),
						  (O.b = O.b * Z.b + ca.b),
						  !0 === j.wireframe
								? t(O, j.wireframeLinewidth, j.wireframeLinecap, j.wireframeLinejoin)
								: u(O))
					: !0 === j.wireframe
				...
				? null !== j.map
					? j.map.mapping instanceof THREE.UVMapping &&
					  ((Va = i.uvs[0]),
					  Ba(K, F, I, L, R, $, Va[g].u, Va[g].v, Va[h].u, Va[h].v, Va[k].u, Va[k].v, j.map))
					: null !== j.envMap
					? j.envMap.mapping instanceof THREE.SphericalReflectionMapping &&
					  ((a = l.matrixWorldInverse),
					  ra.copy(i.vertexNormalsWorld[g]),
					  (ib = 0.5 * (ra.x * a.elements[0] + ra.y * a.elements[4] + ra.z * a.elements[8]) + 0.5),
					  (Ra = 0.5 * (ra.x * a.elements[1] + ra.y * a.elements[5] + ra.z * a.elements[9]) + 0.5),
					  ra.copy(i.vertexNormalsWorld[h]),
					  (eb = 0.5 * (ra.x * a.elements[0] + ra.y * a.elements[4] + ra.z * a.elements[8]) + 0.5),
					  (pb = 0.5 * (ra.x * a.elements[1] + ra.y * a.elements[5] + ra.z * a.elements[9]) + 0.5),
					  ra.copy(i.vertexNormalsWorld[k]),
					  (Pb = 0.5 * (ra.x * a.elements[0] + ra.y * a.elements[4] + ra.z * a.elements[8]) + 0.5),
					  (db = 0.5 * (ra.x * a.elements[1] + ra.y * a.elements[5] + ra.z * a.elements[9]) + 0.5),
					  Ba(K, F, I, L, R, $, ib, Ra, eb, pb, Pb, db, j.envMap))
					: (O.copy(j.color),
					  j.vertexColors === THREE.FaceColors &&
							((O.r *= i.color.r), (O.g *= i.color.g), (O.b *= i.color.b)),
					  !0 === j.wireframe ? t(O, j.wireframeLinewidth, j.wireframeLinecap, j.wireframeLinejoin) : u(O))
				: j instanceof THREE.MeshDepthMaterial
				? ((Ia = l.near),
				  (Ua = l.far),
				  (fa.r = fa.g = fa.b = 1 - tb(a.positionScreen.z, Ia, Ua)),
				  (W.r = W.g = W.b = 1 - tb(d.positionScreen.z, Ia, Ua)),
				  (V.r = V.g = V.b = 1 - tb(e.positionScreen.z, Ia, Ua)),
				  (ia.r = 0.5 * (W.r + V.r)),
				  (ia.g = 0.5 * (W.g + V.g)),
				  (ia.b = 0.5 * (W.b + V.b)),
				  (na = Dc(fa, W, V, ia)),
				...
				: j instanceof THREE.MeshNormalMaterial &&
				  ((O.r = jc(i.normalWorld.x)),
				  (O.g = jc(i.normalWorld.y)),
				  (O.b = jc(i.normalWorld.z)),
				  !0 === j.wireframe ? t(O, j.wireframeLinewidth, j.wireframeLinecap, j.wireframeLinejoin) : u(O));
		}
			...
			if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
				...
				0 === Ba
					? (void 0 === Pa[n.id] &&
							...
							(Pa[n.id] = b.getImageData(0, 0, n.image.width, n.image.height).data)),
					  (b = Pa[n.id]),
					  (h = 4 * (Math.floor(h) + Math.floor(k) * n.image.width)),
		...
		if (!1 === l instanceof THREE.Camera)
			...
			if (!0 === wb) {
				...
				for (Fc = i.length; B < Fc; B++) {
					aa = i[B];
					var z = aa.color;
					aa instanceof THREE.AmbientLight
						? ((Da.r += z.r), (Da.g += z.g), (Da.b += z.b))
						: aa instanceof THREE.DirectionalLight
						? ((qb.r += z.r), (qb.g += z.g), (qb.b += z.b))
						: aa instanceof THREE.PointLight && ((fb.r += z.r), (fb.g += z.g), (fb.b += z.b));
				}
			}
			B = 0;
				...
				if (((ja = h[B]), (aa = ja.material), !(void 0 === aa || !1 === aa.visible))) {
					...
					if (ja instanceof THREE.RenderableParticle) {
						...
						var rb = void 0,
							...
							kc = (ja = void 0),
							Uc = void 0;
						aa instanceof THREE.ParticleBasicMaterial
							? null === aa.map
								? ((jb = Xa.object.scale.x),
								  (kb = Xa.object.scale.y),
								  (jb *= Xa.scale.x * p),
								  (kb *= Xa.scale.y * o),
								  wa.set(z.x - jb, z.y - kb, z.x + jb, z.y + kb),
								  !1 !== $a.intersects(wa) &&
										(e(aa.color.getContextStyle()),
										q.save(),
										q.translate(z.x, z.y),
										q.rotate(-Xa.rotation),
										q.scale(jb, kb),
										q.fillRect(-1, -1, 2, 2),
										q.restore()))
								: ((ja = aa.map.image),
								  ...
								  (rb = jb * kc),
								  (sb = kb * Uc),
								  wa.set(z.x - rb, z.y - sb, z.x + rb, z.y + sb),
								  !1 !== $a.intersects(wa) &&
										(q.save(),
										q.translate(z.x, z.y),
										q.rotate(-Xa.rotation),
										...
										q.drawImage(ja, 0, 0),
										q.restore()))
							: aa instanceof THREE.ParticleCanvasMaterial &&
							  ((rb = Xa.scale.x * p),
							  (sb = Xa.scale.y * o),
							  wa.set(z.x - rb, z.y - sb, z.x + rb, z.y + sb),
							  !1 !== $a.intersects(wa) &&
									(d(aa.color.getContextStyle()),
									e(aa.color.getContextStyle()),
									q.save(),
									q.translate(z.x, z.y),
									q.rotate(-Xa.rotation),
						...
						if (
							...
							wa.addPoint(C.positionScreen.x, C.positionScreen.y),
							wa.addPoint(G.positionScreen.x, G.positionScreen.y),
							!0 === $a.intersects(wa) &&
								((z = C),
								(Xa = G),
								b(aa.opacity),
								c(aa.blending),
								q.beginPath(),
								q.moveTo(z.positionScreen.x, z.positionScreen.y),
								q.lineTo(Xa.positionScreen.x, Xa.positionScreen.y),
								aa instanceof THREE.LineBasicMaterial))
						)
							(z = aa.linewidth),
								A !== z && (A = q.lineWidth = z),
								(z = aa.linecap),
						...
						(C = ja.v1),
							...
							(G.positionScreen.x *= p),
							(G.positionScreen.y *= o),
							(H.positionScreen.x *= p),
							(H.positionScreen.y *= o),
							!0 === aa.overdraw &&
								(Wb(C.positionScreen, G.positionScreen),
								Wb(G.positionScreen, H.positionScreen),
								Wb(H.positionScreen, C.positionScreen)),
							wa.add3Points(
								C.positionScreen.x,
								C.positionScreen.y,
								G.positionScreen.x,
							...
							!0 === $a.intersects(wa) && n(C, G, H, 0, 1, 2, ja, aa, a);
					else if (
						ja instanceof THREE.RenderableFace4 &&
						((C = ja.v1),
						(G = ja.v2),
						(H = ja.v3),
						(J = ja.v4),
						...
						(H.positionScreen.x *= p),
						(H.positionScreen.y *= o),
						(J.positionScreen.x *= p),
						(J.positionScreen.y *= o),
						E.positionScreen.copy(G.positionScreen),
						M.positionScreen.copy(J.positionScreen),
						!0 === aa.overdraw &&
							(Wb(C.positionScreen, G.positionScreen),
							Wb(G.positionScreen, J.positionScreen),
							Wb(J.positionScreen, C.positionScreen),
							Wb(H.positionScreen, E.positionScreen),
							Wb(H.positionScreen, M.positionScreen)),
						wa.addPoint(C.positionScreen.x, C.positionScreen.y),
						wa.addPoint(G.positionScreen.x, G.positionScreen.y),
						wa.addPoint(H.positionScreen.x, H.positionScreen.y),
						wa.addPoint(J.positionScreen.x, J.positionScreen.y),
						!0 === $a.intersects(wa))
					)
						((z = C),
						(Xa = G),
						...
						b(aa.opacity),
						c(aa.blending),
						(void 0 !== aa.map && null !== aa.map) || (void 0 !== aa.envMap && null !== aa.envMap))
							? (n(z, Xa, sb, 0, 1, 3, ja, aa, kc), n(jb, rb, kb, 1, 2, 3, ja, aa, kc))
							: ((K = z.positionScreen.x),
							  (F = z.positionScreen.y),
							  (I = Xa.positionScreen.x),
							  (L = Xa.positionScreen.y),
							  (R = rb.positionScreen.x),
							  ($ = rb.positionScreen.y),
							  (Y = sb.positionScreen.x),
							  (N = sb.positionScreen.y),
							  (ea = jb.positionScreen.x),
							  (Q = jb.positionScreen.y),
							  (qa = kb.positionScreen.x),
							  (la = kb.positionScreen.y),
							  aa instanceof THREE.MeshLambertMaterial || aa instanceof THREE.MeshPhongMaterial)
							? (Z.copy(aa.color),
							  ca.copy(aa.emissive),
							  aa.vertexColors === THREE.FaceColors &&
									((Z.r *= ja.color.r), (Z.g *= ja.color.g), (Z.b *= ja.color.b)),
							  !0 === wb)
								? !1 === aa.wireframe &&
								  aa.shading == THREE.SmoothShading &&
								  4 == ja.vertexNormalsLength
									? ((fa.r = W.r = V.r = ia.r = Da.r),
									  (fa.g = W.g = V.g = ia.g = Da.g),
									  (fa.b = W.b = V.b = ia.b = Da.b),
									  m(ja.v1.positionWorld, ja.vertexNormalsWorld[0], fa),
									  m(ja.v2.positionWorld, ja.vertexNormalsWorld[1], W),
									  m(ja.v4.positionWorld, ja.vertexNormalsWorld[3], V),
									  m(ja.v3.positionWorld, ja.vertexNormalsWorld[2], ia),
									  (fa.r = fa.r * Z.r + ca.r),
									  (fa.g = fa.g * Z.g + ca.g),
									  (fa.b = fa.b * Z.b + ca.b),
									  (W.r = W.r * Z.r + ca.r),
									  ...
									  (na = Dc(fa, W, V, ia)),
									  r(K, F, I, L, Y, N),
									  gc(K, F, I, L, Y, N, 0, 0, 1, 0, 0, 1, na),
									  r(ea, Q, R, $, qa, la),
									  gc(ea, Q, R, $, qa, la, 1, 0, 1, 1, 0, 1, na))
									: ((O.r = Da.r),
									  (O.g = Da.g),
									  (O.b = Da.b),
									  m(ja.centroidWorld, ja.normalWorld, O),
									  (O.r = O.r * Z.r + ca.r),
									  (O.g = O.g * Z.g + ca.g),
									  (O.b = O.b * Z.b + ca.b),
									  s(K, F, I, L, R, $, Y, N),
									  !0 === aa.wireframe
											? t(O, aa.wireframeLinewidth, aa.wireframeLinecap, aa.wireframeLinejoin)
											: u(O))
								: ((O.r = Z.r + ca.r),
								  (O.g = Z.g + ca.g),
								  (O.b = Z.b + ca.b),
								  ...
								  !0 === aa.wireframe
										? t(O, aa.wireframeLinewidth, aa.wireframeLinecap, aa.wireframeLinejoin)
										: u(O))
							: aa instanceof THREE.MeshBasicMaterial
							? (O.copy(aa.color),
							  aa.vertexColors === THREE.FaceColors &&
									((O.r *= ja.color.r), (O.g *= ja.color.g), (O.b *= ja.color.b)),
							  s(K, F, I, L, R, $, Y, N),
							  !0 === aa.wireframe
									? t(O, aa.wireframeLinewidth, aa.wireframeLinecap, aa.wireframeLinejoin)
									: u(O))
							: aa instanceof THREE.MeshNormalMaterial
							? ((O.r = jc(ja.normalWorld.x)),
							  (O.g = jc(ja.normalWorld.y)),
							  (O.b = jc(ja.normalWorld.z)),
							  s(K, F, I, L, R, $, Y, N),
							  !0 === aa.wireframe
									? t(O, aa.wireframeLinewidth, aa.wireframeLinecap, aa.wireframeLinejoin)
									: u(O))
							: aa instanceof THREE.MeshDepthMaterial &&
							  ((Ia = l.near),
							  (Ua = l.far),
							  (fa.r = fa.g = fa.b = 1 - tb(z.positionScreen.z, Ia, Ua)),
							  (W.r = W.g = W.b = 1 - tb(Xa.positionScreen.z, Ia, Ua)),
							  (V.r = V.g = V.b = 1 - tb(sb.positionScreen.z, Ia, Ua)),
							  (ia.r = ia.g = ia.b = 1 - tb(rb.positionScreen.z, Ia, Ua)),
							  (na = Dc(fa, W, V, ia)),
							  r(K, F, I, L, Y, N),
							  gc(K, F, I, L, Y, N, 0, 0, 1, 0, 0, 1, na),
							  r(ea, Q, R, $, qa, la),
...
THREE.WebGLRenderer = function (a) {
	...
	function g(a, b, c) {
		...
		if (c.sortParticles) {
			...
			for (d = 0; d < g; d++) (e = h[d]), Za.copy(e), gb.multiplyVector3(Za), (m[d] = [Za.z, d]);
			m.sort(function (a, b) {
				return b[0] - a[0];
			});
	...
	function h(a, b, c) {
		...
		a.elementsNeedUpdate &&
			void 0 !== f &&
			(k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, f.buffer), k.bufferData(k.ELEMENT_ARRAY_BUFFER, f.array, b));
		a.verticesNeedUpdate &&
			void 0 !== e &&
			(k.bindBuffer(k.ARRAY_BUFFER, e.buffer), k.bufferData(k.ARRAY_BUFFER, e.array, b));
		a.normalsNeedUpdate &&
			void 0 !== g &&
			(k.bindBuffer(k.ARRAY_BUFFER, g.buffer), k.bufferData(k.ARRAY_BUFFER, g.array, b));
		a.uvsNeedUpdate &&
			void 0 !== h &&
			(k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.bufferData(k.ARRAY_BUFFER, h.array, b));
		a.colorsNeedUpdate &&
			void 0 !== i &&
			(k.bindBuffer(k.ARRAY_BUFFER, i.buffer), k.bufferData(k.ARRAY_BUFFER, i.array, b));
		a.tangentsNeedUpdate &&
			void 0 !== d &&
			(k.bindBuffer(k.ARRAY_BUFFER, d.buffer), k.bufferData(k.ARRAY_BUFFER, d.array, b));
	...
	function l(a, b, c) {
		if (a.length)
			for (var d = 0, f = a.length; d < f; d++)
				(ia = O = null),
					(W = V = Pa = Ga = Ra = ib = Ia = -1),
					(Ea = !0),
					a[d].render(b, c, Da, qb),
					(ia = O = null),
					(W = V = Pa = Ga = Ra = ib = Ia = -1),
					(Ea = !0);
	}
		...
		for (var n = i; n !== b; n += l)
			if (((k = a[n]), k.render)) {
				...
				j instanceof THREE.BufferGeometry
					? Q.renderBufferDirect(d, f, e, k, j, i)
					: Q.renderBuffer(d, f, e, k, j, i);
			}
	}
	function n(a, b, c, d, f, e, g) {
		for (var h, k, i = 0, j = a.length; i < j; i++)
			if (((h = a[i]), (k = h.object), k.visible)) {
				if (g) h = g;
				else {
					h = h[b];
					if (!h) continue;
		...
		if (e) {
						...
						(j = b[c]),
							!j.onlyShadow &&
								...
								j instanceof THREE.AmbientLight
									...
									? ((p = 3 * fa),
									  Q.gammaInput ? z(t, p, o, r * r) : A(t, p, o, r),
									  Wa.copy(j.matrixWorld.getPosition()),
									  Wa.subSelf(j.target.matrixWorld.getPosition()),
									  Wa.normalize(),
									  (v[p] = Wa.x),
									  (v[p + 1] = Wa.y),
									  (v[p + 2] = Wa.z),
									...
									? ((q = 3 * R),
									  Q.gammaInput ? z(y, q, o, r * r) : A(y, q, o, r),
									...
									? ((q = 3 * ea),
									  Q.gammaInput ? z(H, q, o, r * r) : A(H, q, o, r),
									  (r = j.matrixWorld.getPosition()),
									  (J[q] = r.x),
									  (J[q + 1] = r.y),
									  (J[q + 2] = r.z),
			...
			if (f.receiveShadow && !d._shadowPass && i.shadowMatrix) {
				...
				for (e = b.length; c < e; c++)
					if (
						((j = b[c]),
						j.castShadow &&
							(j instanceof THREE.SpotLight || (j instanceof THREE.DirectionalLight && !j.shadowCascade)))
					)
			...
			for (Y = b.length; i < Y; i++)
				if ((e = g.uniforms[b[i][1]]))
					...
					else if ("iv1" === l) k.uniform1iv(e, j);
							...
							if (m.image instanceof Array && 6 === m.image.length) {
								if (((c = m), (e = j), 6 === c.image.length))
									if (c.needsUpdate) {
										...
										j = [];
										for (l = 0; 6 > l; l++)
											Q.autoScaleCubemaps && !e
												? ((n = j),
												  (m = l),
												  (s = c.image[l]),
												  (v = Tc),
												  (s.width <= v && s.height <= v) ||
														((y = Math.max(s.width, s.height)),
														(t = Math.floor((s.width * v) / y)),
														(v = Math.floor((s.height * v) / y)),
														(y = document.createElement("canvas")),
														(y.width = t),
														(y.height = v),
														y
															.getContext("2d")
															.drawImage(s, 0, 0, s.width, s.height, 0, 0, t, v),
														(s = y)),
												  (n[m] = s))
												: (j[l] = c.image[l]);
										l = j[0];
	...
	function C(a, b) {
		...
		return !k.getShaderParameter(c, k.COMPILE_STATUS)
			? (console.error(k.getShaderInfoLog(c)), console.error(y(b)), null)
			: c;
	}
	function G(a, b, c) {
		c
			? (k.texParameteri(a, k.TEXTURE_WRAP_S, E(b.wrapS)),
			  k.texParameteri(a, k.TEXTURE_WRAP_T, E(b.wrapT)),
			  k.texParameteri(a, k.TEXTURE_MAG_FILTER, E(b.magFilter)),
			  k.texParameteri(a, k.TEXTURE_MIN_FILTER, E(b.minFilter)))
			: (k.texParameteri(a, k.TEXTURE_WRAP_S, k.CLAMP_TO_EDGE),
			  k.texParameteri(a, k.TEXTURE_WRAP_T, k.CLAMP_TO_EDGE),
			  k.texParameteri(a, k.TEXTURE_MAG_FILTER, J(b.magFilter)),
			  k.texParameteri(a, k.TEXTURE_MIN_FILTER, J(b.minFilter)));
		if (Qb && b.type !== THREE.FloatType && (1 < b.anisotropy || b.__oldAnisotropy))
			k.texParameterf(a, Qb.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, Ec)),
		...
		if (!1 !== d.visible)
			if (
				...
				f instanceof THREE.ParticleSystem &&
					...
					Q.info.render.calls++,
					(Q.info.render.points += h.numItems / 3));
	};
		...
		if (!1 !== d.visible) {
			...
			if (!d.morphTargets && 0 <= b.position)
				...
				if (f.morphTargetForcedOrder.length) {
					...
					for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length; )
						k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[h[i]]),
							...
							d.morphNormals &&
								...
								k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0)),
					...
					h.length > d.numSupportedMorphTargets
						? (h.sort(j), (h.length = d.numSupportedMorphTargets))
					...
					for (i = 0; i < d.numSupportedMorphTargets; )
						h[i]
							...
							: (k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, !1, 0, 0),
							  d.morphNormals && k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, !1, 0, 0),
							  (f.__webglMorphTargetInfluences[i] = 0)),
							i++;
				}
				null !== d.program.uniforms.morphTargetInfluences &&
					k.uniform1fv(d.program.uniforms.morphTargetInfluences, f.__webglMorphTargetInfluences);
			}
			if (a) {
					...
					for (h = e.__webglCustomAttributesList.length; g < h; g++)
						(c = e.__webglCustomAttributesList[g]),
							0 <= b[c.buffer.belongsToAttribute] &&
								...
								k.vertexAttribPointer(b[c.buffer.belongsToAttribute], c.size, k.FLOAT, !1, 0, 0));
				}
				0 <= b.color &&
			...
			f instanceof THREE.Mesh
				...
				: f instanceof THREE.Ribbon &&
				  (k.drawArrays(k.TRIANGLE_STRIP, 0, e.__webglVertexCount), Q.info.render.calls++);
		}
	};
		...
		if (!1 === b instanceof THREE.Camera)
			...
			a.overrideMaterial
				? ((d = a.overrideMaterial),
				  ...
				  v(d.polygonOffset, d.polygonOffsetFactor, d.polygonOffsetUnits),
				  m(a.__webglObjects, !1, "", b, j, o, !0, d),
				  n(a.__webglObjectsImmediate, "", b, j, o, !1, d))
				: (this.setBlending(THREE.NormalBlending),
				  m(a.__webglObjects, !0, "opaque", b, j, o, !1),
				  n(a.__webglObjectsImmediate, "opaque", b, j, o, !1),
				  m(a.__webglObjects, !1, "transparent", b, j, o, !0),
				  n(a.__webglObjectsImmediate, "transparent", b, j, o, !0));
	...
	this.renderImmediateObject = function (a, b, c, d, e) {
		...
		e.immediateRenderCallback
			? e.immediateRenderCallback(f, k, fb)
			: e.render(function (a) {
	...
	this.initWebGLObjects = function (a) {
		...
		for (; a.__objectsAdded.length; ) {
						...
						if (void 0 === m.geometryGroups) {
							...
							for (v = s.faces.length; u < v; u++)
								(y = s.faces[u]),
									(z = y.materialIndex),
									(B = void 0 !== z ? z : -1),
									void 0 === E[B] && (E[B] = { hash: B, counter: 0 }),
									(C = E[B].hash + "_" + E[B].counter),
									void 0 === s.geometryGroups[C] &&
										(s.geometryGroups[C] = {
											faces3: [],
											faces4: [],
											materialIndex: z,
									...
									(A = y instanceof THREE.Face3 ? 3 : 4),
									65535 < s.geometryGroups[C].vertices + A &&
										((E[B].counter += 1),
										(C = E[B].hash + "_" + E[B].counter),
										void 0 === s.geometryGroups[C] &&
											(s.geometryGroups[C] = {
									...
									y instanceof THREE.Face3
										? s.geometryGroups[C].faces3.push(u)
										: s.geometryGroups[C].faces4.push(u),
									(s.geometryGroups[C].vertices += A);
							...
							if (((n = m.geometryGroups[l]), !n.__webglVertexBuffer)) {
								...
								if (Y) {
									if (0 < L.faceUvs.length || 0 < L.faceVertexUvs.length)
										F.__uvArray = new Float32Array(2 * V);
								...
								M.geometry.skinWeights.length &&
									...
									((F.__skinIndexArray = new Float32Array(4 * V)),
									(F.__skinWeightArray = new Float32Array(4 * V)));
			...
			if (!i.__webglActive) {
				if (i instanceof THREE.Mesh)
					...
					i instanceof THREE.Ribbon || i instanceof THREE.Line || i instanceof THREE.ParticleSystem
						? ((m = i.geometry), p(j.__webglObjects, m, i))
						: i instanceof THREE.ImmediateRenderObject || i.immediateRenderCallback
						? j.__webglObjectsImmediate.push({ object: i, opaque: null, transparent: null })
		...
		for (; a.__objectsRemoved.length; ) {
			...
			lb instanceof THREE.Line
				? r(Za.__webglObjects, lb)
				: lb instanceof THREE.Sprite
				? t(Za.__webglSprites, lb)
				: lb instanceof THREE.LensFlare
				? t(Za.__webglFlares, lb)
				: (lb instanceof THREE.ImmediateRenderObject || lb.immediateRenderCallback) &&
				  r(Za.__webglObjectsImmediate, lb);
			lb.__webglActive = !1;
			...
			if (ub instanceof THREE.Mesh)
				if (ga instanceof THREE.BufferGeometry)
					(ga.verticesNeedUpdate ||
						...
						ga.colorsNeedUpdate ||
						ga.tangentsNeedUpdate) &&
						h(ga, k.DYNAMIC_DRAW, !ga.dynamic),
					...
					for (var pb = 0, wb = ga.geometryGroupsList.length; pb < wb; pb++)
						if (
							...
							if (ma.__inittedArrays) {
								...
								if (jd) {
									...
									for (rc = bc.length; Ma < rc; Ma++) {
										...
										for (X = oa.length; D < X; D++)
											($b = oa[D]),
												(P = Ta[$b]),
												(S = bc[Ma].vertices[P.a]),
												(T = bc[Ma].vertices[P.b]),
												(U = bc[Ma].vertices[P.c]),
												(Ka = Vc[Ma]),
												(Ka[ha] = S.x),
												(Ka[ha + 1] = S.y),
												(Ka[ha + 2] = S.z),
												...
												db.morphNormals &&
													(Gc
														? ((Sb = Ic[Ma].vertexNormals[$b]),
														  (Cb = Sb.a),
														  (Db = Sb.b),
														  (Eb = Sb.c))
														: (Eb = Db = Cb = Ic[Ma].faceNormals[$b]),
													(La = Wc[Ma]),
													(La[ha] = Cb.x),
													(La[ha + 1] = Cb.y),
													(La[ha + 2] = Cb.z),
												...
												db.morphNormals &&
													(Gc
														? ((Sb = Ic[Ma].vertexNormals[$b]),
														  ...
														  (Eb = Sb.c),
														  (tc = Sb.d))
														: (tc = Eb = Db = Cb = Ic[Ma].faceNormals[$b]),
													(La = Wc[Ma]),
													(La[ha] = Cb.x),
													(La[ha + 1] = Cb.y),
													(La[ha + 2] = Cb.z),
										...
										db.morphNormals &&
											(k.bindBuffer(k.ARRAY_BUFFER, ma.__webglMorphNormalsBuffers[Ma]),
											k.bufferData(k.ARRAY_BUFFER, Wc[Ma], mb));
									}
								}
								if (ac.length) {
									D = 0;
									...
									for (X = pa.length; D < X; D++)
										(P = Ta[pa[D]]),
											...
											(da += 16);
									0 < da &&
										(k.bindBuffer(k.ARRAY_BUFFER, ma.__webglSkinIndicesBuffer),
										k.bufferData(k.ARRAY_BUFFER, ya, mb),
										k.bindBuffer(k.ARRAY_BUFFER, ma.__webglSkinWeightsBuffer),
								...
								if (id && Pb) {
									...
									for (X = oa.length; D < X; D++)
										(P = Ta[oa[D]]),
											(vb = P.vertexColors),
											(Hc = P.color),
											3 === vb.length && Pb === THREE.VertexColors
												? ((Fb = vb[0]), (Gb = vb[1]), (Hb = vb[2]))
												: (Hb = Gb = Fb = Hc),
											(Oa[Fa] = Fb.r),
											(Oa[Fa + 1] = Fb.g),
											(Oa[Fa + 2] = Fb.b),
									...
									for (X = pa.length; D < X; D++)
										(P = Ta[pa[D]]),
											(vb = P.vertexColors),
											(Hc = P.color),
											4 === vb.length && Pb === THREE.VertexColors
												? ((Fb = vb[0]), (Gb = vb[1]), (Hb = vb[2]), (uc = vb[3]))
												: (uc = Hb = Gb = Fb = Hc),
											(Oa[Fa] = Fb.r),
											(Oa[Fa + 1] = Fb.g),
											(Oa[Fa + 2] = Fb.b),
											...
											(Fa += 12);
									0 < Fa &&
										(k.bindBuffer(k.ARRAY_BUFFER, ma.__webglColorBuffer),
										k.bufferData(k.ARRAY_BUFFER, Oa, mb));
								}
									...
									for (X = pa.length; D < X; D++)
										if (((Xb = pa[D]), (mc = Yc[Xb]), void 0 !== mc))
											for (sa = 0; 4 > sa; sa++)
												(oc = mc[sa]), (xc[Tb] = oc.u), (xc[Tb + 1] = oc.v), (Tb += 2);
									0 < Tb &&
										(k.bindBuffer(k.ARRAY_BUFFER, ma.__webglUVBuffer),
									...
									for (X = pa.length; D < X; D++)
										if (((Xb = pa[D]), (nc = Zc[Xb]), void 0 !== nc))
											for (sa = 0; 4 > sa; sa++)
												(pc = nc[sa]), (yc[Ub] = pc.u), (yc[Ub + 1] = pc.v), (Ub += 2);
									0 < Ub &&
										(k.bindBuffer(k.ARRAY_BUFFER, ma.__webglUV2Buffer),
										...
										if (((w = Xc[sa]), w.__original.needsUpdate)) {
											...
											if (1 === w.size)
												if (void 0 === w.boundTo || "vertices" === w.boundTo) {
													...
													for (X = oa.length; D < X; D++)
														(P = Ta[oa[D]]),
															(w.array[x] = w.value[P.a]),
															(w.array[x + 1] = w.value[P.b]),
															(w.array[x + 2] = w.value[P.c]),
															(x += 3);
													D = 0;
													for (X = pa.length; D < X; D++)
														(P = Ta[pa[D]]),
												...
												if (void 0 === w.boundTo || "vertices" === w.boundTo) {
													...
													for (X = pa.length; D < X; D++)
														(P = Ta[pa[D]]),
															...
															(w.array[x + 8] = U[ba[2]]),
															(w.array[x + 9] = ka[ba[0]]),
															(w.array[x + 10] = ka[ba[1]]),
															(w.array[x + 11] = ka[ba[2]]),
															(x += 12);
								...
								yb &&
									(delete ma.__inittedArrays,
									delete ma.__colorArray,
									delete ma.__normalArray,
									delete ma.__tangentArray,
									delete ma.__uvArray,
									delete ma.__uv2Array,
									delete ma.__faceArray,
									delete ma.__vertexArray,
									delete ma.__lineArray,
									delete ma.__skinIndexArray,
									delete ma.__skinWeightArray);
							}
						}
					ga.verticesNeedUpdate = !1;
				...
				if (ga.verticesNeedUpdate || ga.colorsNeedUpdate || eb) {
					...
					if (ad) {
						...
						for (hd = ad.length; Rc < hd; Rc++)
							if (
								((va = ad[Rc]), va.needsUpdate && (void 0 === va.boundTo || "vertices" === va.boundTo))
							) {
								Aa = 0;
								qc = va.value.length;
				...
				ub instanceof THREE.ParticleSystem &&
					(ga instanceof THREE.BufferGeometry
						? ((ga.verticesNeedUpdate || ga.colorsNeedUpdate) && h(ga, k.DYNAMIC_DRAW, !ga.dynamic),
						  (ga.verticesNeedUpdate = !1),
						  (ga.colorsNeedUpdate = !1))
						: ((ab = c(ub, gb)),
						  (eb = ab.attributes && o(ab)),
						  (ga.verticesNeedUpdate || ga.colorsNeedUpdate || ub.sortParticles || eb) &&
								g(ga, k.DYNAMIC_DRAW, ub),
						  (ga.verticesNeedUpdate = !1),
						  (ga.colorsNeedUpdate = !1),
						  ab.attributes && q(ab)));
		}
	...
	this.initMaterial = function (a, b, c, d) {
		...
		for (s = b.length; o < s; o++)
			(q = b[o]),
				q.castShadow &&
					(q instanceof THREE.SpotLight && p++,
					q instanceof THREE.DirectionalLight && !q.shadowCascade && p++);
		m = p;
		ic && d && d.useVertexTexture
			? (l = 1024)
		...
		a.skinning &&
			0 <= r.skinIndex &&
			0 <= r.skinWeight &&
			(k.enableVertexAttribArray(r.skinIndex), k.enableVertexAttribArray(r.skinWeight));
		...
		if (a.morphNormals) {
			...
			for (j = 0; j < this.maxMorphNormals; j++)
				(y = v + j), 0 <= r[y] && (k.enableVertexAttribArray(r[y]), a.numSupportedMorphNormals++);
		}
		a.uniformsList = [];
	...
	this.setFaceCulling = function (a, b) {
		a
			? (!b || "ccw" === b ? k.frontFace(k.CCW) : k.frontFace(k.CW),
			  "back" === a ? k.cullFace(k.BACK) : "front" === a ? k.cullFace(k.FRONT) : k.cullFace(k.FRONT_AND_BACK),
			  k.enable(k.CULL_FACE))
...
THREE.GeometryUtils = {
	merge: function (a, b) {
		...
		for (o = j.length; p < o; p++) {
			...
			void 0 !== g.materialIndex &&
				((h = f.materials[g.materialIndex]),
				(q = h.id),
				(u = n[q]),
				void 0 === u && ((u = a.materials.length), (n[q] = u), a.materials.push(h)),
				(r.materialIndex = u));
					...
					for (g = a.faceVertexUvs.length; f < g; f++)
						a.faceVertexUvs[f].length &&
							...
							0 === e
								? ((l = s.clone()),
								  l.lerpSelf(h, 0.5),
								  (j = [s.clone(), l.clone(), u.clone()]),
								  (h = [l.clone(), h.clone(), u.clone()]))
								: 1 === e
								? ((l = h.clone()),
								  l.lerpSelf(u, 0.5),
								  (j = [s.clone(), h.clone(), l.clone()]),
								  (h = [l.clone(), u.clone(), s.clone()]))
								: ((l = s.clone()),
								  l.lerpSelf(u, 0.5),
								  (j = [s.clone(), h.clone(), l.clone()]),
								  (h = [l.clone(), h.clone(), u.clone()])),
					...
					a.faceVertexUvs[f].length &&
						...
						0 === e
							? ((l = s.clone()),
							  ...
							  (m = u.clone()),
							  m.lerpSelf(j, 0.5),
							  (s = [s.clone(), l.clone(), m.clone(), j.clone()]),
							  (h = [l.clone(), h.clone(), u.clone(), m.clone()]))
							: ((l = h.clone()),
							  l.lerpSelf(u, 0.5),
							  (m = j.clone()),
							  m.lerpSelf(s, 0.5),
							  (s = [s.clone(), h.clone(), l.clone(), m.clone()]),
							  (h = [m.clone(), l.clone(), u.clone(), j.clone()])),
						A[f].push(s, h));
			} else {
				z.push(e);
				f = 0;
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
	...
	if (p) {
		...
		q = true;
		m = false;
		u = b.frames !== void 0 ? b.frames : new THREE.TubeGeometry.FrenetFrames(p, n, false);
		s = new THREE.Vector3();
		z = new THREE.Vector3();
		A = new THREE.Vector3();
	}
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
	...
	generateSideWallUV: function (a, b, c, d, e, f, g, h) {
		...
		return Math.abs(c - i) < 0.01
			? [new THREE.UV(b, 1 - e), new THREE.UV(d, 1 - f), new THREE.UV(j, 1 - g), new THREE.UV(m, 1 - a)]
			: [new THREE.UV(c, 1 - e), new THREE.UV(i, 1 - f), new THREE.UV(l, 1 - g), new THREE.UV(n, 1 - a)];
	}
};
...
THREE.PolyhedronGeometry = function (a, b, c, d) {
	...
	function g(a, b) {
		...
		c === void 0 &&
			(m[a.index][b.index] = m[b.index][a.index] = c = e(new THREE.Vector3().add(a, b).divideScalar(2)));
		return c;
	}
	function h(a, b, c) {
...
THREE.SubdivisionModifier.prototype.smooth = function (a) {
	...
	function g(a, b, c) {
		var e = a + ":" + b;
		e in u ? d("dup vertexNo", a, "oldFaceNo", b, "value", c, "key", e, u[e]) : (u[e] = c);
	}
	var h = [],
		i = [],
		j = [],
			...
			for (q = s.length; o < q; o++) {
				...
				if (B.render) {
					...
					B instanceof THREE.BufferGeometry
						? b.renderBufferDirect(r, l.__lights, null, u, B, t)
						: b.renderBuffer(r, l.__lights, null, u, B, t);
				}
			}
				...
				if (z.visible && z.opacity !== 0 && z.map && z.map.image && z.map.image.width) {
					if (z.useScreenCoordinates) {
						...
						b.uniform3f(
							...
							(z.position.x - p) / p,
							(u - z.position.y) / u,
							Math.max(0, Math.min(1, z.position.z))
						);
					} else {
