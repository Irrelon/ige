	...
	init: function () {
		...
		ige.start(function (success) {
			...
			if (success) {
				...
				self.objectScene = new IgeScene2d().id("objectScene").depth(0).mount(self.mainScene);
				...
				self.vp1 = new IgeViewport().id("vp1").autoSize(true).scene(self.mainScene).drawMouse(true).mount(ige);
