function printStackTrace(t) {
    ...
    for (
        var i = t.e || null,
            e = !!t.guess,
            o = new printStackTrace.implementation(),
            s = o.run(i),
            n = e ? o.guessAnonymousFunctions(s) : s,
            r = 0;
        4 > r;
        r++
    )
...
(printStackTrace.implementation = function () {}),
    (printStackTrace.implementation.prototype = {
        ...
        opera: function (t) {
            ...
            for (i = 4, e = 0, o = s.length; o > i; i += 2)
                r.test(s[i]) &&
                    (s[e++] =
                        (RegExp.$3 ? RegExp.$3 + "()@" + RegExp.$2 + RegExp.$1 : n + "()@" + RegExp.$2 + ":" + RegExp.$1) +
                        " -- " +
                        s[i + 1].replace(/^\s+/, ""));
                      ...
                      (o.constructor === Array
                          ? (t[e] =
                                3 > o.length
                                    ...
                                    : "[" + this.stringifyArguments(i.call(o, 0, 1)) + "..." + this.stringifyArguments(i.call(o, -1)) + "]")
        ...
        ajax: function (t) {
            ...
            if (i) return i.open("GET", t, !1), i.send(""), i.responseText;
        },
        ...
        findFunctionName: function (t, i) {
            for (
                var e,
                    o,
                    s = /function\s+([^(]*?)\s*\(([^)]*)\)/,
                    n = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*function\b/,
                    r = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*(?:eval|new Function)\b/,
                    a = "",
                    h = 10,
                    l = 0;
                h > l;
                ...
                if ((e = t[i - l])) {
                    if (((a = e + a), (o = n.exec(a)), o && o[1])) return o[1];
                    if (((o = s.exec(a)), o && o[1])) return o[1];
                    if (((o = r.exec(a)), o && o[1])) return o[1];
                }
            return "(?)";
        }
    }),
    ...
    (Array.prototype.clone = function () {
        var t,
            i = [];
        for (t in this) this.hasOwnProperty(t) && (i[t] = this[t] instanceof Array ? this[t].clone() : this[t]);
        return i;
    }),
    ...
    (Array.prototype.destroyAll = function () {
        var t,
            i = this.length;
        for (t = i - 1; t >= 0; t--) typeof this[t].destroy == "function" && this[t].destroy();
    }),
    ...
    typeof CanvasRenderingContext2D != "undefined" &&
        (Object.defineProperty(CanvasRenderingContext2D.prototype, "circle", { enumerable: !1, writable: !0, configurable: !0 }),
        Object.defineProperty(CanvasRenderingContext2D.prototype, "strokeCircle", { enumerable: !1, writable: !0, configurable: !0 }),
        Object.defineProperty(CanvasRenderingContext2D.prototype, "fillCircle", { enumerable: !1, writable: !0, configurable: !0 }),
    ...
    typeof ImageData != "undefined" &&
        ...
        Object.defineProperty(ImageData.prototype, "makeTransparent", { enumerable: !1, writable: !0, configurable: !0 }),
...
Array.prototype.indexOf ||
    ...
    (Array.prototype.indexOf = function (t) {
        var i,
            e = this.length;
        for (i = 0; e > i; i++) if (this[i] === t) return i;
        return -1;
    })),
    (requestAnimFrame =
    ...
    typeof console == "object"
        ? typeof console.log == "function" &&
          (console.info === void 0 && (console.info = console.log), console.warn === void 0 && (console.warn = console.log))
        : (console = { log: function () {}, warn: function () {}, info: function () {}, error: function () {} });
var $i_2 = (function () {
    var t = !1,
        i = (/xyz/.test(function () {}) ? /\b_super\b/ : /.*/, function () {}),
        e = function (t, i, e) {
            if (igeConfig.debug._enabled) {
                ...
                if (
                    ...
                    (i === "warning" || i === "error") &&
                        ...
                        (igeConfig.debug._node
                            ...
                            : typeof printStackTrace == "function" && console.log("Stack:", printStackTrace().join("\n ---- "))),
                    i === "error")
                ) {
                    if (
                        (typeof ige != "undefined" &&
                            (console.log(
                                n +
                                    "IGE *" +
                                    i +
                ...
                } else console.log(n + "IGE *" + i + "* [" + (this._classId || this.prototype._classId) + s + "] : " + t);
            }
            return this;
        },
        o = function () {
        ...
        n = function (t) {
            return (
                this[t] && this[t].destroy && this[t].destroy(), this._components && this._components.pull(this[t]), delete this[t], this
            );
        },
        r = function (t, i) {
            var e,
                o = t.prototype || t;
            for (e in o) o.hasOwnProperty(e) && (i || this[e] === void 0) && (this[e] = o[e]);
            return this;
        },
        a = function (t, i) {
            return t !== void 0
    ...
    return (
        (i.extend = function () {
            ...
            var h,
                ...
                y = arguments[0];
            if (!d.classId) throw (console.log(d), "Cannot create a new class without giving the class a classId property!");
            if (igeClassStore[d.classId])
                throw 'Cannot create class with classId "' + d.classId + '" because a class with that ID has already been created!';
            (t = !0), (l = new this()), (t = !1);
            ...
            if (arguments.length > 1 && y && y.length)
                for (m = 0; y.length > m; m++) {
                    ...
                    for (u in p) p.hasOwnProperty(u) && (_ || l[u] === void 0) && (l[u] = p[u]);
                }
            return (
                (i.prototype = l),
...
var $i_3 = $i_2.extend({
    ...
    on: function (t, i, e, o, s) {
        ...
        if (((this._eventListeners = this._eventListeners || {}), typeof i == "function")) {
            if (typeof t == "string")
                return (
                    (n = { call: i, context: e, oneShot: o, sendEventName: s }),
            ...
            if (t.length) {
                ...
                for (c in t) t.hasOwnProperty(c) && ((_ = t[c]), (m = _[0]), (u = _[1]), l[0]++, m.on(u, l[3], null, !0, !0));
            }
        } else
            typeof t != "string" && (t = "*Multi-Event*"),
                this.log('Cannot register event listener for event "' + t + '" because the passed callback is not a function!', "error");
    },
    off: function (t, i, e) {
        if (this._eventListeners) {
            ...
            if (this._eventListeners[t]) {
                ...
                if (o > -1) return this._eventListeners[t].splice(o, 1), e && e(!0), !0;
    ...
    _processRemovals: function () {
        if (this._eventListeners) {
            ...
            if (o) {
                t = o.length;
                while (t--) (i = o[t]), (e = this.off(i[0], i[1])), typeof o[2] == "function" && o[2](e);
            }
...
var $i_4 = $i_2.extend({
    ...
    init: function (t, i, e) {
        return (
            ...
            this._floor ? ((this.x2 = Math.floor(t / 2)), (this.y2 = Math.floor(i / 2))) : ((this.x2 = t / 2), (this.y2 = i / 2)),
            this
        );
    },
    floor: function (t) {
...
var $i_5 = $i_2.extend({
    ...
    toIso: function () {
        var t = this.x - this.y,
            i = -this.z * 1.2247 + (this.x + this.y) * 0.5;
        return { x: t, y: i };
    },
    thisToIso: function () {
        var t = this.toIso();
...
var $i_6 = $i_2.extend({
    ...
    pointInPoly: function (t) {
        var i,
            ...
            n = 0;
        for (i = 0; o > i; s = i++)
            e[i].y > t.y != e[s].y > t.y && ((e[s].x - e[i].x) * (t.y - e[i].y)) / (e[s].y - e[i].y) + e[i].x > t.x && (n = !n);
        return Boolean(n);
    },
    ...
    aabb: function () {
        var t,
            ...
            a = this._poly,
            h = a.length;
        for (s = 0; h > s; s++) n.push(a[s].x), r.push(a[s].y);
        return (
    ...
    clone: function () {
        var t,
            ...
            e = this._poly,
            o = e.length;
        for (t = 0; o > t; t++) i.addPoint(e[t].x, e[t].y);
    ...
    clockWiseTriangle: function () {
        var t,
            ...
            o,
            s = this._poly;
        return (i = s[0]), (e = s[1]), (o = s[2]), (t = i.x * e.y + e.x * o.y + o.x * i.y - e.y * o.x - o.y * i.x - i.y * e.x), t > 0;
    },
    ...
    triangulationIndices: function () {
        var t,
            ...
            u = [];
        if (3 > _) return c;
        if (this._area() > 0) for (m = 0; _ > m; m++) u[m] = m;
        else for (m = 0; _ > m; m++) u[m] = _ - 1 - m;
        for (t = _, i = 2 * t, e = 0, m = t - 1; t > 2; ) {
            if (0 >= i--) return c;
            if (((o = m), t > o || (o = 0), (m = o + 1), t > m || (m = 0), (s = m + 1), t > s || (s = 0), this._snip(o, m, s, t, u))) {
                for (n = u[o], r = u[m], a = u[s], c.push(n), c.push(r), c.push(a), e++, h = m, l = m + 1; t > l; l++) (u[h] = u[l]), h++;
                t--, (i = 2 * t);
            }
        }
        return c.reverse(), c;
    ...
    _area: function () {
        var t,
            ...
            s = 0,
            n = 0;
        for (t = o - 1; o > n; t = n++) (i = this._poly[t]), (e = this._poly[n]), (s += i.x * e.y - e.x * i.y);
        return s * 0.5;
    },
    _snip: function (t, i, e, o, s) {
        var n,
            ...
            h = this._poly[s[i]],
            l = this._poly[s[e]];
        if (1e-5 > (h.x - a.x) * (l.y - a.y) - (h.y - a.y) * (l.x - a.x)) return !1;
        for (n = 0; o > n; n++) if (n != t && n != i && n != e && ((r = this._poly[s[n]]), this._insideTriangle(a, h, l, r))) return !1;
        return !0;
    },
    ...
    render: function (t, i) {
        var e,
            ...
            n = this._scale.x,
            r = this._scale.y;
        for (t.beginPath(), t.moveTo(o[0].x * n, o[0].y * r), e = 1; s > e; e++) t.lineTo(o[e].x * n, o[e].y * r);
...
var $i_7 = $i_2.extend({
    ...
    combineRect: function (t) {
        var i = this.x + this.width,
            ...
            o = t.x + t.width,
            s = t.y + t.height,
            n = Math.min(this.x, t.x),
            r = Math.min(this.y, t.y),
            a = Math.max(i - this.x, o - this.x),
            h = Math.max(e - this.y, s - this.y);
    ...
    rectIntersect: function (t) {
        return (
            this.log(
                'rectIntersect has been renamed to "intersects". Please update your code. rectIntersect will be removed in a later version of IGE.',
                "warning"
            ),
            this.intersects(t)
        );
...
($i_8.prototype = {
    ...
    transform: function (t, i) {
        var e,
            o = t.length;
        for (e = 0; o > e; e++) this.transformCoord(t[e], i);
        return t;
    },
    ...
    compare: function (t) {
        for (var i = this.matrix, e = t.matrix, o = 0; 9 > o; o++) if (i[o] !== e[o]) return !1;
        return !0;
    },
    identity: function () {
        var t = this.matrix;
    ...
    premultiply: function (t) {
        var i = t.matrix[0] * this.matrix[0] + t.matrix[1] * this.matrix[3] + t.matrix[2] * this.matrix[6],
            e = t.matrix[0] * this.matrix[1] + t.matrix[1] * this.matrix[4] + t.matrix[2] * this.matrix[7],
    ...
    getInverse: function () {
        var t = this.matrix,
            ...
            l = t[8],
            c = new $i_8(),
            _ = i * (n * l - h * r) - s * (e * l - h * o) + a * (e * r - n * o);
        if (_ === 0) return null;
        var m = c.matrix;
        return (
            (m[0] = n * l - r * h),
...
var $i_11 = $i_2.extend({
    ...
    linearForceVector3: function (t, i, e) {
        var o = (this._linearForce = this._linearForce || new $i_5(0, 0, 0)),
            s = t.x / 1e3,
            n = t.y / 1e3,
            r = t.z / 1e3;
        return e ? ((o.x += s || 0), (o.y += n || 0), (o.z += r || 0)) : ((o.x = s || 0), (o.y = n || 0), (o.z = r || 0)), this._entity;
    },
    ...
    tick: function () {
        var t,
            ...
            o = ige._tickDelta,
            s = this._velocity;
        o && (this._applyLinearForce(o), (t = s.x * o), (i = s.y * o), (e = s.z * o), (t || i || e) && this._entity.translateBy(t, i, e));
    }
});
...
var $i_12 = $i_2.extend({
    ...
    start: function (t) {
        return (
            t._startTime > ige._currentTime ? this._tweens.push(t) : ((t._currentStep = 0), this._setupStep(t, !1) && this._tweens.push(t)),
            this.enable(),
            t
        );
    },
    _setupStep: function (t, i) {
        var e,
            ...
            a = [];
        if ((r && (e = r.props), n)) {
            t._currentStep !== 0 || i ? (t._startTime = ige._currentTime) : t._startTime === void 0 && (t._startTime = ige._currentTime),
                (o = r.durationMs ? r.durationMs : t._durationMs),
                (t._selectedEasing = r.easing ? r.easing : t._easing),
                (t._endTime = t._startTime + o);
            for (s in e) e.hasOwnProperty(s) && a.push({ targetObj: n, propName: s, deltaVal: e[s] - (r.isDelta ? 0 : n[s]), oldDelta: 0 });
                    ...
                    if (
                        (i._started ||
                            ...
                            typeof i._beforeStep == "function" &&
                                ((c = i._stepDirection ? i._steps.length - (i._currentStep + 1) : i._currentStep), i._beforeStep(i, c)),
                            (i._started = !0)),
                        (e = u - i._startTime),
                        (o = i._destTime),
                        (s = i._selectedEasing),
                        ...
                        typeof i._afterStep == "function" &&
                            ((c = i._stepDirection ? i._steps.length - (i._currentStep + 1) : i._currentStep), i._afterStep(i, c)),
                            i._steps.length === i._currentStep + 1
                                ? (i._repeatMode
                                      ? (i._repeatCount !== -1 && (i._repeatedCount++, i._repeatCount === i._repeatedCount && (_ = !0)),
                                        _ ||
                                            (i._repeatMode === 1 && (i._currentStep = 0),
                                            i._repeatMode === 2 &&
                                                ((i._stepDirection = !i._stepDirection), i._steps.reverse(), (i._currentStep = 1)),
                                            typeof i._stepsComplete == "function" && i._stepsComplete(i, i._currentStep),
                                            typeof i._beforeStep == "function" &&
                                                ((c = i._stepDirection ? i._steps.length - (i._currentStep + 1) : i._currentStep),
                                                i._beforeStep(i, c)),
                                            t._setupStep(i, !0)))
                                      : (_ = !0),
                                  _ && (i.stop(), typeof i._afterTween == "function" && (i._afterTween(i), delete i._afterTween)))
                                : (i._currentStep++,
                                  typeof i._beforeStep == "function" &&
                                      ((c = i._stepDirection ? i._steps.length - (i._currentStep + 1) : i._currentStep),
                                      i._beforeStep(i, c)),
    ...
    easing: {
        ...
        inOutCirc: function (t, i, e) {
            return 1 > (t /= e / 2) ? (-i / 2) * (Math.sqrt(1 - t * t) - 1) : (i / 2) * (Math.sqrt(1 - (t -= 2) * t) + 1);
        },
        ...
        outInElastic: function (t, i, e, o, s) {
            return e / 2 > t ? this.outElastic(t * 2, i / 2, e, o, s) : this.inElastic(t * 2 - e, i / 2, i / 2, e, o, s);
        },
...
var $i_14 = $i_3.extend({
    ...
    fireManualEvent: function (t, i) {
        t && i
            ? this._evRef[t]
                ? this._evRef[t](i)
                : this.log('Cannot fire manual event "' + t + '" because no listener exists in the engine for this event type!', "warning")
    ...
    _mouseDown: function (t) {
        ...
        var i = t.igeX - ige._bounds2d.x2,
            e = t.igeY - ige._bounds2d.y2,
            o = this;
    ...
    _updateMouseData: function (t) {
        var i,
            ...
            o = ige._children,
            s = o.length,
            n = t.igeX - ige._bounds2d.x2 - ige._translate.x,
        ...
        while (s--)
            if (
                ...
                (i._mousePos = new $i_5(
                    Math.floor((n - i._translate.x) / i.camera._scale.x + i.camera._translate.x),
                    Math.floor((r - i._translate.y) / i.camera._scale.y + i.camera._translate.y),
                    0
                )),
                    (e = i),
                    (t.igeViewport = i);
    ...
    tick: function () {
        var t = this._eventQueue,
            i = t.length,
            e = this._eventControl;
        while (i--) if ((t[i][1].apply(t[i][0], [e, t[i][2]]), e._cancelled)) break;
        (this._eventQueue = []),
    ...
    emit: function (t, i) {
        if (this._eventListeners && this._eventListeners[t]) {
            ...
            if (h) {
                if (((e = []), typeof i == "object" && i !== null && i[0] !== null)) for (o in i) i.hasOwnProperty(o) && (e[o] = i[o]);
                else e = [i];
                (s = !1), (this._eventListeners._processing = !0);
                while (h--) {
                    if (c._cancelled) break;
                    (n = l - h),
                        (r = this._eventListeners[t][n]),
                        r.sendEventName && (e = [t]),
                        (a = r.call.apply(r.context || this, e)),
...
var $i_18 = $i_2.extend({
        ...
        init: function (t, i) {
            ...
            (this._entity = t),
                ...
                ige.input.on("keyDown", function (t) {
                    e._keyDown(t);
                });
        },
        style: function (t, i) {
...
(function (t, i) {
    ...
    !(Object.defineProperty instanceof Function) &&
        ...
        (Object.defineProperty = function (t, i, e) {
            e.get instanceof Function && t.__defineGetter__(i, e.get), e.set instanceof Function && t.__defineSetter__(i, e.set);
        }),
        ...
        (t.NVector = function (t) {
            t === i && (t = 0);
            for (var e = Array(t || 0), o = 0; t > o; ++o) e[o] = 0;
            return e;
        }),
        (t.is = function (t, e) {
            return t === null
...
var Vector = Array,
    Vector_a2j_Number = $i_22.NVector;
$i_22 === void 0 && ($i_22 = {}),
    ...
    (function () {
        ...
        function d() {
            d.b2ManifoldPoint.apply(this, arguments), this.constructor === d && this.b2ManifoldPoint.apply(this, arguments);
        }
        function y() {
            y.b2Point.apply(this, arguments);
        }
        function x() {
            x.b2RayCastInput.apply(this, arguments), this.constructor === x && this.b2RayCastInput.apply(this, arguments);
        }
        function f() {
        ...
        function R() {
            R.b2PolygonShape.apply(this, arguments), this.constructor === R && this.b2PolygonShape.apply(this, arguments);
        }
        function L() {
        ...
        function ri() {
            ri.b2ContactConstraint.apply(this, arguments), this.constructor === ri && this.b2ContactConstraint.apply(this, arguments);
        }
        function ai() {
        ...
        function li() {
            li.b2ContactFactory.apply(this, arguments), this.constructor === li && this.b2ContactFactory.apply(this, arguments);
        }
        function ci() {
        ...
        function mi() {
            mi.b2ContactSolver.apply(this, arguments), this.constructor === mi && this.b2ContactSolver.apply(this, arguments);
        }
        function ui() {
            ui.b2EdgeAndCircleContact.apply(this, arguments);
        }
        function pi() {
            pi.b2NullContact.apply(this, arguments), this.constructor === pi && this.b2NullContact.apply(this, arguments);
        }
        function di() {
        ...
        function Si() {
            Si.b2DistanceJoint.apply(this, arguments), this.constructor === Si && this.b2DistanceJoint.apply(this, arguments);
        }
        function Ii() {
            Ii.b2DistanceJointDef.apply(this, arguments), this.constructor === Ii && this.b2DistanceJointDef.apply(this, arguments);
        }
        function Ai() {
            Ai.b2FrictionJoint.apply(this, arguments), this.constructor === Ai && this.b2FrictionJoint.apply(this, arguments);
        }
        function Mi() {
            Mi.b2FrictionJointDef.apply(this, arguments), this.constructor === Mi && this.b2FrictionJointDef.apply(this, arguments);
        }
        function Ti() {
            Ti.b2GearJoint.apply(this, arguments), this.constructor === Ti && this.b2GearJoint.apply(this, arguments);
        }
        function Pi() {
            Pi.b2GearJointDef.apply(this, arguments), this.constructor === Pi && this.b2GearJointDef.apply(this, arguments);
        }
        function Vi() {
        ...
        function Gi() {
            Gi.b2LineJointDef.apply(this, arguments), this.constructor === Gi && this.b2LineJointDef.apply(this, arguments);
        }
        function Ei() {
            Ei.b2MouseJoint.apply(this, arguments), this.constructor === Ei && this.b2MouseJoint.apply(this, arguments);
        }
        function zi() {
            zi.b2MouseJointDef.apply(this, arguments), this.constructor === zi && this.b2MouseJointDef.apply(this, arguments);
        }
        function Ji() {
            Ji.b2PrismaticJoint.apply(this, arguments), this.constructor === Ji && this.b2PrismaticJoint.apply(this, arguments);
        }
        function Oi() {
            Oi.b2PrismaticJointDef.apply(this, arguments), this.constructor === Oi && this.b2PrismaticJointDef.apply(this, arguments);
        }
        function Ni() {
            Ni.b2PulleyJoint.apply(this, arguments), this.constructor === Ni && this.b2PulleyJoint.apply(this, arguments);
        }
        function Wi() {
            Wi.b2PulleyJointDef.apply(this, arguments), this.constructor === Wi && this.b2PulleyJointDef.apply(this, arguments);
        }
        function ji() {
            ji.b2RevoluteJoint.apply(this, arguments), this.constructor === ji && this.b2RevoluteJoint.apply(this, arguments);
        }
        function Ui() {
            Ui.b2RevoluteJointDef.apply(this, arguments), this.constructor === Ui && this.b2RevoluteJointDef.apply(this, arguments);
        }
        function qi() {
            qi.b2WeldJoint.apply(this, arguments), this.constructor === qi && this.b2WeldJoint.apply(this, arguments);
        }
        function Xi() {
            Xi.b2WeldJointDef.apply(this, arguments), this.constructor === Xi && this.b2WeldJointDef.apply(this, arguments);
        }
    ...
    ($i_22.postDefs = []),
    (function () {
        var t = $i_22.Collision.Shapes.b2CircleShape,
            i =
            ...
            e = $i_22.Collision.Shapes.b2Shape,
            o = ($i_22.Common.b2Color, $i_22.Common.b2internal, $i_22.Common.b2Settings),
            s = ($i_22.Common.Math.b2Mat22, $i_22.Common.Math.b2Mat33, $i_22.Common.Math.b2Math),
            n = $i_22.Common.Math.b2Sweep,
            r = $i_22.Common.Math.b2Transform,
            a = $i_22.Common.Math.b2Vec2,
            h = ($i_22.Common.Math.b2Vec3, $i_22.Collision.b2AABB),
            l = $i_22.Collision.b2Bound,
            c = $i_22.Collision.b2BoundValues,
            _ = $i_22.Collision.b2Collision,
            m = $i_22.Collision.b2ContactID,
            u = $i_22.Collision.b2ContactPoint,
            p = $i_22.Collision.b2Distance,
            d = $i_22.Collision.b2DistanceInput,
            y = $i_22.Collision.b2DistanceOutput,
            x = $i_22.Collision.b2DistanceProxy,
            f = $i_22.Collision.b2DynamicTree,
            g = $i_22.Collision.b2DynamicTreeBroadPhase,
            b = $i_22.Collision.b2DynamicTreeNode,
            v = $i_22.Collision.b2DynamicTreePair,
            w = $i_22.Collision.b2Manifold,
            C = $i_22.Collision.b2ManifoldPoint,
            D = $i_22.Collision.b2Point,
            B = $i_22.Collision.b2RayCastInput,
            S = $i_22.Collision.b2RayCastOutput,
            I = $i_22.Collision.b2Segment,
            A = $i_22.Collision.b2SeparationFunction,
            M = $i_22.Collision.b2Simplex,
            T = $i_22.Collision.b2SimplexCache,
            P = $i_22.Collision.b2SimplexVertex,
            V = $i_22.Collision.b2TimeOfImpact,
            R = $i_22.Collision.b2TOIInput,
            L = $i_22.Collision.b2WorldManifold,
            k = $i_22.Collision.ClipVertex,
            F = $i_22.Collision.Features,
            G = $i_22.Collision.IBroadPhase;
        (h.b2AABB = function () {
            ...
            (h.prototype.Contains = function (t) {
                var i = !0;
                return (
                    (i = i && t.lowerBound.x >= this.lowerBound.x),
            ...
            (h.prototype.RayCast = function (t, i) {
                ...
                if (Number.MIN_VALUE > h) {
                    if (this.lowerBound.x > s || s > this.upperBound.x) return !1;
                } else if (
                    ((_ = 1 / r),
                ...
                if (Number.MIN_VALUE > l) {
                    if (this.lowerBound.y > n || n > this.upperBound.y) return !1;
                } else if (
                    ((_ = 1 / a),
            ...
            (h.prototype.TestOverlap = function (t) {
                var i = t.lowerBound.x - this.upperBound.x,
                    e = t.lowerBound.y - this.upperBound.y,
            ...
            (_.EdgeSeparation = function (t, i, e, o, s) {
                ...
                var n,
                    ...
                    c = o.m_vertices;
                (n = i.R), (r = h[e]);
                var _ = n.col1.x * r.x + n.col2.x * r.y,
                    m = n.col1.y * r.x + n.col2.y * r.y;
                n = s.R;
                ...
                (r = a[e]), (n = i.R);
                var g = i.position.x + (n.col1.x * r.x + n.col2.x * r.y),
                    b = i.position.y + (n.col1.y * r.x + n.col2.y * r.y);
                (r = c[d]), (n = s.R);
                var v = s.position.x + (n.col1.x * r.x + n.col2.x * r.y),
            ...
            (_.FindMaxSeparation = function (t, i, e, o, s) {
                ...
                for (
                    var m = l * e.R.col1.x + c * e.R.col1.y, u = l * e.R.col2.x + c * e.R.col2.y, p = 0, d = -Number.MAX_VALUE, y = 0;
                    a > y;
                    ++y
                ) {
                    n = h[y];
                ...
                var f = _.EdgeSeparation(i, e, p, o, s),
                    g = parseInt(0 > p - 1 ? a - 1 : p - 1),
                    b = _.EdgeSeparation(i, e, g, o, s),
                    v = parseInt(a > p + 1 ? p + 1 : 0),
                    w = _.EdgeSeparation(i, e, v, o, s),
                    C = 0,
                    D = 0,
                    B = 0;
                if (b > f && b > w) (B = -1), (C = g), (D = b);
                else {
                    if (f >= w) return (t[0] = p), f;
                    (B = 1), (C = v), (D = w);
                }
                for (;;) {
                    if (
                        ((p = B == -1 ? (0 > C - 1 ? a - 1 : C - 1) : a > C + 1 ? C + 1 : 0), (f = _.EdgeSeparation(i, e, p, o, s)), D >= f)
                    )
                        break;
                    (C = p), (D = f);
                }
            ...
            (_.CollidePolygons = function (t, i, e, s, n) {
                ...
                if (((h = _.s_edgeAO[0]), a >= l)) {
                    ...
                    if (((c = _.s_edgeBO[0]), a >= m)) {
                        ...
                        var F = R.x * L.x + R.y * L.y,
                            G = -P.x * L.x - P.y * L.y + a,
                            E = P.x * k.x + P.y * k.y + a,
                            z = _.s_clipPoints1,
                            J = _.s_clipPoints2,
                            O = 0;
                        if (((O = _.ClipSegmentToLine(z, C, V, G)), O >= 2 && ((O = _.ClipSegmentToLine(J, z, P, E)), O >= 2))) {
                            ...
                            for (var N = 0, W = 0; o.b2_maxManifoldPoints > W; ++W) {
                                ...
                                if (a >= j) {
                                    var U = t.m_points[N];
                                    x = y.R;
                                    var q = r.v.x - y.position.x,
                                        X = r.v.y - y.position.y;
            ...
            (_.CollideCircles = function (t, i, e, o, s) {
                ...
                var n, r;
                (n = e.R), (r = i.m_p);
                var a = e.position.x + (n.col1.x * r.x + n.col2.x * r.y),
                    h = e.position.y + (n.col1.y * r.x + n.col2.y * r.y);
                (n = s.R), (r = o.m_p);
            ...
            (_.CollidePolygonAndCircle = function (t, i, e, o, s) {
                ...
                for (
                    var _ = a * r.col1.x + h * r.col1.y,
                        m = a * r.col2.x + h * r.col2.y,
                        u = 0,
                        p = -Number.MAX_VALUE,
                        d = i.m_radius + o.m_radius,
                        y = parseInt(i.m_vertexCount),
                        x = i.m_vertices,
                        f = i.m_normals,
                        g = 0;
                    y > g;
                ...
                var S = (_ - D.x) * (B.x - D.x) + (m - D.y) * (B.y - D.y),
                    I = (_ - B.x) * (D.x - B.x) + (m - B.y) * (D.y - B.y);
                if (0 < S)
                    if (0 < I) {
                        var A = 0.5 * (D.x + B.x),
                            M = 0.5 * (D.y + B.y);
                        if (((p = (_ - A) * f[v].x + (m - M) * f[v].y), p > d)) return;
                        (t.m_pointCount = 1),
                            (t.m_type = w.e_faceA),
                        ...
                        if ((_ - B.x) * (_ - B.x) + (m - B.y) * (m - B.y) > d * d) return;
                        (t.m_pointCount = 1),
                            (t.m_type = w.e_faceA),
                    ...
                    if ((_ - D.x) * (_ - D.x) + (m - D.y) * (m - D.y) > d * d) return;
                    (t.m_pointCount = 1),
                        (t.m_type = w.e_faceA),
            ...
            (p.Distance = function (t, i, e) {
                ...
                var _,
                    ...
                    w = 0;
                while (u > w) {
                    for (x = c.m_count, v = 0; x > v; v++) (d[v] = m[v].indexA), (y[v] = m[v].indexB);
                    switch (c.m_count) {
                        case 1:
                            break;
                        case 2:
                    ...
                    if (c.m_count == 3) break;
                    (_ = c.GetClosestPoint()), (b = _.LengthSquared()), (g = b);
                    var C = c.GetSearchDirection();
                    if (Number.MIN_VALUE * Number.MIN_VALUE > C.LengthSquared()) break;
                    var D = m[c.m_count];
                ...
                if (
                    ((p.b2_gjkMaxIters = s.Max(p.b2_gjkMaxIters, w)),
                    ...
                    if (t.distance > S + I && t.distance > Number.MIN_VALUE) {
                        ...
                        A.Normalize(), (t.pointA.x += S * A.x), (t.pointA.y += S * A.y), (t.pointB.x -= I * A.x), (t.pointB.y -= I * A.y);
                    } else
                        (_ = new a()),
            ...
            (f.prototype.MoveProxy = function (t, i, e) {
                if ((o.b2Assert(t.IsLeaf()), t.aabb.Contains(i))) return !1;
                this.RemoveLeaf(t);
                var s = o.b2_aabbExtension + o.b2_aabbMultiplier * (e.x > 0 ? e.x : -e.x),
                    n = o.b2_aabbExtension + o.b2_aabbMultiplier * (e.y > 0 ? e.y : -e.y);
                return (
                    (t.aabb.lowerBound.x = i.lowerBound.x - s),
            ...
            (f.prototype.Rebalance = function (t) {
                if ((t === void 0 && (t = 0), this.m_root != null))
                    for (var i = 0; t > i; i++) {
                        var e = this.m_root,
                            o = 0;
                        while (e.IsLeaf() == 0) (e = (this.m_path >> o) & 1 ? e.child2 : e.child1), (o = (o + 1) & 31);
                    ...
                    while (o > 0) {
                        ...
                        if (s.aabb.TestOverlap(i))
                            if (s.IsLeaf()) {
                                var n = t(s);
                                if (!n) return;
                            } else (e[o++] = s.child1), (e[o++] = s.child2);
                    }
                }
            }),
                ...
                if (this.m_root != null) {
                    ...
                    while (p > 0) {
                        ...
                        if (d.aabb.TestOverlap(c) != 0) {
                            var y = d.aabb.GetCenter(),
                                x = d.aabb.GetExtents(),
                                f = Math.abs(r.x * (e.x - y.x) + r.y * (e.y - y.y)) - a.x * x.x - a.y * x.y;
                            if (0 >= f)
                                if (d.IsLeaf()) {
                                    var g = new B();
                                    if (((g.p1 = i.p1), (g.p2 = i.p2), (g.maxFraction = i.maxFraction), (l = t(g, d)), l == 0)) return;
                                    l > 0 &&
                                        ((_ = e.x + l * (o.x - e.x)),
                                        (m = e.y + l * (o.y - e.y)),
                                        (c.lowerBound.x = Math.min(e.x, _)),
                                        ...
                                        (c.upperBound.x = Math.max(e.x, _)),
                                        (c.upperBound.y = Math.max(e.y, m)));
                                } else (u[p++] = d.child1), (u[p++] = d.child2);
                        }
                    }
                }
            }),
            ...
            (f.prototype.InsertLeaf = function (t) {
                if ((++this.m_insertionCount, this.m_root == null)) return (this.m_root = t), (this.m_root.parent = null), void 0;
                ...
                if (e.IsLeaf() == 0)
                    do {
                        var o = e.child1,
                            s = e.child2,
                            n =
                                Math.abs((o.aabb.lowerBound.x + o.aabb.upperBound.x) / 2 - i.x) +
                                Math.abs((o.aabb.lowerBound.y + o.aabb.upperBound.y) / 2 - i.y),
                            r =
                                Math.abs((s.aabb.lowerBound.x + s.aabb.upperBound.x) / 2 - i.x) +
                ...
                if (((h.parent = a), (h.userData = null), h.aabb.Combine(t.aabb, e.aabb), a)) {
                    e.parent.child1 == e ? (a.child1 = h) : (a.child2 = h), (h.child1 = e), (h.child2 = t), (e.parent = h), (t.parent = h);
                    do {
                        if (a.aabb.Contains(h.aabb)) break;
                        a.aabb.Combine(a.child1.aabb, a.child2.aabb), (h = a), (a = a.parent);
                    } while (a);
                } else (h.child1 = e), (h.child2 = t), (e.parent = h), (t.parent = h), (this.m_root = h);
            }),
            (f.prototype.RemoveLeaf = function (t) {
                if (t == this.m_root) return (this.m_root = null), void 0;
                var i,
                    e = t.parent,
                    o = e.parent;
                if (((i = e.child1 == t ? e.child2 : e.child1), o)) {
                    ...
                    while (o) {
                        var s = o.aabb;
                        if (((o.aabb = h.Combine(o.child1.aabb, o.child2.aabb)), s.Contains(o.aabb))) break;
                        o = o.parent;
                    }
                } else (this.m_root = i), (i.parent = null), this.FreeNode(e);
            }),
            (g.b2DynamicTreeBroadPhase = function () {
                (this.m_tree = new f()), (this.m_moveBuffer = new Vector()), (this.m_pairBuffer = new Vector()), (this.m_pairCount = 0);
            }),
            ...
            (g.prototype.TestOverlap = function (t, i) {
                var e = this.m_tree.GetFatAABB(t),
                    o = this.m_tree.GetFatAABB(i);
            ...
            (g.prototype.UpdatePairs = function (t) {
                ...
                for (var s = 0; e.m_pairCount > s; ) {
                    var r = e.m_pairBuffer[s],
                        a = e.m_tree.GetUserData(r.proxyA),
                        h = e.m_tree.GetUserData(r.proxyB);
                    t(a, h), ++s;
            ...
            (w.prototype.b2Manifold = function () {
                ...
                for (var t = 0; o.b2_maxManifoldPoints > t; t++) this.m_points[t] = new C();
                (this.m_localPlaneNormal = new a()), (this.m_localPoint = new a());
            }),
            (w.prototype.Reset = function () {
                for (var t = 0; o.b2_maxManifoldPoints > t; t++) (this.m_points[t] instanceof C ? this.m_points[t] : null).Reset();
            ...
            (I.prototype.ExtendForward = function (t) {
                var i = this.p2.x - this.p1.x,
                    e = this.p2.y - this.p1.y,
                    o = Math.min(
                        i > 0 ? (t.upperBound.x - this.p1.x) / i : 0 > i ? (t.lowerBound.x - this.p1.x) / i : Number.POSITIVE_INFINITY,
                        e > 0 ? (t.upperBound.y - this.p1.y) / e : 0 > e ? (t.lowerBound.y - this.p1.y) / e : Number.POSITIVE_INFINITY
                    );
            ...
            (I.prototype.ExtendBackward = function (t) {
                var i = -this.p2.x + this.p1.x,
                    e = -this.p2.y + this.p1.y,
                    o = Math.min(
                        i > 0 ? (t.upperBound.x - this.p2.x) / i : 0 > i ? (t.lowerBound.x - this.p2.x) / i : Number.POSITIVE_INFINITY,
                        e > 0 ? (t.upperBound.y - this.p2.y) / e : 0 > e ? (t.lowerBound.y - this.p2.y) / e : Number.POSITIVE_INFINITY
                    );
                ...
                switch (this.m_count) {
                    ...
                    case 2:
                        var t = s.SubtractVV(this.m_v2.w, this.m_v1.w),
                            i = s.CrossVV(t, this.m_v1.w.GetNegative());
            ...
            (M.prototype.GetWitnessPoints = function (t, i) {
                switch (this.m_count) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        (i.x = t.x = this.m_v1.a * this.m_v1.wA.x + this.m_v2.a * this.m_v2.wA.x + this.m_v3.a * this.m_v3.wA.x),
                            (i.y = t.y = this.m_v1.a * this.m_v1.wA.y + this.m_v2.a * this.m_v2.wA.y + this.m_v3.a * this.m_v3.wA.y);
                        break;
                    default:
                        o.b2Assert(!1);
                }
            ...
            (M.prototype.Solve2 = function () {
                var t = this.m_v1.w,
                    ...
                    e = s.SubtractVV(i, t),
                    o = -(t.x * e.x + t.y * e.y);
                if (0 >= o) return (this.m_v1.a = 1), (this.m_count = 1), void 0;
                var n = i.x * e.x + i.y * e.y;
                if (0 >= n) return (this.m_v2.a = 1), (this.m_count = 1), this.m_v1.Set(this.m_v2), void 0;
                var r = 1 / (n + o);
            ...
            (M.prototype.Solve3 = function () {
                var t = this.m_v1.w,
                    ...
                    v = g * s.CrossVV(e, t),
                    w = g * s.CrossVV(t, i);
                if (0 >= h && 0 >= u) return (this.m_v1.a = 1), (this.m_count = 1), void 0;
                if (a > 0 && h > 0 && 0 >= w) {
                    var C = 1 / (a + h);
                ...
                if (m > 0 && u > 0 && 0 >= v) {
                    var D = 1 / (m + u);
                    return (this.m_v1.a = m * D), (this.m_v3.a = u * D), (this.m_count = 2), this.m_v2.Set(this.m_v3), void 0;
                }
                if (0 >= a && 0 >= f) return (this.m_v2.a = 1), (this.m_count = 1), this.m_v1.Set(this.m_v2), void 0;
                if (0 >= m && 0 >= x) return (this.m_v3.a = 1), (this.m_count = 1), this.m_v1.Set(this.m_v3), void 0;
                if (x > 0 && f > 0 && 0 >= b) {
                    var B = 1 / (x + f);
                    return (this.m_v2.a = x * B), (this.m_v3.a = f * B), (this.m_count = 2), this.m_v1.Set(this.m_v3), void 0;
                }
                var S = 1 / (b + v + w);
            ...
            (V.TimeOfImpact = function (t) {
                ...
                for (V.s_cache.count = 0, V.s_distanceInput.useRadii = !1; ; ) {
                    ...
                    for (var b = 0; ; ) {
                        ...
                        if ((w > m ? ((y = v), (f = w)) : ((x = v), (g = w)), ++b, ++V.b2_toiRootIters, b == 50)) break;
                    }
                    if (((V.b2_toiMaxRootIters = s.Max(V.b2_toiMaxRootIters, b)), (1 + 100 * Number.MIN_VALUE) * l > d)) break;
                    if (((l = d), _++, ++V.b2_toiIters, _ == c)) break;
                }
            ...
            (L.prototype.b2WorldManifold = function () {
                this.m_points = new Vector(o.b2_maxManifoldPoints);
                for (var t = 0; o.b2_maxManifoldPoints > t; t++) this.m_points[t] = new a();
            }),
                ...
                if ((e === void 0 && (e = 0), s === void 0 && (s = 0), t.m_pointCount != 0)) {
                    ...
                    switch (t.m_type) {
                        case w.e_circles:
                            ...
                            var p = i.position.x + r.col1.x * n.x + r.col2.x * n.y,
                                d = i.position.y + r.col1.y * n.x + r.col2.y * n.y;
                            (r = o.R), (n = t.m_points[0].m_localPoint);
                            var y = o.position.x + r.col1.x * n.x + r.col2.x * n.y,
                            ...
                            var C = p + e * this.m_normal.x,
                                D = d + e * this.m_normal.y,
                                B = y - s * this.m_normal.x,
    ...
    (function () {
        var t = ($i_22.Common.b2Color, $i_22.Common.b2internal, $i_22.Common.b2Settings),
            i = $i_22.Collision.Shapes.b2CircleShape,
            e = $i_22.Collision.Shapes.b2EdgeChainDef,
            o = $i_22.Collision.Shapes.b2EdgeShape,
            s = $i_22.Collision.Shapes.b2MassData,
            n = $i_22.Collision.Shapes.b2PolygonShape,
            r = $i_22.Collision.Shapes.b2Shape,
            a = $i_22.Common.Math.b2Mat22,
            h = ($i_22.Common.Math.b2Mat33, $i_22.Common.Math.b2Math),
            l = ($i_22.Common.Math.b2Sweep, $i_22.Common.Math.b2Transform),
            c = $i_22.Common.Math.b2Vec2,
            _ =
            ...
            m = $i_22.Collision.b2DistanceInput,
            u = $i_22.Collision.b2DistanceOutput,
            p = $i_22.Collision.b2DistanceProxy,
            d =
        ...
        $i_22.Collision.b2SimplexVertex,
            ...
            (i.prototype.TestPoint = function (t, i) {
                var e = t.R,
                    o = t.position.x + (e.col1.x * this.m_p.x + e.col2.x * this.m_p.y),
                    s = t.position.y + (e.col1.y * this.m_p.x + e.col2.y * this.m_p.y);
                return (o = i.x - o), (s = i.y - s), this.m_radius * this.m_radius >= o * o + s * s;
            }),
            (i.prototype.RayCast = function (t, i, e) {
                var o = e.R,
                    s = e.position.x + (o.col1.x * this.m_p.x + o.col2.x * this.m_p.y),
                    n = e.position.y + (o.col1.y * this.m_p.x + o.col2.y * this.m_p.y),
                    r = i.p1.x - s,
                    a = i.p1.y - n,
                    ...
                    m = l * l + c * c,
                    u = _ * _ - m * h;
                if (0 > u || Number.MIN_VALUE > m) return !1;
                var p = -(_ + Math.sqrt(u));
                return 0 > p || p > i.maxFraction * m
                    ? !1
                    : ((p /= m), (t.fraction = p), (t.normal.x = r + p * l), (t.normal.y = a + p * c), t.normal.Normalize(), !0);
            }),
            (i.prototype.ComputeAABB = function (t, i) {
                var e = i.R,
                    o = i.position.x + (e.col1.x * this.m_p.x + e.col2.x * this.m_p.y),
                    s = i.position.y + (e.col1.y * this.m_p.x + e.col2.y * this.m_p.y);
                t.lowerBound.Set(o - this.m_radius, s - this.m_radius), t.upperBound.Set(o + this.m_radius, s + this.m_radius);
            }),
            (i.prototype.ComputeMass = function (i, e) {
                e === void 0 && (e = 0),
                    (i.mass = e * t.b2_pi * this.m_radius * this.m_radius),
                    i.center.SetV(this.m_p),
                    (i.I = i.mass * (0.5 * this.m_radius * this.m_radius + (this.m_p.x * this.m_p.x + this.m_p.y * this.m_p.y)));
            }),
            (i.prototype.ComputeSubmergedArea = function (t, i, e, o) {
                i === void 0 && (i = 0);
                var s = h.MulX(e, this.m_p),
                    n = -(h.Dot(t, s) - i);
                if (-this.m_radius + Number.MIN_VALUE > n) return 0;
                if (n > this.m_radius) return o.SetV(s), Math.PI * this.m_radius * this.m_radius;
            ...
            (i.prototype.b2CircleShape = function (t) {
                t === void 0 && (t = 0), this.__super.b2Shape.call(this), (this.m_type = r.e_circleShape), (this.m_radius = t);
            }),
            ...
            (o.prototype.RayCast = function (t, i, e) {
                var o,
                    ...
                    n = i.p2.y - i.p1.y;
                o = e.R;
                var r = e.position.x + (o.col1.x * this.m_v1.x + o.col2.x * this.m_v1.y),
                    a = e.position.y + (o.col1.y * this.m_v1.x + o.col2.y * this.m_v1.y),
                    h = e.position.y + (o.col1.y * this.m_v2.x + o.col2.y * this.m_v2.y) - a,
                    l = -(e.position.x + (o.col1.x * this.m_v2.x + o.col2.x * this.m_v2.y) - r),
            ...
            (o.prototype.ComputeAABB = function (t, i) {
                var e = i.R,
                    o = i.position.x + (e.col1.x * this.m_v1.x + e.col2.x * this.m_v1.y),
                    s = i.position.y + (e.col1.y * this.m_v1.x + e.col2.y * this.m_v1.y),
                    n = i.position.x + (e.col1.x * this.m_v2.x + e.col2.x * this.m_v2.y),
                    r = i.position.y + (e.col1.y * this.m_v2.x + e.col2.y * this.m_v2.y);
            ...
            (o.prototype.ComputeSubmergedArea = function (t, i, e, o) {
                i === void 0 && (i = 0);
                var s = new c(t.x * i, t.y * i),
                    n = h.MulX(e, this.m_v1),
                    r = h.MulX(e, this.m_v2),
                    a = h.Dot(t, n) - i,
                    l = h.Dot(t, r) - i;
                if (a > 0) {
                    if (l > 0) return 0;
                    (n.x = (-l / (a - l)) * n.x + (a / (a - l)) * r.x), (n.y = (-l / (a - l)) * n.y + (a / (a - l)) * r.y);
                } else l > 0 && ((r.x = (-l / (a - l)) * n.x + (a / (a - l)) * r.x), (r.y = (-l / (a - l)) * n.y + (a / (a - l)) * r.y));
                return (
                    (o.x = (s.x + n.x + r.x) / 3),
                    (o.y = (s.y + n.y + r.y) / 3),
            ...
            (n.prototype.SetAsArray = function (t, i) {
                ...
                var e,
                    o = new Vector(),
                    s = 0;
                for (s = 0; t.length > s; ++s) (e = t[s]), o.push(e);
            ...
            (n.prototype.SetAsVector = function (i, e) {
                e === void 0 && (e = 0), e == 0 && (e = i.length), t.b2Assert(e >= 2), (this.m_vertexCount = e), this.Reserve(e);
                var o = 0;
                for (o = 0; this.m_vertexCount > o; o++) this.m_vertices[o].SetV(i[o]);
            ...
            (n.prototype.TestPoint = function (t, i) {
                for (
                    var e,
                        ...
                        s = i.x - t.position.x,
                        n = i.y - t.position.y,
                        r = s * o.col1.x + n * o.col1.y,
                        a = s * o.col2.x + n * o.col2.y,
                        h = 0;
                    this.m_vertexCount > h;
                    ++h
                ) {
            ...
            (n.prototype.RayCast = function (t, i, e) {
                ...
                for (
                    var _ = a * o.col1.x + h * o.col1.y, m = a * o.col2.x + h * o.col2.y, u = _ - l, p = m - c, d = parseInt(-1), y = 0;
                    this.m_vertexCount > y;
                    ++y
                ) {
                    ...
                    if (f == 0) {
                        if (0 > x) return !1;
                    } else 0 > f && n * f > x ? ((n = x / f), (d = y)) : f > 0 && r * f > x && (r = x / f);
                    if (n - Number.MIN_VALUE > r) return !1;
                }
                return 0 > d
                    ? !1
                    : ((t.fraction = n),
            ...
            (n.prototype.ComputeAABB = function (t, i) {
                for (
                    var e = i.R,
                        o = this.m_vertices[0],
                        s = i.position.x + (e.col1.x * o.x + e.col2.x * o.y),
                        n = i.position.y + (e.col1.y * o.x + e.col2.y * o.y),
                        r = s,
                        a = n,
                        h = 1;
                    this.m_vertexCount > h;
                    ...
                    o = this.m_vertices[h];
                    var l = i.position.x + (e.col1.x * o.x + e.col2.x * o.y),
                        c = i.position.y + (e.col1.y * o.x + e.col2.y * o.y);
            ...
            (n.prototype.ComputeMass = function (t, i) {
                ...
                for (var e = 0, o = 0, s = 0, n = 0, r = 0, a = 0, h = 1 / 3, l = 0; this.m_vertexCount > l; ++l) {
                    var c = this.m_vertices[l],
                        _ = this.m_vertexCount > l + 1 ? this.m_vertices[parseInt(l + 1)] : this.m_vertices[0],
                        m = c.x - r,
                        u = c.y - a,
                        p = _.x - r,
                        d = _.y - a,
                    ...
                    var f = r,
                        ...
                        w = p,
                        C = d,
                        D = h * (0.25 * (b * b + w * b + w * w) + (f * b + f * w)) + 0.5 * f * f,
                        B = h * (0.25 * (v * v + C * v + C * C) + (g * v + g * C)) + 0.5 * g * g;
                    n += y * (D + B);
                }
            ...
            (n.prototype.ComputeSubmergedArea = function (t, i, e, o) {
                i === void 0 && (i = 0);
                var n = h.MulTMV(e.R, t),
                    r = i - h.Dot(t, e.position),
                ...
                var x,
                    f = parseInt((_ + 1) % this.m_vertexCount),
                    g = parseInt((m + 1) % this.m_vertexCount),
                    b = (0 - a[_]) / (a[f] - a[_]),
                    v = (0 - a[m]) / (a[g] - a[m]),
                    w = new c(
                        this.m_vertices[_].x * (1 - b) + this.m_vertices[f].x * b,
                        this.m_vertices[_].y * (1 - b) + this.m_vertices[f].y * b
                    ),
                    C = new c(
                        this.m_vertices[m].x * (1 - v) + this.m_vertices[g].x * v,
                        this.m_vertices[m].y * (1 - v) + this.m_vertices[g].y * v
                    ),
                    D = 0,
                    B = new c(),
                    S = this.m_vertices[f];
            ...
            (n.prototype.Reserve = function (t) {
                t === void 0 && (t = 0);
                for (var i = parseInt(this.m_vertices.length); t > i; i++) (this.m_vertices[i] = new c()), (this.m_normals[i] = new c());
            }),
            (n.ComputeCentroid = function (t, i) {
                i === void 0 && (i = 0);
                for (var e = new c(), o = 0, s = 0, n = 0, r = 1 / 3, a = 0; i > a; ++a) {
                    var h = t[a],
                        l = i > a + 1 ? t[parseInt(a + 1)] : t[0],
                        _ = h.x - s,
                        m = h.y - n,
                        u = l.x - s,
                        p = l.y - n,
            ...
            (n.ComputeOBB = function (t, i, e) {
                ...
                for (o = 1; e >= o; ++o) {
                    ...
                    (a /= l), (h /= l);
                    for (
                        var c = -h, _ = a, m = Number.MAX_VALUE, u = Number.MAX_VALUE, p = -Number.MAX_VALUE, d = -Number.MAX_VALUE, y = 0;
                        e > y;
                        ++y
                    ) {
                        var x = s[y].x - r.x,
    ...
    (function () {
        var t = $i_22.Common.b2Color,
            i = ($i_22.Common.b2internal, $i_22.Common.b2Settings),
            e = ($i_22.Common.Math.b2Mat22, $i_22.Common.Math.b2Mat33, $i_22.Common.Math.b2Math);
    ...
    (function () {
        var t = ($i_22.Collision.b2AABB, $i_22.Common.b2Color, $i_22.Common.b2internal, $i_22.Common.b2Settings, $i_22.Common.Math.b2Mat22),
            i = $i_22.Common.Math.b2Mat33,
            e = $i_22.Common.Math.b2Math,
            o = $i_22.Common.Math.b2Sweep,
            s = $i_22.Common.Math.b2Transform,
            n = $i_22.Common.Math.b2Vec2,
            r = $i_22.Common.Math.b2Vec3;
        (t.b2Mat22 = function () {
            ...
            (t.prototype.GetInverse = function (t) {
                var i = this.col1.x,
                    ...
                    s = this.col2.y,
                    n = i * s - e * o;
                return n != 0 && (n = 1 / n), (t.col1.x = n * s), (t.col2.x = -n * e), (t.col1.y = -n * o), (t.col2.y = n * i), t;
            }),
            ...
            (i.prototype.Solve33 = function (t, i, e, o) {
                ...
                var s = this.col1.x,
                    ...
                    _ = this.col3.y,
                    m = this.col3.z,
                    u = s * (h * m - l * _) + n * (l * c - a * m) + r * (a * _ - h * c);
                return (
                    u != 0 && (u = 1 / u),
            ...
            (e.MulTMM = function (i, o) {
                var s = new n(e.Dot(i.col1, o.col1), e.Dot(i.col2, o.col1)),
                    r = new n(e.Dot(i.col1, o.col2), e.Dot(i.col2, o.col2)),
                    a = t.FromVV(s, r);
                return a;
            }),
            (e.Abs = function (t) {
            ...
            (n.prototype.Normalize = function () {
                ...
                if (Number.MIN_VALUE > t) return 0;
                var i = 1 / t;
            ...
            (r.prototype.b2Vec3 = function (t, i, e) {
                t === void 0 && (t = 0), i === void 0 && (i = 0), e === void 0 && (e = 0), (this.x = t), (this.y = i), (this.z = e);
            }),
    ...
    (function () {
        var t =
                ($i_22.Dynamics.Controllers.b2ControllerEdge,
                $i_22.Common.Math.b2Mat22,
                $i_22.Common.Math.b2Mat33,
                $i_22.Common.Math.b2Math),
            i = $i_22.Common.Math.b2Sweep,
            e = $i_22.Common.Math.b2Transform,
            o = $i_22.Common.Math.b2Vec2,
            s = ($i_22.Common.Math.b2Vec3, $i_22.Common.b2Color),
            n = ($i_22.Common.b2internal, $i_22.Common.b2Settings),
            r = $i_22.Collision.b2AABB,
            a =
                ($i_22.Collision.b2Bound,
                $i_22.Collision.b2BoundValues,
                $i_22.Collision.b2Collision,
            ...
            l =
                ...
                $i_22.Collision.b2Point,
                $i_22.Collision.b2RayCastInput),
            c = $i_22.Collision.b2RayCastOutput,
            _ =
                ($i_22.Collision.b2Segment,
                $i_22.Collision.b2SeparationFunction,
                $i_22.Collision.b2Simplex,
            ...
            m = ($i_22.Collision.Shapes.b2EdgeChainDef, $i_22.Collision.Shapes.b2EdgeShape),
            u = $i_22.Collision.Shapes.b2MassData,
            p = $i_22.Collision.Shapes.b2PolygonShape,
            d = $i_22.Collision.Shapes.b2Shape,
            y = $i_22.Dynamics.b2Body,
            x = $i_22.Dynamics.b2BodyDef,
            f = $i_22.Dynamics.b2ContactFilter,
            g = $i_22.Dynamics.b2ContactImpulse,
            b = $i_22.Dynamics.b2ContactListener,
            v = $i_22.Dynamics.b2ContactManager,
            w = $i_22.Dynamics.b2DebugDraw,
            C = $i_22.Dynamics.b2DestructionListener,
            D = $i_22.Dynamics.b2FilterData,
            B = $i_22.Dynamics.b2Fixture,
            S = $i_22.Dynamics.b2FixtureDef,
            I = $i_22.Dynamics.b2Island,
            A = $i_22.Dynamics.b2TimeStep,
            M = $i_22.Dynamics.b2World,
            T = ($i_22.Dynamics.Contacts.b2CircleContact, $i_22.Dynamics.Contacts.b2Contact),
            P =
                ($i_22.Dynamics.Contacts.b2ContactConstraint,
                $i_22.Dynamics.Contacts.b2ContactConstraintPoint,
                $i_22.Dynamics.Contacts.b2ContactEdge,
                $i_22.Dynamics.Contacts.b2ContactFactory),
            V =
                ($i_22.Dynamics.Contacts.b2ContactRegister,
                $i_22.Dynamics.Contacts.b2ContactResult,
                $i_22.Dynamics.Contacts.b2ContactSolver),
            R =
                ($i_22.Dynamics.Contacts.b2EdgeAndCircleContact,
                ...
                $i_22.Dynamics.Joints.b2Joint),
            L =
                ($i_22.Dynamics.Joints.b2JointDef,
        ...
        $i_22.Dynamics.Joints.b2PulleyJointDef,
            ...
            (y.b2Body = function () {
                (this.m_xf = new e()), (this.m_sweep = new i()), (this.m_linearVelocity = new o()), (this.m_force = new o());
            }),
            (y.prototype.connectEdges = function (i, e, o) {
                o === void 0 && (o = 0);
                var s = Math.atan2(e.GetDirectionVector().y, e.GetDirectionVector().x),
                    r = Math.tan((s - o) * 0.5),
                    a = t.MulFV(r, e.GetDirectionVector());
                (a = t.SubtractVV(a, e.GetNormalVector())), (a = t.MulFV(n.b2_toiSlop, a)), (a = t.AddVV(a, e.GetVertex1()));
            ...
            (y.prototype.SetPositionAndAngle = function (t, i) {
                ...
                if (this.m_world.IsLocked() != 1) {
                    ...
                    for (e = this.m_fixtureList; e; e = e.m_next) e.Synchronize(n, this.m_xf, this.m_xf);
            ...
            (y.prototype.Split = function (i) {
                for (
                    var e,
                        o = this.GetLinearVelocity().Copy(),
                        s = this.GetAngularVelocity(),
                ...
                var c = r.GetWorldCenter(),
                    _ = a.GetWorldCenter(),
                    m = t.AddVV(o, t.CrossFV(s, t.SubtractVV(c, n))),
                    u = t.AddVV(o, t.CrossFV(s, t.SubtractVV(_, n)));
                return (
                    r.SetLinearVelocity(m),
            ...
            (y.prototype.SetMassData = function (i) {
                if ((n.b2Assert(this.m_world.IsLocked() == 0), this.m_world.IsLocked() != 1 && this.m_type == y.b2_dynamicBody)) {
                    (this.m_invMass = 0),
                        (this.m_I = 0),
                        (this.m_invI = 0),
                        (this.m_mass = i.mass),
            ...
            (y.prototype.ResetMassData = function () {
                if (
                    ...
                    for (var i = o.Make(0, 0), e = this.m_fixtureList; e; e = e.m_next)
                        if (e.m_density != 0) {
                            var s = e.GetMassData();
                            (this.m_mass += s.mass), (i.x += s.center.x * s.mass), (i.y += s.center.y * s.mass), (this.m_I += s.I);
                        }
                    this.m_mass > 0
            ...
            (y.prototype.GetWorldPoint = function (t) {
                var i = this.m_xf.R,
                    e = new o(i.col1.x * t.x + i.col2.x * t.y, i.col1.y * t.x + i.col2.y * t.y);
            ...
            (y.prototype.GetLinearVelocityFromLocalPoint = function (t) {
                var i = this.m_xf.R,
                    e = new o(i.col1.x * t.x + i.col2.x * t.y, i.col1.y * t.x + i.col2.y * t.y);
                return (
                    (e.x += this.m_xf.position.x),
                    (e.y += this.m_xf.position.y),
                    new o(
                        this.m_linearVelocity.x - this.m_angularVelocity * (e.y - this.m_sweep.c.y),
                        this.m_linearVelocity.y + this.m_angularVelocity * (e.x - this.m_sweep.c.x)
                    )
                );
            }),
            ...
            (y.prototype.SetType = function (t) {
                if ((t === void 0 && (t = 0), this.m_type != t)) {
                    (this.m_type = t),
                        this.ResetMassData(),
                        this.m_type == y.b2_staticBody && (this.m_linearVelocity.SetZero(), (this.m_angularVelocity = 0)),
                        this.SetAwake(!0),
            ...
            (y.prototype.SetActive = function (t) {
                if (t != this.IsActive()) {
                    ...
                    if (t)
                        for (
                            this.m_flags |= y.e_activeFlag, i = this.m_world.m_contactManager.m_broadPhase, e = this.m_fixtureList;
                            e;
                            e = e.m_next
                        )
            ...
            (y.prototype.b2Body = function (t, i) {
                ...
                (this.m_sweep.c.x = e.col1.x * o.x + e.col2.x * o.y),
                    ...
                    (this.m_sleepTime = 0),
                    (this.m_type = t.type),
                    this.m_type == y.b2_dynamicBody ? ((this.m_mass = 1), (this.m_invMass = 1)) : ((this.m_mass = 0), (this.m_invMass = 0)),
                    (this.m_I = 0),
                    (this.m_invI = 0),
            ...
            (y.prototype.SynchronizeFixtures = function () {
                ...
                for (o = this.m_fixtureList; o; o = o.m_next) o.Synchronize(s, t, this.m_xf);
            }),
            ...
            (y.prototype.ShouldCollide = function (t) {
                ...
                for (var i = this.m_jointList; i; i = i.next) if (i.other == t && i.joint.m_collideConnected == 0) return !1;
                return !0;
            }),
            ...
            (f.prototype.ShouldCollide = function (t, i) {
                var e = t.GetFilterData(),
                    o = i.GetFilterData();
                if (e.groupIndex == o.groupIndex && e.groupIndex != 0) return e.groupIndex > 0;
            ...
            (v.prototype.AddPair = function (t, i) {
                var e = t instanceof B ? t : null,
                    o = i instanceof B ? i : null,
                    s = e.GetBody(),
                    n = o.GetBody();
                if (s != n) {
            ...
            (B.prototype.GetMassData = function (t) {
                return t === void 0 && (t = null), t == null && (t = new u()), this.m_shape.ComputeMass(t, this.m_density), t;
            }),
            ...
            (I.prototype.Initialize = function (t, i, e, o, s, n) {
                ...
                for (r = this.m_contacts.length; i > r; r++) this.m_contacts[r] = null;
                for (r = this.m_joints.length; e > r; r++) this.m_joints[r] = null;
            }),
            ...
            (I.prototype.Solve = function (i, e, o) {
                ...
                for (_.InitVelocityConstraints(i), a = 0; this.m_jointCount > a; ++a) (r = this.m_joints[a]), r.InitVelocityConstraints(i);
                for (a = 0; i.velocityIterations > a; ++a) {
                    for (h = 0; this.m_jointCount > h; ++h) (r = this.m_joints[h]), r.SolveVelocityConstraints(i);
                    _.SolveVelocityConstraints();
                }
                for (a = 0; this.m_jointCount > a; ++a) (r = this.m_joints[a]), r.FinalizeVelocityConstraints();
                for (_.FinalizeVelocityConstraints(), a = 0; this.m_bodyCount > a; ++a)
                    if (((s = this.m_bodies[a]), s.GetType() != y.b2_staticBody)) {
                        var m = i.dt * s.m_linearVelocity.x,
                            u = i.dt * s.m_linearVelocity.y;
                        ...
                        p * p > n.b2_maxRotationSquared &&
                            (s.m_angularVelocity = 0 > s.m_angularVelocity ? -n.b2_maxRotation * i.inv_dt : n.b2_maxRotation * i.inv_dt),
                ...
                for (a = 0; i.positionIterations > a; ++a) {
                    var d = _.SolvePositionConstraints(n.b2_contactBaumgarte),
                        x = !0;
                ...
                if ((this.Report(_.m_constraints), o)) {
                    var g = Number.MAX_VALUE,
                        b = n.b2_linearSleepTolerance * n.b2_linearSleepTolerance,
                    ...
                    if (g >= n.b2_timeToSleep) for (a = 0; this.m_bodyCount > a; ++a) (s = this.m_bodies[a]), s.SetAwake(!1);
                }
            }),
            (I.prototype.SolveTOI = function (t) {
                ...
                for (i = 0; this.m_jointCount > i; ++i) this.m_joints[i].InitVelocityConstraints(t);
                for (i = 0; t.velocityIterations > i; ++i)
                    for (o.SolveVelocityConstraints(), e = 0; this.m_jointCount > e; ++e) this.m_joints[e].SolveVelocityConstraints(t);
                for (i = 0; this.m_bodyCount > i; ++i) {
                    ...
                    if (s.GetType() != y.b2_staticBody) {
                        ...
                        h * h > n.b2_maxRotationSquared &&
                            (s.m_angularVelocity = 0 > s.m_angularVelocity ? -n.b2_maxRotation * t.inv_dt : n.b2_maxRotation * t.inv_dt),
                            s.m_sweep.c0.SetV(s.m_sweep.c),
                            (s.m_sweep.a0 = s.m_sweep.a),
            ...
            (M.prototype.SetBroadPhase = function (t) {
                ...
                for (var e = this.m_bodyList; e; e = e.m_next)
                    for (var o = e.m_fixtureList; o; o = o.m_next) o.m_proxy = t.CreateProxy(i.GetFatAABB(o.m_proxy), o);
            }),
            ...
            (M.prototype.CreateJoint = function (t) {
                ...
                if (t.collideConnected == 0) {
                    ...
                    while (s) s.other == e && s.contact.FlagForFiltering(), (s = s.next);
                }
                return i;
            }),
            ...
            (M.prototype.DrawDebugData = function () {
                if (this.m_debugDraw != null) {
                    ...
                    if (h & w.e_jointBit) for (n = this.m_jointList; n; n = n.m_next) this.DrawJoint(n);
                    if (h & w.e_controllerBit) for (var m = this.m_controllerList; m; m = m.m_next) m.Draw(this.m_debugDraw);
                    if (h & w.e_pairBit) {
                        _.Set(0.3, 0.9, 0.9);
                        for (var u = this.m_contactManager.m_contactList; u; u = u.GetNext()) {
                            var p = u.GetFixtureA(),
                                ...
                                f = d.GetAABB().GetCenter();
                            this.m_debugDraw.DrawSegment(x, f, _);
                        }
                    }
                    if (h & w.e_aabbBit)
                        for (
                            a = this.m_contactManager.m_broadPhase, c = [new o(), new o(), new o(), new o()], t = this.m_bodyList;
                            t;
                            t = t.GetNext()
                        )
                            if (t.IsActive() != 0)
            ...
            (M.prototype.RayCast = function (t, i, e) {
                function s(s, n) {
                    ...
                    if (c) {
                        var _ = a.fraction,
                            m = new o((1 - _) * i.x + _ * e.x, (1 - _) * i.y + _ * e.y);
            ...
            (M.prototype.Solve = function (t) {
                for (var i, e = this.m_controllerList; e; e = e.m_next) e.Step(t);
                var o = this.m_island;
                for (
                    o.Initialize(
                        this.m_bodyCount,
                ...
                for (var s = this.m_contactList; s; s = s.m_next) s.m_flags &= ~T.e_islandFlag;
                ...
                for (var r = this.s_stack, a = this.m_bodyList; a; a = a.m_next)
                    if (!(a.m_flags & y.e_islandFlag) && a.IsAwake() != 0 && a.IsActive() != 0 && a.GetType() != y.b2_staticBody) {
                        o.Clear();
                        var h = 0;
                        (r[h++] = a), (a.m_flags |= y.e_islandFlag);
                        while (h > 0)
                            if (((i = r[--h]), o.AddBody(i), i.IsAwake() == 0 && i.SetAwake(!0), i.GetType() != y.b2_staticBody)) {
                                for (var l, c = i.m_contactList; c; c = c.next)
                                    c.contact.m_flags & T.e_islandFlag ||
                                        (c.contact.IsSensor() != 1 &&
                                            ...
                                            (c.contact.m_flags |= T.e_islandFlag),
                                            (l = c.other),
                                            l.m_flags & y.e_islandFlag || ((r[h++] = l), (l.m_flags |= y.e_islandFlag))));
            ...
            (M.prototype.SolveTOI = function (t) {
                ...
                l.Initialize(
                    this.m_bodyCount,
                    n.b2_maxTOIContactsPerIsland,
                    n.b2_maxTOIJointsPerIsland,
                    null,
                    this.m_contactManager.m_contactListener,
                    this.m_contactSolver
                );
                var c = M.s_queue;
                for (i = this.m_bodyList; i; i = i.m_next) (i.m_flags &= ~y.e_islandFlag), (i.m_sweep.t0 = 0);
                var _;
                for (_ = this.m_contactList; _; _ = _.m_next) _.m_flags &= ~(T.e_toiFlag | T.e_islandFlag);
                ...
                for (;;) {
                    ...
                    for (_ = this.m_contactList; _; _ = _.m_next)
                        if (_.IsSensor() != 1 && _.IsEnabled() != 0 && _.IsContinuous() != 0) {
                            var p = 1;
                            if (_.m_flags & T.e_toiFlag) p = _.m_toi;
                            else {
                                if (
                                    ((e = _.m_fixtureA),
                                    (o = _.m_fixtureB),
                    ...
                    if (m == null || u > 1 - 100 * Number.MIN_VALUE) break;
                    if (
                        ((e = m.m_fixtureA),
                        (o = m.m_fixtureB),
                        (s = e.m_body),
                        ...
                        if (m.IsTouching() != 0) {
                            ...
                            while (g > 0)
                                if (
                                    ((i = c[f++]), --g, l.AddBody(i), i.IsAwake() == 0 && i.SetAwake(!0), i.GetType() == y.b2_dynamicBody)
                                ) {
                                    for (a = i.m_contactList; a; a = a.next) {
                                        if (l.m_contactCount == l.m_contactCapacity) break;
                                        if (
                            ...
                            for (C = 0; l.m_bodyCount > C; ++C)
                                if (
                                    ...
                                    for (i.SynchronizeFixtures(), a = i.m_contactList; a; a = a.next) a.contact.m_flags &= ~T.e_toiFlag;
                            for (C = 0; l.m_contactCount > C; ++C) (_ = l.m_contacts[C]), (_.m_flags &= ~(T.e_toiFlag | T.e_islandFlag));
                            for (C = 0; l.m_jointCount > C; ++C) (h = l.m_joints[C]), (h.m_islandFlag = !1);
                            this.m_contactManager.FindNewContacts();
                        }
                    } else s.m_sweep.Set(M.s_backupA), r.m_sweep.Set(M.s_backupB), s.SynchronizeTransform(), r.SynchronizeTransform();
                }
            }),
            (M.prototype.DrawJoint = function (t) {
                ...
                switch (t.m_type) {
                    ...
                    case R.e_pulleyJoint:
                        var c = t instanceof L ? t : null,
                            _ = c.GetGroundAnchorA(),
                            m = c.GetGroundAnchorB();
                        this.m_debugDraw.DrawSegment(_, a, l), this.m_debugDraw.DrawSegment(m, h, l), this.m_debugDraw.DrawSegment(_, m, l);
                        break;
                    case R.e_mouseJoint:
                        this.m_debugDraw.DrawSegment(a, h, l);
                        break;
            ...
            (M.prototype.DrawShape = function (i, e, o) {
                switch (i.m_type) {
                    ...
                    case d.e_polygonShape:
                        var h = 0,
                            l = i instanceof p ? i : null,
                            c = parseInt(l.GetVertexCount()),
                            u = l.GetVertices(),
                            y = new Vector(c);
                        for (h = 0; c > h; ++h) y[h] = t.MulX(e, u[h]);
    ...
    (function () {
        var t = $i_22.Collision.Shapes.b2CircleShape,
            i = ($i_22.Collision.Shapes.b2EdgeChainDef, $i_22.Collision.Shapes.b2EdgeShape),
            e = ($i_22.Collision.Shapes.b2MassData, $i_22.Collision.Shapes.b2PolygonShape),
            o = $i_22.Collision.Shapes.b2Shape,
            s = $i_22.Dynamics.Contacts.b2CircleContact,
            n = $i_22.Dynamics.Contacts.b2Contact,
            r = $i_22.Dynamics.Contacts.b2ContactConstraint,
            a = $i_22.Dynamics.Contacts.b2ContactConstraintPoint,
            h = $i_22.Dynamics.Contacts.b2ContactEdge,
            l = $i_22.Dynamics.Contacts.b2ContactFactory,
            c = $i_22.Dynamics.Contacts.b2ContactRegister,
            _ = $i_22.Dynamics.Contacts.b2ContactResult,
            m = $i_22.Dynamics.Contacts.b2ContactSolver,
            u = $i_22.Dynamics.Contacts.b2EdgeAndCircleContact,
            p = $i_22.Dynamics.Contacts.b2NullContact,
            d = $i_22.Dynamics.Contacts.b2PolyAndCircleContact,
            y = $i_22.Dynamics.Contacts.b2PolyAndEdgeContact,
            x = $i_22.Dynamics.Contacts.b2PolygonContact,
            f = $i_22.Dynamics.Contacts.b2PositionSolverManifold,
            g = $i_22.Dynamics.b2Body,
            b =
                ($i_22.Dynamics.b2BodyDef,
                $i_22.Dynamics.b2ContactFilter,
                $i_22.Dynamics.b2ContactImpulse,
                ...
                $i_22.Dynamics.b2Island,
                $i_22.Dynamics.b2TimeStep),
            v = ($i_22.Dynamics.b2World, $i_22.Common.b2Color, $i_22.Common.b2internal, $i_22.Common.b2Settings),
            w = $i_22.Common.Math.b2Mat22,
            C = ($i_22.Common.Math.b2Mat33, $i_22.Common.Math.b2Math),
            D = ($i_22.Common.Math.b2Sweep, $i_22.Common.Math.b2Transform, $i_22.Common.Math.b2Vec2),
            B =
                ($i_22.Common.Math.b2Vec3,
                $i_22.Collision.b2AABB,
                $i_22.Collision.b2Bound,
            ...
            A =
                ...
                $i_22.Collision.b2SimplexVertex,
                $i_22.Collision.b2TimeOfImpact),
            M = $i_22.Collision.b2TOIInput,
            T = $i_22.Collision.b2WorldManifold;
        $i_22.Collision.ClipVertex,
            $i_22.Collision.Features,
            $i_22.Collision.IBroadPhase,
            ...
            (n.b2Contact = function () {
                (this.m_nodeA = new h()), (this.m_nodeB = new h()), (this.m_manifold = new I()), (this.m_oldManifold = new I());
            }),
            ...
            (n.prototype.Update = function (t) {
                ...
                if (this.m_flags & n.e_sensorFlag) {
                    ...
                    if (
                        (r.GetType() != g.b2_dynamicBody || r.IsBullet() || a.GetType() != g.b2_dynamicBody || a.IsBullet()
                            ? (this.m_flags |= n.e_continuousFlag)
                            : (this.m_flags &= ~n.e_continuousFlag),
                        h)
                    ) {
            ...
            (n.prototype.ComputeTOI = function (t, i) {
                return (
                    n.s_input.proxyA.Set(this.m_fixtureA.GetShape()),
            ...
            (r.prototype.b2ContactConstraint = function () {
                ...
                for (var t = 0; v.b2_maxManifoldPoints > t; t++) this.points[t] = new a();
            }),
            ...
            (l.prototype.InitializeRegisters = function () {
                ...
                for (var t = 0; o.e_shapeTypeCount > t; t++) {
                    ...
                    for (var i = 0; o.e_shapeTypeCount > i; i++) this.m_registers[t][i] = new c();
                }
            ...
            (l.prototype.Create = function (t, i) {
                var e,
                    ...
                    s = parseInt(i.GetType()),
                    n = this.m_registers[o][s];
                if (n.pool) return (e = n.pool), (n.pool = e.m_next), n.poolCount--, e.Reset(t, i), e;
                var r = n.createFcn;
                return r != null
                    ? n.primary
            ...
            (l.prototype.Destroy = function (t) {
                ...
                var i = parseInt(t.m_fixtureA.GetType()),
                    e = parseInt(t.m_fixtureB.GetType()),
                    o = this.m_registers[i][e];
            ...
            (m.prototype.Initialize = function (t, i, e, o) {
                ...
                while (this.m_constraintCount > this.m_constraints.length) this.m_constraints[this.m_constraints.length] = new r();
                for (n = 0; e > n; ++n) {
                    s = i[n];
                    var a = s.m_fixtureA,
                        h = s.m_fixtureB,
                        ...
                        d = h.m_body,
                        y = s.GetManifold(),
                        x = v.b2MixFriction(a.GetFriction(), h.GetFriction()),
                        f = v.b2MixRestitution(a.GetRestitution(), h.GetRestitution()),
                        g = p.m_linearVelocity.x,
                        b = p.m_linearVelocity.y,
                        w = d.m_linearVelocity.x,
                        C = d.m_linearVelocity.y,
                        D = p.m_angularVelocity,
                        B = d.m_angularVelocity;
                    v.b2Assert(y.m_pointCount > 0), m.s_worldManifold.Initialize(y, p.m_xf, _, d.m_xf, u);
                    var S = m.s_worldManifold.m_normal.x,
                        I = m.s_worldManifold.m_normal.y,
                    ...
                    for (var M = 0; A.pointCount > M; ++M) {
                        var T = y.m_points[M],
                            P = A.points[M];
                        (P.normalImpulse = T.m_normalImpulse), (P.tangentImpulse = T.m_tangentImpulse), P.localPoint.SetV(T.m_localPoint);
                        var V = (P.rA.x = m.s_worldManifold.m_points[M].x - p.m_sweep.c.x),
                            R = (P.rA.y = m.s_worldManifold.m_points[M].y - p.m_sweep.c.y),
                            L = (P.rB.x = m.s_worldManifold.m_points[M].x - d.m_sweep.c.x),
                            k = (P.rB.y = m.s_worldManifold.m_points[M].y - d.m_sweep.c.y),
                            F = V * I - R * S,
                            G = L * I - k * S;
                        (F *= F), (G *= G);
                    ...
                    if (A.pointCount == 2) {
                        var H = A.points[0],
                            ...
                            Q = d.m_invMass,
                            $ = d.m_invI,
                            ti = H.rA.x * I - H.rA.y * S,
                            ii = H.rB.x * I - H.rB.y * S,
                            ei = K.rA.x * I - K.rA.y * S,
                            oi = K.rB.x * I - K.rB.y * S,
                            si = Y + Q + Z * ti * ti + $ * ii * ii,
                            ni = Y + Q + Z * ei * ei + $ * oi * oi,
                            ri = Y + Q + Z * ti * ei + $ * ii * oi,
                            ai = 100;
                ...
                for (var i = 0; this.m_constraintCount > i; ++i) {
                    ...
                    if (t.warmStarting)
                        for (p = e.pointCount, u = 0; p > u; ++u) {
                            ...
                            var y = d.normalImpulse * l + d.tangentImpulse * _,
                                x = d.normalImpulse * c + d.tangentImpulse * m;
                ...
                for (
                    ...
                    if ((parseInt(g.pointCount), g.pointCount == 1))
                        ...
                        for (i = g.K, q -= i.col1.x * E + i.col2.x * z, X -= i.col1.y * E + i.col2.y * z; ; ) {
                            i = g.normalMass;
                            var H = -(i.col1.x * q + i.col2.x * X),
                                K = -(i.col1.y * q + i.col2.y * X);
                            if (H >= 0 && K >= 0) {
                                (m = H - E),
                                    (u = K - z),
                                    (p = m * P),
            ...
            (m.prototype.SolvePositionConstraints = function (t) {
                ...
                for (var i = 0, e = 0; this.m_constraintCount > e; e++) {
                    ...
                    for (var c = m.s_psm.m_normal, _ = 0; o.pointCount > _; _++) {
                        var u = o.points[_],
                            p = m.s_psm.m_points[_],
                            d = m.s_psm.m_separations[_],
                            y = p.x - s.m_sweep.c.x,
                            x = p.y - s.m_sweep.c.y,
                            f = p.x - n.m_sweep.c.x,
                            g = p.y - n.m_sweep.c.y;
                        i = d > i ? i : d;
                        var b = C.Clamp(t * (d + v.b2_linearSlop), -v.b2_maxLinearCorrection, 0),
                            w = -u.equalizedMass * b,
                            D = w * c.x,
                            B = w * c.y;
                        (s.m_sweep.c.x -= r * D),
            ...
            (d.prototype.Evaluate = function () {
                ...
                B.CollidePolygonAndCircle(
                    this.m_manifold,
                    this.m_fixtureA.GetShape() instanceof e ? this.m_fixtureA.GetShape() : null,
                    i.m_xf,
                    this.m_fixtureB.GetShape() instanceof t ? this.m_fixtureB.GetShape() : null,
                    o.m_xf
                );
            ...
            (y.prototype.Reset = function (t, i) {
                this.__super.Reset.call(this, t, i), v.b2Assert(t.GetType() == o.e_polygonShape), v.b2Assert(i.GetType() == o.e_edgeShape);
            }),
            ...
            (x.prototype.Evaluate = function () {
                ...
                B.CollidePolygons(
                    ...
                    this.m_fixtureA.GetShape() instanceof e ? this.m_fixtureA.GetShape() : null,
                    t.m_xf,
                    this.m_fixtureB.GetShape() instanceof e ? this.m_fixtureB.GetShape() : null,
                    i.m_xf
                );
            }),
            ...
            (f.prototype.b2PositionSolverManifold = function () {
                ...
                for (var t = 0; v.b2_maxManifoldPoints > t; t++) this.m_points[t] = new D();
            }),
            (f.prototype.Initialize = function (t) {
                ...
                switch (t.type) {
                    case I.e_circles:
                        ...
                        var h = t.bodyA.m_xf.position.x + (i.col1.x * e.x + i.col2.x * e.y),
                            l = t.bodyA.m_xf.position.y + (i.col1.y * e.x + i.col2.y * e.y);
                        (i = t.bodyB.m_xf.R), (e = t.points[0].localPoint);
                        var c = t.bodyB.m_xf.position.x + (i.col1.x * e.x + i.col2.x * e.y),
                            _ = t.bodyB.m_xf.position.y + (i.col1.y * e.x + i.col2.y * e.y),
                            m = c - h,
                            u = _ - l,
                            p = m * m + u * u;
                    ...
                    case I.e_faceA:
                        for (
                            ...
                            (e = t.points[o].localPoint),
                                ...
                                (this.m_separations[o] = (s - r) * this.m_normal.x + (n - a) * this.m_normal.y - t.radius),
                                (this.m_points[o].x = s),
                                (this.m_points[o].y = n);
                        break;
                    case I.e_faceB:
    ...
    (function () {
        var t =
                ...
                $i_22.Dynamics.b2World,
                $i_22.Common.Math.b2Mat22),
            i = ($i_22.Common.Math.b2Mat33, $i_22.Common.Math.b2Math),
            e = ($i_22.Common.Math.b2Sweep, $i_22.Common.Math.b2Transform, $i_22.Common.Math.b2Vec2),
            o = ($i_22.Common.Math.b2Vec3, $i_22.Common.b2Color),
            s =
                ...
                $i_22.Dynamics.Controllers.b2BuoyancyController),
            n = $i_22.Dynamics.Controllers.b2ConstantAccelController,
            r = $i_22.Dynamics.Controllers.b2ConstantForceController,
            a = $i_22.Dynamics.Controllers.b2Controller,
            h = $i_22.Dynamics.Controllers.b2ControllerEdge,
            l = $i_22.Dynamics.Controllers.b2GravityController,
            c = $i_22.Dynamics.Controllers.b2TensorDampingController;
        $i_22.inherit(s, $i_22.Dynamics.Controllers.b2Controller),
            ...
            (n.prototype.Step = function (t) {
                for (var i = new e(this.A.x * t.dt, this.A.y * t.dt), o = this.m_bodyList; o; o = o.nextBody) {
                    var s = o.body;
                    s.IsAwake() && s.SetLinearVelocity(new e(s.GetLinearVelocity().x + i.x, s.GetLinearVelocity().y + i.y));
                }
            }),
            ...
            (a.prototype.RemoveBody = function (t) {
                ...
                while (i && i.controller != this) i = i.nextController;
            ...
            (l.b2GravityController = function () {
                $i_22.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments), (this.G = 1), (this.invSqr = !0);
            }),
            ...
            (c.b2TensorDampingController = function () {
                $i_22.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments), (this.T = new t()), (this.maxTimestep = 0);
            }),
    ...
    (function () {
        var t = ($i_22.Common.b2Color, $i_22.Common.b2internal, $i_22.Common.b2Settings),
            i = $i_22.Common.Math.b2Mat22,
            e = $i_22.Common.Math.b2Mat33,
            o = $i_22.Common.Math.b2Math,
            s = ($i_22.Common.Math.b2Sweep, $i_22.Common.Math.b2Transform, $i_22.Common.Math.b2Vec2),
            n = $i_22.Common.Math.b2Vec3,
            r = $i_22.Dynamics.Joints.b2DistanceJoint,
            a = $i_22.Dynamics.Joints.b2DistanceJointDef,
            h = $i_22.Dynamics.Joints.b2FrictionJoint,
            l = $i_22.Dynamics.Joints.b2FrictionJointDef,
            c = $i_22.Dynamics.Joints.b2GearJoint,
            _ = $i_22.Dynamics.Joints.b2GearJointDef,
            m = $i_22.Dynamics.Joints.b2Jacobian,
            u = $i_22.Dynamics.Joints.b2Joint,
            p = $i_22.Dynamics.Joints.b2JointDef,
            d = $i_22.Dynamics.Joints.b2JointEdge,
            y = $i_22.Dynamics.Joints.b2LineJoint,
            x = $i_22.Dynamics.Joints.b2LineJointDef,
            f = $i_22.Dynamics.Joints.b2MouseJoint,
            g = $i_22.Dynamics.Joints.b2MouseJointDef,
            b = $i_22.Dynamics.Joints.b2PrismaticJoint,
            v = $i_22.Dynamics.Joints.b2PrismaticJointDef,
            w = $i_22.Dynamics.Joints.b2PulleyJoint,
            C = $i_22.Dynamics.Joints.b2PulleyJointDef,
            D = $i_22.Dynamics.Joints.b2RevoluteJoint,
            B = $i_22.Dynamics.Joints.b2RevoluteJointDef,
            S = $i_22.Dynamics.Joints.b2WeldJoint,
        ...
        $i_22.Dynamics.b2Body,
            ...
            (r.prototype.InitVelocityConstraints = function (i) {
                ...
                var _ = r * this.m_u.y - a * this.m_u.x,
                    m = h * this.m_u.y - l * this.m_u.x,
                    u = s.m_invMass + s.m_invI * _ * _ + n.m_invMass + n.m_invI * m * m;
            ...
            (r.prototype.SolveVelocityConstraints = function () {
                ...
                var h = i.m_linearVelocity.x + -i.m_angularVelocity * s,
                    l = i.m_linearVelocity.y + i.m_angularVelocity * o,
                    c = e.m_linearVelocity.x + -e.m_angularVelocity * a,
                    _ = e.m_linearVelocity.y + e.m_angularVelocity * r,
                    m = this.m_u.x * (c - h) + this.m_u.y * (_ - l),
            ...
            (r.prototype.SolvePositionConstraints = function (i) {
                ...
                var _ = n.m_sweep.c.x + l - s.m_sweep.c.x - r,
                    m = n.m_sweep.c.y + c - s.m_sweep.c.y - a,
                    u = Math.sqrt(_ * _ + m * m);
                (_ /= u), (m /= u);
            ...
            (h.prototype.SolveVelocityConstraints = function (t) {
                var i,
                    ...
                    p = r.m_invI;
                i = n.m_xf.R;
                var d = this.m_localAnchorA.x - n.m_sweep.localCenter.x,
                    y = this.m_localAnchorA.y - n.m_sweep.localCenter.y;
            ...
            (l.prototype.b2FrictionJointDef = function () {
                this.__super.b2JointDef.call(this), (this.type = u.e_frictionJoint), (this.maxForce = 0), (this.maxTorque = 0);
            }),
            ...
            (c.prototype.GetReactionForce = function (t) {
                return t === void 0 && (t = 0), new s(t * this.m_impulse * this.m_J.linearB.x, t * this.m_impulse * this.m_J.linearB.y);
            }),
            (c.prototype.GetReactionTorque = function (t) {
                t === void 0 && (t = 0);
                var i = this.m_bodyB.m_xf.R,
                    e = this.m_localAnchor1.x - this.m_bodyB.m_sweep.localCenter.x,
                    o = this.m_localAnchor1.y - this.m_bodyB.m_sweep.localCenter.y,
                    s = i.col1.x * e + i.col2.x * o;
            ...
            (c.prototype.SolveVelocityConstraints = function () {
                var t = this.m_bodyA,
                    i = this.m_bodyB,
                    e = this.m_J.Compute(t.m_linearVelocity, t.m_angularVelocity, i.m_linearVelocity, i.m_angularVelocity),
                    o = -this.m_mass * e;
                (this.m_impulse += o),
            ...
            (c.prototype.SolvePositionConstraints = function (i) {
                ...
                var a = this.m_constant - (n + this.m_ratio * r),
                    h = -this.m_mass * a;
                return (
                    (o.m_sweep.c.x += o.m_invMass * h * this.m_J.linearA.x),
            ...
            (u.b2Joint = function () {
                (this.m_edgeA = new d()), (this.m_edgeB = new d()), (this.m_localCenterA = new s()), (this.m_localCenterB = new s());
            }),
            ...
            (y.prototype.GetReactionForce = function (t) {
                return (
                    t === void 0 && (t = 0),
                    new s(
                        t * (this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.y) * this.m_axis.x),
                        t * (this.m_impulse.x * this.m_perp.y + (this.m_motorImpulse + this.m_impulse.y) * this.m_axis.y)
                    )
                );
            }),
            ...
            (y.prototype.GetJointTranslation = function () {
                var t = this.m_bodyA,
                    i = this.m_bodyB,
                    e = t.GetWorldPoint(this.m_localAnchor1),
                    o = i.GetWorldPoint(this.m_localAnchor2),
                    s = o.x - e.x,
                    n = o.y - e.y,
            ...
            (y.prototype.GetJointSpeed = function () {
                ...
                var r = this.m_localAnchor2.x - e.m_sweep.localCenter.x,
                    a = this.m_localAnchor2.y - e.m_sweep.localCenter.y;
                (n = t.col1.x * r + t.col2.x * a), (a = t.col1.y * r + t.col2.y * a), (r = n);
                var h = i.m_sweep.c.x + o,
                    l = i.m_sweep.c.y + s,
                    c = e.m_sweep.c.x + r,
                    _ = e.m_sweep.c.y + a,
                    m = c - h,
                    u = _ - l,
                    p = i.GetWorldVector(this.m_localXAxis1),
                    d = i.m_linearVelocity,
                    y = e.m_linearVelocity,
                    x = i.m_angularVelocity,
                    f = e.m_angularVelocity,
                    g = m * -x * p.y + u * x * p.x + (p.x * (y.x + -f * a - d.x - -x * s) + p.y * (y.y + f * r - d.y - x * o));
                return g;
            }),
            ...
            (y.prototype.SetMaxMotorForce = function (t) {
                t === void 0 && (t = 0), this.m_bodyA.SetAwake(!0), this.m_bodyB.SetAwake(!0), (this.m_maxMotorForce = t);
            }),
            ...
            (y.prototype.InitVelocityConstraints = function (i) {
                ...
                var m = n.m_sweep.c.x + c - s.m_sweep.c.x - h,
                    p = n.m_sweep.c.y + _ - s.m_sweep.c.y - l;
                ...
                var d = this.m_invMassA,
                    ...
                    f = this.m_invIB;
                if (
                    ((this.m_K.col1.x = d + y + x * this.m_s1 * this.m_s1 + f * this.m_s2 * this.m_s2),
                    ...
                    2 * t.b2_linearSlop > o.Abs(this.m_upperTranslation - this.m_lowerTranslation)
                        ...
                        ? this.m_upperTranslation > g
                            ...
                            : this.m_limitState != u.e_atUpperLimit && ((this.m_limitState = u.e_atUpperLimit), (this.m_impulse.y = 0))
                        : this.m_limitState != u.e_atLowerLimit && ((this.m_limitState = u.e_atLowerLimit), (this.m_impulse.y = 0));
            ...
            (y.prototype.SolveVelocityConstraints = function (t) {
                ...
                if (this.m_enableLimit && this.m_limitState != u.e_inactiveLimit) {
                    ...
                    var w = -f - (this.m_impulse.y - b.y) * this.m_K.col2.x,
                        C = 0;
                ...
                i.m_linearVelocity.SetV(n), (i.m_angularVelocity = r), e.m_linearVelocity.SetV(a), (e.m_angularVelocity = h);
            }),
            (y.prototype.SolvePositionConstraints = function (e) {
                ...
                if (this.m_enableLimit) {
                    ...
                    2 * t.b2_linearSlop > o.Abs(this.m_upperTranslation - this.m_lowerTranslation)
                        ? ((b = o.Clamp(M, -t.b2_maxLinearCorrection, t.b2_maxLinearCorrection)), (x = o.Abs(M)), (g = !0))
                ...
                var T = new s(),
                    P = this.m_perp.x * I + this.m_perp.y * A;
                if (((x = o.Max(x, o.Abs(P))), (f = 0), g))
                    ...
                    var V = u + p + d * this.m_s1 * this.m_s1 + y * this.m_s2 * this.m_s2,
                        R = 0;
                    (R = V != 0 ? -P / V : 0), (T.x = R), (T.y = 0);
                }
                var L = T.x * this.m_perp.x + T.y * this.m_axis.x,
                    k = T.x * this.m_perp.y + T.y * this.m_axis.y,
            ...
            (f.prototype.b2MouseJoint = function (t) {
                ...
                var i = this.m_target.x - this.m_bodyB.m_xf.position.x,
                    e = this.m_target.y - this.m_bodyB.m_xf.position.y,
            ...
            (f.prototype.InitVelocityConstraints = function (t) {
                ...
                var a = this.m_localAnchor.x - i.m_sweep.localCenter.x,
                    h = this.m_localAnchor.y - i.m_sweep.localCenter.y,
            ...
            (b.prototype.GetReactionForce = function (t) {
                return (
                    t === void 0 && (t = 0),
                    new s(
                        t * (this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.x),
                        t * (this.m_impulse.x * this.m_perp.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.y)
                    )
                );
            }),
                ...
                if (
                    ...
                    2 * t.b2_linearSlop > o.Abs(this.m_upperTranslation - this.m_lowerTranslation)
                        ...
                        ? this.m_upperTranslation > g
                            ...
                            : this.m_limitState != u.e_atUpperLimit && ((this.m_limitState = u.e_atUpperLimit), (this.m_impulse.z = 0))
                        : this.m_limitState != u.e_atLowerLimit && ((this.m_limitState = u.e_atLowerLimit), (this.m_impulse.z = 0));
                } else this.m_limitState = u.e_inactiveLimit;
                if ((this.m_enableMotor == 0 && (this.m_motorImpulse = 0), i.warmStarting)) {
                    (this.m_impulse.x *= i.dtRatio), (this.m_impulse.y *= i.dtRatio), (this.m_motorImpulse *= i.dtRatio);
            ...
            (b.prototype.SolveVelocityConstraints = function (t) {
                var i = this.m_bodyA,
                    ...
                    p = 0;
                if (this.m_enableMotor && this.m_limitState != u.e_equalLimits) {
                    var d = this.m_axis.x * (h.x - r.x) + this.m_axis.y * (h.y - r.y) + this.m_a2 * l - this.m_a1 * a,
                        y = this.m_motorMass * (this.m_motorSpeed - d),
                ...
                var g = this.m_perp.x * (h.x - r.x) + this.m_perp.y * (h.y - r.y) + this.m_s2 * l - this.m_s1 * a,
                    b = l - a;
                if (this.m_enableLimit && this.m_limitState != u.e_inactiveLimit) {
                    var v = this.m_axis.x * (h.x - r.x) + this.m_axis.y * (h.y - r.y) + this.m_a2 * l - this.m_a1 * a,
                        w = this.m_impulse.Copy(),
                        C = this.m_K.Solve33(new n(), -g, -b, -v);
                    ...
                    var D = -g - (this.m_impulse.z - w.z) * this.m_K.col3.x,
                        B = -b - (this.m_impulse.z - w.z) * this.m_K.col3.y,
                ...
                i.m_linearVelocity.SetV(r), (i.m_angularVelocity = a), e.m_linearVelocity.SetV(h), (e.m_angularVelocity = l);
            }),
            (b.prototype.SolvePositionConstraints = function (e) {
                ...
                if (this.m_enableLimit) {
                    ...
                    2 * t.b2_linearSlop > o.Abs(this.m_upperTranslation - this.m_lowerTranslation)
                        ? ((v = o.Clamp(T, -t.b2_maxLinearCorrection, t.b2_maxLinearCorrection)), (f = o.Abs(T)), (b = !0))
                ...
                var P = new n(),
                    V = this.m_perp.x * A + this.m_perp.y * M,
                    R = m - c - this.m_refAngle;
                if (((f = o.Max(f, o.Abs(V))), (g = o.Abs(R)), b))
                    ...
                    var L = p + d + y * this.m_s1 * this.m_s1 + x * this.m_s2 * this.m_s2,
                        k = y * this.m_s1 + x * this.m_s2,
                        F = y + x;
                    this.m_K.col1.Set(L, k, 0), this.m_K.col2.Set(k, F, 0);
                    var G = this.m_K.Solve22(new s(), -V, -R);
                    (P.x = G.x), (P.y = G.y), (P.z = 0);
                }
                var E = P.x * this.m_perp.x + P.z * this.m_axis.x,
                    z = P.x * this.m_perp.y + P.z * this.m_axis.y,
                    J = P.x * this.m_s1 + P.y + P.z * this.m_a1,
                    O = P.x * this.m_s2 + P.y + P.z * this.m_a2;
                return (
                    (l.x -= this.m_invMassA * E),
            ...
            (w.prototype.GetLength1 = function () {
                var t = this.m_bodyA.GetWorldPoint(this.m_localAnchor1),
                    ...
                    e = this.m_ground.m_xf.position.y + this.m_groundAnchor1.y,
                    o = t.x - i,
                    s = t.y - e;
            ...
            (w.prototype.GetLength2 = function () {
                var t = this.m_bodyB.GetWorldPoint(this.m_localAnchor2),
                    ...
                    e = this.m_ground.m_xf.position.y + this.m_groundAnchor2.y,
                    o = t.x - i,
                    s = t.y - e;
                return Math.sqrt(o * o + s * s);
            }),
            ...
            (w.prototype.InitVelocityConstraints = function (i) {
                ...
                if (
                    ((this.m_limitMass1 = o.m_invMass + o.m_invI * w * w),
            ...
            (w.prototype.SolveVelocityConstraints = function () {
                ...
                var a = this.m_localAnchor2.x - e.m_sweep.localCenter.x,
                    h = this.m_localAnchor2.y - e.m_sweep.localCenter.y;
            ...
            (C.prototype.Initialize = function (t, i, e, o, s, n, r) {
                ...
                (this.maxLengthA = _ - this.ratio * w.b2_minPulleyLength), (this.maxLengthB = (_ - w.b2_minPulleyLength) / this.ratio);
            }),
            ...
            (D.prototype.InitVelocityConstraints = function (i) {
                ...
                var _ = s.m_invMass,
                    ...
                    d = n.m_invI;
                if (
                    ((this.m_mass.col1.x = _ + m + h * h * p + c * c * d),
                    ...
                    2 * t.b2_angularSlop > o.Abs(this.m_upperAngle - this.m_lowerAngle)
                        ...
                        ? this.m_upperAngle > y
                            ? ((this.m_limitState = u.e_inactiveLimit), (this.m_impulse.z = 0))
                            : (this.m_limitState != u.e_atUpperLimit && (this.m_impulse.z = 0), (this.m_limitState = u.e_atUpperLimit))
                        : (this.m_limitState != u.e_atLowerLimit && (this.m_impulse.z = 0), (this.m_limitState = u.e_atLowerLimit));
                } else this.m_limitState = u.e_inactiveLimit;
                if (i.warmStarting) {
                    (this.m_impulse.x *= i.dtRatio), (this.m_impulse.y *= i.dtRatio), (this.m_motorImpulse *= i.dtRatio);
            ...
            (D.prototype.SolveVelocityConstraints = function (t) {
                var i,
                    ...
                    d = s.m_angularVelocity,
                    y = e.m_invMass,
                    x = s.m_invMass,
                    f = e.m_invI,
                    g = s.m_invI;
                if (this.m_enableMotor && this.m_limitState != u.e_equalLimits) {
                    var b = d - m - this.m_motorSpeed,
                ...
                e.m_linearVelocity.SetV(_), (e.m_angularVelocity = m), s.m_linearVelocity.SetV(p), (s.m_angularVelocity = d);
            }),
            (D.prototype.SolvePositionConstraints = function (i) {
                ...
                var e,
                    ...
                    _ = 0;
                if (this.m_enableLimit && this.m_limitState != u.e_inactiveLimit) {
                    var m = r.m_sweep.a - n.m_sweep.a - this.m_referenceAngle,
                        p = 0;
                    this.m_limitState == u.e_equalLimits
                ...
                e = n.m_xf.R;
                var d = this.m_localAnchor1.x - n.m_sweep.localCenter.x,
                    y = this.m_localAnchor1.y - n.m_sweep.localCenter.y;
                ...
                var g = r.m_sweep.c.x + x - n.m_sweep.c.x - d,
            ...
            (S.prototype.SolveVelocityConstraints = function () {
                ...
                var u = this.m_localAnchorA.x - e.m_sweep.localCenter.x,
                    p = this.m_localAnchorA.y - e.m_sweep.localCenter.y;
                (i = t.col1.x * u + t.col2.x * p), (p = t.col1.y * u + t.col2.y * p), (u = i), (t = o.m_xf.R);
                var d = this.m_localAnchorB.x - o.m_sweep.localCenter.x,
                    y = this.m_localAnchorB.y - o.m_sweep.localCenter.y;
                (i = t.col1.x * d + t.col2.x * y), (y = t.col1.y * d + t.col2.y * y), (d = i);
                var x = a.x - h * y - s.x + r * p,
                    f = a.y + h * d - s.y - r * u,
                    g = h - r,
                    b = new n();
            ...
            (S.prototype.SolvePositionConstraints = function (i) {
                ...
                var m = r.m_invMass,
                    ...
                    p = r.m_invI,
                    d = a.m_invI,
                    y = a.m_sweep.c.x + c - r.m_sweep.c.x - h,
                    x = a.m_sweep.c.y + _ - r.m_sweep.c.y - l,
        ...
        (t.b2DebugDraw = function () {
            ...
            (t.prototype.DrawPolygon = function (t, i, e) {
                if (i) {
                    var o = this.m_ctx,
                        s = this.m_drawScale;
                    o.beginPath(), (o.strokeStyle = this._color(e.color, this.m_alpha)), o.moveTo(t[0].x * s, t[0].y * s);
                    for (var n = 1; i > n; n++) o.lineTo(t[n].x * s, t[n].y * s);
...
var i;
for (i = 0; $i_22.postDefs.length > i; ++i) $i_22.postDefs[i]();
            ...
            if (t !== void 0) {
                if (t === null) delete this._uiLeft, delete this._uiLeftPercent;
                    ...
                    var e,
                        o,
                        s = parseInt(t, 10);
                    (e = this._parent ? this._parent._bounds2d.x : ige._bounds2d.x), (o = ((e / 100) * s) | 0), (this._uiLeft = o);
            ...
            if (t !== void 0) {
                if (t === null) delete this._uiRight, delete this._uiRightPercent;
                    ...
                    var e,
                        o,
                        s = parseInt(t, 10);
                    (e = this._parent ? this._parent._bounds2d.x : ige._bounds2d.x), (o = ((e / 100) * s) | 0), (this._uiRight = o);
            ...
            if (t !== void 0) {
                if (t === null) delete this._uiCenter, delete this._uiCenterPercent;
                    ...
                    var e,
                        o,
                        s = parseInt(t, 10);
                    (e = this._parent ? this._parent._bounds2d.x2 : ige._bounds2d.x2), (o = ((e / 100) * s) | 0), (this._uiCenter = o);
            ...
            if (t !== void 0) {
                if (t === null) delete this._uiTop, delete this._uiTopPercent;
                    ...
                    var e,
                        o,
                        s = parseInt(t, 10);
                    (e = this._parent ? this._parent._bounds2d.y : ige._bounds2d.y), (o = ((e / 100) * s) | 0), (this._uiTop = o);
            ...
            if (t !== void 0) {
                if (t === null) delete this._uiBottom, delete this._uiBottomPercent;
                    ...
                    var e,
                        o,
                        s = parseInt(t, 10);
                    (e = this._parent ? this._parent._bounds2d.y : ige._bounds2d.y), (o = ((e / 100) * s) | 0), (this._uiBottom = o);
            ...
            if (t !== void 0) {
                if (t === null) delete this._uiMiddle, delete this._uiMiddlePercent;
                    ...
                    var e,
                        o,
                        s = parseInt(t, 10);
                    (e = this._parent ? this._parent._bounds2d.y2 : ige._bounds2d.y2), (o = ((e / 100) * s) | 0), (this._uiMiddle = o);
...
var $i_44 = {
    ...
    backgroundImage: function (t, i) {
        if (t && t.image) {
            ...
            } else this._patternFill = ige._ctx.createPattern(t.image, i);
            ...
            ? (typeof t == "string" && (t = (this._bounds2d.x / 100) * parseInt(t, 10)),
              ...
              t !== 0 && i !== 0
                  ? ((this._backgroundSize = { x: t, y: i }),
                    this._patternTexture && this._patternRepeat && this.backgroundImage(this._patternTexture, this._patternRepeat),
                    this.cacheDirty(!0))
    ...
    padding: function (t, i, e, o) {
        return (
            (this._paddingLeft = t), (this._paddingTop = i), (this._paddingRight = e), (this._paddingBottom = o), this.cacheDirty(!0), this
        );
    },
...
var $i_52 = $i_2.extend({
    ...
    step: function (t, i, e) {
        return (
            this.log(
                "The step method has been renamed to stepTo(). Please update your code as the step() method will soon be removed.",
                "warning"
            ),
            this.stepTo(t, i, e),
            this
        ...
        return (
            t !== void 0 &&
                (ige.tween.easing[t]
                    ? (this._easing = t)
                    : this.log(
                          "The easing method you have selected does not exist, please use a valid easing method. For a list of easing methods please inspect ige.tween.easing from your console.",
                          "error",
                          ige.tween.easing
                      )),
            this
    ...
    start: function (t) {
        return (
            t !== void 0 && this.startTime(t + ige._currentTime),
...
var $i_53 = $i_3.extend({
    ...
    assignSmartTextureImage: function (t) {
        ...
        typeof t.render == "function"
            ? ((i._mode = 1), (i.script = t), typeof t.init == "function" && t.init.apply(t, [i]), (i._loaded = !0), i.emit("loaded"))
        ...
        (e = typeof i == "string" ? this.cellIdToIndex(i) : i),
            this._cells[e]
                ? ((o = this._cells[e]),
                  ...
                  (n = s.getContext("2d")),
                  this._smoothing
                      ? ((n.imageSmoothingEnabled = !0), (n.webkitImageSmoothingEnabled = !0), (n.mozImageSmoothingEnabled = !0))
                      : ((n.imageSmoothingEnabled = !1), (n.webkitImageSmoothingEnabled = !1), (n.mozImageSmoothingEnabled = !1)),
                  (s.width = o[2]),
                  (s.height = o[3]),
                ...
                : this.log("Unable to create new texture from passed cell index (" + i + ") because the cell does not exist!", "warning");
    },
    sizeX: function (t) {
        this._sizeX = t;
    },
        ...
        if (i._cell !== null) {
            if (
                ...
                if (e) {
                    ...
                    this.log(
                        "Cannot render texture using cell " + i._cell + " because the cell does not exist in the assigned texture!",
                        "error"
                    );
            }
    ...
    removeFilter: function (t) {
        var i;
        while ((i = this._preFilters.indexOf(t)) > -1) (this._preFilters[i] = void 0), (this._preFiltersData[i] = void 0);
        while ((i = this._applyFilters.indexOf(t)) > -1) (this._applyFilters[i] = void 0), (this._applyFiltersData[i] = void 0);
    ...
    preFilter: function (t, i) {
        return t !== void 0
            ? (this._originalImage &&
              ...
              this)
            : (this.log("Cannot use pre-filter, no filter method was passed!", "warning"), this._preFilters[this._preFilters.length - 1]);
    },
    ...
    _applyCells: function () {
        ...
        if (this.image && this._cellRows && this._cellColumns)
            if (
                ...
                for (r = 1; e * o >= r; r++) (h = Math.ceil(r / o) - 1), (a = r - o * h - 1), (this._cells[r] = [a * s, h * n, s, n]);
...
var $i_55 = $i_53.extend({
    ...
    detectCells: function (t) {
        var i,
            ...
            a = [];
        for (
            n.width = t.width, n.height = t.height, r.drawImage(t, 0, 0), i = r.getImageData(0, 0, n.width, n.height), o = 0;
            n.height > o;
            o++
        )
            for (e = 0; n.width > e; e++)
    ...
    _pixelInRects: function (t, i, e) {
        var o,
            s,
            n = t.length;
        for (o = 0; n > o; o++) if (((s = t[o]), !(s.x > i || i > s.x + s.width || s.y > e || e > s.y + s.height))) return !0;
        return !1;
    },
    _determineRect: function (t, i, e) {
        var o,
            s = [{ x: i, y: e }],
            n = { x: i, y: e, width: 1, height: 1 };
        while (s.length)
            (o = s.shift()),
                ...
                t.isTransparent(o.x - 1, o.y - 1) || (t.makeTransparent(o.x - 1, o.y - 1), s.push({ x: o.x - 1, y: o.y - 1 })),
    ...
    cellIdToIndex: function (t) {
        var i,
            e = this._cells;
        for (i = 1; e.length > i; i++) if (e[i][4] === t) return i;
        return -1;
    },
    stringify: function () {
...
var $i_56 = $i_53.extend({
    ...
    init: function (t) {
        $i_53.prototype.init.call(this, t),
            arguments[1] &&
                this.log(
                    "Font sheets no longer accept a caching limit value. All font output is now cached by default via the actual font entity - fontEntity.cache(true);",
                    "warning"
                ),
    ...
    decodeHeader: function () {
        var t = document.createElement("canvas"),
            i = t.getContext("2d");
        return (t.width = this.image.width), (t.height = 1), i.drawImage(this.image, 0, 0), this._decode(t, 0, 0, this.image.width);
    },
    _decode: function (t, i, e, o) {
        "use strict";
        var s,
            n = t.getContext("2d"),
            r = n.getImageData(i, e, o, t.height).data,
            a = !0,
            h = 0,
            l = "";
        while (a) {
            if (((s = r[h] + "" + " " + (r[h + 1] + "") + " " + (r[h + 2] + "")), s === "3 2 1")) return (a = !1), JSON.parse(l);
    ...
    measureTextWidth: function (t) {
        if (this._loaded) {
            ...
            for (t.indexOf("\n") > -1 ? (a = t.split("\n")) : a.push(t), o = 0; a.length > o; o++) {
                for (s = 0, i = 0; a[o].length > i; i++) (e = n[a[o].charCodeAt(i)]), (s += r[e] || 0);
                s > h && (h = s);
            }
            return s;
        }
    ...
    render: function (t, i) {
        if (i._renderText && this._loaded) {
            ...
            for (o = 0; l.length > o; o++) {
                for (e = l[o], s = 0; e.length > s; s++) (r = c[e.charCodeAt(s)]), (w += m[r] || 0);
                (b[o] = w), w > C && (C = w), (w = 0);
            }
...
var $i_57 = {
    ...
    $i_58 = $i_3.extend({
                ...
                if (((t = arguments[e]), t instanceof Array)) {
                    ...
                    while (i--)
                        (this._groups && this._groups.indexOf(t[i]) !== -1) ||
                            ((this._groups = this._groups || []), this._groups.push(t[i]), ige.groupRegister(this, t[i]));
                } else
        ...
        inAllGroups: function (t) {
            ...
            e = t.length;
            while (e--) if (((i = t[e]), i && (!this._groups || this._groups.indexOf(i) === -1))) return !1;
            return !0;
        },
        inAnyGroup: function (t) {
            ...
            if (!(t instanceof Array)) return this._groups && this._groups.indexOf(t) > -1;
            e = t.length;
            while (e--) if (((i = t[e]), i && this._groups && this._groups.indexOf(i) > -1)) return !0;
            return !1;
        },
        groups: function () {
            return this._groups || [];
        ...
        removeGroup: function () {
            if (this._groups) {
                ...
                while (e--)
                    if (((t = arguments[e]), t instanceof Array)) {
                        i = t.length;
                        while (i--) this._groups.pull(t[i]), ige.groupUnRegister(this, t[i]);
        ...
        removeAllGroups: function () {
            if (this._groups) {
                var t = this._groups,
                    i = t.length;
                while (i--) ige.groupUnRegister(this, t[i]);
                delete this._groups;
            }
            return this;
        },
        addBehaviour: function (t, i, e) {
            if (typeof t == "string") {
                if (typeof i == "function")
                    return (
                        e
                            ? ((this._tickBehaviours = this._tickBehaviours || []), this._tickBehaviours.push({ id: t, method: i }))
                            : ((this._updateBehaviours = this._updateBehaviours || []), this._updateBehaviours.push({ id: t, method: i })),
                        this
                    );
        ...
        removeBehaviour: function (t, i) {
            if (t !== void 0) {
                ...
                if ((e = i ? this._tickBehaviours : this._updateBehaviours)) {
                    o = e.length;
                    while (o--) if (e[o].id === t) return e.splice(o, 1), this;
                }
            }
            return !1;
        },
        ...
        $$: function (t) {
            var i,
                ...
                s = [],
                n = this.id();
            while (o--) (i = e[o]), (i._parent === this || i.parent(n)) && s.push(i);
            return s;
        },
        parent: function (t) {
        ...
        unMount: function () {
            if (this._parent) {
                var t = this._parent._children,
                    i = t.indexOf(this),
                    e = this._parent;
                return i > -1 ? (t.splice(i, 1), this._parent._childUnMounted(this), (this._parent = null), this._unMounted(e), this) : !1;
            }
            return !1;
        },
        ...
        destroyComponents: function () {
            ...
            if (i) {
                t = i.length;
                while (t--) i[t].destroy && i[t].destroy();
            }
                ...
                if (s && ((t = s.length), t > 1))
                    if (this._mountMode === 1) {
                        if (this._depthSortMode === 0) {
                            ...
                            for (e = 0; t > e; ++e) i.c[e] === 0 && this._depthSortVisit(e, i);
                            for (e = 0; i.order.length > e; e++) s[i.order[e]].depth(e);
                        ...
                        if (
                            ...
                            while (t--) (i = s[t]), (o = i._translate), o && (i._depth = o.x + o.y + o.z);
                            this._children.sort(function (t, i) {
                                var e = i._layer - t._layer;
                                return e === 0 ? i._depth - t._depth : e;
                            });
        ...
        viewCheckChildren: function () {
            if (ige._currentViewport) {
                ...
                while (e--) (t = i[e]), (t._inView = t._alwaysInView ? !0 : t.aabb ? (o.intersects(t.aabb(!0)) ? !0 : !1) : !1);
            }
            return this;
        },
        update: function (t, i) {
        ...
        _depthSortVisit: function (t, i) {
            var e,
                ...
                s = i.adj[t],
                n = s.length;
            for (i.c[t] = 1, e = 0; n > e; ++e) (o = s[e]), i.c[o] === 0 && ((i.p[o] = t), this._depthSortVisit(o, i));
        ...
        _processUpdateBehaviours: function () {
            var t,
                i = this._updateBehaviours;
            if (i) {
                t = i.length;
                while (t--) i[t].method.apply(this, arguments);
            }
        },
        _processTickBehaviours: function () {
            var t,
                i = this._tickBehaviours;
            if (i) {
                t = i.length;
                while (t--) i[t].method.apply(this, arguments);
            }
        ...
        saveSpecialProp: function (t, i) {
            switch (i) {
                case "_id":
                    if (t._id) return { _id: t._id };
                    break;
                case "_parent":
                    if (t._parent) return { _parent: t._parent.id() };
                    break;
                case "_children":
                    if (t._children.length) {
                        var e,
                            o,
                            s = [];
                        for (e = 0; t._children.length > e; e++) (o = t._children[e]), s.push(o.objSave());
                        return { _children: s };
                    }
            }
            return void 0;
        ...
        loadGraph: function (t) {
            if (t.igeClass && t.data) {
                var i,
                    ...
                    o,
                    s,
                    n = ige.newClassInstance(t.igeClass);
                if (
                    (n.objLoad(t),
                    ...
                    for (e = n._children, n._children = [], o = 0; e.length > o; o++) n.loadGraph(e[o]);
                n.mount(this);
            }
        },
                ...
                if (t.hasOwnProperty(r))
                    if (typeof t[r] == "object") {
                        if (a.indexOf(r) === -1)
                            (o = i.indexOf(t[r])),
                                o > -1
                                    ? ((e[r] = "{ref:" + o + "}"), this.log("Possible circular reference for property " + r))
                                    : (i.push(t[r]), (e[r] = this._objSaveReassign(t[r], i)));
                        else if ((s = this.saveSpecialProp(t, r)))
                            if (typeof s != "object" || s instanceof Array) e[r] = s;
                            else for (n in s) s.hasOwnProperty(n) && (e[n] = s[n]);
                    } else e[r] = t[r];
            return e;
        },
        _objLoadReassign: function (t, i) {
            ...
            for (s in i)
                if (i.hasOwnProperty(s))
                    if (n.indexOf(s) === -1) typeof i[s] == "object" && t[s] ? this._objLoadReassign(t[s], i[s]) : (t[s] = i[s]);
                    else if ((e = this.loadSpecialProp(i, s)))
                        if (typeof e != "object" || e instanceof Array) t[s] = e;
                        else for (o in e) e.hasOwnProperty(o) && (t[o] = e[o]);
        },
...
var $i_59 = $i_58.extend({
    ...
    rotateToPoint: function (t) {
        ...
        return (
            this.rotateTo(this._rotate.x, this._rotate.y, Math.atan2(i.y - t.y, i.x - t.x) - this._parent._rotate.z + Math.radians(270)),
            this
        );
    },
    ...
    occupyTile: function (t, i, e, o) {
        if (this._parent && this._parent.$i_66)
            if (t !== void 0 && i !== void 0) this._parent.occupyTile(t, i, e, o, this);
            else {
                var s = new $i_5(
                ...
                this._parent._mountMode === 1 && n.thisToIso(), this._parent.occupyTile(n.x, n.y, this._tileWidth, this._tileHeight, this);
            }
        return this;
    },
    unOccupyTile: function (t, i, e, o) {
        if (this._parent && this._parent.$i_66)
            if (t !== void 0 && i !== void 0) this._parent.unOccupyTile(t, i, e, o);
            else {
                var s = new $i_5(
                        this._translate.x - (this._tileWidth / 2 - 0.5) * this._parent._tileWidth,
                        this._translate.y - (this._tileHeight / 2 - 0.5) * this._parent._tileHeight,
                    ...
                    n = this._parent.pointToTile(s);
                this._parent._mountMode === 1 && n.thisToIso(), this._parent.unOccupyTile(n.x, n.y, this._tileWidth, this._tileHeight);
            }
        return this;
    },
    overTiles: function () {
        if (this._parent && this._parent.$i_66) {
            var t,
                ...
                n = [];
            for (t = 0; e > t; t++) for (i = 0; o > i; i++) n.push(new $i_5(s.x + t, s.y + i, 0));
            return n;
        }
    },
    anchor: function (t, i) {
    ...
    bounds3d: function (t, i, e) {
        return t !== void 0 && i !== void 0 && e !== void 0 ? ((this._bounds3d = new $i_5(t, i, e)), this) : this._bounds3d;
    },
    size3d: function () {
        this.log(
    ...
    deathTime: function (t, i) {
        return t !== void 0 ? ((this._deathTime = t), i !== void 0 && (this._deathCallBack = i), this) : this._deathTime;
    },
    opacity: function (t) {
        ...
        if (t !== void 0)
            if (this._texture) {
                var i,
                    e = this._texture,
                    o = e._cells;
                for (i = 1; o.length > i; i++) if (o[i][4] === t) return this.cell(i), this;
                this.log(
                ...
                this.log(
                    "Cannot assign cell index from cell ID until an $i_55 has been set as the texture for this entity. Please set the texture before calling cellById().",
                    "error"
                );
        return this._cell;
    },
        ...
        return (
            this._texture &&
                (t === void 0
                    ...
                    : (this.width(Math.floor((this._texture._sizeX / 100) * t)), this.height(Math.floor((this._texture._sizeY / 100) * t))),
                this.localAabb(!0)),
            this
        );
    },
    dimensionsFromCell: function (t) {
        return (
            this._texture &&
                ...
                (t === void 0
                    ? (this.width(this._texture._cells[this._cell][2]), this.height(this._texture._cells[this._cell][3]))
    ...
    localBounds3dPolygon: function (t) {
        if (this._bounds3dPolygonDirty || !this._localBounds3dPolygon || t) {
            var i = this._bounds3d,
                e = new $i_6(),
                o = Math.toIso(+i.x2, -i.y2, -i.z2),
                s = Math.toIso(+i.x2, +i.y2, -i.z2),
                n = Math.toIso(-i.x2, +i.y2, -i.z2),
                r = Math.toIso(-i.x2, -i.y2, i.z2),
                a = Math.toIso(+i.x2, -i.y2, i.z2),
                h = Math.toIso(-i.x2, +i.y2, i.z2);
            e
                .addPoint(r.x, r.y)
                .addPoint(a.x, a.y)
                .addPoint(o.x, o.y)
    ...
    mouseInBounds3d: function (t) {
        var i = this.localBounds3dPolygon(t),
            e = this.mousePos();
    ...
    compositeAabb: function (t) {
        ...
        if (((e = t ? this.aabb(!0, t).clone() : this.aabb().clone()), o)) {
            i = o.length;
            while (i--) e.thisCombineRect(o[i].compositeAabb(t));
        }
        return e;
    },
    ...
    _childMounted: function (t) {
        this.compositeStream() && (t.compositeStream(!0), t.streamMode(this.streamMode()), t.streamControl(this.streamControl())),
    ...
    _internalsOverlap: function (t, i, e, o) {
        var s;
        return (
            t > i && ((s = this._swapVars(t, i)), (t = s[0]), (i = s[1])),
            e > o && ((s = this._swapVars(e, o)), (e = s[0]), (o = s[1])),
            t > e && ((s = this._swapVars(t, e)), (t = s[0]), (e = s[1]), (s = this._swapVars(i, o)), (i = s[0]), (o = s[1])),
            i > e
        );
    },
    _projectionOverlap: function (t) {
        var i = this._bounds3d,
            e = { x: this._translate.x - i.x / 2, y: this._translate.y - i.y / 2, z: this._translate.z - i.z },
            o = { x: this._translate.x + i.x / 2, y: this._translate.y + i.y / 2, z: this._translate.z + i.z },
            s = t._bounds3d,
            n = { x: t._translate.x - s.x / 2, y: t._translate.y - s.y / 2, z: t._translate.z - s.z },
            r = { x: t._translate.x + s.x / 2, y: t._translate.y + s.y / 2, z: t._translate.z + s.z };
        return (
            this._internalsOverlap(e.x - o.y, o.x - e.y, n.x - r.y, r.x - n.y) &&
    ...
    isBehind: function (t) {
        var i = this._bounds3d,
            e = new $i_5(this._translate.x - i.x / 2, this._translate.y - i.y / 2, this._translate.z),
            o = new $i_5(this._translate.x + i.x / 2, this._translate.y + i.y / 2, this._translate.z + i.z),
            s = t._bounds3d,
            n = new $i_5(t._translate.x - s.x / 2, t._translate.y - s.y / 2, t._translate.z),
            r = new $i_5(t._translate.x + s.x / 2, t._translate.y + s.y / 2, t._translate.z + s.z);
        return o.x > n.x
            ? r.x > e.x
                ? o.y > n.y
                    ? r.y > e.y
    ...
    ignoreCameraComposite: function (t) {
        var i,
            e = this._children,
            o = e.length;
        for (this._ignoreCamera = t, i = 0; o > i; i++) e[i].ignoreCameraComposite && e[i].ignoreCameraComposite(t);
    },
    newFrame: function () {
    ...
    _transformContext: function (t, i) {
        (t.globalAlpha = this._parent ? this._parent._opacity * this._opacity : this._opacity),
            i ? this._localMatrix.getInverse().transformRenderingContext(t) : this._localMatrix.transformRenderingContext(t);
    },
            ...
            ? this._bornTime !== void 0 && this._bornTime > ige._currentTime
                ...
                : (delete this._streamDataCache,
                  ...
                  (this._velocity.x || this._velocity.y) &&
                      ((this._translate.x += (this._velocity.x / 16) * i), (this._translate.y += (this._velocity.y / 16) * i)),
                  this._timeStream.length && this._processInterpolate(ige._tickStart - ige.network.stream._renderLatency),
        ...
        this._hidden ||
            ...
            this._mouseEventsActive &&
                (this._processTriggerHitTests()
                    ...
                    : ige.input.mouseMove && this._handleMouseOut(ige.input.mouseMove)),
            this._dontRender ||
            ...
            this._compositeCache
                ? this._cacheDirty && ($i_58.prototype.tick.call(this, this._cacheCtx), this._renderCache(t), (this._cacheDirty = !1))
        ...
        if (this._opacity > 0) {
            this._backgroundPattern &&
                (this._backgroundPatternFill ||
                    (t && (this._backgroundPatternFill = t.createPattern(this._backgroundPattern.image, this._backgroundPatternRepeat))),
                this._backgroundPatternFill &&
                    (t.save(),
            ...
            i &&
                i._loaded &&
                (i.render(t, this, ige._tickDelta), this._highlight && ((t.globalCompositeOperation = "lighter"), i.render(t, this))),
                this._compositeCache &&
    ...
    _renderCache: function (t) {
        if ((t.save(), this._compositeCache)) {
            ...
            t.translate(this._bounds2d.x2 + i.x, this._bounds2d.y2 + i.y), this._parent && this._parent._ignoreCamera && ige._currentCamera;
        }
    ...
    _transformPoints: function (t) {
        ...
        while (e--)
            if (((i = t[e]), this._parent)) {
                var o = new $i_8();
                o.copy(this._parent._worldMatrix), o.multiply(this._localMatrix), o.getInverse().transformCoord(i, this);
            } else this._localMatrix.transformCoord(i, this);
    },
    _stringify: function (t) {
        t === void 0 && (t = {});
        var i,
            e = $i_58.prototype._stringify.call(this, t);
        for (i in this)
            if (this.hasOwnProperty(i) && this[i] !== void 0)
                switch (i) {
                    case "_opacity":
                    ...
                    case "_scale":
                        ...
                        break;
                    case "_origin":
                        t.origin !== !1 && (e += ".originTo(" + this._origin.x + ", " + this._origin.y + ", " + this._origin.z + ")");
                        break;
                    case "_anchor":
    ...
    saveSpecialProp: function (t, i) {
        switch (i) {
            case "_texture":
                if (t._texture) return { _texture: t._texture.id() };
                break;
            default:
    ...
    _handleMouseIn: function (t, i, e) {
        this._mouseStateOver ||
            ((this._mouseStateOver = !0), this._mouseOver && this._mouseOver(t, i, e), this.emit("mouseOver", [t, i, e])),
    ...
    _handleMouseOut: function (t, i, e) {
        (this._mouseStateDown = !1),
            this._mouseStateOver &&
                ((this._mouseStateOver = !1), this._mouseOut && this._mouseOut(t, i, e), this.emit("mouseOut", [t, i, e]));
    },
    ...
    _handleMouseDown: function (t, i, e) {
        this._mouseStateDown ||
            ((this._mouseStateDown = !0), this._mouseDown && this._mouseDown(t, i, e), this.emit("mouseDown", [t, i, e]));
    },
    _mouseInTrigger: function (t, i) {
        ige.input.mouseMove && this._handleMouseIn(ige.input.mouseMove, t, i),
            ige.input.mouseDown && this._handleMouseDown(ige.input.mouseDown, t, i),
            ige.input.mouseUp && this._handleMouseUp(ige.input.mouseUp, t, i),
            ige.input.mouseWheel && this._handleMouseWheel(ige.input.mouseWheel, t, i);
    },
    debugTransforms: function () {
        return (
            ige.traceSet(this._translate, "x", 1, function (t) {
                return isNaN(t);
            }),
    ...
    translateToTile: function (t, i, e) {
        if (this._parent && this._parent._tileWidth !== void 0 && this._parent._tileHeight !== void 0) {
            ...
            (o = e !== void 0 ? e * this._parent._tileWidth : this._translate.z),
                this.translateTo(
                    t * this._parent._tileWidth + this._parent._tileWidth / 2,
                    i * this._parent._tileHeight + this._parent._tileWidth / 2,
                    o
                );
        } else
            this.log(
    ...
    scale: function () {
        return (
            arguments.length && this.log("You called scale with arguments, did you mean scaleTo or scaleBy instead of scale?", "warning"),
    ...
    updateTransform: function () {
        ...
        return (
            ...
            this._oldBounds2d.compare(this._bounds2d) || ((this._aabbDirty = !0), this._oldBounds2d.copy(this._bounds2d)),
            this._oldBounds3d.compare(this._bounds3d) || ((this._bounds3dPolygonDirty = !0), this._oldBounds3d.copy(this._bounds3d)),
            this
        );
    },
            ...
            case "transform":
                ...
                this._disableInterpolation || e || this._streamJustCreated
                    ...
                    : (o[0] && (o[0] = parseFloat(o[0])),
                      ...
                      this._timeStream.push([ige.network.stream._streamDataTime + ige.network._latency, o]),
    ...
    ],
    {
        ...
        _renderBackground: function (t) {
            ...
            (this._backgroundColor || this._patternFill) &&
                ...
                t.save(),
                t.beginPath(),
                this._borderTopRightRadius || !this._borderBottomRightRadius || this._borderBottomLeftRadius || this._borderTopLeftRadius
                    ? (t.moveTo(i + this._borderTopLeftRadius, e),
                      ...
                      this._borderTopLeftRadius > 0 && t.arcTo(i, e, i + this._borderTopLeftRadius, e, this._borderTopLeftRadius),
                      t.clip())
                    : t.rect(i, e, o, s),
            ...
            if (
                ...
                (i = Math.PI / 180),
                    ...
                    this._borderTopWidth &&
                        ...
                        this._borderTopLeftRadius > 0 &&
                            t.arc(
                                o + this._borderTopLeftRadius,
                                s + this._borderTopLeftRadius,
                                this._borderTopLeftRadius,
                                225 * i,
                                270 * i
                            ),
                        ...
                        this._borderTopRightRadius > 0 &&
                            t.arc(
                                o + n - this._borderTopRightRadius,
                                s + this._borderTopRightRadius,
                                this._borderTopRightRadius,
                                -90 * i,
                                -44 * i
                            )),
                    ...
                    this._borderRightWidth &&
                        ...
                        this._borderBottomRightRadius > 0 &&
                            t.arc(
                                o + n - this._borderBottomRightRadius,
                                s + r - this._borderBottomRightRadius,
                                this._borderTopRightRadius,
                                0,
                                46 * i
                            )),
                    ...
                    this._borderBottomWidth &&
                        ...
                        this._borderBottomLeftRadius > 0 &&
                            t.arc(
                                o + this._borderBottomLeftRadius,
                                s + r - this._borderBottomLeftRadius,
                                this._borderBottomLeftRadius,
                                90 * i,
                                136 * i
                            )),
                    ...
                    t.stroke();
            } else (t.strokeStyle = this._borderColor), (t.lineWidth = this._borderWidth), t.strokeRect(o, s, n, r);
        },
        cell: function (t) {
        ...
        mount: function (t) {
            ...
            return (
                this._parent && (this._updateUiPosition && this._updateUiPosition(), this._children.length && this.updateUiChildren()), i
            );
        },
        tick: function (t, i) {
            if (!this._hidden && this._inView && (!this._parent || this._parent._inView) && !this._streamJustCreated) {
                if ((i || this._transformContext(t), this._renderBackground(t), this._renderBorder(t), this._overflow === "hidden")) {
                    var e = this._bounds2d,
                        o = (-(e.x / 2) + this._paddingLeft) | 0,
                        s = (-(e.y / 2) + this._paddingTop) | 0,
                        n = e.x + this._paddingRight,
                        r = e.y + this._paddingBottom;
...
var $i_61 = $i_60.extend({
    ...
    init: function () {
        ...
        this.on("mouseOver", function () {
            this._allowHover ? (i(), ige.input.stopPropagation()) : (this._mouseStateOver = !1);
        }),
            this.on("mouseOut", function () {
                this._allowHover ? (i(), ige.input.stopPropagation()) : (this._mouseStateOver = !1);
            }),
            this.on("mouseDown", function () {
                this._allowActive ? (i(), ige.input.stopPropagation()) : (this._mouseStateDown = !1);
            }),
            this.on("mouseUp", function () {
                this._allowFocus ? (t.focus() ? ige.input.stopPropagation() : i()) : this._allowActive && i();
            }),
...
var $i_62 = $i_60.extend({
    ...
    _stringify: function () {
        var t,
            i = $i_60.prototype._stringify.call(this);
        for (t in this)
...
var $i_63 = $i_60.extend({
    ...
    vectorFromBaseMinMax: function (t) {
        if (t.min && t.max) {
            var i = t.base,
                ...
                s = {};
            return (
                (s.x = i.x + (e.x + Math.random() * (o.x - e.x))),
    ...
    tick: function (t) {
        if (
            ...
            if (
                (this._currentDelta > this._quantityTimespan && (this._currentDelta = this._quantityTimespan),
                ...
                while (i--) {
                    ...
                    for (
                        e = this.baseAndVarianceValue(this._translateBaseX, this._translateVarianceX, !0),
    ...
    $i_65 = $i_2.extend({
        ...
        tileData: function (t, i, e) {
            if (t !== void 0 && i !== void 0) {
                if (e !== void 0) return (this._mapData[i] = this._mapData[i] || []), (this._mapData[i][t] = e), this;
                if (this._mapData[i]) return this._mapData[i][t];
            }
            return void 0;
        },
        ...
        collision: function (t, i, e, o) {
            ...
            if ((e === void 0 && (e = 1), o === void 0 && (o = 1), t !== void 0 && i !== void 0))
                for (n = 0; o > n; n++) for (s = 0; e > s; s++) if (this.tileData(t + s, i + n)) return !0;
            return !1;
        },
        collisionWith: function (t, i, e, o, s) {
            var n, r;
            if ((e === void 0 && (e = 1), o === void 0 && (o = 1), t !== void 0 && i !== void 0))
                for (r = 0; o > r; r++) for (n = 0; e > n; n++) if (this.tileData(t + n, i + r) === s) return !0;
            return !1;
        },
                ...
                for (r = 0; o > r; r++)
                    for (n = 0; e > n; n++)
                        if ((a = this.tileData(t + n, i + r))) {
                            if (this.tileData(t + n, i + r) !== s) return !1;
                            h = !0;
                        }
            return h;
        },
        mapData: function (t, i, e) {
            if (t !== void 0) {
                if (i || e) {
                    var o, s;
                    for (s in t) for (o in t[s]) this._mapData[e + parseInt(s)][i + parseInt(o)] = t[s][o];
        ...
        sortedMapDataAsArray: function () {
            ...
            for (o = this._sortKeys(r), s = 0; o.length > s; s++)
                for (i = o[s], e = this._sortKeys(r[i]), a[i] = a[i] || {}, n = 0; e.length > n; n++) (t = e[n]), (a[i][t] = r[i][t]);
            return a;
        },
        ...
        translateDataBy: function (t, i) {
            ...
            for (o in a)
                if (a.hasOwnProperty(o)) {
                    ...
                    for (e in s) s.hasOwnProperty(e) && ((r = parseInt(e, 10)), (h[n + i][r + t] = a[o][e]));
                }
            this.mapData(h, 0, 0);
        }
    });
...
var $i_66 = $i_59.extend({
    ...
    tileWidth: function (t) {
        return t !== void 0
            ? ((this._tileWidth = t),
              this._gridSize && this._gridSize.x && (this.width(this._tileWidth * this._gridSize.x), this._updateAdjustmentMatrix()),
              this)
            : this._tileWidth;
    },
    tileHeight: function (t) {
        return t !== void 0
            ? ((this._tileHeight = t),
              this._gridSize && this._gridSize.y && (this.height(this._tileHeight * this._gridSize.y), this._updateAdjustmentMatrix()),
              this)
            : this._tileHeight;
    },
    ...
    occupyTile: function (t, i, e, o, s) {
        ...
        if (
            ...
            for (n = 0; e > n; n++) for (r = 0; o > r; r++) this.map.tileData(t + n, i + r, s);
    ...
    unOccupyTile: function (t, i, e, o) {
        ...
        if (
            ...
            for (s = 0; e > s; s++)
                for (n = 0; o > n; n++)
                    (r = this.map.tileData(t + s, i + n)), r && r._occupiedRect && delete r._occupiedRect, this.map.clearData(t + s, i + n);
        return this;
    },
    ...
    pointToTile: function (t) {
        ...
        return (
            ...
            this._mountMode === 1 &&
                ((i = s), (e = n), (o = new $i_5(Math.floor(i / this._tileWidth), Math.floor(e / this._tileHeight), 0))),
            o
        );
    },
    ...
    _scanRects: function (t, i, e, o) {
        var s = { x: i, y: e, width: 1, height: 1 },
            n = i + 1,
            r = e + 1;
        t[e][i] = 0;
        while (t[e][n] && (!o || (o && o(t[e][n], n, e)))) s.width++, (t[e][n] = 0), n++;
        while (t[r] && t[r][i] && (!o || (o && o(t[r][i], i, r)))) {
            if (
                (t[r][i - 1] && (!o || (o && o(t[r][i - 1], i - 1, r)))) ||
                (t[r][i + s.width] && (!o || (o && o(t[r][i + s.width], i + s.width, r))))
            )
                return s;
            for (n = i; i + s.width > n; n++) if (!t[r][n] || (o && !o(t[r][n], n, r))) return s;
            for (n = i; i + s.width > n; n++) t[r][n] = 0;
            s.height++, r++;
        }
        return s;
    },
    inGrid: function (t, i, e, o) {
        return e === void 0 && (e = 1), o === void 0 && (o = 1), !(0 > t || 0 > i || t + e > this._gridSize.x || i + o > this._gridSize.y);
    },
            ...
            if (s.hasOwnProperty(i))
                for (t in s[i])
                    s[i].hasOwnProperty(t) &&
                        (parseInt(e) > parseInt(t) && (e = parseInt(t)), parseInt(o) > parseInt(i) && (o = parseInt(i)));
...
var $i_53Map = $i_66.extend({
    ...
    negate: function (t) {
        if (t !== void 0) {
            var i,
                ...
                o = t.map._mapData,
                s = this.map._mapData;
            for (e in o) if (o.hasOwnProperty(e)) for (i in o[e]) o[e].hasOwnProperty(i) && s[e] && s[e][i] && delete s[e][i];
        }
        return this;
    },
    ...
    allTexturesLoaded: function () {
        if (!this._allTexturesLoaded) {
            var t = this._textureList,
                i = t.length;
            while (i--) if (!t[i]._loaded) return !1;
        }
        return (this._allTexturesLoaded = !0), !0;
    },
    paintTile: function (t, i, e, o) {
        t !== void 0 && i !== void 0 && e !== void 0 && ((o === void 0 || 1 > o) && (o = 1), this.map.tileData(t, i, [e, o]));
    },
    ...
    saveMap: function () {
        var t,
            ...
            n = 0,
            r = this.map._mapData;
        for (t = 0; this._textureList.length > t; t++) o.push(this._textureList[t].stringify());
        for (e in r) if (r.hasOwnProperty(e)) for (i in r[e]) r[e].hasOwnProperty(i) && (s > i && (s = i), n > e && (n = e));
    ...
    convertHorizontalData: function (t) {
        var i,
            e,
            o = [];
        for (i in t) if (t.hasOwnProperty(i)) for (e in t[i]) t[i].hasOwnProperty(e) && ((o[e] = o[e] || []), (o[e][i] = t[i][e]));
        return o;
    },
    tick: function (t) {
                                ...
                                for (x = 0; d.length > x; x++)
                                    (y = d[x]),
                                        ...
                                        this._sectionTileRegion[m][u][n][r] ||
                                            ((this._sectionTileRegion[m][u][n][r] = !0), this._renderTile(p, n, r, l, g, null, m, u));
                (this._cacheDirty = !1), delete this._sectionTileRegion;
            }
            this._drawSectionsToCtx(t);
        } else if (this.allTexturesLoaded())
            for (e in f)
                if (f.hasOwnProperty(e)) for (i in f[e]) f[e].hasOwnProperty(i) && ((l = f[e][i]), l && this._renderTile(t, i, e, l, g));
    },
        ...
        (this._sections[t] = this._sections[t] || []),
            ...
            this._sections[t][i] ||
                ...
                ige._globalSmoothing
                    ? ((e.imageSmoothingEnabled = !0), (e.webkitImageSmoothingEnabled = !0), (e.mozImageSmoothingEnabled = !0))
                    : ((e.imageSmoothingEnabled = !1), (e.webkitImageSmoothingEnabled = !1), (e.mozImageSmoothingEnabled = !1)),
    ...
    _drawSectionsToCtx: function (t) {
        var i,
            ...
            h,
            l,
            c = ige._currentViewport.viewArea();
                    ...
                    this._sections[i].hasOwnProperty(e) &&
                        ...
                        -(c.width / 2) > r + h + this._tileHeight / 2 ||
                            ...
                            this._drawSectionBounds &&
                                ...
                                t.strokeRect(
                                    i * this._tileWidth * this._autoSection,
                                    e * this._tileHeight * this._autoSection,
    ...
    _renderTile: function (t, i, e, o, s, n, r, a) {
        var h,
            ...
            g,
            b,
            v = this._mountMode === 1 ? this._tileWidth / 2 : 0;
        return (
            this._mountMode === 1 ? this._tileHeight / 2 : 0,
            ...
            !n || n.xyInside(h, l)
                ? (0 > h - v && ((c = c || []), c.push({ x: -1 }), (_ = !0), (d = d || {}), (d.x = -1)),
                  h + v > t.canvas.width - this._tileWidth && ((c = c || []), c.push({ x: 1 }), (m = !0), (d = d || {}), (d.x = 1)),
                  0 > l - 0 && ((c = c || []), c.push({ y: -1 }), (u = !0), (d = d || {}), (d.y = -1)),
                  l + 0 > t.canvas.height - this._tileHeight && ((c = c || []), c.push({ y: 1 }), (p = !0), (d = d || {}), (d.y = 1)),
                  (_ || u || m || p) && c.push(d),
                  t.save(),
                  t.translate(h, l),
...
var $i_66SmartTexture = {
    ...
    $i_70 = $i_59.extend({
        ...
        panTo: function (t, i, e) {
            return (
                t !== void 0 && this._translate.tween().properties({ x: t.x, y: t.y, z: t.z }).duration(i).easing(e).start(), this._entity
            );
        },
        panBy: function (t, i, e) {
            return (
                t !== void 0 &&
                    this._translate
                        .tween()
                        .properties({ x: t.x + this._translate.x, y: t.y + this._translate.y, z: t.z + this._translate.z })
                        .duration(i)
                        .easing(e)
                        .start(),
                this._entity
            ...
            return (
                t !== void 0 &&
                    ...
                    i
                        ? this._translate
                              .tween()
                              .properties({ x: Math.floor(t._worldMatrix.matrix[2]), y: Math.floor(t._worldMatrix.matrix[5]), z: 0 })
                              .duration(i)
                              .easing(e)
                              .start()
        ...
        update: function (t) {
            if ((this._processUpdateBehaviours(t), this._trackTranslateTarget)) {
                var i,
                    ...
                    o,
                    s,
                    n = this._trackTranslateTarget,
                    r = n._worldMatrix.matrix,
                    a = r[2],
                    h = r[5];
            ...
            if (this._trackRotateTarget) {
                var l,
                    c,
                    _ = this._trackRotateTarget._parent !== void 0 ? this._trackRotateTarget._parent._rotate.z : 0,
                    m = -(_ + this._trackRotateTarget._rotate.z);
        ...
        _stringify: function () {
            var t,
                i = $i_59.prototype._stringify.call(this);
            for (t in this)
                if (this.hasOwnProperty(t) && this[t] !== void 0)
                    switch (t) {
                        case "_trackTranslateTarget":
                            i +=
                                ".trackTranslate(ige.$('" + this._trackTranslateTarget.id() + "'), " + this.trackTranslateSmoothing() + ")";
                            break;
                        case "_trackRotateTarget":
                            i += ".trackRotate(ige.$('" + this._trackRotateTarget.id() + "'), " + this.trackRotateSmoothing() + ")";
                    }
            return i;
        }
    });
...
var $i_71 = $i_59.extend(
    ...
    ],
    {
        ...
        init: function (t) {
            ...
            (this._alwaysInView = !0),
                ...
                t &&
                    ((i = t.width),
                    (e = t.height),
                    t && t.scaleToWidth && t.scaleToHeight && (this._lockDimension = new $i_5(t.scaleToWidth, t.scaleToHeight, 0))),
        ...
        viewArea: function () {
            var t = this.aabb(),
                i = this.camera._translate,
                e = this.camera._scale,
                o = t.width * (1 / e.x),
                s = t.height * (1 / e.y);
        ...
        tick: function (t) {
            if (this._scene) {
                if (
                    ...
                    this._drawGuides &&
                        t === ige._ctx &&
                        (t.save(), t.translate(-this._translate.x, -this._translate.y), this.paintGuides(t), t.restore()),
                    this._drawBounds &&
                        t === ige._ctx &&
                        (t.save(), t.translate(-this._translate.x, -this._translate.y), this.paintAabbs(t, this._scene, 0), t.restore()),
                        ...
                        s._shouldRender !== !1 &&
                            (((s._classId !== "$i_72" && !this._drawBoundsLimitId && !this._drawBoundsLimitCategory) ||
                                ...
                                this._drawCompositeBounds &&
                                    s._compositeCache &&
                                    ((r = s.compositeAabb()), (t.strokeStyle = "#ff0000"), t.strokeRect(r.x, r.y, r.width, r.height)),
                                n &&
                                    ...
                                    this._drawBoundsData &&
                                        ...
                                        (t.fillStyle = "#f6ff00"),
                                        t.fillText(
                                            "ID: " + s.id() + " " + "(" + s.classId() + ") " + s.layer() + ":" + s.depth().toFixed(0),
                                            n.x + n.width + 3,
                                            n.y + 10
                                        ),
                                        t.fillText(
        ...
        _resizeEvent: function (t) {
            if (
                (this._autoSize && this._parent && (this._bounds2d = this._parent._bounds2d.clone()),
                ...
                this._bounds2d.x > this._lockDimension.x && this._bounds2d.y > this._lockDimension.y
                    ? ((i = this._bounds2d.x / this._lockDimension.x), (e = this._bounds2d.y / this._lockDimension.y), (o = e > i ? i : e))
...
var $i_72 = $i_59.extend({
    ...
    streamSectionData: function (t, i) {
        switch (t) {
            case "ignoreCamera":
                if (i === void 0) return this._ignoreCamera + "";
...
for (var methodName in $i_59.prototype)
    $i_59.prototype.hasOwnProperty(methodName) &&
        ...
        ($i_78.prototype[methodName] = (function (t) {
            return function () {
                for (var i = this.length, e = 0; i > e; e++) this[e][t].apply(this[e], arguments);
            };
        })(methodName));
...
var $i_81 = $i_3.extend({
            ...
            (this.b2Contact.prototype.igeEitherCategory = function (t, i) {
                return i
                    ? !(
                          ...
                          (this.m_fixtureA.m_body._entity._category !== i && this.m_fixtureB.m_body._entity._category !== i)
                      )
                    : this.m_fixtureA.m_body._entity._category === t || this.m_fixtureB.m_body._entity._category === t;
            }),
    ...
    createFixture: function (t) {
        var i,
            e = new this.b2FixtureDef();
        for (i in t) t.hasOwnProperty(i) && i !== "shape" && i !== "filter" && (e[i] = t[i]);
        return e;
    },
                ...
                switch (e) {
                    ...
                    case "fixtures":
                        if (i.fixtures && i.fixtures.length)
                                ...
                                if (((s = i.fixtures[l]), (n = this.createFixture(s)), (n.igeId = s.igeId), s.shape)) {
                                    switch (s.shape.type) {
                                        case "circle":
                                            ...
                                            break;
                                        case "polygon":
                                            (a = new this.b2PolygonShape()), a.SetAsArray(s.shape.data._poly, s.shape.data.length());
                                            break;
                                        case "rectangle":
                                            (a = new this.b2PolygonShape()),
                                                s.shape.data
                                                    ? ((c = s.shape.data.x !== void 0 ? s.shape.data.x : 0),
                                                      (_ = s.shape.data.y !== void 0 ? s.shape.data.y : 0),
                                                      (m = s.shape.data.width !== void 0 ? s.shape.data.width : t._bounds2d.x / 2),
                                                      (u = s.shape.data.height !== void 0 ? s.shape.data.height : t._bounds2d.y / 2))
                                                    : ((c = 0), (_ = 0), (m = t._bounds2d.x / 2), (u = t._bounds2d.y / 2)),
                                                a.SetAsOrientedBox(
                                                    m / this._scaleRatio,
                                                    u / this._scaleRatio,
                                                    new this.b2Vec2(c / this._scaleRatio, _ / this._scaleRatio),
                                                    0
                                                );
                                    }
                            ...
                            this.log(
                                "$i_22 body has no fixtures, have you specified fixtures correctly? They are supposed to be an array of fixture objects.",
                                "warning"
                            );
                }
    ...
    staticsFromMap: function (t, i) {
        ...
        } else this.log("Cannot extract box2d static bodies from map data because passed map does not have a .map property!", "error");
    },
    ...
    enableDebug: function (t) {
        ...
        } else this.log("Cannot enable box2d debug drawing because the passed argument is not an object on the scenegraph.", "error");
    },
        ...
        if (r._active && r._world) {
            ...
            while (t)
                t._entity &&
                    ...
                    (t = t.GetNext());
            r._world.ClearForces(), (t = null), (i = null), typeof r._updateCallback == "function" && r._updateCallback();
        }
    },
    destroy: function () {
...
var $i_84 = $i_58.extend({
        ...
        tick: function (t) {
            this._parent && this._parent.isometricMounts() === 1 && (t.scale(1.414, 0.707), t.rotate((45 * Math.PI) / 180)),
    ...
    $i_59Box2d = $i_59.extend({
        ...
        gravitic: function (t) {
            return this._box2dBody
                ? t !== void 0
                    ? ((this._box2dBody.m_nonGravitic = !t), (this._box2dBodyDef.gravitic = t), this._box2dBody.SetAwake(!0), this)
        ...
        _translateTo: function (t, i, e) {
            ...
            return (
                this._translateToProto(t, i, e),
                o && !o.updating && (o.SetPosition({ x: t / this._b2dRef._scaleRatio, y: i / this._b2dRef._scaleRatio }), o.SetAwake(!0)),
                this
            );
        },
...
var $i_90 = $i_61.extend({
        ...
        barText: function (t, i, e) {
            return t !== void 0 && i !== void 0 && e !== void 0 ? ((this._barText = { pre: t, post: i, color: e }), this) : this._barText;
        },
        min: function (t) {
        ...
        render: function (t) {
            ...
            o > e && (o = e),
                ...
                this._barBackColor &&
                    ...
                    t.fillRect(-this._bounds2d.x2, -this._bounds2d.y2, this._bounds2d.x, this._bounds2d.y)),
                this._barColor && ((t.fillStyle = this._barColor), t.fillRect(-this._bounds2d.x2, -this._bounds2d.y2, n, this._bounds2d.y)),
    ...
    $i_113 = $i_59.extend({
        ...
        groupUnRegister: function (t, i) {
            return (
                t !== void 0 &&
                    (i !== void 0
                        ? this._groupRegister[i] && (this._groupRegister[i].pull(t), t.groupCount() || (t._groupRegister = !1))
                        : t.removeAllGroups()),
                this
            );
        },
        ...
        removeGraph: function (t, i) {
            if (t !== void 0) {
                ...
                e
                    ? (this.log("Removing SceneGraph data class: " + t), e.removeGraph(i), delete this._graphInstances[t])
                    : this.log(
        ...
        dependencyCheck: function () {
            var t = this._dependencyQueue,
                i = t.length;
            while (i--) if (!this._dependencyQueue[i]()) return !1;
            return !0;
        },
        ...
        updateProgress: function () {
            if (typeof document != "undefined" && document.getElementById) {
                ...
                if (t) {
                    var e = parseInt(t.parentNode.offsetWidth),
                        o = Math.floor((e / this._texturesTotal) * (this._texturesTotal - this._texturesLoading));
                    (t.style.width = o + "px"),
                        i &&
        ...
        textureFromUrl: function (t) {
            var i,
                e = this._textureStore,
                o = e.length;
            while (o--) if (((i = e[o]), i._url === t)) return i;
        },
        ...
        newIdFromString: function (t) {
            if (t !== void 0) {
                var i,
                    ...
                    o = 0,
                    s = t.length;
                for (e = 0; s > e; e++) o += t.charCodeAt(e) * Math.pow(10, 17);
                i = o.toString(16);
                while (ige.$(i)) (o += Math.pow(10, 17)), (i = o.toString(16));
                return i;
            }
        },
        start: function (t) {
            if (!ige._state)
                if (ige.dependencyCheck()) {
                    if (
                        ...
                        (ige._state = 1),
                        this.isClient && document.getElementsByClassName && document.getElementsByClassName("igeLoading"))
                    ) {
                        var i = document.getElementsByClassName("igeLoading"),
                            e = i.length;
                        while (e--) i[e].parentNode.removeChild(i[e]);
                    }
        ...
        renderContext: function (t) {
            return t !== void 0
                ? ((this._renderContext = t), (this._renderMode = this._renderModes[t]), this.log("Rendering mode set to: " + t), this)
                : this._renderContext;
        },
        createFrontBuffer: function (t, i) {
            this.isClient &&
                (this._canvas || ((this._createdFrontBuffer = !0), (this._pixelRatioScaling = !i), this._frontBufferSetup(t, i)));
        },
                ...
                t !== void 0 &&
                    (this._canvas ||
                        ...
                        this._pixelRatioScaling
                            ...
                            : ((this._devicePixelRatio = 1), (this._backingStoreRatio = 1), (this._deviceFinalDrawRatio = 1)),
                        i && (this._autoSize = i),
        ...
        mouseOverList: function (t, i) {
            ...
            if ((t || ((t = ige), (i = []), (r = !0)), t === ige)) {
                if ((e = t._children)) {
                    o = e.length;
                    while (o--) e[o]._scene && e[o]._scene._shouldRender && this.mouseOverList(e[o]._scene, i);
                }
            } else if (
                ((s = this.mousePosWorld()), s && t.aabb && ((n = t.aabb()), n.xyInside(s.x, s.y) && i.push(t)), (e = t._children))
            ) {
                o = e.length;
                while (o--) this.mouseOverList(e[o], i);
            }
        ...
        getClassDerivedList: function (t, i) {
            return i ? t._classId && i.push(t._classId) : (i = []), t.__proto__._classId && this.getClassDerivedList(t.__proto__, i), i;
        },
        ...
        engineStep: function (t, i) {
            var e,
                ...
                u = m.length;
            if (
                (_.incrementTime(t, _._timeScaleLastTimestamp),
                ...
                for (
                    i === void 0 && (i = _._ctx),
                        ...
                        ige._useManualTicks ? (_._manualFrameAlternator = !_._frameAlternator) : requestAnimFrame(_.engineStep),
                        _._tickStart = t,
                        _._tickStart -= _._clientNetDiff,
                        _.lastTick ? (_._tickDelta = _._tickStart - _.lastTick) : ((_.lastTick = 0), (_._tickDelta = 0)),
                        a = ige._spawnQueue,
                        h = a.length,
                        l = h - 1;
                    l >= 0;
                ...
                for (
                    _._enableUpdates &&
                        (igeConfig.debug._timing
                            ? ((s = new Date().getTime()), _.updateSceneGraph(i), (ige._updateTime = new Date().getTime() - s))
                            : _.updateSceneGraph(i)),
                        _._enableRenders &&
                            (_._useManualRender
                                ? _._manualRender &&
                                  (igeConfig.debug._timing
                                      ? ((n = new Date().getTime()), _.renderSceneGraph(i), (ige._renderTime = new Date().getTime() - n))
                ...
                if (((o = s.length), igeConfig.debug._timing))
                    while (o--)
                        t.save(),
                            ...
                            t.restore();
                else while (o--) t.save(), s[o].tick(t), t.restore();
            t.restore();
        },
        fps: function () {
            return this._fps;
        ...
        analyseTiming: function () {
            igeConfig.debug._timing ||
                this.log(
                    "Cannot analyse timing because the igeConfig.debug._timing flag is not enabled so no timing data has been recorded!",
                    "warning"
                );
        },
        ...
        sceneGraph: function (t, i) {
            var e,
                ...
                n,
                r = "";
            for (i === void 0 && (i = 0), t || (t = ige), e = 0; i > e; e++) r += "----";
            if (
                (igeConfig.debug._timing
                    ? ((o = ""),
                                ...
                                ? ((o = ""),
                                  ...
                                  ige._timeSpentLastTick[s[n].id()] &&
                                      ...
                                      typeof ige._timeSpentLastTick[s[n].id()].depthSortChildren == "number" &&
                                          (o += " | ChildDepthSort: " + ige._timeSpentLastTick[s[n].id()].depthSortChildren)),
                                  console.log(r + "----" + s[n].id() + " (" + s[n]._classId + ") : " + s[n]._inView + " Timing(" + o + ")"))
                                : console.log(r + "----" + s[n].id() + " (" + s[n]._classId + ") : " + s[n]._inView),
                            this.sceneGraph(s[n]._scene, i + 1));
                }
            } else if ((s = t._children)) {
                n = s.length;
                while (n--) this.sceneGraph(s[n], i);
            }
        },
        getSceneGraphData: function (t, i) {
            ...
            if (
                ...
                if ((r = t._children)) {
                    ...
                    while (a--)
                        (o = { text: "[" + r[a]._classId + "] " + r[a].id(), id: r[a].id(), classId: r[a].classId() }),
                            i ? r[a]._parent && (o.parentId = r[a]._parent.id()) : ((o.parent = r[a]._parent), (o.obj = r[a])),
                            r[a].camera
                                ? ((n = { text: "[$i_70] " + r[a].id(), id: r[a].camera.id(), classId: r[a].camera.classId() }),
                ...
                a = r.length;
                while (a--) (o = this.getSceneGraphData(r[a], i)), h.push(o);
            }
        ...
        destroy: function () {
            this.stop(), this.isClient && this.removeCanvas(), $i_59.prototype.destroy.call(this), this.log("Engine destroy complete.");
        }
    });
...
var ClientWorld = {
        createWorld: function () {
            (this.mainScene = new $i_72().id("mainScene")),
                ...
                new $i_62().texture(ige.client.textures.font).width(100).text("Score").top(5).right(10).mount(this.uiScene),
                new $i_62()
                    .id("scoreText")
                    ...
                    .right(10)
                    .mount(this.uiScene),
                new $i_62().texture(ige.client.textures.font).width(100).text("Fuel Level").top(80).right(10).mount(this.uiScene),
                new $i_90()
                    .id("player_fuelBar")
                    .max(100)
                    .min(0)
                ...
                (this.vp1 = new $i_71().id("vp1").autoSize(!0).scene(this.mainScene).drawBounds(!1).drawBoundsData(!0).mount(ige));
        }
    },
    ClientTerrain = {
        createTerrain: function () {
            var t, i, e, o, s;
            this.landingPads = [];
            while (!this.landingPadPositions || !this.orbPositions || 1 > this.landingPadPositions.length || 3 > this.orbPositions.length) {
                for (
                    this.landingPadPositions = [], this.orbPositions = [], this.terrain = [], e = new $i_6(), e.addPoint(0, 20), t = 0;
                    40 > t;
                    t++
                )
                    (i = Math.random() * 100),
            ...
            for (
                e.multiply(20),
                    ...
                    s = [],
                    t = 0;
                this.terrainTriangles.length > t;
                t++
            )
                s.push({ filter: { categoryBits: 1, maskBits: 65535 }, shape: { type: "polygon", data: this.terrainTriangles[t] } });
    ...
    Orb = $i_59Box2d.extend({
            ...
            $i_59Box2d.prototype.init.call(this),
                ...
                this.category("orb")
                    ...
                    .box2dBody({
                        ...
                        gravitic: !0,
                        fixedRotation: !1,
                        fixtures: [{ density: 1, filter: { categoryBits: 256, maskBits: 65535 }, shape: { type: "circle" } }]
                    });
        },
        ...
        distanceBonus: function (t) {
            var i = t._translate.x - this._originalStart.x,
                e = t._translate.y - this._originalStart.y,
                o = Math.sqrt(i * i + e * e);
    ...
    Player = $i_59Box2d.extend({
        ...
        tick: function (t) {
            this._landed && 100 > this._fuel && ((this._fuel += 0.05 * ige._tickDelta), this._fuel > 100 && (this._fuel = 100)),
        ...
        carryOrb: function (t, i) {
            if (!this._oldOrb || this._oldOrb !== t) {
                var e = new ige.box2d.b2DistanceJointDef(),
                    o = i.m_fixtureA.m_body,
                    s = i.m_fixtureB.m_body;
...
var PlayerBehaviour = function () {
        if (
            ...
            var t = this._rotate.z + Math.radians(-90),
                i = new ige.box2d.b2Vec2(Math.cos(t) * this._thrustPower, Math.sin(t) * this._thrustPower);
        ...
        } else this.thrustEmitter.stop();
        ige.input.actionState("drop") && this._carryingOrb && this.dropOrb();
    },
    ThrustParticle = $i_59Box2d.extend({
        ...
        init: function (t) {
            (this._emitter = t),
                ...
                this.addComponent($i_11).texture(ige.client.textures.rectangle).width(5).height(5).layer(1).category("thrustParticle");
        },
        destroy: function () {
    ...
    ExplosionParticle = ThrustParticle.extend({
        ...
        destroy: function () {
            this._emitter !== void 0 && this._emitter._particles.pull(this), ThrustParticle.prototype.destroy.call(this);
        }
    }),
    ...
    ClientScore = $i_62.extend({
        ...
        init: function (t) {
            $i_62.prototype.init.call(this),
                this.depth(1).width(480).height(110).texture(ige.client.textures.font).textAlignX(1).textLineSpacing(0).text(t).hide();
        },
        start: function (t) {
            var i = this;
            return t
    ...
    Client = $i_2.extend({
        ...
        init: function () {
            ...
            (t.obj = []),
                ...
                ige.addComponent($i_81).box2d.sleep(!0).box2d.gravity(0, 1).box2d.createWorld().box2d.mode(0).box2d.start(),
                        ...
                        ige.start(function (i) {
                            i &&
                                ...
                                ige.box2d.contactListener(
                                    function (i) {
                                        if (i.igeEitherCategory("floor") && i.igeEitherCategory("ship")) t.player.crash();
                                        else if (i.igeEitherCategory("landingPad") && i.igeEitherCategory("ship")) {
                                            delete t.player._oldOrb;
                                            var e = Math.degrees(t.player._rotate.z),
                                                o = Math.round(e / 360);
                                            o > 0 && (e -= 360 * o),
                                                0 > o && (e -= 360 * o),
                                            ...
                                            !t.player._carryingOrb && i.igeEitherCategory("orb") && i.igeEitherCategory("ship")
                                                ...
                                                : i.igeEitherCategory("orb") &&
                                                  ...
                                                  (t.player._carryingOrb && t.player._orb === i.igeEntityByCategory("orb")
                                                      ? t.player._orb.deposit(!0, i.igeEntityByCategory("landingPad"))
                                                      : i.igeEntityByCategory("orb").deposit(!1, i.igeEntityByCategory("landingPad")));
                                    },
                                    function (i) {
                                        i.igeEitherCategory("landingPad") && i.igeEitherCategory("ship") && (t.player._landed = !1);
                                    }
                                ));
                        });
                });
