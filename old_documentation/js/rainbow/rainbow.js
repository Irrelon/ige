			...
			processGroup = function (i, group_keys, callback) {
				...
				var group = pattern["matches"][group_keys[i]],
					...
					_replaceAndContinue = function (block, replace_block, match_name) {
						replacement = _replaceAtPosition(
							_indexOfGroup(match, group_keys[i]),
							block,
							match_name ? _wrapCodeInSpan(match_name, replace_block) : replace_block,
							replacement
						);
						processNextGroup();
					};
				...
				_processCodeWithPatterns(
					block,
					process_group.length ? process_group : [process_group],
					function (code) {
