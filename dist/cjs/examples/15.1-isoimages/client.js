...
class Client extends IgeBaseClass_1.IgeBaseClass {
    ...
    setupUi_BuildingsMenu() {
        ...
        const uiMenuBuildings_bank = new IgeUiRadioButton_1.IgeUiRadioButton()
            ...
            const tempItem = instance_1.ige.client.createTemporaryItem(uiMenuBuildings_bank.data("buildingType")).opacity(0.7);
    ...
    placeItem(type, tileX, tileY) {
        const item = new instance_1.ige.classStore[type]().mount(instance_1.ige.$("tileMap1")).translateToTile(tileX, tileY);
        return item;
    }
    /**
