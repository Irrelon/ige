...
class Client extends IgeBaseClass_1.IgeBaseClass {
		...
		this.fsm.defineState("build", {
			enter: (data, completeCallback) =>
				__awaiter(this, void 0, void 0, function* () {
					...
					let cursorObject = new instance_1.ige.classStore[data.classId]().mount(tileMap);
					mouseMoveHandler = () => {
	...
	loadTextures() {
		this.gameTextures.background1 = new IgeTexture_1.IgeTexture(
			"background1",
			"../assets/textures/backgrounds/grassTile.png"
		);
		this.gameTextures.bank = new IgeTexture_1.IgeTexture("bank", "../assets/textures/buildings/bank1.png");
		this.gameTextures.electricals = new IgeTexture_1.IgeTexture(
			"electricals",
			"../assets/textures/buildings/electricalsShop1.png"
		);
		this.gameTextures.burgers = new IgeTexture_1.IgeTexture(
			"burgers",
			"../assets/textures/buildings/burgerShop1.png"
		);
		this.gameTextures.base_se = new IgeTexture_1.IgeTexture("base_se", "../assets/textures/buildings/base_se.png");
		this.gameTextures.base_se_left = new IgeTexture_1.IgeTexture(
			"base_se_left",
			"../assets/textures/buildings/base_se_left.png"
		);
		this.gameTextures.base_se_middle = new IgeTexture_1.IgeTexture(
			"base_se_middle",
			"../assets/textures/buildings/base_se_middle.png"
		);
		this.gameTextures.base_se_right = new IgeTexture_1.IgeTexture(
			"base_se_right",
		...
		this.gameTextures.base_sw_left = new IgeTexture_1.IgeTexture(
			"base_sw_left",
			"../assets/textures/buildings/base_sw_left.png"
		);
		this.gameTextures.base_sw_middle = new IgeTexture_1.IgeTexture(
			"base_sw_middle",
			"../assets/textures/buildings/base_sw_middle.png"
		);
		this.gameTextures.base_sw_right = new IgeTexture_1.IgeTexture(
			"base_sw_right",
			"../assets/textures/buildings/base_sw_right.png"
		);
		this.gameTextures.stacker_se = new IgeTexture_1.IgeTexture(
			"stacker_se",
			"../assets/textures/buildings/stacker_se.png"
		);
		this.gameTextures.stacker_se_left = new IgeTexture_1.IgeTexture(
			"stacker_se_left",
			"../assets/textures/buildings/stacker_se_left.png"
		);
		this.gameTextures.stacker_se_middle = new IgeTexture_1.IgeTexture(
			"stacker_se_middle",
			"../assets/textures/buildings/stacker_se_middle.png"
		);
		this.gameTextures.stacker_se_right = new IgeTexture_1.IgeTexture(
			"stacker_se_right",
			"../assets/textures/buildings/stacker_se_right.png"
		);
		this.gameTextures.stacker_sw = new IgeTexture_1.IgeTexture(
			"stacker_sw",
			"../assets/textures/buildings/stacker_sw.png"
		);
		this.gameTextures.stacker_sw_left = new IgeTexture_1.IgeTexture(
			"stacker_sw_left",
			"../assets/textures/buildings/stacker_sw_left.png"
		);
		this.gameTextures.stacker_sw_middle = new IgeTexture_1.IgeTexture(
			"stacker_sw_middle",
			"../assets/textures/buildings/stacker_sw_middle.png"
		);
		this.gameTextures.stacker_sw_right = new IgeTexture_1.IgeTexture(
			"stacker_sw_right",
			"../assets/textures/buildings/stacker_sw_right.png"
		);
		this.gameTextures.crane_se = new IgeTexture_1.IgeTexture(
			"crane_se",
			"../assets/textures/buildings/crane_se.png"
		);
		this.gameTextures.crane_sw = new IgeTexture_1.IgeTexture(
			"crane_sw",
			"../assets/textures/buildings/crane_sw.png"
		);
		this.gameTextures.crane_ne = new IgeTexture_1.IgeTexture(
			"crane_ne",
			"../assets/textures/buildings/crane_ne.png"
		);
		this.gameTextures.crane_nw = new IgeTexture_1.IgeTexture(
			"crane_nw",
			"../assets/textures/buildings/crane_nw.png"
		);
		this.gameTextures.uiButtonSelect = new IgeTexture_1.IgeTexture(
			"uiButtonSelect",
			"../assets/textures/ui/uiButton_select.png"
		);
		this.gameTextures.uiButtonMove = new IgeTexture_1.IgeTexture(
			"uiButtonMove",
			"../assets/textures/ui/uiButton_move.png"
		);
		this.gameTextures.uiButtonDelete = new IgeTexture_1.IgeTexture(
			"uiButtonDelete",
			"../assets/textures/ui/uiButton_delete.png"
		);
		this.gameTextures.uiButtonHouse = new IgeTexture_1.IgeTexture(
			"uiButtonHouse",
			"../assets/textures/ui/uiButton_house.png"
		);
	}
	/**
	...
	setupUi_BuildingsMenu() {
		...
		const uiMenuBuildings_bank = new IgeUiRadioButton_1.IgeUiRadioButton()
			...
			.select(function () {
				...
				const tempItem = instance_1.ige.client
					.createTemporaryItem(uiMenuBuildings_bank.data("buildingType"))
					.opacity(0.7);
		...
		switch (instance_1.ige.client.data("cursorMode")) {
			...
			case "move": {
				...
				if (!instance_1.ige.client.data("moveItem")) {
					...
					// down now
					const item = instance_1.ige.client.data("moveItem"),
	...
	_mapOnPointerOver(event, evc) {
		...
		switch (instance_1.ige.client.data("cursorMode")) {
			...
			case "move": {
				const item = instance_1.ige.client.data("moveItem"),
					map = instance_1.ige.client.tileMap1.map;
				if (item) {
			...
			case "build": {
				...
				if (item) {
					...
					if (
						!instance_1.ige.client.tileMap1.map.collision(
							x,
							y,
							item.data("tileWidth"),
