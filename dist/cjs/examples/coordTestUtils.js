...
exports.assertPixelColor = assertPixelColor;
 ...
 */
function assertPixelColor(pixels, x, y, canvasWidth, canvasHeight, expectedR, expectedG, expectedB, tolerance = 40, isWebGl = true) {
 ...
 */
function readAllPixels(gl, width, height) {
 ...
 */
function worldToScreen(worldPoint, viewMatrix, projMatrix, canvasWidth, canvasHeight) {
