    ...
    loadAnimatedModel() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.animatedModel = yield IgeGltfLoader_1.igeGltfLoader.load(modelPath, "animatedModel");
        ...
        if (!mesh) {
            ...
            if (this.animatedModel.meshes.length > 0) {
                ...
                if (firstMesh.primitives.length > 0) {
                    this.animatedEntity._geometryData = Object.assign(Object.assign({}, firstMesh.primitives[0].geometry), { id: "animatedCharacter_geometry" });
                }
            }
        }
        else {
            ...
            if (primitive) {
                this.animatedEntity._geometryData = Object.assign(Object.assign({}, primitive.geometry), { id: "animatedCharacter_geometry" });
                const vertexCount = (((_a = primitive.geometry.vertices) === null || _a === void 0 ? void 0 : _a.length) || 0) / 3;
        ...
        window.addEventListener("keydown", (event) => {
            ...
            switch (event.key) {
                ...
                case "5":
                    ...
                    if (((_a = this.animatedModel) === null || _a === void 0 ? void 0 : _a.animations) && index < this.animatedModel.animations.length) {
