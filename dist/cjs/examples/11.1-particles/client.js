	...
	init() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const particleEmitter = new IgeParticleEmitter_1.IgeParticleEmitter()
				...
				.opacityBase(0.5)
				.velocityVector(
					new IgePoint3d_1.IgePoint3d(0, -0.1, 0),
					new IgePoint3d_1.IgePoint3d(-0.2, -0.1, 0),
					new IgePoint3d_1.IgePoint3d(0.2, -0.25, 0)
				)
				.linearForceVector(
					new IgePoint3d_1.IgePoint3d(0, 0.12, 0),
					new IgePoint3d_1.IgePoint3d(0, 0, 0),
					new IgePoint3d_1.IgePoint3d(0, 0, 0)
				)
				.deathScaleBaseX(0)
