...
const IgeCamera_1 = require("../engine/core/IgeCamera.js");
...
function createCamera() {
    ...
    return new IgeCamera_1.IgeCamera(mockViewport);
}
describe("IgeCamera", () => {
    ...
    describe("lookAtPoint", () => {
        it("can set a look-at target point", () => {
            const camera = createCamera();
            const target = new IgePoint3d_1.IgePoint3d(10, 20, 30);
            camera.lookAtPoint(target);
            const result = camera.lookAtPoint();
            expect(result).toBeDefined();
            expect(result === null || result === void 0 ? void 0 : result.x).toBe(10);
            expect(result === null || result === void 0 ? void 0 : result.y).toBe(20);
            expect(result === null || result === void 0 ? void 0 : result.z).toBe(30);
        });
        ...
        it("returns this for method chaining when setting", () => {
            ...
            const result = camera.lookAtPoint(target);
            expect(result).toBe(camera);
        });
    });
    describe("presets", () => {
    ...
    describe("camera positioning", () => {
        ...
        it("preset distance affects camera position", () => {
            ...
            const dist1 = Math.sqrt(camera1._translate.x * camera1._translate.x +
                camera1._translate.y * camera1._translate.y +
                camera1._translate.z * camera1._translate.z);
            const dist2 = Math.sqrt(camera2._translate.x * camera2._translate.x +
