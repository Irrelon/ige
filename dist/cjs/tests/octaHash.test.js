...
const octaHash_1 = require("../engine/utils/octaHash.js");
describe("hashToExtents()", () => {
    it("should correctly encode `A`", () => {
        const hash = "A";
        const result = (0, octaHash_1.decode)(hash);
    ...
    it("should throw an Error when an invalid quadrant identifier is used", () => {
        ...
        expect(() => (0, octaHash_1.decode)(invalidHash)).toThrowError("Invalid quadrant identifier");
    });
});
describe("extentsToHash()", () => {
    it("should correctly encode A", () => {
        const hash = "A";
        const expectedArr = (0, octaHash_1.decode)(hash);
        const result = (0, octaHash_1.encode)(expectedArr, 1);
        expect(result).toBeDefined();
    ...
    it("should correctly encode ABCD", () => {
        const hash = "ABCD";
        const expectedArr = (0, octaHash_1.decode)(hash);
        const result = (0, octaHash_1.encode)(expectedArr, 4);
        expect(result).toBeDefined();
        expect(result).toEqual(hash);
    });
    it("should correctly encode ABCDAAAAAA", () => {
        const hash = "ABCDAAAAAA";
        const expectedArr = (0, octaHash_1.decode)(hash);
        const result = (0, octaHash_1.encode)(expectedArr, 10);
        expect(result).toBeDefined();
        expect(result).toEqual(hash);
    });
    it("should correctly encode DACDBCABDABCBCABDABC", () => {
        const hash = "DACDBCABDABCBCABDABC";
        const expectedArr = (0, octaHash_1.decode)(hash);
        const result = (0, octaHash_1.encode)(expectedArr, 20);
        expect(result).toBeDefined();
        expect(result).toEqual(hash);
    });
});
