...
class IgeUiEntity extends IgeEntity_1.IgeEntity {
    ...
    _renderBorder(ctx) {
        ...
        if (!this._anyBorderRadius() && this._borderWidthsMatch()) {
            ...
            if (this._borderTopWidth) {
                ...
                if (this._borderTopLeftRadius > 0) {
                    // Top-left corner top-half
                    ctx.arc(left + this._borderTopLeftRadius, top + this._borderTopLeftRadius, this._borderTopLeftRadius, 225 * utils_1.PI180, 270 * utils_1.PI180);
                }
                // Top border
                ctx.moveTo(left + this._borderTopLeftRadius, top);
                ctx.lineTo(left + width - this._borderTopRightRadius, top);
                if (this._borderTopRightRadius > 0) {
                    ...
                    ctx.arc(left + width - this._borderTopRightRadius, top + this._borderTopRightRadius, this._borderTopRightRadius, -90 * utils_1.PI180, -44 * utils_1.PI180); // use -44 instead of -45 to fully connect with next piece
                }
            }
            ...
            if (this._borderRightWidth) {
                ...
                if (this._borderTopRightRadius > 0) {
                    ctx.arc(left + width - this._borderTopRightRadius, top + this._borderTopRightRadius, this._borderTopRightRadius, -45 * utils_1.PI180, 0);
                }
                // Right border
                ...
                if (this._borderBottomRightRadius > 0) {
                    ...
                    ctx.arc(left + width - this._borderBottomRightRadius, top + height - this._borderBottomRightRadius, this._borderTopRightRadius, 0, 46 * utils_1.PI180); // use 46 instead of 45 to fully connect with next piece
                }
            }
            ...
            if (this._borderBottomWidth) {
                ...
                if (this._borderBottomRightRadius > 0) {
                    ctx.arc(left + width - this._borderBottomRightRadius, top + height - this._borderBottomRightRadius, this._borderBottomRightRadius, 45 * utils_1.PI180, 90 * utils_1.PI180);
                }
                // Bottom border
                ...
                if (this._borderBottomLeftRadius > 0) {
                    ...
                    ctx.arc(left + this._borderBottomLeftRadius, top + height - this._borderBottomLeftRadius, this._borderBottomLeftRadius, 90 * utils_1.PI180, 136 * utils_1.PI180); // use 136 instead of 135 to fully connect with next piece
                }
            }
            ...
            if (this._borderLeftWidth) {
                ...
                if (this._borderBottomLeftRadius > 0) {
                    ctx.arc(left + this._borderBottomLeftRadius, top + height - this._borderBottomLeftRadius, this._borderBottomLeftRadius, 135 * utils_1.PI180, 180 * utils_1.PI180);
                }
                // Left border
                ...
                if (this._borderTopLeftRadius > 0) {
                    ...
                    ctx.arc(left + this._borderTopLeftRadius, top + this._borderTopLeftRadius, this._borderTopLeftRadius, 180 * utils_1.PI180, 226 * utils_1.PI180); // use 226 instead of 225 to fully connect with next piece
                }
            }
            ctx.stroke();
        }
    ...
    backgroundImage(texture, repeatType) {
        ...
        if (this._cell && this._cell > 1) {
            ...
            this._patternFill = ((_a = instance_1.ige.engine._ctx) === null || _a === void 0 ? void 0 : _a.createPattern(canvas, repeatType)) || undefined;
        }
        else {
            // Create the pattern from the texture
            this._patternFill = ((_b = instance_1.ige.engine._ctx) === null || _b === void 0 ? void 0 : _b.createPattern(texture.image, repeatType)) || undefined;
        }
