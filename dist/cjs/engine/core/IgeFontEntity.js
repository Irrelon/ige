...
class IgeFontEntity extends IgeUiEntity_1.IgeUiEntity {
    ...
    measureTextWidth(text) {
        ...
        if (((_a = this._texture) === null || _a === void 0 ? void 0 : _a._renderMode) === IgeTextureRenderMode_1.IgeTextureRenderMode.image) {
            return ((_c = (_b = this._texture.script) === null || _b === void 0 ? void 0 : _b.meta) === null || _c === void 0 ? void 0 : _c.measureTextWidth(text, this)) || -1;
        }
        else if (((_d = this._texture) === null || _d === void 0 ? void 0 : _d._renderMode) === IgeTextureRenderMode_1.IgeTextureRenderMode.smartTexture) {
