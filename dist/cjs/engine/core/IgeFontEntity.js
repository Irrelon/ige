...
class IgeFontEntity extends IgeUiEntity_1.IgeUiEntity {
	constructor() {
		...
		this._textAlignX = IgeFontAlign_1.IgeFontAlignX.center;
		this._textAlignY = IgeFontAlign_1.IgeFontAlignY.multiLineMiddle;
	...
	measureTextWidth(text) {
		...
		if (
			((_a = this._texture) === null || _a === void 0 ? void 0 : _a._renderMode) ===
			IgeTextureRenderMode_1.IgeTextureRenderMode.image
		) {
			return (
				((_c = (_b = this._texture.script) === null || _b === void 0 ? void 0 : _b.meta) === null ||
				_c === void 0
					? void 0
					: _c.measureTextWidth(text, this)) || -1
			);
		} else if (
			((_d = this._texture) === null || _d === void 0 ? void 0 : _d._renderMode) ===
			IgeTextureRenderMode_1.IgeTextureRenderMode.smartTexture
		) {
			return (
				((_f = (_e = this._texture.script) === null || _e === void 0 ? void 0 : _e.meta) === null ||
				_f === void 0
					? void 0
					: _f.measureTextWidth(text, this)) || -1
			);
		}
		return -1;
	}
