    ...
    constructor() {
        ...
        this.update = () => {
            ...
            while (tweenCount--) {
                ...
                const deltaTime = currentTime - tween._startTime;
                    ...
                    if (tween._steps.length === tween._currentStep + 1) {
                        ...
                        if (tween._repeatMode) {
                            ...
                            if (!stopped) {
                                ...
                                if (tween._repeatMode === IgeTweenRepeatMode_1.IgeTweenRepeatMode.replay) {
                                    tween._currentStep = 0;
                                }
                                if (tween._repeatMode === IgeTweenRepeatMode_1.IgeTweenRepeatMode.reverse) {
...
exports.IgeTweenController = IgeTweenController;
