...
class IgeTextureMap extends IgeTileMap2d_1.IgeTileMap2d {
    ...
    _renderTile(ctx, x, y, tileData, tileEntity, rect, sectionX, sectionY) {
        ...
        const xAdjust = this._mountMode === IgeMountMode_1.IgeMountMode.iso ? this._tileWidth / 2 : 0, yAdjust = this._mountMode === IgeMountMode_1.IgeMountMode.iso ? this._tileHeight / 2 : 0;
