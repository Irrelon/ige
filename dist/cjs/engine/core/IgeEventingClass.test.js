...
describe("IgeEventingClass", () => {
	it("on()", () => {
		...
		assert_1.default.strictEqual(
			(_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo["*"].length,
			1,
			"Listener registered on event"
		);
		myClass.off("moo");
		assert_1.default.strictEqual(
	...
	describe("once()", () => {
		it("Only calls a listener once for the event", () =>
			__awaiter(void 0, void 0, void 0, function* () {
				...
				myClass.emit("moo");
				myClass.emit("moo");
				assert_1.default.strictEqual(callCount, 1, "Number of times listener called is correct");
				assert_1.default.strictEqual(
					!((_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo) ||
						!((_b = myClass._eventListeners) === null || _b === void 0 ? void 0 : _b.moo["*"]) ||
						!((_c = myClass._eventListeners) === null || _c === void 0 ? void 0 : _c.moo["*"].length),
					true,
					"Listeners all removed from event"
				);
			}));
		it("The correct arguments are emitted", () =>
			__awaiter(void 0, void 0, void 0, function* () {
				var _d, _e, _f;
				const myClass = new IgeEventingClass_1.IgeEventingClass();
				let callCount = 0;
				...
				assert_1.default.strictEqual(callCount, 1, "Number of times listener called is correct");
				// @ts-ignore
				assert_1.default.strictEqual(receivedArg1, 1, "Argument 1 was correct");
				// @ts-ignore
				assert_1.default.strictEqual(receivedArg2, "one", "Argument 2 was correct");
				assert_1.default.strictEqual(
					!((_d = myClass._eventListeners) === null || _d === void 0 ? void 0 : _d.moo) ||
						!((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"]) ||
						!((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["*"].length),
					true,
					"Listeners all removed from event"
				);
			}));
	...
	describe("off()", () => {
		it("Cancels all listeners (event)", () => {
			...
			assert_1.default.strictEqual(
				(_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo["*"].length,
				1,
				"Listeners registered on event"
			);
			myClass.on("moo", "testId", () => {});
			assert_1.default.strictEqual(
				(_b = myClass._eventListeners) === null || _b === void 0 ? void 0 : _b.moo["testId"].length,
				1,
				"Listeners registered on event"
			);
			...
			assert_1.default.strictEqual(
				(_d = myClass._eventListeners) === null || _d === void 0 ? void 0 : _d.moo["testId"].length,
				2,
				"Listeners registered on event"
			);
			myClass.off("moo");
			assert_1.default.strictEqual(
				!((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo) ||
					(((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["*"].length) === 0 &&
						((_g = myClass._eventListeners) === null || _g === void 0
							? void 0
							: _g.moo["testId"].length) === 0),
				true,
				"Listeners all removed from event"
			);
		});
		it("Cancels id-based listeners (event, id)", () => {
			...
			assert_1.default.strictEqual(
				((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"].length) === 2,
				true,
				"Listeners all removed from event"
			);
			assert_1.default.strictEqual(
				!((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["testId"]) ||
					((_g = myClass._eventListeners) === null || _g === void 0 ? void 0 : _g.moo["testId"].length) === 0,
				true,
				"Listeners all removed from event"
			);
		});
		it("Cancels listener-based listeners (event, listener)", () => {
			...
			assert_1.default.strictEqual(
				((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"].length) === 1,
				true,
				"Listeners all removed from event"
			);
			assert_1.default.strictEqual(
				((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["testId"].length) === 2,
				true,
				"Listeners all removed from event"
			);
		});
		it("Cancels id-based + listener-based listeners (event, id, listener)", () => {
			...
			assert_1.default.strictEqual(
				((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["testId"].length) === 1,
				true,
				"Listeners all removed from event"
			);
		});
	...
	describe("emitId()", () => {
		it("Fires an id-based event first followed by a catch-all event", () => {
			...
			assert_1.default.strictEqual(
				(_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo["testId"].length,
				1,
				"Listener registered on event"
			);
			...
			assert_1.default.strictEqual(
				((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo) &&
					...
					((_g = myClass._eventListeners) === null || _g === void 0 ? void 0 : _g.moo["*"].length) === 1,
				true,
				"Global listener still there"
			);
			myClass.off("moo");
			assert_1.default.strictEqual(
				!((_h = myClass._eventListeners) === null || _h === void 0 ? void 0 : _h.moo) ||
					!((_j = myClass._eventListeners) === null || _j === void 0 ? void 0 : _j.moo["*"]) ||
					((_k = myClass._eventListeners) === null || _k === void 0 ? void 0 : _k.moo["*"].length) === 0,
				true,
				"Listeners all removed from event"
			);
		});
