...
describe("IgeEventingClass", () => {
    it("on()", () => {
        ...
        myClass.off("moo");
        assert_1.default.strictEqual(!myClass._eventListeners.moo || !myClass._eventListeners.moo["*"] || myClass._eventListeners.moo["*"].length, true, "Listeners all removed from event");
    });
    describe("once()", () => {
        it("Only calls a listener once for the event", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            assert_1.default.strictEqual(!((_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo) || !((_b = myClass._eventListeners) === null || _b === void 0 ? void 0 : _b.moo["*"]) || !((_c = myClass._eventListeners) === null || _c === void 0 ? void 0 : _c.moo["*"].length), true, "Listeners all removed from event");
        }));
        it("The correct arguments are emitted", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            assert_1.default.strictEqual(!((_d = myClass._eventListeners) === null || _d === void 0 ? void 0 : _d.moo) || !((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"]) || !((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["*"].length), true, "Listeners all removed from event");
        }));
    });
    describe("off()", () => {
