...
describe("IgeEventingClass", () => {
    it("on()", () => {
        var _a;
        const myClass = new exports_1.IgeEventingClass();
        myClass.on("moo", () => {
        });
        node_assert_1.default.strictEqual((_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo["*"].length, 1, "Listener registered on event");
        myClass.off("moo");
        node_assert_1.default.strictEqual(!myClass._eventListeners.moo ||
    ...
    describe("once()", () => {
        it("Only calls a listener once for the event", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            myClass.emit("moo");
            myClass.emit("moo");
            node_assert_1.default.strictEqual(callCount, 1, "Number of times listener called is correct");
    ...
    describe("off()", () => {
        it("Cancels all listeners (event)", () => {
            ...
            node_assert_1.default.strictEqual((_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo["*"].length, 1, "Listeners registered on event");
            myClass.on("moo", "testId", () => {
            });
            node_assert_1.default.strictEqual((_b = myClass._eventListeners) === null || _b === void 0 ? void 0 : _b.moo["testId"].length, 1, "Listeners registered on event");
            myClass.on("moo", listener1);
            node_assert_1.default.strictEqual((_c = myClass._eventListeners) === null || _c === void 0 ? void 0 : _c.moo["*"].length, 2, "Listeners registered on event");
            myClass.on("moo", "testId", listener2);
            node_assert_1.default.strictEqual((_d = myClass._eventListeners) === null || _d === void 0 ? void 0 : _d.moo["testId"].length, 2, "Listeners registered on event");
            myClass.off("moo");
            node_assert_1.default.strictEqual(!((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo) ||
        ...
        it("Cancels id-based listeners (event, id)", () => {
            ...
            node_assert_1.default.strictEqual(((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"].length) === 2, true, "Listeners all removed from event");
            node_assert_1.default.strictEqual(!((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["testId"]) || ((_g = myClass._eventListeners) === null || _g === void 0 ? void 0 : _g.moo["testId"].length) === 0, true, "Listeners all removed from event");
        });
        it("Cancels listener-based listeners (event, listener)", () => {
            ...
            node_assert_1.default.strictEqual(((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"].length) === 1, true, "Listeners all removed from event");
            node_assert_1.default.strictEqual(((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["testId"].length) === 2, true, "Listeners all removed from event");
        });
        it("Cancels id-based + listener-based listeners (event, id, listener)", () => {
            ...
            node_assert_1.default.strictEqual(((_e = myClass._eventListeners) === null || _e === void 0 ? void 0 : _e.moo["*"].length) === 2, true, "Listeners all removed from event");
            node_assert_1.default.strictEqual(((_f = myClass._eventListeners) === null || _f === void 0 ? void 0 : _f.moo["testId"].length) === 1, true, "Listeners all removed from event");
        });
    });
    describe("emitStatic()", () => {
        it("Static emitter will emit when a new listener is added", (resolve) => {
            class MyClass extends exports_1.IgeEventingClass {
            }
            expect(1);
            ...
            myClass.on("moo", () => {
                countAssertion();
                node_assert_1.default.ok(true, "Callback was fired");
                resolve();
            });
        });
    });
    describe("cancelStatic()", () => {
        it("Removes static emitter", (resolve) => {
            ...
            myClass.on("moo", () => {
                countAssertion();
                node_assert_1.default.ok(false, "Callback was fired");
            });
            setTimeout(() => {
                resolve();
            }, 10);
    ...
    describe("overwrite()", () => {
        it("Only fires the last listener added, cancelling all other listeners before it", (resolve) => {
            ...
            myClass.on("moo", () => {
                countAssertion();
                node_assert_1.default.ok(false, "Correct callback was fired");
            });
            myClass.on("moo", () => {
                countAssertion();
                node_assert_1.default.ok(false, "Correct callback was fired");
            ...
            myClass.overwrite("moo", () => {
                countAssertion();
                node_assert_1.default.ok(true, "Correct callback was fired");
            });
            myClass.emit("moo");
            setTimeout(() => {
                resolve();
    ...
    describe("emitId()", () => {
        it("Fires an id-based event first followed by a catch-all event", () => {
            ...
            node_assert_1.default.strictEqual((_a = myClass._eventListeners) === null || _a === void 0 ? void 0 : _a.moo["testId"].length, 1, "Listener registered on event");
            myClass.emitId("moo", "testId", "foo");
            node_assert_1.default.strictEqual(emitCount, 2, "Event fired correctly");
            myClass.off("moo", "testId");
            node_assert_1.default.strictEqual(!((_b = myClass._eventListeners) === null || _b === void 0 ? void 0 : _b.moo) ||
            ...
            myClass.off("moo");
            node_assert_1.default.strictEqual(!((_h = myClass._eventListeners) === null || _h === void 0 ? void 0 : _h.moo) ||
