...
import { IgeStats } from "./IgeStats.js"
...
export declare class Ige implements IgeIsReadyPromise {
    ...
    config: IgeConfig;
    version: string;
    classStore: Record<string, import("../..").IgeGenericClass>;
     ...
     */
    $$<ReturnType extends IgeCanRegisterByCategory | undefined = IgeCanRegisterByCategory>(categoryName: string, live?: boolean): ReturnType[];
    /**
