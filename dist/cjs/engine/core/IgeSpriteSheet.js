...
class IgeSpriteSheet extends exports_1.IgeTexture {
     ...
     */
    isPixelTransparent(imageData, x, y) {
     ...
     */
    makePixelTransparent(imageData, x, y) {
        const pixelStart = y * imageData.width * 4 + x * 4;
...
exports.IgeSpriteSheet = IgeSpriteSheet;
