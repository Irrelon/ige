...
class IgeTileMap2d extends IgeEntity_1.IgeEntity {
    constructor(tileWidth, tileHeight) {
        ...
        if (!clientServer_1.isServer) {
            const tex = new IgeTexture_1.IgeTexture((0, utils_1.newIdHex)(), IgeTileMap2dSmartTexture_1.IgeTileMap2dSmartTexture);
            this.texture(tex);
        }
    ...
    _scanRects(mapData, x, y, callback) {
        ...
        while (mapData[ny] && mapData[ny][x] && (!callback || (callback && callback(mapData[ny][x], x, ny)))) {
            ...
            if ((mapData[ny][x - 1] && (!callback || (callback && callback(mapData[ny][x - 1], x - 1, ny)))) ||
