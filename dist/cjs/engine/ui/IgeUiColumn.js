...
exports.IgeUiColumn = void 0;
const IgeUiElement_1 = require("../core/IgeUiElement.js");
const igeClassStore_1 = require("../igeClassStore.js");
class IgeUiColumn extends IgeUiElement_1.IgeUiElement {
    constructor() {
        super(...arguments);
        this.classId = "IgeUiColumn";
    }
    tick(ctx) {
...
exports.IgeUiColumn = IgeUiColumn;
(0, igeClassStore_1.registerClass)(IgeUiColumn);
