...
exports.extentsToHash = exports.hashToExtents = void 0;
const hashToExtents = (hash) => {
    let extents = [-1, -1, 1, 1];
...
exports.hashToExtents = hashToExtents;
const extentsToHash = ([x1, y1, x2, y2], level = 1) => {
    let hash = "";
...
exports.extentsToHash = extentsToHash;
