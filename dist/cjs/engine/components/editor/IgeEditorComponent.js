...
class IgeEditorComponent extends IgeComponent_1.IgeComponent {
	...
	constructor(entity, options) {
		 ...
		 */
		this._statsTick = () => {
			let self = instance_1.ige.components.editor,
				i,
				watchCount,
				watchItem,
				itemName,
		...
		instance_1.ige.sync(instance_1.ige.requireStylesheet, [
			igeRoot + "engine/components/editor/react/build/static/css/main.min.css"
		]);
