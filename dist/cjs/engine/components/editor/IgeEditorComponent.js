    ...
    constructor(entity, options) {
        ...
        this.toggleShowEditor = () => {
            ...
            if (this._showSgTree) {
                ...
                instance_1.ige._sgTreeUpdateInterval = setInterval(() => { self.sgTreeUpdate(); }, 1000);
            }
            else {
                // Kill interval
        ...
        instance_1.ige.sync(instance_1.ige.requireScript, [igeRoot + "engine/components/editor/react/build/static/js/main.min.js", undefined]);
