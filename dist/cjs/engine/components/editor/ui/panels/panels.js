                    ...
                    props: {
                        '_texture': {
                            ...
                            beforeRender: function (obj, propItem) {
                                var textureArr = ige._textureStore, textureIndex, tex;
                        ...
                        '_cell': {
                            ...
                            // Setup the data the template needs to render correctly
                            beforeRender: function (obj, propItem) {
                                var cellIndex, columns, rows, width, height, xScale, yScale, x, y;
                                // Setup an array for the textures
                                propItem.images = [];
                        ...
                        '_isometricMounts': {
                            ...
                            beforeRender: function (obj, propItem) {
                                ...
                                propItem.list = [{
                                        value: 'yes',
                                        text: 'Yes',
                                        selected: obj._mountMode === IgeMountMode_1.IgeMountMode.iso ? true : false
                                    }, {
                                        value: 'no',
                                        text: 'No',
                                        selected: obj._mountMode === IgeMountMode_1.IgeMountMode.flat ? true : false
                                    }];
                            },
                            // Enable any listeners and logic to take action when the user interacts with the panel
                            afterRender: function (obj, propItem) {
...
showPanelByInstance: function (obj) {
    if (obj) {
        var classArr = ige.getClassDerivedList(obj), classIndex, className;
...
_buildPanelHtml: function (props, obj) {
    if (obj) {
        ...
        var self = this, groupProps = props.groups, propName, item;
        if (groupProps) {
                ...
                if (groupProps.hasOwnProperty(propName)) {
                    ...
                    (function (groupData) {
                        ...
                        ige.editor.template(igeRoot + 'components/editor/ui/panels/templates/group.html', function (err, template) {
                            if (!err) {
                                var groupSelector = $($.parseHTML(template.render(groupData))), propName, propItem, properties = groupData.props;
                                    ...
                                    if (properties.hasOwnProperty(propName)) {
                                        ...
                                        (function (propData) {
                                            ...
                                            if (propData.obj && (propData.alwaysShow || propData.obj[propData.id])) {
                                                var igeClass, propertyTemplateUrl;
                                                ...
                                                if (propertyTemplateUrl) {
                                                    ...
                                                    ige.editor.template(propertyTemplateUrl, function (err, template) {
                                                        if (!err) {
                                                            var propSelector, updateMethod;
                                                            updateMethod = function () {
                                                                // Remove existing property panel section
                                                                var existingSelector = $('#igeEditorProperty_' + propData.id), existingData = existingSelector.data('igePanelUpdate');
