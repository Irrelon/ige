...
}
{
    ...
    _dialogOrder = 200010;
    ige;
    requireStylesheet(igeRoot + 'components/editor/ui/dialogs/dialogs.css');
    ;
}
ready: function () {
    var self = this;
...
create: function (dialogData) {
    var self = this;
    self._dialogOrder += 2;
    dialogData.id = dialogData.id || (0, utils_1.newIdHex)();
    ...
    ige.editor.renderTemplate(igeRoot + 'components/editor/ui/dialogs/templates/dialog.html', dialogData, function (err, dialogElem) {
        if (!err) {
            ...
            if (dialogData.contentTemplate) {
                ige.editor.renderTemplate(dialogData.contentTemplate, dialogData.contentData || {}, function (err, contentElem) {
                    if (!err) {
                        /*dialogElem.animate({
                            'opacity': 1.0
                        }, 300);*/
...
confirm: function (dialogOptions) {
    dialogOptions.id = dialogOptions.id || (0, utils_1.newIdHex)();
