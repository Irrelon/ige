    ...
    constructor(entity, options) {
        ...
        this._pointerDown = (event) => {
            if (!this._opStarted && this._enabled && this._targetEntity) {
                ...
                this._opStarted = false;
                document.getElementById("igeSgEditorStatus").innerHTML = "Degrees: " + (0, utils_1.radiansToDegrees)(this._targetEntity._rotate.z);
            }
        };
        /**
        ...
        this._pointerMove = (event) => {
            if (this._enabled && this._targetEntity) {
                ...
                if (this._opStartMouse) {
                    const curMousePos = this._ige._pointerPos, rotateCords = {
                    ...
                    if (this._opPreStart) {
                        ...
                        if (Math.abs(distX) > this._startThreshold) {
                            this._targetEntity.rotateTo(this._targetEntity._rotate.x, this._targetEntity._rotate.y, (0, utils_1.degreesToRadians)(-distX));
