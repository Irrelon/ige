...
//package structure
if (typeof exports.Box2D.Collision === "undefined") exports.Box2D.Collision = {};
if (typeof exports.Box2D.Collision.Shapes === "undefined") exports.Box2D.Collision.Shapes = {};
if (typeof exports.Box2D.Common === "undefined") exports.Box2D.Common = {};
if (typeof exports.Box2D.Common.Math === "undefined") exports.Box2D.Common.Math = {};
if (typeof exports.Box2D.Dynamics === "undefined") exports.Box2D.Dynamics = {};
if (typeof exports.Box2D.Dynamics.Contacts === "undefined") exports.Box2D.Dynamics.Contacts = {};
if (typeof exports.Box2D.Dynamics.Controllers === "undefined") exports.Box2D.Dynamics.Controllers = {};
if (typeof exports.Box2D.Dynamics.Joints === "undefined") exports.Box2D.Dynamics.Joints = {};
//pre-definitions
(function () {
...
(function () {
	const b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape,
		b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef,
		b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape,
		b2MassData = exports.Box2D.Collision.Shapes.b2MassData,
		b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape,
		b2Shape = exports.Box2D.Collision.Shapes.b2Shape,
		b2Color = exports.Box2D.Common.b2Color,
		b2internal = exports.Box2D.Common.b2internal,
		b2Settings = exports.Box2D.Common.b2Settings,
		b2Mat22 = exports.Box2D.Common.Math.b2Mat22,
		b2Mat33 = exports.Box2D.Common.Math.b2Mat33,
		b2Math = exports.Box2D.Common.Math.b2Math,
		b2Sweep = exports.Box2D.Common.Math.b2Sweep,
		b2Transform = exports.Box2D.Common.Math.b2Transform,
		b2Vec2 = exports.Box2D.Common.Math.b2Vec2,
		b2Vec3 = exports.Box2D.Common.Math.b2Vec3,
		b2AABB = exports.Box2D.Collision.b2AABB,
		b2Bound = exports.Box2D.Collision.b2Bound,
		b2BoundValues = exports.Box2D.Collision.b2BoundValues,
		b2Collision = exports.Box2D.Collision.b2Collision,
		b2ContactID = exports.Box2D.Collision.b2ContactID,
		b2ContactPoint = exports.Box2D.Collision.b2ContactPoint,
		b2Distance = exports.Box2D.Collision.b2Distance,
		b2DistanceInput = exports.Box2D.Collision.b2DistanceInput,
		b2DistanceOutput = exports.Box2D.Collision.b2DistanceOutput,
		b2DistanceProxy = exports.Box2D.Collision.b2DistanceProxy,
		b2DynamicTree = exports.Box2D.Collision.b2DynamicTree,
		b2DynamicTreeBroadPhase = exports.Box2D.Collision.b2DynamicTreeBroadPhase,
		b2DynamicTreeNode = exports.Box2D.Collision.b2DynamicTreeNode,
		b2DynamicTreePair = exports.Box2D.Collision.b2DynamicTreePair,
		b2Manifold = exports.Box2D.Collision.b2Manifold,
		b2ManifoldPoint = exports.Box2D.Collision.b2ManifoldPoint,
		b2Point = exports.Box2D.Collision.b2Point,
		b2RayCastInput = exports.Box2D.Collision.b2RayCastInput,
		b2RayCastOutput = exports.Box2D.Collision.b2RayCastOutput,
		b2Segment = exports.Box2D.Collision.b2Segment,
		b2SeparationFunction = exports.Box2D.Collision.b2SeparationFunction,
		b2Simplex = exports.Box2D.Collision.b2Simplex,
		b2SimplexCache = exports.Box2D.Collision.b2SimplexCache,
		b2SimplexVertex = exports.Box2D.Collision.b2SimplexVertex,
		b2TimeOfImpact = exports.Box2D.Collision.b2TimeOfImpact,
		b2TOIInput = exports.Box2D.Collision.b2TOIInput,
		b2WorldManifold = exports.Box2D.Collision.b2WorldManifold,
		ClipVertex = exports.Box2D.Collision.ClipVertex,
		Features = exports.Box2D.Collision.Features,
		IBroadPhase = exports.Box2D.Collision.IBroadPhase;
	...
	b2DynamicTree.prototype.InsertLeaf = function (leaf) {
		...
		if (sibling.IsLeaf() == false) {
			do {
				...
				const norm1 =
					Math.abs((child1.aabb.lowerBound.x + child1.aabb.upperBound.x) / 2 - center.x) +
					Math.abs((child1.aabb.lowerBound.y + child1.aabb.upperBound.y) / 2 - center.y);
				const norm2 =
					Math.abs((child2.aabb.lowerBound.x + child2.aabb.upperBound.x) / 2 - center.x) +
...
(function () {
	const b2Color = exports.Box2D.Common.b2Color,
		b2internal = exports.Box2D.Common.b2internal,
		b2Settings = exports.Box2D.Common.b2Settings,
		b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape,
		b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef,
		b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape,
		b2MassData = exports.Box2D.Collision.Shapes.b2MassData,
		b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape,
		...
		b2Vec2 = exports.Box2D.Common.Math.b2Vec2,
		b2Vec3 = exports.Box2D.Common.Math.b2Vec3,
		b2Body = exports.Box2D.Dynamics.b2Body,
		b2BodyDef = exports.Box2D.Dynamics.b2BodyDef,
		b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter,
		b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse,
		b2ContactListener = exports.Box2D.Dynamics.b2ContactListener,
		b2ContactManager = exports.Box2D.Dynamics.b2ContactManager,
		b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw,
		b2DestructionListener = exports.Box2D.Dynamics.b2DestructionListener,
		b2FilterData = exports.Box2D.Dynamics.b2FilterData,
		b2Fixture = exports.Box2D.Dynamics.b2Fixture,
		b2FixtureDef = exports.Box2D.Dynamics.b2FixtureDef,
		b2Island = exports.Box2D.Dynamics.b2Island,
		b2TimeStep = exports.Box2D.Dynamics.b2TimeStep,
		b2World = exports.Box2D.Dynamics.b2World,
		b2AABB = exports.Box2D.Collision.b2AABB,
		b2Bound = exports.Box2D.Collision.b2Bound,
		b2BoundValues = exports.Box2D.Collision.b2BoundValues,
		b2Collision = exports.Box2D.Collision.b2Collision,
...
(function () {
	...
	exports.Box2D.postDefs.push(function () {
		...
		exports.Box2D.Common.b2Settings.b2_maxTranslationSquared =
...
(function () {
	const b2AABB = exports.Box2D.Collision.b2AABB,
		b2Color = exports.Box2D.Common.b2Color,
		b2internal = exports.Box2D.Common.b2internal,
		b2Settings = exports.Box2D.Common.b2Settings,
		b2Mat22 = exports.Box2D.Common.Math.b2Mat22,
	...
	exports.Box2D.postDefs.push(function () {
		...
		exports.Box2D.Common.Math.b2Math.b2Transform_identity = new b2Transform(
			b2Math.b2Vec2_zero,
...
(function () {
	const b2ControllerEdge = exports.Box2D.Dynamics.Controllers.b2ControllerEdge,
		b2Mat22 = exports.Box2D.Common.Math.b2Mat22,
		b2Mat33 = exports.Box2D.Common.Math.b2Mat33,
		b2Math = exports.Box2D.Common.Math.b2Math,
		b2Sweep = exports.Box2D.Common.Math.b2Sweep,
		...
		b2TimeStep = exports.Box2D.Dynamics.b2TimeStep,
		b2World = exports.Box2D.Dynamics.b2World,
		b2CircleContact = exports.Box2D.Dynamics.Contacts.b2CircleContact,
		b2Contact = exports.Box2D.Dynamics.Contacts.b2Contact,
		b2ContactConstraint = exports.Box2D.Dynamics.Contacts.b2ContactConstraint,
		b2ContactConstraintPoint = exports.Box2D.Dynamics.Contacts.b2ContactConstraintPoint,
		b2ContactEdge = exports.Box2D.Dynamics.Contacts.b2ContactEdge,
		b2ContactFactory = exports.Box2D.Dynamics.Contacts.b2ContactFactory,
		b2ContactRegister = exports.Box2D.Dynamics.Contacts.b2ContactRegister,
		b2ContactResult = exports.Box2D.Dynamics.Contacts.b2ContactResult,
		b2ContactSolver = exports.Box2D.Dynamics.Contacts.b2ContactSolver,
		b2EdgeAndCircleContact = exports.Box2D.Dynamics.Contacts.b2EdgeAndCircleContact,
		b2NullContact = exports.Box2D.Dynamics.Contacts.b2NullContact,
		b2PolyAndCircleContact = exports.Box2D.Dynamics.Contacts.b2PolyAndCircleContact,
		b2PolyAndEdgeContact = exports.Box2D.Dynamics.Contacts.b2PolyAndEdgeContact,
		b2PolygonContact = exports.Box2D.Dynamics.Contacts.b2PolygonContact,
		b2PositionSolverManifold = exports.Box2D.Dynamics.Contacts.b2PositionSolverManifold,
		b2Controller = exports.Box2D.Dynamics.Controllers.b2Controller,
		b2DistanceJoint = exports.Box2D.Dynamics.Joints.b2DistanceJoint,
		b2DistanceJointDef = exports.Box2D.Dynamics.Joints.b2DistanceJointDef,
		b2FrictionJoint = exports.Box2D.Dynamics.Joints.b2FrictionJoint,
		b2FrictionJointDef = exports.Box2D.Dynamics.Joints.b2FrictionJointDef,
		b2GearJoint = exports.Box2D.Dynamics.Joints.b2GearJoint,
		b2GearJointDef = exports.Box2D.Dynamics.Joints.b2GearJointDef,
		b2Jacobian = exports.Box2D.Dynamics.Joints.b2Jacobian,
		b2Joint = exports.Box2D.Dynamics.Joints.b2Joint,
		b2JointDef = exports.Box2D.Dynamics.Joints.b2JointDef,
		b2JointEdge = exports.Box2D.Dynamics.Joints.b2JointEdge,
		b2LineJoint = exports.Box2D.Dynamics.Joints.b2LineJoint,
		b2LineJointDef = exports.Box2D.Dynamics.Joints.b2LineJointDef,
		b2MouseJoint = exports.Box2D.Dynamics.Joints.b2MouseJoint,
		b2MouseJointDef = exports.Box2D.Dynamics.Joints.b2MouseJointDef,
		b2PrismaticJoint = exports.Box2D.Dynamics.Joints.b2PrismaticJoint,
		b2PrismaticJointDef = exports.Box2D.Dynamics.Joints.b2PrismaticJointDef,
		b2PulleyJoint = exports.Box2D.Dynamics.Joints.b2PulleyJoint,
		b2PulleyJointDef = exports.Box2D.Dynamics.Joints.b2PulleyJointDef,
		b2RevoluteJoint = exports.Box2D.Dynamics.Joints.b2RevoluteJoint,
		b2RevoluteJointDef = exports.Box2D.Dynamics.Joints.b2RevoluteJointDef,
		b2WeldJoint = exports.Box2D.Dynamics.Joints.b2WeldJoint,
...
(function () {
	...
	b2CircleContact.prototype.Evaluate = function () {
		...
		b2Collision.CollideCircles(
			this.m_manifold,
			this.m_fixtureA.GetShape() instanceof b2CircleShape ? this.m_fixtureA.GetShape() : null,
			bA.m_xf,
	...
	b2PolyAndEdgeContact.prototype.Evaluate = function () {
		...
		this.b2CollidePolyAndEdge(
			...
			this.m_fixtureA.GetShape() instanceof b2PolygonShape ? this.m_fixtureA.GetShape() : null,
			bA.m_xf,
			this.m_fixtureB.GetShape() instanceof b2EdgeShape ? this.m_fixtureB.GetShape() : null,
			bB.m_xf
		);
	};
...
(function () {
	const b2Body = exports.Box2D.Dynamics.b2Body,
		b2BodyDef = exports.Box2D.Dynamics.b2BodyDef,
		b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter,
		b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse,
		b2ContactListener = exports.Box2D.Dynamics.b2ContactListener,
		...
		b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape,
		b2Shape = exports.Box2D.Collision.Shapes.b2Shape,
		b2BuoyancyController = exports.Box2D.Dynamics.Controllers.b2BuoyancyController,
		b2ConstantAccelController = exports.Box2D.Dynamics.Controllers.b2ConstantAccelController,
		b2ConstantForceController = exports.Box2D.Dynamics.Controllers.b2ConstantForceController,
		b2Controller = exports.Box2D.Dynamics.Controllers.b2Controller,
		b2ControllerEdge = exports.Box2D.Dynamics.Controllers.b2ControllerEdge,
		b2GravityController = exports.Box2D.Dynamics.Controllers.b2GravityController,
		b2TensorDampingController = exports.Box2D.Dynamics.Controllers.b2TensorDampingController;
	...
	b2ConstantAccelController.prototype.Step = function (step) {
		...
		for (let i = this.m_bodyList; i; i = i.nextBody) {
			...
			body.SetLinearVelocity(
				new b2Vec2(body.GetLinearVelocity().x + smallA.x, body.GetLinearVelocity().y + smallA.y)
			);
		}
	};
...
(function () {
	...
	b2LineJoint.prototype.SolveVelocityConstraints = function (step) {
		...
		if (this.m_enableMotor && this.m_limitState != b2Joint.e_equalLimits) {
			const Cdot =
				this.m_axis.x * (v2.x - v1.x) + this.m_axis.y * (v2.y - v1.y) + this.m_a2 * w2 - this.m_a1 * w1;
	...
	b2PrismaticJoint.prototype.GetReactionForce = function (inv_dt) {
		if (inv_dt === undefined) inv_dt = 0;
		return new b2Vec2(
			inv_dt * (this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.x),
	...
	b2PrismaticJoint.prototype.InitVelocityConstraints = function (step) {
		...
		if (step.warmStarting) {
			...
			const L1 =
				this.m_impulse.x * this.m_s1 + this.m_impulse.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_a1;
			const L2 =
				this.m_impulse.x * this.m_s2 + this.m_impulse.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_a2;
			bA.m_linearVelocity.x -= this.m_invMassA * PX;
			bA.m_linearVelocity.y -= this.m_invMassA * PY;
			bA.m_angularVelocity -= this.m_invIA * L1;
			bB.m_linearVelocity.x += this.m_invMassB * PX;
...
let i;
for (i = 0; i < exports.Box2D.postDefs.length; ++i) exports.Box2D.postDefs[i]();
