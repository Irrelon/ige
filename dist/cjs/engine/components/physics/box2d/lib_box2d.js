...
const Vector = Array;
const Vector_a2j_Number = exports.Box2D.NVector;
//package structure
if (typeof exports.Box2D.Collision === "undefined")
    exports.Box2D.Collision = {};
if (typeof exports.Box2D.Collision.Shapes === "undefined")
    exports.Box2D.Collision.Shapes = {};
if (typeof exports.Box2D.Common === "undefined")
    exports.Box2D.Common = {};
if (typeof exports.Box2D.Common.Math === "undefined")
    exports.Box2D.Common.Math = {};
if (typeof exports.Box2D.Dynamics === "undefined")
    exports.Box2D.Dynamics = {};
if (typeof exports.Box2D.Dynamics.Contacts === "undefined")
    exports.Box2D.Dynamics.Contacts = {};
if (typeof exports.Box2D.Dynamics.Controllers === "undefined")
    exports.Box2D.Dynamics.Controllers = {};
if (typeof exports.Box2D.Dynamics.Joints === "undefined")
    exports.Box2D.Dynamics.Joints = {};
//pre-definitions
(function () {
    exports.Box2D.Collision.IBroadPhase = "Box2D.Collision.IBroadPhase";
    function b2AABB() {
        b2AABB.b2AABB.apply(this, arguments);
    }
    exports.Box2D.Collision.b2AABB = b2AABB;
    function b2Bound() {
        b2Bound.b2Bound.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Bound = b2Bound;
    function b2BoundValues() {
        b2BoundValues.b2BoundValues.apply(this, arguments);
        if (this.constructor === b2BoundValues)
            this.b2BoundValues.apply(this, arguments);
    }
    exports.Box2D.Collision.b2BoundValues = b2BoundValues;
    function b2Collision() {
        b2Collision.b2Collision.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Collision = b2Collision;
    function b2ContactID() {
        b2ContactID.b2ContactID.apply(this, arguments);
        if (this.constructor === b2ContactID)
            this.b2ContactID.apply(this, arguments);
    }
    exports.Box2D.Collision.b2ContactID = b2ContactID;
    function b2ContactPoint() {
        b2ContactPoint.b2ContactPoint.apply(this, arguments);
    }
    exports.Box2D.Collision.b2ContactPoint = b2ContactPoint;
    function b2Distance() {
        b2Distance.b2Distance.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Distance = b2Distance;
    function b2DistanceInput() {
        b2DistanceInput.b2DistanceInput.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DistanceInput = b2DistanceInput;
    function b2DistanceOutput() {
        b2DistanceOutput.b2DistanceOutput.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DistanceOutput = b2DistanceOutput;
    function b2DistanceProxy() {
        b2DistanceProxy.b2DistanceProxy.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DistanceProxy = b2DistanceProxy;
    function b2DynamicTree() {
        b2DynamicTree.b2DynamicTree.apply(this, arguments);
        if (this.constructor === b2DynamicTree)
            this.b2DynamicTree.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DynamicTree = b2DynamicTree;
    function b2DynamicTreeBroadPhase() {
        b2DynamicTreeBroadPhase.b2DynamicTreeBroadPhase.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DynamicTreeBroadPhase = b2DynamicTreeBroadPhase;
    function b2DynamicTreeNode() {
        b2DynamicTreeNode.b2DynamicTreeNode.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DynamicTreeNode = b2DynamicTreeNode;
    function b2DynamicTreePair() {
        b2DynamicTreePair.b2DynamicTreePair.apply(this, arguments);
    }
    exports.Box2D.Collision.b2DynamicTreePair = b2DynamicTreePair;
    function b2Manifold() {
        b2Manifold.b2Manifold.apply(this, arguments);
        if (this.constructor === b2Manifold)
            this.b2Manifold.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Manifold = b2Manifold;
    function b2ManifoldPoint() {
        b2ManifoldPoint.b2ManifoldPoint.apply(this, arguments);
        if (this.constructor === b2ManifoldPoint)
            this.b2ManifoldPoint.apply(this, arguments);
    }
    exports.Box2D.Collision.b2ManifoldPoint = b2ManifoldPoint;
    function b2Point() {
        b2Point.b2Point.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Point = b2Point;
    function b2RayCastInput() {
        b2RayCastInput.b2RayCastInput.apply(this, arguments);
        if (this.constructor === b2RayCastInput)
            this.b2RayCastInput.apply(this, arguments);
    }
    exports.Box2D.Collision.b2RayCastInput = b2RayCastInput;
    function b2RayCastOutput() {
        b2RayCastOutput.b2RayCastOutput.apply(this, arguments);
    }
    exports.Box2D.Collision.b2RayCastOutput = b2RayCastOutput;
    function b2Segment() {
        b2Segment.b2Segment.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Segment = b2Segment;
    function b2SeparationFunction() {
        b2SeparationFunction.b2SeparationFunction.apply(this, arguments);
    }
    exports.Box2D.Collision.b2SeparationFunction = b2SeparationFunction;
    function b2Simplex() {
        b2Simplex.b2Simplex.apply(this, arguments);
        if (this.constructor === b2Simplex)
            this.b2Simplex.apply(this, arguments);
    }
    exports.Box2D.Collision.b2Simplex = b2Simplex;
    function b2SimplexCache() {
        b2SimplexCache.b2SimplexCache.apply(this, arguments);
    }
    exports.Box2D.Collision.b2SimplexCache = b2SimplexCache;
    function b2SimplexVertex() {
        b2SimplexVertex.b2SimplexVertex.apply(this, arguments);
    }
    exports.Box2D.Collision.b2SimplexVertex = b2SimplexVertex;
    function b2TimeOfImpact() {
        b2TimeOfImpact.b2TimeOfImpact.apply(this, arguments);
    }
    exports.Box2D.Collision.b2TimeOfImpact = b2TimeOfImpact;
    function b2TOIInput() {
        b2TOIInput.b2TOIInput.apply(this, arguments);
    }
    exports.Box2D.Collision.b2TOIInput = b2TOIInput;
    function b2WorldManifold() {
        b2WorldManifold.b2WorldManifold.apply(this, arguments);
        if (this.constructor === b2WorldManifold)
            this.b2WorldManifold.apply(this, arguments);
    }
    exports.Box2D.Collision.b2WorldManifold = b2WorldManifold;
    function ClipVertex() {
        ClipVertex.ClipVertex.apply(this, arguments);
    }
    exports.Box2D.Collision.ClipVertex = ClipVertex;
    function Features() {
        Features.Features.apply(this, arguments);
    }
    exports.Box2D.Collision.Features = Features;
    function b2CircleShape() {
        b2CircleShape.b2CircleShape.apply(this, arguments);
        if (this.constructor === b2CircleShape)
            this.b2CircleShape.apply(this, arguments);
    }
    exports.Box2D.Collision.Shapes.b2CircleShape = b2CircleShape;
    function b2EdgeChainDef() {
        b2EdgeChainDef.b2EdgeChainDef.apply(this, arguments);
        if (this.constructor === b2EdgeChainDef)
            this.b2EdgeChainDef.apply(this, arguments);
    }
    exports.Box2D.Collision.Shapes.b2EdgeChainDef = b2EdgeChainDef;
    function b2EdgeShape() {
        b2EdgeShape.b2EdgeShape.apply(this, arguments);
        if (this.constructor === b2EdgeShape)
            this.b2EdgeShape.apply(this, arguments);
    }
    exports.Box2D.Collision.Shapes.b2EdgeShape = b2EdgeShape;
    function b2MassData() {
        b2MassData.b2MassData.apply(this, arguments);
    }
    exports.Box2D.Collision.Shapes.b2MassData = b2MassData;
    function b2PolygonShape() {
        b2PolygonShape.b2PolygonShape.apply(this, arguments);
        if (this.constructor === b2PolygonShape)
            this.b2PolygonShape.apply(this, arguments);
    }
    exports.Box2D.Collision.Shapes.b2PolygonShape = b2PolygonShape;
    function b2Shape() {
        b2Shape.b2Shape.apply(this, arguments);
        if (this.constructor === b2Shape)
            this.b2Shape.apply(this, arguments);
    }
    exports.Box2D.Collision.Shapes.b2Shape = b2Shape;
    exports.Box2D.Common.b2internal = "Box2D.Common.b2internal";
    function b2Color() {
        b2Color.b2Color.apply(this, arguments);
        if (this.constructor === b2Color)
            this.b2Color.apply(this, arguments);
    }
    exports.Box2D.Common.b2Color = b2Color;
    function b2Settings() {
        b2Settings.b2Settings.apply(this, arguments);
    }
    exports.Box2D.Common.b2Settings = b2Settings;
    function b2Mat22() {
        b2Mat22.b2Mat22.apply(this, arguments);
        if (this.constructor === b2Mat22)
            this.b2Mat22.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Mat22 = b2Mat22;
    function b2Mat33() {
        b2Mat33.b2Mat33.apply(this, arguments);
        if (this.constructor === b2Mat33)
            this.b2Mat33.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Mat33 = b2Mat33;
    function b2Math() {
        b2Math.b2Math.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Math = b2Math;
    function b2Sweep() {
        b2Sweep.b2Sweep.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Sweep = b2Sweep;
    function b2Transform() {
        b2Transform.b2Transform.apply(this, arguments);
        if (this.constructor === b2Transform)
            this.b2Transform.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Transform = b2Transform;
    function b2Vec2() {
        b2Vec2.b2Vec2.apply(this, arguments);
        if (this.constructor === b2Vec2)
            this.b2Vec2.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Vec2 = b2Vec2;
    function b2Vec3() {
        b2Vec3.b2Vec3.apply(this, arguments);
        if (this.constructor === b2Vec3)
            this.b2Vec3.apply(this, arguments);
    }
    exports.Box2D.Common.Math.b2Vec3 = b2Vec3;
    function b2Body() {
        b2Body.b2Body.apply(this, arguments);
        if (this.constructor === b2Body)
            this.b2Body.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2Body = b2Body;
    function b2BodyDef() {
        b2BodyDef.b2BodyDef.apply(this, arguments);
        if (this.constructor === b2BodyDef)
            this.b2BodyDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2BodyDef = b2BodyDef;
    function b2ContactFilter() {
        b2ContactFilter.b2ContactFilter.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2ContactFilter = b2ContactFilter;
    function b2ContactImpulse() {
        b2ContactImpulse.b2ContactImpulse.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2ContactImpulse = b2ContactImpulse;
    function b2ContactListener() {
        b2ContactListener.b2ContactListener.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2ContactListener = b2ContactListener;
    function b2ContactManager() {
        b2ContactManager.b2ContactManager.apply(this, arguments);
        if (this.constructor === b2ContactManager)
            this.b2ContactManager.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2ContactManager = b2ContactManager;
    function b2DebugDraw() {
        b2DebugDraw.b2DebugDraw.apply(this, arguments);
        if (this.constructor === b2DebugDraw)
            this.b2DebugDraw.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2DebugDraw = b2DebugDraw;
    function b2DestructionListener() {
        b2DestructionListener.b2DestructionListener.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2DestructionListener = b2DestructionListener;
    function b2FilterData() {
        b2FilterData.b2FilterData.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2FilterData = b2FilterData;
    function b2Fixture() {
        b2Fixture.b2Fixture.apply(this, arguments);
        if (this.constructor === b2Fixture)
            this.b2Fixture.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2Fixture = b2Fixture;
    function b2FixtureDef() {
        b2FixtureDef.b2FixtureDef.apply(this, arguments);
        if (this.constructor === b2FixtureDef)
            this.b2FixtureDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2FixtureDef = b2FixtureDef;
    function b2Island() {
        b2Island.b2Island.apply(this, arguments);
        if (this.constructor === b2Island)
            this.b2Island.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2Island = b2Island;
    function b2TimeStep() {
        b2TimeStep.b2TimeStep.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2TimeStep = b2TimeStep;
    function b2World() {
        b2World.b2World.apply(this, arguments);
        if (this.constructor === b2World)
            this.b2World.apply(this, arguments);
    }
    exports.Box2D.Dynamics.b2World = b2World;
    function b2CircleContact() {
        b2CircleContact.b2CircleContact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2CircleContact = b2CircleContact;
    function b2Contact() {
        b2Contact.b2Contact.apply(this, arguments);
        if (this.constructor === b2Contact)
            this.b2Contact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2Contact = b2Contact;
    function b2ContactConstraint() {
        b2ContactConstraint.b2ContactConstraint.apply(this, arguments);
        if (this.constructor === b2ContactConstraint)
            this.b2ContactConstraint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactConstraint = b2ContactConstraint;
    function b2ContactConstraintPoint() {
        b2ContactConstraintPoint.b2ContactConstraintPoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactConstraintPoint = b2ContactConstraintPoint;
    function b2ContactEdge() {
        b2ContactEdge.b2ContactEdge.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactEdge = b2ContactEdge;
    function b2ContactFactory() {
        b2ContactFactory.b2ContactFactory.apply(this, arguments);
        if (this.constructor === b2ContactFactory)
            this.b2ContactFactory.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactFactory = b2ContactFactory;
    function b2ContactRegister() {
        b2ContactRegister.b2ContactRegister.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactRegister = b2ContactRegister;
    function b2ContactResult() {
        b2ContactResult.b2ContactResult.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactResult = b2ContactResult;
    function b2ContactSolver() {
        b2ContactSolver.b2ContactSolver.apply(this, arguments);
        if (this.constructor === b2ContactSolver)
            this.b2ContactSolver.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2ContactSolver = b2ContactSolver;
    function b2EdgeAndCircleContact() {
        b2EdgeAndCircleContact.b2EdgeAndCircleContact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2EdgeAndCircleContact = b2EdgeAndCircleContact;
    function b2NullContact() {
        b2NullContact.b2NullContact.apply(this, arguments);
        if (this.constructor === b2NullContact)
            this.b2NullContact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2NullContact = b2NullContact;
    function b2PolyAndCircleContact() {
        b2PolyAndCircleContact.b2PolyAndCircleContact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2PolyAndCircleContact = b2PolyAndCircleContact;
    function b2PolyAndEdgeContact() {
        b2PolyAndEdgeContact.b2PolyAndEdgeContact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2PolyAndEdgeContact = b2PolyAndEdgeContact;
    function b2PolygonContact() {
        b2PolygonContact.b2PolygonContact.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2PolygonContact = b2PolygonContact;
    function b2PositionSolverManifold() {
        b2PositionSolverManifold.b2PositionSolverManifold.apply(this, arguments);
        if (this.constructor === b2PositionSolverManifold)
            this.b2PositionSolverManifold.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Contacts.b2PositionSolverManifold = b2PositionSolverManifold;
    function b2BuoyancyController() {
        b2BuoyancyController.b2BuoyancyController.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2BuoyancyController = b2BuoyancyController;
    function b2ConstantAccelController() {
        b2ConstantAccelController.b2ConstantAccelController.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2ConstantAccelController = b2ConstantAccelController;
    function b2ConstantForceController() {
        b2ConstantForceController.b2ConstantForceController.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2ConstantForceController = b2ConstantForceController;
    function b2Controller() {
        b2Controller.b2Controller.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2Controller = b2Controller;
    function b2ControllerEdge() {
        b2ControllerEdge.b2ControllerEdge.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2ControllerEdge = b2ControllerEdge;
    function b2GravityController() {
        b2GravityController.b2GravityController.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2GravityController = b2GravityController;
    function b2TensorDampingController() {
        b2TensorDampingController.b2TensorDampingController.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Controllers.b2TensorDampingController = b2TensorDampingController;
    function b2DistanceJoint() {
        b2DistanceJoint.b2DistanceJoint.apply(this, arguments);
        if (this.constructor === b2DistanceJoint)
            this.b2DistanceJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2DistanceJoint = b2DistanceJoint;
    function b2DistanceJointDef() {
        b2DistanceJointDef.b2DistanceJointDef.apply(this, arguments);
        if (this.constructor === b2DistanceJointDef)
            this.b2DistanceJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2DistanceJointDef = b2DistanceJointDef;
    function b2FrictionJoint() {
        b2FrictionJoint.b2FrictionJoint.apply(this, arguments);
        if (this.constructor === b2FrictionJoint)
            this.b2FrictionJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2FrictionJoint = b2FrictionJoint;
    function b2FrictionJointDef() {
        b2FrictionJointDef.b2FrictionJointDef.apply(this, arguments);
        if (this.constructor === b2FrictionJointDef)
            this.b2FrictionJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2FrictionJointDef = b2FrictionJointDef;
    function b2GearJoint() {
        b2GearJoint.b2GearJoint.apply(this, arguments);
        if (this.constructor === b2GearJoint)
            this.b2GearJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2GearJoint = b2GearJoint;
    function b2GearJointDef() {
        b2GearJointDef.b2GearJointDef.apply(this, arguments);
        if (this.constructor === b2GearJointDef)
            this.b2GearJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2GearJointDef = b2GearJointDef;
    function b2Jacobian() {
        b2Jacobian.b2Jacobian.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2Jacobian = b2Jacobian;
    function b2Joint() {
        b2Joint.b2Joint.apply(this, arguments);
        if (this.constructor === b2Joint)
            this.b2Joint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2Joint = b2Joint;
    function b2JointDef() {
        b2JointDef.b2JointDef.apply(this, arguments);
        if (this.constructor === b2JointDef)
            this.b2JointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2JointDef = b2JointDef;
    function b2JointEdge() {
        b2JointEdge.b2JointEdge.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2JointEdge = b2JointEdge;
    function b2LineJoint() {
        b2LineJoint.b2LineJoint.apply(this, arguments);
        if (this.constructor === b2LineJoint)
            this.b2LineJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2LineJoint = b2LineJoint;
    function b2LineJointDef() {
        b2LineJointDef.b2LineJointDef.apply(this, arguments);
        if (this.constructor === b2LineJointDef)
            this.b2LineJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2LineJointDef = b2LineJointDef;
    function b2MouseJoint() {
        b2MouseJoint.b2MouseJoint.apply(this, arguments);
        if (this.constructor === b2MouseJoint)
            this.b2MouseJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2MouseJoint = b2MouseJoint;
    function b2MouseJointDef() {
        b2MouseJointDef.b2MouseJointDef.apply(this, arguments);
        if (this.constructor === b2MouseJointDef)
            this.b2MouseJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2MouseJointDef = b2MouseJointDef;
    function b2PrismaticJoint() {
        b2PrismaticJoint.b2PrismaticJoint.apply(this, arguments);
        if (this.constructor === b2PrismaticJoint)
            this.b2PrismaticJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2PrismaticJoint = b2PrismaticJoint;
    function b2PrismaticJointDef() {
        b2PrismaticJointDef.b2PrismaticJointDef.apply(this, arguments);
        if (this.constructor === b2PrismaticJointDef)
            this.b2PrismaticJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2PrismaticJointDef = b2PrismaticJointDef;
    function b2PulleyJoint() {
        b2PulleyJoint.b2PulleyJoint.apply(this, arguments);
        if (this.constructor === b2PulleyJoint)
            this.b2PulleyJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2PulleyJoint = b2PulleyJoint;
    function b2PulleyJointDef() {
        b2PulleyJointDef.b2PulleyJointDef.apply(this, arguments);
        if (this.constructor === b2PulleyJointDef)
            this.b2PulleyJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2PulleyJointDef = b2PulleyJointDef;
    function b2RevoluteJoint() {
        b2RevoluteJoint.b2RevoluteJoint.apply(this, arguments);
        if (this.constructor === b2RevoluteJoint)
            this.b2RevoluteJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2RevoluteJoint = b2RevoluteJoint;
    function b2RevoluteJointDef() {
        b2RevoluteJointDef.b2RevoluteJointDef.apply(this, arguments);
        if (this.constructor === b2RevoluteJointDef)
            this.b2RevoluteJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2RevoluteJointDef = b2RevoluteJointDef;
    function b2WeldJoint() {
        b2WeldJoint.b2WeldJoint.apply(this, arguments);
        if (this.constructor === b2WeldJoint)
            this.b2WeldJoint.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2WeldJoint = b2WeldJoint;
    function b2WeldJointDef() {
        b2WeldJointDef.b2WeldJointDef.apply(this, arguments);
        if (this.constructor === b2WeldJointDef)
            this.b2WeldJointDef.apply(this, arguments);
    }
    exports.Box2D.Dynamics.Joints.b2WeldJointDef = b2WeldJointDef;
})(); //definitions
exports.Box2D.postDefs = [];
(function () {
    const b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape, b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef, b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape, b2MassData = exports.Box2D.Collision.Shapes.b2MassData, b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape, b2Shape = exports.Box2D.Collision.Shapes.b2Shape, b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3, b2AABB = exports.Box2D.Collision.b2AABB, b2Bound = exports.Box2D.Collision.b2Bound, b2BoundValues = exports.Box2D.Collision.b2BoundValues, b2Collision = exports.Box2D.Collision.b2Collision, b2ContactID = exports.Box2D.Collision.b2ContactID, b2ContactPoint = exports.Box2D.Collision.b2ContactPoint, b2Distance = exports.Box2D.Collision.b2Distance, b2DistanceInput = exports.Box2D.Collision.b2DistanceInput, b2DistanceOutput = exports.Box2D.Collision.b2DistanceOutput, b2DistanceProxy = exports.Box2D.Collision.b2DistanceProxy, b2DynamicTree = exports.Box2D.Collision.b2DynamicTree, b2DynamicTreeBroadPhase = exports.Box2D.Collision.b2DynamicTreeBroadPhase, b2DynamicTreeNode = exports.Box2D.Collision.b2DynamicTreeNode, b2DynamicTreePair = exports.Box2D.Collision.b2DynamicTreePair, b2Manifold = exports.Box2D.Collision.b2Manifold, b2ManifoldPoint = exports.Box2D.Collision.b2ManifoldPoint, b2Point = exports.Box2D.Collision.b2Point, b2RayCastInput = exports.Box2D.Collision.b2RayCastInput, b2RayCastOutput = exports.Box2D.Collision.b2RayCastOutput, b2Segment = exports.Box2D.Collision.b2Segment, b2SeparationFunction = exports.Box2D.Collision.b2SeparationFunction, b2Simplex = exports.Box2D.Collision.b2Simplex, b2SimplexCache = exports.Box2D.Collision.b2SimplexCache, b2SimplexVertex = exports.Box2D.Collision.b2SimplexVertex, b2TimeOfImpact = exports.Box2D.Collision.b2TimeOfImpact, b2TOIInput = exports.Box2D.Collision.b2TOIInput, b2WorldManifold = exports.Box2D.Collision.b2WorldManifold, ClipVertex = exports.Box2D.Collision.ClipVertex, Features = exports.Box2D.Collision.Features, IBroadPhase = exports.Box2D.Collision.IBroadPhase;
    ...
    b2Collision.CollidePolygonAndCircle = function (manifold, polygon, xf1, circle, xf2) {
        ...
        if (u1 <= 0.0) {
            ...
            separation =
                (cLocalX - faceCenterX) * normals[vertIndex1].x + (cLocalY - faceCenterY) * normals[vertIndex1].y;
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.b2Collision.s_incidentEdge = b2Collision.MakeClipPointVector();
        exports.Box2D.Collision.b2Collision.s_clipPoints1 = b2Collision.MakeClipPointVector();
        exports.Box2D.Collision.b2Collision.s_clipPoints2 = b2Collision.MakeClipPointVector();
        exports.Box2D.Collision.b2Collision.s_edgeAO = new Vector_a2j_Number(1);
        exports.Box2D.Collision.b2Collision.s_edgeBO = new Vector_a2j_Number(1);
        exports.Box2D.Collision.b2Collision.s_localTangent = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_localNormal = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_planePoint = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_normal = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_tangent = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_tangent2 = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_v11 = new b2Vec2();
        exports.Box2D.Collision.b2Collision.s_v12 = new b2Vec2();
        exports.Box2D.Collision.b2Collision.b2CollidePolyTempVec = new b2Vec2();
        exports.Box2D.Collision.b2Collision.b2_nullFeature = 0x000000ff;
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.b2Distance.s_simplex = new b2Simplex();
        exports.Box2D.Collision.b2Distance.s_saveA = new Vector_a2j_Number(3);
        exports.Box2D.Collision.b2Distance.s_saveB = new Vector_a2j_Number(3);
    });
    ...
    b2DynamicTree.prototype.InsertLeaf = function (leaf) {
        ...
        if (sibling.IsLeaf() == false) {
            do {
                ...
                const norm1 = Math.abs((child1.aabb.lowerBound.x + child1.aabb.upperBound.x) / 2 - center.x) +
                    Math.abs((child1.aabb.lowerBound.y + child1.aabb.upperBound.y) / 2 - center.y);
                const norm2 = Math.abs((child2.aabb.lowerBound.x + child2.aabb.upperBound.x) / 2 - center.x) +
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.b2Manifold.e_circles = 0x0001;
        exports.Box2D.Collision.b2Manifold.e_faceA = 0x0002;
        exports.Box2D.Collision.b2Manifold.e_faceB = 0x0004;
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.b2SeparationFunction.e_points = 0x01;
        exports.Box2D.Collision.b2SeparationFunction.e_faceA = 0x02;
        exports.Box2D.Collision.b2SeparationFunction.e_faceB = 0x04;
    });
    ...
    b2Simplex.prototype.WriteCache = function (cache) {
        ...
        cache.count = exports.Box2D.parseUInt(this.m_count);
        const vertices = this.m_vertices;
        for (let i = 0; i < this.m_count; i++) {
            cache.indexA[i] = exports.Box2D.parseUInt(vertices[i].indexA);
            cache.indexB[i] = exports.Box2D.parseUInt(vertices[i].indexB);
        }
    };
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.b2TimeOfImpact.b2_toiCalls = 0;
        exports.Box2D.Collision.b2TimeOfImpact.b2_toiIters = 0;
        exports.Box2D.Collision.b2TimeOfImpact.b2_toiMaxIters = 0;
        exports.Box2D.Collision.b2TimeOfImpact.b2_toiRootIters = 0;
        exports.Box2D.Collision.b2TimeOfImpact.b2_toiMaxRootIters = 0;
        exports.Box2D.Collision.b2TimeOfImpact.s_cache = new b2SimplexCache();
        exports.Box2D.Collision.b2TimeOfImpact.s_distanceInput = new b2DistanceInput();
        exports.Box2D.Collision.b2TimeOfImpact.s_xfA = new b2Transform();
        exports.Box2D.Collision.b2TimeOfImpact.s_xfB = new b2Transform();
        exports.Box2D.Collision.b2TimeOfImpact.s_fcn = new b2SeparationFunction();
        exports.Box2D.Collision.b2TimeOfImpact.s_distanceOutput = new b2DistanceOutput();
    });
...
(function () {
    const b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape, b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef, b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape, b2MassData = exports.Box2D.Collision.Shapes.b2MassData, b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape, b2Shape = exports.Box2D.Collision.Shapes.b2Shape, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3, b2Body = exports.Box2D.Dynamics.b2Body, b2BodyDef = exports.Box2D.Dynamics.b2BodyDef, b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter, b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse, b2ContactListener = exports.Box2D.Dynamics.b2ContactListener, b2ContactManager = exports.Box2D.Dynamics.b2ContactManager, b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw, b2DestructionListener = exports.Box2D.Dynamics.b2DestructionListener, b2FilterData = exports.Box2D.Dynamics.b2FilterData, b2Fixture = exports.Box2D.Dynamics.b2Fixture, b2FixtureDef = exports.Box2D.Dynamics.b2FixtureDef, b2Island = exports.Box2D.Dynamics.b2Island, b2TimeStep = exports.Box2D.Dynamics.b2TimeStep, b2World = exports.Box2D.Dynamics.b2World, b2AABB = exports.Box2D.Collision.b2AABB, b2Bound = exports.Box2D.Collision.b2Bound, b2BoundValues = exports.Box2D.Collision.b2BoundValues, b2Collision = exports.Box2D.Collision.b2Collision, b2ContactID = exports.Box2D.Collision.b2ContactID, b2ContactPoint = exports.Box2D.Collision.b2ContactPoint, b2Distance = exports.Box2D.Collision.b2Distance, b2DistanceInput = exports.Box2D.Collision.b2DistanceInput, b2DistanceOutput = exports.Box2D.Collision.b2DistanceOutput, b2DistanceProxy = exports.Box2D.Collision.b2DistanceProxy, b2DynamicTree = exports.Box2D.Collision.b2DynamicTree, b2DynamicTreeBroadPhase = exports.Box2D.Collision.b2DynamicTreeBroadPhase, b2DynamicTreeNode = exports.Box2D.Collision.b2DynamicTreeNode, b2DynamicTreePair = exports.Box2D.Collision.b2DynamicTreePair, b2Manifold = exports.Box2D.Collision.b2Manifold, b2ManifoldPoint = exports.Box2D.Collision.b2ManifoldPoint, b2Point = exports.Box2D.Collision.b2Point, b2RayCastInput = exports.Box2D.Collision.b2RayCastInput, b2RayCastOutput = exports.Box2D.Collision.b2RayCastOutput, b2Segment = exports.Box2D.Collision.b2Segment, b2SeparationFunction = exports.Box2D.Collision.b2SeparationFunction, b2Simplex = exports.Box2D.Collision.b2Simplex, b2SimplexCache = exports.Box2D.Collision.b2SimplexCache, b2SimplexVertex = exports.Box2D.Collision.b2SimplexVertex, b2TimeOfImpact = exports.Box2D.Collision.b2TimeOfImpact, b2TOIInput = exports.Box2D.Collision.b2TOIInput, b2WorldManifold = exports.Box2D.Collision.b2WorldManifold, ClipVertex = exports.Box2D.Collision.ClipVertex, Features = exports.Box2D.Collision.Features, IBroadPhase = exports.Box2D.Collision.IBroadPhase;
    exports.Box2D.inherit(b2CircleShape, exports.Box2D.Collision.Shapes.b2Shape);
    b2CircleShape.prototype.__super = exports.Box2D.Collision.Shapes.b2Shape.prototype;
    b2CircleShape.b2CircleShape = function () {
        exports.Box2D.Collision.Shapes.b2Shape.b2Shape.apply(this, arguments);
        this.m_p = new b2Vec2();
    };
    ...
    b2CircleShape.prototype.Set = function (other) {
        ...
        if (exports.Box2D.is(other, b2CircleShape)) {
    ...
    b2CircleShape.prototype.ComputeMass = function (massData, density) {
        ...
        massData.I =
            massData.mass * (0.5 * this.m_radius * this.m_radius + (this.m_p.x * this.m_p.x + this.m_p.y * this.m_p.y));
    };
    ...
    exports.Box2D.inherit(b2EdgeShape, exports.Box2D.Collision.Shapes.b2Shape);
    b2EdgeShape.prototype.__super = exports.Box2D.Collision.Shapes.b2Shape.prototype;
    ...
    exports.Box2D.inherit(b2PolygonShape, exports.Box2D.Collision.Shapes.b2Shape);
    b2PolygonShape.prototype.__super = exports.Box2D.Collision.Shapes.b2Shape.prototype;
    ...
    b2PolygonShape.prototype.Set = function (other) {
        this.__super.Set.call(this, other);
        if (exports.Box2D.is(other, b2PolygonShape)) {
    ...
    b2PolygonShape.prototype.ComputeMass = function (massData, density) {
        ...
        for (let i = 0; i < this.m_vertexCount; ++i) {
            ...
            const inty2 = k_inv3 * (0.25 * (ey1 * ey1 + ey2 * ey1 + ey2 * ey2) + (py * ey1 + py * ey2)) + 0.5 * py * py;
            I += D * (intx2 + inty2);
        }
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.Shapes.b2PolygonShape.s_mat = new b2Mat22();
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Collision.Shapes.b2Shape.e_unknownShape = parseInt(-1);
        exports.Box2D.Collision.Shapes.b2Shape.e_circleShape = 0;
        exports.Box2D.Collision.Shapes.b2Shape.e_polygonShape = 1;
        exports.Box2D.Collision.Shapes.b2Shape.e_edgeShape = 2;
        exports.Box2D.Collision.Shapes.b2Shape.e_shapeTypeCount = 3;
        exports.Box2D.Collision.Shapes.b2Shape.e_hitCollide = 1;
        exports.Box2D.Collision.Shapes.b2Shape.e_missCollide = 0;
        exports.Box2D.Collision.Shapes.b2Shape.e_startsInsideCollide = parseInt(-1);
    });
})();
(function () {
    const b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3;
    ...
    b2Color.prototype.b2Color = function (rr, gg, bb) {
        ...
        if (bb === undefined)
            bb = 0;
        this._r = exports.Box2D.parseUInt(255 * b2Math.Clamp(rr, 0.0, 1.0));
        this._g = exports.Box2D.parseUInt(255 * b2Math.Clamp(gg, 0.0, 1.0));
        this._b = exports.Box2D.parseUInt(255 * b2Math.Clamp(bb, 0.0, 1.0));
    };
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Common.b2Settings.VERSION = "2.1alpha";
        exports.Box2D.Common.b2Settings.USHRT_MAX = 0x0000ffff;
        exports.Box2D.Common.b2Settings.b2_pi = Math.PI;
        exports.Box2D.Common.b2Settings.b2_maxManifoldPoints = 2;
        exports.Box2D.Common.b2Settings.b2_aabbExtension = 0.1;
        exports.Box2D.Common.b2Settings.b2_aabbMultiplier = 2.0;
        exports.Box2D.Common.b2Settings.b2_polygonRadius = 2.0 * b2Settings.b2_linearSlop;
        exports.Box2D.Common.b2Settings.b2_linearSlop = 0.005;
        exports.Box2D.Common.b2Settings.b2_angularSlop = (2.0 / 180.0) * b2Settings.b2_pi;
        exports.Box2D.Common.b2Settings.b2_toiSlop = 8.0 * b2Settings.b2_linearSlop;
        exports.Box2D.Common.b2Settings.b2_maxTOIContactsPerIsland = 32;
        exports.Box2D.Common.b2Settings.b2_maxTOIJointsPerIsland = 32;
        exports.Box2D.Common.b2Settings.b2_velocityThreshold = 1.0;
        exports.Box2D.Common.b2Settings.b2_maxLinearCorrection = 0.2;
        exports.Box2D.Common.b2Settings.b2_maxAngularCorrection = (8.0 / 180.0) * b2Settings.b2_pi;
        exports.Box2D.Common.b2Settings.b2_maxTranslation = 2.0;
        exports.Box2D.Common.b2Settings.b2_maxTranslationSquared = b2Settings.b2_maxTranslation * b2Settings.b2_maxTranslation;
        exports.Box2D.Common.b2Settings.b2_maxRotation = 0.5 * b2Settings.b2_pi;
        exports.Box2D.Common.b2Settings.b2_maxRotationSquared = b2Settings.b2_maxRotation * b2Settings.b2_maxRotation;
        exports.Box2D.Common.b2Settings.b2_contactBaumgarte = 0.2;
        exports.Box2D.Common.b2Settings.b2_timeToSleep = 0.5;
        exports.Box2D.Common.b2Settings.b2_linearSleepTolerance = 0.01;
        exports.Box2D.Common.b2Settings.b2_angularSleepTolerance = (2.0 / 180.0) * b2Settings.b2_pi;
    });
})();
(function () {
    const b2AABB = exports.Box2D.Collision.b2AABB, b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3;
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Common.Math.b2Math.b2Vec2_zero = new b2Vec2(0.0, 0.0);
        exports.Box2D.Common.Math.b2Math.b2Mat22_identity = b2Mat22.FromVV(new b2Vec2(1.0, 0.0), new b2Vec2(0.0, 1.0));
        exports.Box2D.Common.Math.b2Math.b2Transform_identity = new b2Transform(b2Math.b2Vec2_zero, b2Math.b2Mat22_identity);
    });
...
(function () {
    const b2ControllerEdge = exports.Box2D.Dynamics.Controllers.b2ControllerEdge, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3, b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2AABB = exports.Box2D.Collision.b2AABB, b2Bound = exports.Box2D.Collision.b2Bound, b2BoundValues = exports.Box2D.Collision.b2BoundValues, b2Collision = exports.Box2D.Collision.b2Collision, b2ContactID = exports.Box2D.Collision.b2ContactID, b2ContactPoint = exports.Box2D.Collision.b2ContactPoint, b2Distance = exports.Box2D.Collision.b2Distance, b2DistanceInput = exports.Box2D.Collision.b2DistanceInput, b2DistanceOutput = exports.Box2D.Collision.b2DistanceOutput, b2DistanceProxy = exports.Box2D.Collision.b2DistanceProxy, b2DynamicTree = exports.Box2D.Collision.b2DynamicTree, b2DynamicTreeBroadPhase = exports.Box2D.Collision.b2DynamicTreeBroadPhase, b2DynamicTreeNode = exports.Box2D.Collision.b2DynamicTreeNode, b2DynamicTreePair = exports.Box2D.Collision.b2DynamicTreePair, b2Manifold = exports.Box2D.Collision.b2Manifold, b2ManifoldPoint = exports.Box2D.Collision.b2ManifoldPoint, b2Point = exports.Box2D.Collision.b2Point, b2RayCastInput = exports.Box2D.Collision.b2RayCastInput, b2RayCastOutput = exports.Box2D.Collision.b2RayCastOutput, b2Segment = exports.Box2D.Collision.b2Segment, b2SeparationFunction = exports.Box2D.Collision.b2SeparationFunction, b2Simplex = exports.Box2D.Collision.b2Simplex, b2SimplexCache = exports.Box2D.Collision.b2SimplexCache, b2SimplexVertex = exports.Box2D.Collision.b2SimplexVertex, b2TimeOfImpact = exports.Box2D.Collision.b2TimeOfImpact, b2TOIInput = exports.Box2D.Collision.b2TOIInput, b2WorldManifold = exports.Box2D.Collision.b2WorldManifold, ClipVertex = exports.Box2D.Collision.ClipVertex, Features = exports.Box2D.Collision.Features, IBroadPhase = exports.Box2D.Collision.IBroadPhase, b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape, b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef, b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape, b2MassData = exports.Box2D.Collision.Shapes.b2MassData, b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape, b2Shape = exports.Box2D.Collision.Shapes.b2Shape, b2Body = exports.Box2D.Dynamics.b2Body, b2BodyDef = exports.Box2D.Dynamics.b2BodyDef, b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter, b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse, b2ContactListener = exports.Box2D.Dynamics.b2ContactListener, b2ContactManager = exports.Box2D.Dynamics.b2ContactManager, b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw, b2DestructionListener = exports.Box2D.Dynamics.b2DestructionListener, b2FilterData = exports.Box2D.Dynamics.b2FilterData, b2Fixture = exports.Box2D.Dynamics.b2Fixture, b2FixtureDef = exports.Box2D.Dynamics.b2FixtureDef, b2Island = exports.Box2D.Dynamics.b2Island, b2TimeStep = exports.Box2D.Dynamics.b2TimeStep, b2World = exports.Box2D.Dynamics.b2World, b2CircleContact = exports.Box2D.Dynamics.Contacts.b2CircleContact, b2Contact = exports.Box2D.Dynamics.Contacts.b2Contact, b2ContactConstraint = exports.Box2D.Dynamics.Contacts.b2ContactConstraint, b2ContactConstraintPoint = exports.Box2D.Dynamics.Contacts.b2ContactConstraintPoint, b2ContactEdge = exports.Box2D.Dynamics.Contacts.b2ContactEdge, b2ContactFactory = exports.Box2D.Dynamics.Contacts.b2ContactFactory, b2ContactRegister = exports.Box2D.Dynamics.Contacts.b2ContactRegister, b2ContactResult = exports.Box2D.Dynamics.Contacts.b2ContactResult, b2ContactSolver = exports.Box2D.Dynamics.Contacts.b2ContactSolver, b2EdgeAndCircleContact = exports.Box2D.Dynamics.Contacts.b2EdgeAndCircleContact, b2NullContact = exports.Box2D.Dynamics.Contacts.b2NullContact, b2PolyAndCircleContact = exports.Box2D.Dynamics.Contacts.b2PolyAndCircleContact, b2PolyAndEdgeContact = exports.Box2D.Dynamics.Contacts.b2PolyAndEdgeContact, b2PolygonContact = exports.Box2D.Dynamics.Contacts.b2PolygonContact, b2PositionSolverManifold = exports.Box2D.Dynamics.Contacts.b2PositionSolverManifold, b2Controller = exports.Box2D.Dynamics.Controllers.b2Controller, b2DistanceJoint = exports.Box2D.Dynamics.Joints.b2DistanceJoint, b2DistanceJointDef = exports.Box2D.Dynamics.Joints.b2DistanceJointDef, b2FrictionJoint = exports.Box2D.Dynamics.Joints.b2FrictionJoint, b2FrictionJointDef = exports.Box2D.Dynamics.Joints.b2FrictionJointDef, b2GearJoint = exports.Box2D.Dynamics.Joints.b2GearJoint, b2GearJointDef = exports.Box2D.Dynamics.Joints.b2GearJointDef, b2Jacobian = exports.Box2D.Dynamics.Joints.b2Jacobian, b2Joint = exports.Box2D.Dynamics.Joints.b2Joint, b2JointDef = exports.Box2D.Dynamics.Joints.b2JointDef, b2JointEdge = exports.Box2D.Dynamics.Joints.b2JointEdge, b2LineJoint = exports.Box2D.Dynamics.Joints.b2LineJoint, b2LineJointDef = exports.Box2D.Dynamics.Joints.b2LineJointDef, b2MouseJoint = exports.Box2D.Dynamics.Joints.b2MouseJoint, b2MouseJointDef = exports.Box2D.Dynamics.Joints.b2MouseJointDef, b2PrismaticJoint = exports.Box2D.Dynamics.Joints.b2PrismaticJoint, b2PrismaticJointDef = exports.Box2D.Dynamics.Joints.b2PrismaticJointDef, b2PulleyJoint = exports.Box2D.Dynamics.Joints.b2PulleyJoint, b2PulleyJointDef = exports.Box2D.Dynamics.Joints.b2PulleyJointDef, b2RevoluteJoint = exports.Box2D.Dynamics.Joints.b2RevoluteJoint, b2RevoluteJointDef = exports.Box2D.Dynamics.Joints.b2RevoluteJointDef, b2WeldJoint = exports.Box2D.Dynamics.Joints.b2WeldJoint, b2WeldJointDef = exports.Box2D.Dynamics.Joints.b2WeldJointDef;
    ...
    b2Body.prototype.SetMassData = function (massData) {
        ...
        if (massData.I > 0.0 && (this.m_flags & b2Body.e_fixedRotationFlag) == 0) {
            this.m_I =
                massData.I -
                    this.m_mass * (massData.center.x * massData.center.x + massData.center.y * massData.center.y);
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2Body.s_xf1 = new b2Transform();
        exports.Box2D.Dynamics.b2Body.e_islandFlag = 0x0001;
        exports.Box2D.Dynamics.b2Body.e_awakeFlag = 0x0002;
        exports.Box2D.Dynamics.b2Body.e_allowSleepFlag = 0x0004;
        exports.Box2D.Dynamics.b2Body.e_bulletFlag = 0x0008;
        exports.Box2D.Dynamics.b2Body.e_fixedRotationFlag = 0x0010;
        exports.Box2D.Dynamics.b2Body.e_activeFlag = 0x0020;
        exports.Box2D.Dynamics.b2Body.b2_staticBody = 0;
        exports.Box2D.Dynamics.b2Body.b2_kinematicBody = 1;
        exports.Box2D.Dynamics.b2Body.b2_dynamicBody = 2;
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2ContactFilter.b2_defaultFilter = new b2ContactFilter();
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2ContactListener.b2_defaultListener = new b2ContactListener();
    });
    ...
    b2ContactManager.prototype.FindNewContacts = function () {
        this.m_broadPhase.UpdatePairs(exports.Box2D.generateCallback(this, this.AddPair));
    };
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2ContactManager.s_evalCP = new b2ContactPoint();
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2DebugDraw.e_shapeBit = 0x0001;
        exports.Box2D.Dynamics.b2DebugDraw.e_jointBit = 0x0002;
        exports.Box2D.Dynamics.b2DebugDraw.e_aabbBit = 0x0004;
        exports.Box2D.Dynamics.b2DebugDraw.e_pairBit = 0x0008;
        exports.Box2D.Dynamics.b2DebugDraw.e_centerOfMassBit = 0x0010;
        exports.Box2D.Dynamics.b2DebugDraw.e_controllerBit = 0x0020;
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2Island.s_impulse = new b2ContactImpulse();
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.b2World.s_timestep2 = new b2TimeStep();
        exports.Box2D.Dynamics.b2World.s_xf = new b2Transform();
        exports.Box2D.Dynamics.b2World.s_backupA = new b2Sweep();
        exports.Box2D.Dynamics.b2World.s_backupB = new b2Sweep();
        exports.Box2D.Dynamics.b2World.s_timestep = new b2TimeStep();
        exports.Box2D.Dynamics.b2World.s_queue = new Vector();
        exports.Box2D.Dynamics.b2World.s_jointColor = new b2Color(0.5, 0.8, 0.8);
        exports.Box2D.Dynamics.b2World.e_newFixture = 0x0001;
        exports.Box2D.Dynamics.b2World.e_locked = 0x0002;
    });
})();
(function () {
    const b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape, b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef, b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape, b2MassData = exports.Box2D.Collision.Shapes.b2MassData, b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape, b2Shape = exports.Box2D.Collision.Shapes.b2Shape, b2CircleContact = exports.Box2D.Dynamics.Contacts.b2CircleContact, b2Contact = exports.Box2D.Dynamics.Contacts.b2Contact, b2ContactConstraint = exports.Box2D.Dynamics.Contacts.b2ContactConstraint, b2ContactConstraintPoint = exports.Box2D.Dynamics.Contacts.b2ContactConstraintPoint, b2ContactEdge = exports.Box2D.Dynamics.Contacts.b2ContactEdge, b2ContactFactory = exports.Box2D.Dynamics.Contacts.b2ContactFactory, b2ContactRegister = exports.Box2D.Dynamics.Contacts.b2ContactRegister, b2ContactResult = exports.Box2D.Dynamics.Contacts.b2ContactResult, b2ContactSolver = exports.Box2D.Dynamics.Contacts.b2ContactSolver, b2EdgeAndCircleContact = exports.Box2D.Dynamics.Contacts.b2EdgeAndCircleContact, b2NullContact = exports.Box2D.Dynamics.Contacts.b2NullContact, b2PolyAndCircleContact = exports.Box2D.Dynamics.Contacts.b2PolyAndCircleContact, b2PolyAndEdgeContact = exports.Box2D.Dynamics.Contacts.b2PolyAndEdgeContact, b2PolygonContact = exports.Box2D.Dynamics.Contacts.b2PolygonContact, b2PositionSolverManifold = exports.Box2D.Dynamics.Contacts.b2PositionSolverManifold, b2Body = exports.Box2D.Dynamics.b2Body, b2BodyDef = exports.Box2D.Dynamics.b2BodyDef, b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter, b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse, b2ContactListener = exports.Box2D.Dynamics.b2ContactListener, b2ContactManager = exports.Box2D.Dynamics.b2ContactManager, b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw, b2DestructionListener = exports.Box2D.Dynamics.b2DestructionListener, b2FilterData = exports.Box2D.Dynamics.b2FilterData, b2Fixture = exports.Box2D.Dynamics.b2Fixture, b2FixtureDef = exports.Box2D.Dynamics.b2FixtureDef, b2Island = exports.Box2D.Dynamics.b2Island, b2TimeStep = exports.Box2D.Dynamics.b2TimeStep, b2World = exports.Box2D.Dynamics.b2World, b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3, b2AABB = exports.Box2D.Collision.b2AABB, b2Bound = exports.Box2D.Collision.b2Bound, b2BoundValues = exports.Box2D.Collision.b2BoundValues, b2Collision = exports.Box2D.Collision.b2Collision, b2ContactID = exports.Box2D.Collision.b2ContactID, b2ContactPoint = exports.Box2D.Collision.b2ContactPoint, b2Distance = exports.Box2D.Collision.b2Distance, b2DistanceInput = exports.Box2D.Collision.b2DistanceInput, b2DistanceOutput = exports.Box2D.Collision.b2DistanceOutput, b2DistanceProxy = exports.Box2D.Collision.b2DistanceProxy, b2DynamicTree = exports.Box2D.Collision.b2DynamicTree, b2DynamicTreeBroadPhase = exports.Box2D.Collision.b2DynamicTreeBroadPhase, b2DynamicTreeNode = exports.Box2D.Collision.b2DynamicTreeNode, b2DynamicTreePair = exports.Box2D.Collision.b2DynamicTreePair, b2Manifold = exports.Box2D.Collision.b2Manifold, b2ManifoldPoint = exports.Box2D.Collision.b2ManifoldPoint, b2Point = exports.Box2D.Collision.b2Point, b2RayCastInput = exports.Box2D.Collision.b2RayCastInput, b2RayCastOutput = exports.Box2D.Collision.b2RayCastOutput, b2Segment = exports.Box2D.Collision.b2Segment, b2SeparationFunction = exports.Box2D.Collision.b2SeparationFunction, b2Simplex = exports.Box2D.Collision.b2Simplex, b2SimplexCache = exports.Box2D.Collision.b2SimplexCache, b2SimplexVertex = exports.Box2D.Collision.b2SimplexVertex, b2TimeOfImpact = exports.Box2D.Collision.b2TimeOfImpact, b2TOIInput = exports.Box2D.Collision.b2TOIInput, b2WorldManifold = exports.Box2D.Collision.b2WorldManifold, ClipVertex = exports.Box2D.Collision.ClipVertex, Features = exports.Box2D.Collision.Features, IBroadPhase = exports.Box2D.Collision.IBroadPhase;
    exports.Box2D.inherit(b2CircleContact, exports.Box2D.Dynamics.Contacts.b2Contact);
    b2CircleContact.prototype.__super = exports.Box2D.Dynamics.Contacts.b2Contact.prototype;
    b2CircleContact.b2CircleContact = function () {
        exports.Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments);
    };
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.Contacts.b2Contact.e_sensorFlag = 0x0001;
        exports.Box2D.Dynamics.Contacts.b2Contact.e_continuousFlag = 0x0002;
        exports.Box2D.Dynamics.Contacts.b2Contact.e_islandFlag = 0x0004;
        exports.Box2D.Dynamics.Contacts.b2Contact.e_toiFlag = 0x0008;
        exports.Box2D.Dynamics.Contacts.b2Contact.e_touchingFlag = 0x0010;
        exports.Box2D.Dynamics.Contacts.b2Contact.e_enabledFlag = 0x0020;
        exports.Box2D.Dynamics.Contacts.b2Contact.e_filterFlag = 0x0040;
        exports.Box2D.Dynamics.Contacts.b2Contact.s_input = new b2TOIInput();
    });
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.Contacts.b2ContactSolver.s_worldManifold = new b2WorldManifold();
        exports.Box2D.Dynamics.Contacts.b2ContactSolver.s_psm = new b2PositionSolverManifold();
    });
    exports.Box2D.inherit(b2EdgeAndCircleContact, exports.Box2D.Dynamics.Contacts.b2Contact);
    b2EdgeAndCircleContact.prototype.__super = exports.Box2D.Dynamics.Contacts.b2Contact.prototype;
    ...
    exports.Box2D.inherit(b2NullContact, exports.Box2D.Dynamics.Contacts.b2Contact);
    b2NullContact.prototype.__super = exports.Box2D.Dynamics.Contacts.b2Contact.prototype;
    ...
    exports.Box2D.inherit(b2PolyAndCircleContact, exports.Box2D.Dynamics.Contacts.b2Contact);
    b2PolyAndCircleContact.prototype.__super = exports.Box2D.Dynamics.Contacts.b2Contact.prototype;
    ...
    exports.Box2D.inherit(b2PolyAndEdgeContact, exports.Box2D.Dynamics.Contacts.b2Contact);
    b2PolyAndEdgeContact.prototype.__super = exports.Box2D.Dynamics.Contacts.b2Contact.prototype;
    ...
    exports.Box2D.inherit(b2PolygonContact, exports.Box2D.Dynamics.Contacts.b2Contact);
    b2PolygonContact.prototype.__super = exports.Box2D.Dynamics.Contacts.b2Contact.prototype;
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.Contacts.b2PositionSolverManifold.circlePointA = new b2Vec2();
        exports.Box2D.Dynamics.Contacts.b2PositionSolverManifold.circlePointB = new b2Vec2();
    });
})();
(function () {
    const b2Body = exports.Box2D.Dynamics.b2Body, b2BodyDef = exports.Box2D.Dynamics.b2BodyDef, b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter, b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse, b2ContactListener = exports.Box2D.Dynamics.b2ContactListener, b2ContactManager = exports.Box2D.Dynamics.b2ContactManager, b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw, b2DestructionListener = exports.Box2D.Dynamics.b2DestructionListener, b2FilterData = exports.Box2D.Dynamics.b2FilterData, b2Fixture = exports.Box2D.Dynamics.b2Fixture, b2FixtureDef = exports.Box2D.Dynamics.b2FixtureDef, b2Island = exports.Box2D.Dynamics.b2Island, b2TimeStep = exports.Box2D.Dynamics.b2TimeStep, b2World = exports.Box2D.Dynamics.b2World, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3, b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2CircleShape = exports.Box2D.Collision.Shapes.b2CircleShape, b2EdgeChainDef = exports.Box2D.Collision.Shapes.b2EdgeChainDef, b2EdgeShape = exports.Box2D.Collision.Shapes.b2EdgeShape, b2MassData = exports.Box2D.Collision.Shapes.b2MassData, b2PolygonShape = exports.Box2D.Collision.Shapes.b2PolygonShape, b2Shape = exports.Box2D.Collision.Shapes.b2Shape, b2BuoyancyController = exports.Box2D.Dynamics.Controllers.b2BuoyancyController, b2ConstantAccelController = exports.Box2D.Dynamics.Controllers.b2ConstantAccelController, b2ConstantForceController = exports.Box2D.Dynamics.Controllers.b2ConstantForceController, b2Controller = exports.Box2D.Dynamics.Controllers.b2Controller, b2ControllerEdge = exports.Box2D.Dynamics.Controllers.b2ControllerEdge, b2GravityController = exports.Box2D.Dynamics.Controllers.b2GravityController, b2TensorDampingController = exports.Box2D.Dynamics.Controllers.b2TensorDampingController;
    exports.Box2D.inherit(b2BuoyancyController, exports.Box2D.Dynamics.Controllers.b2Controller);
    b2BuoyancyController.prototype.__super = exports.Box2D.Dynamics.Controllers.b2Controller.prototype;
    b2BuoyancyController.b2BuoyancyController = function () {
        exports.Box2D.Dynamics.Controllers.b2Controller.b2Controller.apply(this, arguments);
    ...
    exports.Box2D.inherit(b2ConstantAccelController, exports.Box2D.Dynamics.Controllers.b2Controller);
    b2ConstantAccelController.prototype.__super = exports.Box2D.Dynamics.Controllers.b2Controller.prototype;
    ...
    exports.Box2D.inherit(b2ConstantForceController, exports.Box2D.Dynamics.Controllers.b2Controller);
    b2ConstantForceController.prototype.__super = exports.Box2D.Dynamics.Controllers.b2Controller.prototype;
    ...
    exports.Box2D.inherit(b2GravityController, exports.Box2D.Dynamics.Controllers.b2Controller);
    b2GravityController.prototype.__super = exports.Box2D.Dynamics.Controllers.b2Controller.prototype;
    ...
    exports.Box2D.inherit(b2TensorDampingController, exports.Box2D.Dynamics.Controllers.b2Controller);
    b2TensorDampingController.prototype.__super = exports.Box2D.Dynamics.Controllers.b2Controller.prototype;
...
(function () {
    const b2Color = exports.Box2D.Common.b2Color, b2internal = exports.Box2D.Common.b2internal, b2Settings = exports.Box2D.Common.b2Settings, b2Mat22 = exports.Box2D.Common.Math.b2Mat22, b2Mat33 = exports.Box2D.Common.Math.b2Mat33, b2Math = exports.Box2D.Common.Math.b2Math, b2Sweep = exports.Box2D.Common.Math.b2Sweep, b2Transform = exports.Box2D.Common.Math.b2Transform, b2Vec2 = exports.Box2D.Common.Math.b2Vec2, b2Vec3 = exports.Box2D.Common.Math.b2Vec3, b2DistanceJoint = exports.Box2D.Dynamics.Joints.b2DistanceJoint, b2DistanceJointDef = exports.Box2D.Dynamics.Joints.b2DistanceJointDef, b2FrictionJoint = exports.Box2D.Dynamics.Joints.b2FrictionJoint, b2FrictionJointDef = exports.Box2D.Dynamics.Joints.b2FrictionJointDef, b2GearJoint = exports.Box2D.Dynamics.Joints.b2GearJoint, b2GearJointDef = exports.Box2D.Dynamics.Joints.b2GearJointDef, b2Jacobian = exports.Box2D.Dynamics.Joints.b2Jacobian, b2Joint = exports.Box2D.Dynamics.Joints.b2Joint, b2JointDef = exports.Box2D.Dynamics.Joints.b2JointDef, b2JointEdge = exports.Box2D.Dynamics.Joints.b2JointEdge, b2LineJoint = exports.Box2D.Dynamics.Joints.b2LineJoint, b2LineJointDef = exports.Box2D.Dynamics.Joints.b2LineJointDef, b2MouseJoint = exports.Box2D.Dynamics.Joints.b2MouseJoint, b2MouseJointDef = exports.Box2D.Dynamics.Joints.b2MouseJointDef, b2PrismaticJoint = exports.Box2D.Dynamics.Joints.b2PrismaticJoint, b2PrismaticJointDef = exports.Box2D.Dynamics.Joints.b2PrismaticJointDef, b2PulleyJoint = exports.Box2D.Dynamics.Joints.b2PulleyJoint, b2PulleyJointDef = exports.Box2D.Dynamics.Joints.b2PulleyJointDef, b2RevoluteJoint = exports.Box2D.Dynamics.Joints.b2RevoluteJoint, b2RevoluteJointDef = exports.Box2D.Dynamics.Joints.b2RevoluteJointDef, b2WeldJoint = exports.Box2D.Dynamics.Joints.b2WeldJoint, b2WeldJointDef = exports.Box2D.Dynamics.Joints.b2WeldJointDef, b2Body = exports.Box2D.Dynamics.b2Body, b2BodyDef = exports.Box2D.Dynamics.b2BodyDef, b2ContactFilter = exports.Box2D.Dynamics.b2ContactFilter, b2ContactImpulse = exports.Box2D.Dynamics.b2ContactImpulse, b2ContactListener = exports.Box2D.Dynamics.b2ContactListener, b2ContactManager = exports.Box2D.Dynamics.b2ContactManager, b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw, b2DestructionListener = exports.Box2D.Dynamics.b2DestructionListener, b2FilterData = exports.Box2D.Dynamics.b2FilterData, b2Fixture = exports.Box2D.Dynamics.b2Fixture, b2FixtureDef = exports.Box2D.Dynamics.b2FixtureDef, b2Island = exports.Box2D.Dynamics.b2Island, b2TimeStep = exports.Box2D.Dynamics.b2TimeStep, b2World = exports.Box2D.Dynamics.b2World;
    exports.Box2D.inherit(b2DistanceJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2DistanceJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    b2DistanceJoint.b2DistanceJoint = function () {
        exports.Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments);
    ...
    exports.Box2D.inherit(b2DistanceJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2DistanceJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    b2DistanceJointDef.b2DistanceJointDef = function () {
        exports.Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments);
    ...
    exports.Box2D.inherit(b2FrictionJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2FrictionJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.inherit(b2FrictionJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2FrictionJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.inherit(b2GearJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2GearJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.inherit(b2GearJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2GearJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.Joints.b2Joint.e_unknownJoint = 0;
        exports.Box2D.Dynamics.Joints.b2Joint.e_revoluteJoint = 1;
        exports.Box2D.Dynamics.Joints.b2Joint.e_prismaticJoint = 2;
        exports.Box2D.Dynamics.Joints.b2Joint.e_distanceJoint = 3;
        exports.Box2D.Dynamics.Joints.b2Joint.e_pulleyJoint = 4;
        exports.Box2D.Dynamics.Joints.b2Joint.e_mouseJoint = 5;
        exports.Box2D.Dynamics.Joints.b2Joint.e_gearJoint = 6;
        exports.Box2D.Dynamics.Joints.b2Joint.e_lineJoint = 7;
        exports.Box2D.Dynamics.Joints.b2Joint.e_weldJoint = 8;
        exports.Box2D.Dynamics.Joints.b2Joint.e_frictionJoint = 9;
        exports.Box2D.Dynamics.Joints.b2Joint.e_inactiveLimit = 0;
        exports.Box2D.Dynamics.Joints.b2Joint.e_atLowerLimit = 1;
        exports.Box2D.Dynamics.Joints.b2Joint.e_atUpperLimit = 2;
        exports.Box2D.Dynamics.Joints.b2Joint.e_equalLimits = 3;
    });
    ...
    exports.Box2D.inherit(b2LineJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2LineJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.inherit(b2LineJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2LineJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.inherit(b2MouseJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2MouseJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.inherit(b2MouseJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2MouseJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.inherit(b2PrismaticJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2PrismaticJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.inherit(b2PrismaticJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2PrismaticJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.inherit(b2PulleyJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2PulleyJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.Joints.b2PulleyJoint.b2_minPulleyLength = 2.0;
    });
    exports.Box2D.inherit(b2PulleyJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2PulleyJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.inherit(b2RevoluteJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2RevoluteJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.postDefs.push(function () {
        exports.Box2D.Dynamics.Joints.b2RevoluteJoint.tImpulse = new b2Vec2();
    });
    exports.Box2D.inherit(b2RevoluteJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2RevoluteJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
    ...
    exports.Box2D.inherit(b2WeldJoint, exports.Box2D.Dynamics.Joints.b2Joint);
    b2WeldJoint.prototype.__super = exports.Box2D.Dynamics.Joints.b2Joint.prototype;
    ...
    exports.Box2D.inherit(b2WeldJointDef, exports.Box2D.Dynamics.Joints.b2JointDef);
    b2WeldJointDef.prototype.__super = exports.Box2D.Dynamics.Joints.b2JointDef.prototype;
...
(function () {
    const b2DebugDraw = exports.Box2D.Dynamics.b2DebugDraw;
    b2DebugDraw.b2DebugDraw = function () {
    ...
    b2DebugDraw.prototype.DrawSolidCircle = function (center, radius, axis, color) {
        if (!radius)
            return;
        const s = this.m_ctx, drawScale = this.m_drawScale, cx = center.x * drawScale, cy = center.y * drawScale;
        s.moveTo(0, 0);
        s.beginPath();
        s.strokeStyle = this._color(color.color, this.m_alpha);
        s.fillStyle = this._color(color.color, this.m_fillAlpha);
    ...
    b2DebugDraw.prototype.DrawSegment = function (p1, p2, color) {
        const s = this.m_ctx, drawScale = this.m_drawScale;
        s.strokeStyle = this._color(color.color, this.m_alpha);
        s.beginPath();
...
let i;
for (i = 0; i < exports.Box2D.postDefs.length; ++i)
    exports.Box2D.postDefs[i]();
delete exports.Box2D.postDefs;
