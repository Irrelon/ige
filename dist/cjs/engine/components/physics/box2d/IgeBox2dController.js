...
class IgeBox2dController extends IgeEventingClass_1.IgeEventingClass {
    constructor() {
        ...
        this.b2Contact.prototype.igeEitherCategory = function (category1, category2) {
            if (!category2) {
                return (this.m_fixtureA.m_body._entity._category === category1 ||
        ...
        this.b2Contact.prototype.igeBothCategories = function (category) {
            return (this.m_fixtureA.m_body._entity._category === category &&
    ...
    start() {
        ...
        if (this._renderMode === IgeBox2dTimingMode_1.IgeBox2dTimingMode.matchEngine) {
            instance_1.ige.engine.addBehaviour(IgeBehaviourType_1.IgeBehaviourType.preUpdate, "box2dStep", this._behaviour);
        }
        else {
