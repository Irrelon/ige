...
const Box2D_1 = require("../../../../types/Box2D.js");
...
class IgeBox2dWorld extends IgeEventingClass_1.IgeEventingClass {
    constructor(entity, options) {
        ...
        this.b2Color = Box2D_1.Box2D.Common.b2Color;
        this.b2Vec2 = Box2D_1.Box2D.Common.Math.b2Vec2;
        this.b2Math = Box2D_1.Box2D.Common.Math.b2Math;
        this.b2Shape = Box2D_1.Box2D.Collision.Shapes.b2Shape;
        this.b2BodyDef = Box2D_1.Box2D.Dynamics.b2BodyDef;
        this.b2Body = Box2D_1.Box2D.Dynamics.b2Body;
        this.b2FixtureDef = Box2D_1.Box2D.Dynamics.b2FixtureDef;
        this.b2Fixture = Box2D_1.Box2D.Dynamics.b2Fixture;
        this.b2World = Box2D_1.Box2D.Dynamics.b2World;
        this.b2MassData = Box2D_1.Box2D.Collision.Shapes.b2MassData;
        this.b2PolygonShape = Box2D_1.Box2D.Collision.Shapes.b2PolygonShape;
        this.b2CircleShape = Box2D_1.Box2D.Collision.Shapes.b2CircleShape;
        this.b2DebugDraw = Box2D_1.Box2D.Dynamics.b2DebugDraw;
        this.b2ContactListener = Box2D_1.Box2D.Dynamics.b2ContactListener;
        this.b2Distance = Box2D_1.Box2D.Collision.b2Distance;
        this.b2Contact = Box2D_1.Box2D.Dynamics.Contacts.b2Contact;
        this.b2FilterData = Box2D_1.Box2D.Dynamics.b2FilterData;
        this.b2DistanceJointDef = Box2D_1.Box2D.Dynamics.Joints.b2DistanceJointDef;
        this._entity = entity;
        options = options || {
