...
class b2RevoluteJointDef extends b2_joint_js_1.b2JointDef {
    constructor() {
...
class b2RevoluteJoint extends b2_joint_js_1.b2Joint {
    constructor(def) {
        super(def);
        // Solver shared
        ...
        this.m_motorImpulse = 0;
        this.m_lowerAngle = (0, b2_settings_js_1.b2Maybe)(def.lowerAngle, 0);
        this.m_upperAngle = (0, b2_settings_js_1.b2Maybe)(def.upperAngle, 0);
    ...
    SolvePositionConstraints(data) {
        ...
        if (this.m_enableLimit && !fixedRotation) {
            ...
            let C = 0.0;
            if ((0, b2_math_js_1.b2Abs)(this.m_upperAngle - this.m_lowerAngle) < 2.0 * b2_settings_js_1.b2_angularSlop) {
                // Prevent large angular corrections
                C = (0, b2_math_js_1.b2Clamp)(angle - this.m_lowerAngle, -b2_settings_js_1.b2_maxAngularCorrection, b2_settings_js_1.b2_maxAngularCorrection);
            }
            else if (angle <= this.m_lowerAngle) {
                // Prevent large angular corrections and allow some slop.
                C = (0, b2_math_js_1.b2Clamp)(angle - this.m_lowerAngle + b2_settings_js_1.b2_angularSlop, -b2_settings_js_1.b2_maxAngularCorrection, 0.0);
            }
            else if (angle >= this.m_upperAngle) {
                // Prevent large angular corrections and allow some slop.
                C = (0, b2_math_js_1.b2Clamp)(angle - this.m_upperAngle - b2_settings_js_1.b2_angularSlop, 0.0, b2_settings_js_1.b2_maxAngularCorrection);
            }
            const limitImpulse = -this.m_axialMass * C;
            aA -= this.m_invIA * limitImpulse;
            aB += this.m_invIB * limitImpulse;
            angularError = (0, b2_math_js_1.b2Abs)(C);
        }
        // Solve point-to-point constraint.
        {
            qA.SetAngle(aA);
