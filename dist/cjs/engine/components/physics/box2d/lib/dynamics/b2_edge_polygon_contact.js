...
class b2EdgeAndPolygonContact extends b2_contact_js_1.b2Contact {
    static Create() {
    ...
    Evaluate(manifold, xfA, xfB) {
        (0, b2_collide_edge_js_1.b2CollideEdgeAndPolygon)(manifold, this.GetShapeA(), xfA, this.GetShapeB(), xfB);
    }
}
