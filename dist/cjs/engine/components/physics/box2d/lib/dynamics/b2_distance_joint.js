...
class b2DistanceJointDef extends b2_joint_1.b2JointDef {
    constructor() {
        ...
        this.length = 1;
        this.minLength = 0;
        this.maxLength = b2_settings_1.b2_maxFloat; // FLT_MAX;
        this.stiffness = 0;
        this.damping = 0;
    }
    Initialize(b1, b2, anchor1, anchor2) {
        ...
        this.length = (0, b2_math_1.b2Max)(b2_math_1.b2Vec2.DistanceVV(anchor1, anchor2), b2_settings_1.b2_linearSlop);
...
class b2DistanceJoint extends b2_joint_1.b2Joint {
    constructor(def) {
        ...
        this.m_length = (0, b2_math_1.b2Max)((0, b2_settings_1.b2Maybe)(def.length, this.GetCurrentLength()), b2_settings_1.b2_linearSlop);
        this.m_minLength = (0, b2_math_1.b2Max)((0, b2_settings_1.b2Maybe)(def.minLength, this.m_length), b2_settings_1.b2_linearSlop);
        this.m_maxLength = (0, b2_math_1.b2Max)((0, b2_settings_1.b2Maybe)(def.maxLength, this.m_length), this.m_minLength);
    ...
    SetLength(length) {
        this.m_impulse = 0;
        this.m_length = (0, b2_math_1.b2Max)(b2_settings_1.b2_linearSlop, length);
    ...
    SetMinLength(minLength) {
        this.m_lowerImpulse = 0;
        this.m_minLength = (0, b2_math_1.b2Clamp)(minLength, b2_settings_1.b2_linearSlop, this.m_maxLength);
        return this.m_minLength;
    }
    SetMaxLength(maxLength) {
        this.m_upperImpulse = 0;
        this.m_maxLength = (0, b2_math_1.b2Max)(maxLength, this.m_minLength);
        return this.m_maxLength;
    }
    GetCurrentLength() {
        const pA = this.m_bodyA.GetWorldPoint(this.m_localAnchorA, new b2_math_1.b2Vec2());
        const pB = this.m_bodyB.GetWorldPoint(this.m_localAnchorB, new b2_math_1.b2Vec2());
    ...
    InitVelocityConstraints(data) {
        ...
        const crAu = b2_math_1.b2Vec2.CrossVV(this.m_rA, this.m_u);
        // float32 crBu = b2Cross(m_rB, m_u);
        const crBu = b2_math_1.b2Vec2.CrossVV(this.m_rB, this.m_u);
        ...
        if (data.step.warmStarting) {
            ...
            const P = b2_math_1.b2Vec2.MulSV(this.m_impulse + this.m_lowerImpulse - this.m_upperImpulse, this.m_u, b2DistanceJoint.InitVelocityConstraints_s_P);
    ...
    SolveVelocityConstraints(data) {
        ...
        if (this.m_minLength < this.m_maxLength) {
            if (this.m_stiffness > 0) {
                ...
                const vpA = b2_math_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                const vpB = b2_math_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                const Cdot = b2_math_1.b2Vec2.DotVV(this.m_u, b2_math_1.b2Vec2.SubVV(vpB, vpA, b2_math_1.b2Vec2.s_t0));
                const impulse = -this.m_softMass * (Cdot + this.m_bias + this.m_gamma * this.m_impulse);
                this.m_impulse += impulse;
                const P = b2_math_1.b2Vec2.MulSV(impulse, this.m_u, b2DistanceJoint.SolveVelocityConstraints_s_P);
                vA.SelfMulSub(this.m_invMassA, P);
                wA -= this.m_invIA * b2_math_1.b2Vec2.CrossVV(this.m_rA, P);
                vB.SelfMulAdd(this.m_invMassB, P);
                wB += this.m_invIB * b2_math_1.b2Vec2.CrossVV(this.m_rB, P);
            ...
            // lower
            {
                ...
                const bias = (0, b2_math_1.b2Max)(0, C) * data.step.inv_dt;
                const vpA = b2_math_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                const vpB = b2_math_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                const Cdot = b2_math_1.b2Vec2.DotVV(this.m_u, b2_math_1.b2Vec2.SubVV(vpB, vpA, b2_math_1.b2Vec2.s_t0));
                let impulse = -this.m_mass * (Cdot + bias);
                const oldImpulse = this.m_lowerImpulse;
                this.m_lowerImpulse = (0, b2_math_1.b2Max)(0, this.m_lowerImpulse + impulse);
            ...
            // upper
            {
                ...
                const vpA = b2_math_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                const vpB = b2_math_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                const Cdot = b2_math_1.b2Vec2.DotVV(this.m_u, b2_math_1.b2Vec2.SubVV(vpA, vpB, b2_math_1.b2Vec2.s_t0));
                let impulse = -this.m_mass * (Cdot + bias);
                const oldImpulse = this.m_upperImpulse;
                this.m_upperImpulse = (0, b2_math_1.b2Max)(0, this.m_upperImpulse + impulse);
    ...
    SolvePositionConstraints(data) {
        ...
        const rA = b2_math_1.b2Rot.MulRV(qA, this.m_lalcA, this.m_rA); // use m_rA
        // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
        const rB = b2_math_1.b2Rot.MulRV(qB, this.m_lalcB, this.m_rB); // use m_rB
        ...
        const P = b2_math_1.b2Vec2.MulSV(impulse, u, b2DistanceJoint.SolvePositionConstraints_s_P);
        ...
        return (0, b2_math_1.b2Abs)(C) < b2_settings_1.b2_linearSlop;
    }
    Draw(draw) {
        const xfA = this.m_bodyA.GetTransform();
        const xfB = this.m_bodyB.GetTransform();
        const pA = b2_math_1.b2Transform.MulXV(xfA, this.m_localAnchorA, b2DistanceJoint.Draw_s_pA);
        const pB = b2_math_1.b2Transform.MulXV(xfB, this.m_localAnchorB, b2DistanceJoint.Draw_s_pB);
        const axis = b2_math_1.b2Vec2.SubVV(pB, pA, b2DistanceJoint.Draw_s_axis);
        axis.Normalize();
        ...
        const pRest = b2_math_1.b2Vec2.AddVMulSV(pA, this.m_length, axis, b2DistanceJoint.Draw_s_pRest);
        draw.DrawPoint(pRest, 8.0, c1);
        if (this.m_minLength != this.m_maxLength) {
            if (this.m_minLength > b2_settings_1.b2_linearSlop) {
                // b2Vec2 pMin = pA + this.m_minLength * axis;
                const pMin = b2_math_1.b2Vec2.AddVMulSV(pA, this.m_minLength, axis, b2DistanceJoint.Draw_s_pMin);
                draw.DrawPoint(pMin, 4.0, c2);
            }
            if (this.m_maxLength < b2_settings_1.b2_maxFloat) {
                // b2Vec2 pMax = pA + this.m_maxLength * axis;
                const pMax = b2_math_1.b2Vec2.AddVMulSV(pA, this.m_maxLength, axis, b2DistanceJoint.Draw_s_pMax);
