...
class b2DistanceJointDef extends b2_joint_js_1.b2JointDef {
    constructor() {
    ...
    Initialize(b1, b2, anchor1, anchor2) {
        ...
        this.length = (0, b2_math_js_1.b2Max)(b2_math_js_1.b2Vec2.DistanceVV(anchor1, anchor2), b2_settings_js_1.b2_linearSlop);
        this.minLength = this.length;
        this.maxLength = this.length;
    }
}
exports.b2DistanceJointDef = b2DistanceJointDef;
class b2DistanceJoint extends b2_joint_js_1.b2Joint {
    constructor(def) {
        super(def);
        this.m_stiffness = 0;
        this.m_damping = 0;
        ...
        this.m_length = (0, b2_math_js_1.b2Max)((0, b2_settings_js_1.b2Maybe)(def.length, this.GetCurrentLength()), b2_settings_js_1.b2_linearSlop);
        this.m_minLength = (0, b2_math_js_1.b2Max)((0, b2_settings_js_1.b2Maybe)(def.minLength, this.m_length), b2_settings_js_1.b2_linearSlop);
        this.m_maxLength = (0, b2_math_js_1.b2Max)((0, b2_settings_js_1.b2Maybe)(def.maxLength, this.m_length), this.m_minLength);
    ...
    SetLength(length) {
        this.m_impulse = 0;
        this.m_length = (0, b2_math_js_1.b2Max)(b2_settings_js_1.b2_linearSlop, length);
    ...
    SetMinLength(minLength) {
        this.m_lowerImpulse = 0;
        this.m_minLength = (0, b2_math_js_1.b2Clamp)(minLength, b2_settings_js_1.b2_linearSlop, this.m_maxLength);
        return this.m_minLength;
    }
    SetMaxLength(maxLength) {
        this.m_upperImpulse = 0;
        this.m_maxLength = (0, b2_math_js_1.b2Max)(maxLength, this.m_minLength);
    ...
    SolveVelocityConstraints(data) {
        ...
        if (this.m_minLength < this.m_maxLength) {
            ...
            // lower
            {
                ...
                const bias = (0, b2_math_js_1.b2Max)(0, C) * data.step.inv_dt;
                const vpA = b2_math_js_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                const vpB = b2_math_js_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                const Cdot = b2_math_js_1.b2Vec2.DotVV(this.m_u, b2_math_js_1.b2Vec2.SubVV(vpB, vpA, b2_math_js_1.b2Vec2.s_t0));
                let impulse = -this.m_mass * (Cdot + bias);
                const oldImpulse = this.m_lowerImpulse;
                this.m_lowerImpulse = (0, b2_math_js_1.b2Max)(0, this.m_lowerImpulse + impulse);
            ...
            // upper
            {
                ...
                this.m_upperImpulse = (0, b2_math_js_1.b2Max)(0, this.m_upperImpulse + impulse);
    ...
    SolvePositionConstraints(data) {
        ...
        return (0, b2_math_js_1.b2Abs)(C) < b2_settings_js_1.b2_linearSlop;
    }
    Draw(draw) {
