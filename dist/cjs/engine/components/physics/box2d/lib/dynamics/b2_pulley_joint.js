...
class b2PulleyJointDef extends b2_joint_js_1.b2JointDef {
    constructor() {
...
class b2PulleyJoint extends b2_joint_js_1.b2Joint {
    constructor(def) {
        super(def);
        ...
        this.m_groundAnchorA.Copy((0, b2_settings_js_1.b2Maybe)(def.groundAnchorA, new b2_math_js_1.b2Vec2(-1, 1)));
        this.m_groundAnchorB.Copy((0, b2_settings_js_1.b2Maybe)(def.groundAnchorB, new b2_math_js_1.b2Vec2(1, 0)));
        this.m_localAnchorA.Copy((0, b2_settings_js_1.b2Maybe)(def.localAnchorA, new b2_math_js_1.b2Vec2(-1, 0)));
        this.m_localAnchorB.Copy((0, b2_settings_js_1.b2Maybe)(def.localAnchorB, new b2_math_js_1.b2Vec2(1, 0)));
        this.m_lengthA = (0, b2_settings_js_1.b2Maybe)(def.lengthA, 0);
        this.m_lengthB = (0, b2_settings_js_1.b2Maybe)(def.lengthB, 0);
        // DEBUG: b2Assert(b2Maybe(def.ratio, 1) !== 0);
        this.m_ratio = (0, b2_settings_js_1.b2Maybe)(def.ratio, 1);
        this.m_constant = (0, b2_settings_js_1.b2Maybe)(def.lengthA, 0) + this.m_ratio * (0, b2_settings_js_1.b2Maybe)(def.lengthB, 0);
        this.m_impulse = 0;
    }
    ...
    SolvePositionConstraints(data) {
        ...
        const linearError = (0, b2_math_js_1.b2Abs)(C);
