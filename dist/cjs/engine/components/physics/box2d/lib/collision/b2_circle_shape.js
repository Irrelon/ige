...
class b2CircleShape extends b2_shape_js_1.b2Shape {
    ...
    TestPoint(transform, p) {
        ...
        return b2_math_js_1.b2Vec2.DotVV(d, d) <= (0, b2_math_js_1.b2Sq)(this.m_radius);
    }
    ...
    RayCast(output, input, transform, childIndex) {
        ...
        const b = b2_math_js_1.b2Vec2.DotVV(s, s) - (0, b2_math_js_1.b2Sq)(this.m_radius);
        ...
        let a = (-(c + (0, b2_math_js_1.b2Sqrt)(sigma)));
    ...
    ComputeMass(massData, density) {
        const radius_sq = (0, b2_math_js_1.b2Sq)(this.m_radius);
    ...
    ComputeSubmergedArea(normal, offset, xf, c) {
        ...
        const l2 = l * l;
        const area = r2 * ((0, b2_math_js_1.b2Asin)(l / this.m_radius) + b2_settings_js_1.b2_pi / 2) + l * (0, b2_math_js_1.b2Sqrt)(r2 - l2);
        const com = (-2 / 3 * (0, b2_math_js_1.b2Pow)(r2 - l2, 1.5) / area);
