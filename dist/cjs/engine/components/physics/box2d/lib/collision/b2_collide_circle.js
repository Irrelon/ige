...
function b2CollideCircles(manifold, circleA, xfA, circleB, xfB) {
    ...
    const pA = b2_math_1.b2Transform.MulXV(xfA, circleA.m_p, b2CollideCircles_s_pA);
    const pB = b2_math_1.b2Transform.MulXV(xfB, circleB.m_p, b2CollideCircles_s_pB);
    const distSqr = b2_math_1.b2Vec2.DistanceSquaredVV(pA, pB);
...
function b2CollidePolygonAndCircle(manifold, polygonA, xfA, circleB, xfB) {
    ...
    const c = b2_math_1.b2Transform.MulXV(xfB, circleB.m_p, b2CollidePolygonAndCircle_s_c);
    const cLocal = b2_math_1.b2Transform.MulTXV(xfA, c, b2CollidePolygonAndCircle_s_cLocal);
    // Find the min separating edge.
    let normalIndex = 0;
    let separation = (-b2_settings_1.b2_maxFloat);
    const radius = polygonA.m_radius + circleB.m_radius;
    const vertexCount = polygonA.m_count;
    const vertices = polygonA.m_vertices;
    const normals = polygonA.m_normals;
    for (let i = 0; i < vertexCount; ++i) {
        const s = b2_math_1.b2Vec2.DotVV(normals[i], b2_math_1.b2Vec2.SubVV(cLocal, vertices[i], b2_math_1.b2Vec2.s_t0));
        if (s > radius) {
            // Early out.
            return;
        }
    ...
    const u1 = b2_math_1.b2Vec2.DotVV(b2_math_1.b2Vec2.SubVV(cLocal, v1, b2_math_1.b2Vec2.s_t0), b2_math_1.b2Vec2.SubVV(v2, v1, b2_math_1.b2Vec2.s_t1));
    const u2 = b2_math_1.b2Vec2.DotVV(b2_math_1.b2Vec2.SubVV(cLocal, v2, b2_math_1.b2Vec2.s_t0), b2_math_1.b2Vec2.SubVV(v1, v2, b2_math_1.b2Vec2.s_t1));
    if (u1 <= 0) {
        ...
        const faceCenter = b2_math_1.b2Vec2.MidVV(v1, v2, b2CollidePolygonAndCircle_s_faceCenter);
        const separation = b2_math_1.b2Vec2.DotVV(b2_math_1.b2Vec2.SubVV(cLocal, faceCenter, b2_math_1.b2Vec2.s_t1), normals[vertIndex1]);
