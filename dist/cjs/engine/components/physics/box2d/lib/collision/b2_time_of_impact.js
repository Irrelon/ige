...
const b2_distance_js_1 = require("./b2_distance.js");
...
const b2TimeOfImpact_s_xfA = new b2_math_js_1.b2Transform();
const b2TimeOfImpact_s_xfB = new b2_math_js_1.b2Transform();
const b2TimeOfImpact_s_pointA = new b2_math_js_1.b2Vec2();
const b2TimeOfImpact_s_pointB = new b2_math_js_1.b2Vec2();
const b2TimeOfImpact_s_normal = new b2_math_js_1.b2Vec2();
const b2TimeOfImpact_s_axisA = new b2_math_js_1.b2Vec2();
const b2TimeOfImpact_s_axisB = new b2_math_js_1.b2Vec2();
...
const b2TimeOfImpact_s_timer = new b2_timer_js_1.b2Timer();
const b2TimeOfImpact_s_cache = new b2_distance_js_1.b2SimplexCache();
const b2TimeOfImpact_s_distanceInput = new b2_distance_js_1.b2DistanceInput();
const b2TimeOfImpact_s_distanceOutput = new b2_distance_js_1.b2DistanceOutput();
const b2TimeOfImpact_s_fcn = new b2SeparationFunction();
const b2TimeOfImpact_s_indexA = [0];
const b2TimeOfImpact_s_indexB = [0];
const b2TimeOfImpact_s_sweepA = new b2_math_js_1.b2Sweep();
const b2TimeOfImpact_s_sweepB = new b2_math_js_1.b2Sweep();
function b2TimeOfImpact(output, input) {
    ...
    const maxVertices = (0, b2_math_js_1.b2Max)(b2_settings_js_1.b2_maxPolygonVertices, (0, b2_math_js_1.b2Max)(proxyA.m_count, proxyB.m_count));
    ...
    const target = (0, b2_math_js_1.b2Max)(b2_settings_js_1.b2_linearSlop, totalRadius - 3 * b2_settings_js_1.b2_linearSlop);
    ...
    for (;;) {
        ...
        (0, b2_distance_js_1.b2Distance)(distanceOutput, cache, distanceInput);
...
*/
        ...
        for (;;) {
            ...
            for (;;) {
                ...
                if ((0, b2_math_js_1.b2Abs)(s - target) < tolerance) {
            ...
            exports.b2_toiMaxRootIters = (0, b2_math_js_1.b2Max)(exports.b2_toiMaxRootIters, rootIterCount);
            ++pushBackIter;
    ...
    exports.b2_toiMaxIters = (0, b2_math_js_1.b2Max)(exports.b2_toiMaxIters, iter);
    const time = timer.GetMilliseconds();
    exports.b2_toiMaxTime = (0, b2_math_js_1.b2Max)(exports.b2_toiMaxTime, time);
