...
class b2EdgeShape extends b2_shape_1.b2Shape {
    constructor() {
        super(b2_shape_1.b2ShapeType.e_edgeShape, b2_settings_1.b2_polygonRadius);
    ...
    ComputeDistance(xf, p, normal, childIndex) {
        const v1 = b2_math_1.b2Transform.MulXV(xf, this.m_vertex1, b2EdgeShape.ComputeDistance_s_v1);
        const v2 = b2_math_1.b2Transform.MulXV(xf, this.m_vertex2, b2EdgeShape.ComputeDistance_s_v2);
        const d = b2_math_1.b2Vec2.SubVV(p, v1, b2EdgeShape.ComputeDistance_s_d);
        const s = b2_math_1.b2Vec2.SubVV(v2, v1, b2EdgeShape.ComputeDistance_s_s);
        const ds = b2_math_1.b2Vec2.DotVV(d, s);
        if (ds > 0) {
            const s2 = b2_math_1.b2Vec2.DotVV(s, s);
            if (ds > s2) {
    ...
    RayCast(output, input, xf, childIndex) {
        ...
        const p1 = b2_math_1.b2Transform.MulTXV(xf, input.p1, b2EdgeShape.RayCast_s_p1);
        const p2 = b2_math_1.b2Transform.MulTXV(xf, input.p2, b2EdgeShape.RayCast_s_p2);
        const d = b2_math_1.b2Vec2.SubVV(p2, p1, b2EdgeShape.RayCast_s_d);
        const v1 = this.m_vertex1;
        const v2 = this.m_vertex2;
        const e = b2_math_1.b2Vec2.SubVV(v2, v1, b2EdgeShape.RayCast_s_e);
        // Normal points to the right, looking from v1 at v2
        const normal = output.normal.Set(e.y, -e.x).SelfNormalize();
        // q = p1 + t * d
        // dot(normal, q - v1) = 0
        // dot(normal, p1 - v1) + t * dot(normal, d) = 0
        const numerator = b2_math_1.b2Vec2.DotVV(normal, b2_math_1.b2Vec2.SubVV(v1, p1, b2_math_1.b2Vec2.s_t0));
        if (this.m_oneSided && numerator > 0.0) {
            return false;
        }
        const denominator = b2_math_1.b2Vec2.DotVV(normal, d);
        if (denominator === 0) {
            return false;
        }
        ...
        const q = b2_math_1.b2Vec2.AddVMulSV(p1, t, d, b2EdgeShape.RayCast_s_q);
        // q = v1 + s * r
        // s = dot(q - v1, r) / dot(r, r)
        const r = b2_math_1.b2Vec2.SubVV(v2, v1, b2EdgeShape.RayCast_s_r);
        const rr = b2_math_1.b2Vec2.DotVV(r, r);
        if (rr === 0) {
            return false;
        }
        const s = b2_math_1.b2Vec2.DotVV(b2_math_1.b2Vec2.SubVV(q, v1, b2_math_1.b2Vec2.s_t0), r) / rr;
        if (s < 0 || 1 < s) {
            return false;
        }
        output.fraction = t;
    ...
    ComputeAABB(aabb, xf, childIndex) {
        const v1 = b2_math_1.b2Transform.MulXV(xf, this.m_vertex1, b2EdgeShape.ComputeAABB_s_v1);
        const v2 = b2_math_1.b2Transform.MulXV(xf, this.m_vertex2, b2EdgeShape.ComputeAABB_s_v2);
