...
exports.b2_180_over_pi = 180 / b2_settings_1.b2_pi;
exports.b2_two_pi = 2 * b2_settings_1.b2_pi;
...
class b2Vec2 {
    ...
    static MakeArray(length) {
        return (0, b2_settings_1.b2MakeArray)(length, (i) => new b2Vec2());
    }
    static AbsV(v, out) {
        out.x = (0, exports.b2Abs)(v.x);
        out.y = (0, exports.b2Abs)(v.y);
        return out;
    }
    static MinV(a, b, out) {
        out.x = b2Min(a.x, b.x);
    ...
    Normalize() {
        ...
        if (length >= b2_settings_1.b2_epsilon) {
    ...
    SelfAbs() {
        this.x = (0, exports.b2Abs)(this.x);
        this.y = (0, exports.b2Abs)(this.y);
        return this;
    }
    SelfNeg() {
        this.x = (-this.x);
...
class b2Mat22 {
    ...
    static AbsM(M, out) {
        ...
        out.ex.x = (0, exports.b2Abs)(M_ex.x);
        out.ex.y = (0, exports.b2Abs)(M_ex.y);
        out.ey.x = (0, exports.b2Abs)(M_ey.x);
        out.ey.y = (0, exports.b2Abs)(M_ey.y);
        return out;
    }
