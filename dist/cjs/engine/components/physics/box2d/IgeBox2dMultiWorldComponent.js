...
exports.IgeBox2dMultiWorldComponent = void 0;
const IgeEventingClass_1 = require("../../../core/IgeEventingClass");
const utils_1 = require("../../../utils");
/**
 * The engine's box2d multi-world component class.
 */
class IgeBox2dMultiWorldComponent extends IgeEventingClass_1.IgeEventingClass {
    ...
    createWorld(options) {
        let world;
        options = options || {};
        options.id = options.id || (0, utils_1.newIdHex)();
...
exports.IgeBox2dMultiWorldComponent = IgeBox2dMultiWorldComponent;
