...
const IgeCannonComponent = IgeEventingClass_1.IgeEventingClass.extend({
    ...
    init: function (entity, options) {
        ...
        this._slipperyNormalCm = new CANNON.ContactMaterial(this._normalMaterial, this._slipperyMaterial, 0.0, // friction coefficient
        0.3 // restitution
        );
                                ...
                                switch (fixtureDef.shape.type) {
                                    case "box":
                                        if (fixtureDef.shape.data) {
                                            ...
                                            if (fixtureDef.shape.data.sizeX !== undefined &&
