...
class IgeInputComponent extends IgeEventingClass_1.IgeEventingClass {
    constructor() {
        ...
        this.destroyListeners = () => {
            ...
            const canvas = instance_1.ige.engine._canvas;
            if (!canvas)
                return;
            // Pointer events
        ...
        this._pointerDown = (event) => {
            ...
            if (event.button === 0) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button0, true);
            }
            if (event.button === 1) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button1, true);
            }
            if (event.button === 2) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button2, true);
            }
            if (event.button === 3) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button3, true);
            }
            if (event.button === 4) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button4, true);
            }
            if (event.button === 5) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button5, true);
            }
            this.pointerDown = event;
            if (this.emit("prePointerDown", event, mx, my, event.button) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
        ...
        this._pointerUp = (event) => {
            ...
            const my = event.igeY - instance_1.ige.engine._bounds2d.y2;
            if (event.button === 0) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button0, false);
            }
            if (event.button === 1) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button1, false);
            }
            if (event.button === 2) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button2, false);
            }
            if (event.button === 3) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button3, false);
            }
            if (event.button === 4) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button4, false);
            }
            if (event.button === 5) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.button5, false);
            }
            this.pointerUp = event;
            if (this.emit("prePointerUp", event, mx, my, event.button) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
        ...
        this._contextMenu = (event) => {
            ...
            if (this.emit("preContextMenu", event, mx, my, event.button) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
        ...
        this._pointerMove = (event) => {
            ...
            const mx = event.igeX - instance_1.ige.engine._bounds2d.x2;
            const my = event.igeY - instance_1.ige.engine._bounds2d.y2;
            this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.x, mx);
            this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.y, my);
            this.pointerMove = event;
            if (this.emit("prePointerMove", event, mx, my, event.button) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
        ...
        this._pointerWheel = (event) => {
            ...
            const my = event.igeY - instance_1.ige.engine._bounds2d.y2;
            if (event.deltaX !== 0) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelX, event.deltaX);
                if (event.deltaX > 0) {
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelRight, true);
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelLeft, false);
                }
                else {
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelLeft, true);
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelRight, false);
                }
            }
            if (event.deltaY !== 0) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelY, event.deltaY);
                if (event.deltaY > 0) {
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelUp, true);
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelDown, false);
                }
                else {
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelDown, true);
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelUp, false);
                }
            }
            if (event.deltaZ !== 0) {
                this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelZ, event.deltaZ);
                if (event.deltaZ > 0) {
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelBackward, true);
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelForward, false);
                }
                else {
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelForward, true);
                    this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.wheelBackward, false);
                }
            }
            this.pointerWheel = event;
            if (this.emit("prePointerWheel", event, mx, my, event.button) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
         ...
         */
        this._keyDown = (event) => {
            this._updateState(IgeInputDeviceMap_1.IgeInputDevice.keyboard, IgeInputDeviceMap_1.IgeInputKeyboardMap[event.code], true);
            if (this._debug) {
                console.log("Key Down", event);
            }
            if (this.emit("preKeyDown", event, event.code) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
         ...
         */
        this._keyUp = (event) => {
            this._updateState(IgeInputDeviceMap_1.IgeInputDevice.keyboard, IgeInputDeviceMap_1.IgeInputKeyboardMap[event.code], false);
            if (this._debug) {
                console.log("Key Up", event);
            }
            if (this.emit("preKeyUp", event, event.code) !== IgeEventReturnFlag_1.IgeEventReturnFlag.cancel) {
                this.queueEvent(() => {
        ...
        this.tick();
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.pointer1);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.keyboard);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad1);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad2);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad3);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad4);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad5);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad6);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad7);
        this._ensureState(IgeInputDeviceMap_1.IgeInputDevice.gamePad8);
        // Set default values for the pointer position
        this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.x, 0);
        this._updateState(IgeInputDeviceMap_1.IgeInputDevice.pointer1, IgeInputDeviceMap_1.IgeInputPointerMap.y, 0);
    }
    isReady() {
        return new Promise((resolve) => {
            setTimeout(() => {
                instance_1.ige.dependencies.waitFor(["engine"], () => {
                    ...
                    instance_1.ige.engine.addBehaviour(IgeBehaviourType_1.IgeBehaviourType.postTick, "inputComponentPostTick", this.tick.bind(this));
                    resolve();
                });
            }, 1);
        });
    ...
    _rationalise(event, type) {
        ...
        const canvasPosition = instance_1.ige.engine._canvasPosition();
