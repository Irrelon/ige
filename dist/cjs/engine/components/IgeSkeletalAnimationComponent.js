...
exports.IgeSkeletalAnimationComponent = void 0;
 ...
 */
class IgeSkeletalAnimationComponent extends IgeComponent_1.IgeComponent {
    constructor(entity, options) {
        super(entity, options);
        this.classId = "IgeSkeletalAnimationComponent";
        this.componentId = "skeletalAnimation";
        ...
        this._tempQuat = new Float32Array(4);
        ...
        entity.addBehaviour(enums_1.IgeBehaviourType.preUpdate, "skeletalAnimation", this._update);
    }
    /**
    ...
    play(animId, options) {
        ...
        const crossFadeDuration = (_a = options === null || options === void 0 ? void 0 : options.crossFadeDuration) !== null && _a !== void 0 ? _a : 0.2;
        const speed = (_b = options === null || options === void 0 ? void 0 : options.speed) !== null && _b !== void 0 ? _b : 1.0;
        const loop = (_c = options === null || options === void 0 ? void 0 : options.loop) !== null && _c !== void 0 ? _c : true;
...
exports.IgeSkeletalAnimationComponent = IgeSkeletalAnimationComponent;
