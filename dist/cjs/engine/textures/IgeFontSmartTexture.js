...
exports.IgeFontSmartTexture = {
    ...
    render: (ctx, entity) => {
        ...
        if (entity._textAlignY === IgeFontAlign_1.IgeFontAlignY.top) {
            ctx.textBaseline = "top";
            renderStartY = -(entity._bounds2d.y / 2);
        }
        if (entity._textAlignY === IgeFontAlign_1.IgeFontAlignY.middle) {
            ctx.textBaseline = "middle";
            renderStartY = -(entity._textLineSpacing / 2) * (lineArr.length - 1);
        }
        if (entity._textAlignY === IgeFontAlign_1.IgeFontAlignY.bottom) {
            ctx.textBaseline = "bottom";
            renderStartY = entity._bounds2d.y / 2 - entity._textLineSpacing * (lineArr.length - 1);
        }
        if (entity._textAlignY === IgeFontAlign_1.IgeFontAlignY.multiLineMiddle) {
            ctx.textBaseline = "middle";
