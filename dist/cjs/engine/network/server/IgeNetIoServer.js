...
const IgeNetIoSocket_1 = require("./IgeNetIoSocket");
...
class IgeNetIoServer extends IgeEventingClass_1.IgeEventingClass {
    ...
    start(port, callback) {
        this._port = port;
        this._httpServer = http_1.default.createServer(function (request, response) {
            response.writeHead(404);
            response.end();
        });
        this._socketServer = new websocket_1.default.server({
    ...
    send(data, clientIdOrArrayOfIds) {
        ...
        if (clientIdOrArrayOfIds === undefined) {
            ...
            this._sendToEach((0, utils_1.arrClone)(this._sockets), encodedData);
            return;
        }
...
exports.IgeNetIoServer = IgeNetIoServer;
