...
class IgeNetIoClientController extends IgeNetIoBaseController_1.IgeNetIoBaseController {
	constructor() {
		...
		this.define(IgeNetworkConstants_1.IGE_NETWORK_STREAM_CREATE, this._onStreamCreate);
		this.define(IgeNetworkConstants_1.IGE_NETWORK_STREAM_DESTROY, this._onStreamDestroy);
		this.define(IgeNetworkConstants_1.IGE_NETWORK_STREAM_DATA, this._onStreamData);
		this.define(IgeNetworkConstants_1.IGE_NETWORK_STREAM_TIME, this._onStreamTime);
	}
	/**
	...
	_sendTimeSync(data) {
		...
		this.send(IgeNetworkConstants_1.IGE_NETWORK_TIME_SYNC, data);
	}
	/**
