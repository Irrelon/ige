...
exports.WithEventingMixin = void 0;
const WithEventingMixin = (Base) =>
	class extends Base {
		constructor() {
			super(...arguments);
			// Private
		...
		on(eventName, callback, context, oneShot = false, sendEventName = false) {
			...
			if (typeof eventName === "string") {
				...
				const elArr = (this._eventListeners[eventName] = this._eventListeners[eventName] || []);
...
exports.WithEventingMixin = WithEventingMixin;
