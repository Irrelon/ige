	...
	class extends Base {
		...
		backgroundImage(texture, repeatType) {
			...
			if (this._cell && this._cell > 1) {
				...
				this._patternFill =
					((_a = instance_1.ige.engine._ctx) === null || _a === void 0
						? void 0
						: _a.createPattern(canvas, repeatType)) || undefined;
			} else {
				// Create the pattern from the texture
				this._patternFill =
					((_b = instance_1.ige.engine._ctx) === null || _b === void 0
						? void 0
