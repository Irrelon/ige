...
exports.getPipeline = exports.getShaderModule = exports.vertexDataFormat = void 0;
...
`;
// x, y, r, g, b, a, u, v
exports.vertexDataFormat = [0, 0, 1, 1, 1, 1, 2, 2];
...
const getPipeline = (device, textureFormat, pipelineLayout) => {
    const shaderModule = (0, exports.getShaderModule)(device);
    const vertexBufferLayout = (0, buffers_1.vertexBufferLayoutByFormat)(exports.vertexDataFormat);
    const pipelineData = {
