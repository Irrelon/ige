...
exports.IgeWebGlLightManager = void 0;
const IgeBaseClass_1 = require("../core/IgeBaseClass.js");
const IgeWebGlLight_1 = require("./IgeWebGlLight.js");
/**
 ...
 */
class IgeWebGlLightManager extends IgeBaseClass_1.IgeBaseClass {
    constructor() {
        super(...arguments);
        this.classId = "IgeWebGlLightManager";
        // Tracked lights
        this._ambientLights = [];
    ...
    addLight(light) {
        ...
        switch (type) {
            ...
            case IgeWebGlLight_1.IgeLightType.Point:
                ...
                break;
            case IgeWebGlLight_1.IgeLightType.Spot:
...
exports.IgeWebGlLightManager = IgeWebGlLightManager;
