...
exports.IgeWebGlShadowManager = exports.MAX_SHADOW_POINT_LIGHTS = void 0;
...
exports.MAX_SHADOW_POINT_LIGHTS = 2;
 ...
 */
class IgeWebGlShadowManager extends IgeBaseClass_1.IgeBaseClass {
    constructor(gl, resourceManager, webglVersion) {
        ...
        this._lightViewMatrix = new IgeMatrix4_1.IgeMatrix4();
        this._lightProjectionMatrix = new IgeMatrix4_1.IgeMatrix4();
        this._lightSpaceMatrix = new IgeMatrix4_1.IgeMatrix4();
        // Shadow frustum bounds (for directional light orthographic projection)
        this._shadowFrustumSize = 400; // World units to cover
        this._shadowNear = 1;
        this._shadowFar = 500;
        this._gl = gl;
    ...
    shadowPlanes(near, far) {
        if (near !== undefined) {
            ...
            this._shadowFar = far !== null && far !== void 0 ? far : this._shadowFar;
            return this;
        }
    ...
    createShadowMap(lightId, config) {
        const gl = this._gl;
        const cfg = Object.assign(Object.assign({}, this._defaultConfig), config);
    ...
    updateLightSpaceMatrix(lightId, light, cameraPosition, sceneCenter) {
        ...
        const targetX = (_a = sceneCenter === null || sceneCenter === void 0 ? void 0 : sceneCenter.x) !== null && _a !== void 0 ? _a : 0;
        const targetY = (_b = sceneCenter === null || sceneCenter === void 0 ? void 0 : sceneCenter.y) !== null && _b !== void 0 ? _b : 0;
        const targetZ = (_c = sceneCenter === null || sceneCenter === void 0 ? void 0 : sceneCenter.z) !== null && _c !== void 0 ? _c : 0;
    ...
    getLightSpaceMatrix(lightId) {
        var _a;
        const shadowMap = this._shadowMaps.get(lightId);
        return (_a = shadowMap === null || shadowMap === void 0 ? void 0 : shadowMap.lightSpaceMatrix) !== null && _a !== void 0 ? _a : null;
    }
    /**
    ...
    getShadowMapTexture(lightId) {
        var _a;
        const shadowMap = this._shadowMaps.get(lightId);
        return (_a = shadowMap === null || shadowMap === void 0 ? void 0 : shadowMap.depthTexture) !== null && _a !== void 0 ? _a : null;
    }
    /**
    ...
    createPointShadowMap(lightId, config) {
        var _a, _b, _c, _d;
        const gl = this._gl;
        const faceSize = (_a = config === null || config === void 0 ? void 0 : config.size) !== null && _a !== void 0 ? _a : 512;
        const bias = (_b = config === null || config === void 0 ? void 0 : config.bias) !== null && _b !== void 0 ? _b : 0.002;
        const nearPlane = (_c = config === null || config === void 0 ? void 0 : config.nearPlane) !== null && _c !== void 0 ? _c : 0.5;
        const farPlane = (_d = config === null || config === void 0 ? void 0 : config.farPlane) !== null && _d !== void 0 ? _d : 500;
    ...
    updatePointLightSpaceMatrices(lightId, light) {
        ...
        const projMatrix = new IgeMatrix4_1.IgeMatrix4();
        projMatrix.perspective(Math.PI / 2, 1.0, near, far);
        for (let face = 0; face < 6; face++) {
            const faceDir = CUBE_FACE_DIRS[face];
            const viewMatrix = new IgeMatrix4_1.IgeMatrix4();
     ...
     */
    getPointShadowMapData(lightId) {
        var _a;
        return (_a = this._pointShadowMaps.get(lightId)) !== null && _a !== void 0 ? _a : null;
    }
    /**
...
exports.IgeWebGlShadowManager = IgeWebGlShadowManager;
