...
exports.IgeWebGlSkeletonManager = void 0;
const IgeBaseClass_1 = require("../core/IgeBaseClass.js");
const IgeSkeletonData_1 = require("../../types/IgeSkeletonData.js");
/**
 * Manages skeleton instances for skeletal animation.
 * Handles bone hierarchy traversal and matrix computation.
 */
class IgeWebGlSkeletonManager extends IgeBaseClass_1.IgeBaseClass {
    constructor() {
        super();
        this.classId = "IgeWebGlSkeletonManager";
    ...
    registerSkeletonData(data) {
        if (data.boneCount > IgeSkeletonData_1.MAX_BONES) {
            this.log(`Skeleton "${data.id}" has ${data.boneCount} bones, exceeding limit of ${IgeSkeletonData_1.MAX_BONES}`, "warning");
        }
...
exports.IgeWebGlSkeletonManager = IgeWebGlSkeletonManager;
