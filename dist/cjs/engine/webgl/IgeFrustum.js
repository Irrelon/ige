...
exports.IgeFrustum = exports.IgePlane = void 0;
...
exports.IgePlane = IgePlane;
/**
 * View frustum for culling objects outside camera view.
 * Extracted from view-projection matrix.
 */
class IgeFrustum extends IgeBaseClass_1.IgeBaseClass {
    constructor() {
        super(...arguments);
        this.classId = "IgeFrustum";
