...
exports.IgeWebGlGeometryManager = void 0;
const IgeBaseClass_1 = require("../core/IgeBaseClass.js");
const IgeWebGlGeometry_1 = require("./IgeWebGlGeometry.js");
/**
 * Manages geometry (VBO/IBO) creation and caching for WebGL renderer.
 */
class IgeWebGlGeometryManager extends IgeBaseClass_1.IgeBaseClass {
    constructor(gl, resourceManager) {
        super();
        this.classId = "IgeWebGlGeometryManager";
        // Cached geometries
    ...
    _createSharedQuadGeometry() {
        const gl = this._gl;
        // Create geometry
        const geometry = new IgeWebGlGeometry_1.IgeWebGlGeometry("shared_quad", gl.TRIANGLES);
    ...
    createGeometryFromData(geometryId, data) {
        ...
        const geometry = new IgeWebGlGeometry_1.IgeWebGlGeometry(geometryId, gl.TRIANGLES);
...
exports.IgeWebGlGeometryManager = IgeWebGlGeometryManager;
