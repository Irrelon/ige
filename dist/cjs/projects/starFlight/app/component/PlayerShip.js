...
class PlayerShip extends Ship_1.Ship {
	...
	_updatePhysics() {
		...
		let thrusting = false;
		if (
			this._controlState[PlayerControls_1.PlayerControls.left] &&
			this._controlState[PlayerControls_1.PlayerControls.right]
		) {
		...
		if (this._controlState[PlayerControls_1.PlayerControls.thrust]) {
			...
			const thrustVector = new instance_1.ige.box2d.b2Vec2(
