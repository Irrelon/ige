...
class SplashClientScene extends IgeSceneGraph_1.IgeSceneGraph {
    ...
    addGraph() {
        ...
        const uiScene = new IgeScene2d_1.IgeScene2d().id("uiScene").layer(1).ignoreCamera(true).mount(sceneBase);
        // Create nebula
        ...
        const leftNav = new IgeUiElement_1.IgeUiElement().id("leftNav").mount(gameOptionsWindow);
        const main = new IgeUiElement_1.IgeUiElement().id("main").mount(gameOptionsWindow);
