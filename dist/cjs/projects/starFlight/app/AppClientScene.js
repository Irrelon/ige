...
class AppClientScene extends IgeSceneGraph_1.IgeSceneGraph {
    ...
    addGraph() {
        ...
        const mainScene = new IgeScene2d_1.IgeScene2d().id("mainScene");
        // Create the main viewport and set the scene
        // it will "look" at as the new mainScene we just
        // created above
        const vp1 = new IgeViewport_1.IgeViewport().id("vp1").autoSize(true).scene(mainScene).drawBounds(false).mount(instance_1.ige.engine);
