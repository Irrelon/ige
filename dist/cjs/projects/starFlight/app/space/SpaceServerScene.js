...
class SpaceServerScene extends IgeSceneGraph_1.IgeSceneGraph {
                    ...
                    if (player.ordinance(["mining"])) {
                        ...
                        if (asteroid._oreCount > 0) {
                            ...
                            if (player.effects[0]) {
                                ...
                                laser = new MiningLaserEffect_1.MiningLaserEffect().streamMode(1).mount(instance_1.ige.$("frontScene"));
    ...
    addGraph() {
        ...
        new IgeScene2d_1.IgeScene2d().id("frontScene").layer(2).mount(sceneBase);
