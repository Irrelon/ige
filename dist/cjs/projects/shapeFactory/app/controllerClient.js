...
const controllerClient = () =>
	__awaiter(void 0, void 0, void 0, function* () {
			...
			enter: () =>
				__awaiter(void 0, void 0, void 0, function* () {
					...
					uiCreateHouse1.pointerUp(() => {
						...
						fsm.data("createArgs", [
							ResourceType_1.ResourceType.science,
							ResourceType_1.ResourceType.energy
						]);
						fsm.enterState("createBuilding");
					});
				...
				__awaiter(void 0, void 0, void 0, function* () {
					...
					switch (buildingType) {
						...
						case BuildingType_1.BuildingType.factory1:
							new FactoryBuilding1_1.FactoryBuilding1(NaN, NaN, createArgs[0], createArgs[1])
								.id("tmpBuilding")
								.mount(tileMap1);
							break;
						case BuildingType_1.BuildingType.factory2:
							new FactoryBuilding2_1.FactoryBuilding2(NaN, NaN, createArgs[0], createArgs[1])
								.id("tmpBuilding")
								.mount(tileMap1);
							break;
						case BuildingType_1.BuildingType.mine:
							new MiningBuilding_1.MiningBuilding(NaN, NaN, ResourceType_1.ResourceType.none, [])
								.id("tmpBuilding")
								.mount(tileMap1);
							break;
						case BuildingType_1.BuildingType.house1:
							new HouseBuilding1_1.HouseBuilding1(NaN, NaN, ResourceType_1.ResourceType.none, [])
								.id("tmpBuilding")
								.mount(tileMap1);
							break;
		...
		return () =>
			__awaiter(void 0, void 0, void 0, function* () {
				instance_1.ige.engine.removeBehaviour(
					IgeBehaviourType_1.IgeBehaviourType.preUpdate,
					"tmpBuildingBehaviour"
				);
			});
	});
