...
class UiClientScene extends IgeSceneGraph_1.IgeSceneGraph {
    addGraph() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uiScene = new IgeScene2d_1.IgeScene2d().id("uiScene").layer(1).ignoreCamera(true).mount(baseScene);
            const buildUi = new IgeUiElement_1.IgeUiElement()
                ...
                .mount(uiScene);
            new UiBuildItem_1.UiBuildItem(instance_1.ige.textures.get("headquarters"), "Headquarters").id("uiCreateStorage").top(20).mount(buildUi);
            new UiBuildItem_1.UiBuildItem(instance_1.ige.textures.get("factory1"), "Factory 1").id("uiCreateFactory1").top(90).mount(buildUi);
            new UiBuildItem_1.UiBuildItem(instance_1.ige.textures.get("factory2"), "Factory 2").id("uiCreateFactory2").top(160).mount(buildUi);
            ...
            new UiBuildItem_1.UiBuildItem(instance_1.ige.textures.get("mine"), "Purple Mine")
                ...
                .top(300)
                .mount(buildUi);
            new UiBuildItem_1.UiBuildItem(instance_1.ige.textures.get("house1"), "House 1").id("uiCreateHouse1").top(370).height(50).mount(buildUi);
        });
    }
    removeGraph() {
        var _a;
