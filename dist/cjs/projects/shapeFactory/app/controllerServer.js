...
const controllerServer = () =>
	__awaiter(void 0, void 0, void 0, function* () {
		...
		const createBuilding = (data, clientId, requestCallback) =>
			__awaiter(void 0, void 0, void 0, function* () {
				...
				switch (buildingType) {
					case BuildingType_1.BuildingType.storage: {
						const building = (0, createBuilding_1.createStorageBuilding)(
							tileMap1,
							(0, utils_1.newIdHex)(),
							x,
							y
					...
					case BuildingType_1.BuildingType.flag: {
						const building = (0, createBuilding_1.createFlagBuilding)(
							tileMap1,
							(0, utils_1.newIdHex)(),
							x,
							y
					...
					case BuildingType_1.BuildingType.factory1: {
						const building = (0, createBuilding_1.createFactoryBuilding1)(
							tileMap1,
							(0, utils_1.newIdHex)(),
							x,
							y
					...
					case BuildingType_1.BuildingType.factory2: {
						const building = (0, createBuilding_1.createFactoryBuilding2)(
							tileMap1,
							(0, utils_1.newIdHex)(),
							x,
							y
					...
					case BuildingType_1.BuildingType.mine: {
						...
						const building = (0, createBuilding_1.createMiningBuilding)(
							tileMap1,
							(0, utils_1.newIdHex)(),
							x,
							y,
					...
					case BuildingType_1.BuildingType.house1: {
						...
						const building = (0, createBuilding_1.createHouseBuilding1)(
							tileMap1,
							(0, utils_1.newIdHex)(),
							x,
							y,
		...
		const createRoad = (data, clientId, requestCallback) =>
			__awaiter(void 0, void 0, void 0, function* () {
