...
class UiRequiresProducesDisplay extends IgeUiEntity_1.IgeUiEntity {
    constructor(produces, requires = []) {
        ...
        if (produces !== ResourceType_1.ResourceType.none) {
            new IgeUiEntity_1.IgeUiEntity().texture(instance_1.ige.textures.get("arrow")).width(20).height(15).mount(this);
            new IgeUiEntity_1.IgeUiEntity().texture(instance_1.ige.textures.get(produces)).center(30).width(30).height(30).mount(this);
        }
    }
}
