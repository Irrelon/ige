...
exports.controlMap = {
	...
	[GameControls.pointerDown]: [
		IgeInputDeviceMap_1.IgeInputDevice.pointer1,
		IgeInputDeviceMap_1.IgeInputPointerMap.down
	],
	[GameControls.panUp]: [
		IgeInputDeviceMap_1.IgeInputDevice.keyboard,
		IgeInputDeviceMap_1.IgeInputKeyboardMap.ArrowUp
	],
	[GameControls.panDown]: [
		IgeInputDeviceMap_1.IgeInputDevice.keyboard,
		IgeInputDeviceMap_1.IgeInputKeyboardMap.ArrowDown
	],
	[GameControls.panLeft]: [
		IgeInputDeviceMap_1.IgeInputDevice.keyboard,
		IgeInputDeviceMap_1.IgeInputKeyboardMap.ArrowLeft
	],
	[GameControls.panRight]: [
		IgeInputDeviceMap_1.IgeInputDevice.keyboard,
		IgeInputDeviceMap_1.IgeInputKeyboardMap.ArrowRight
	]
};
