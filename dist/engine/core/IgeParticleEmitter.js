import { IgeTween } from "../../export/exports.js"
import { IgeUiEntity } from "../../export/exports.js"
import { registerClass } from "../../export/exports.js"
import { degreesToRadians } from "../../export/exports.js"
...
export class IgeParticleEmitter extends IgeUiEntity {
    ...
    _started = false;
    _particles;
    _particleMountTarget;
    _applyDepthToParticles = true;
    _applyLayerToParticles = true;
    _quantityTimespan = 1000;
    _quantityBase = 10;
    _quantityVariance = [0, 0];
    _quantityMax = 0; // Unlimited = 0
    _quantityProduced = 0;
    _translateBaseX = 0;
    _translateBaseY = 0;
    _translateBaseZ = 0;
    _translateVarianceX = [0, 0];
    _translateVarianceY = [0, 0];
    _translateVarianceZ = [0, 0];
    _rotateBase = 0;
    _rotateVariance = [0, 0];
    _deathRotateBase = 0;
    _deathRotateVariance = [0, 0];
    _scaleBaseX = 0;
    _scaleBaseY = 0;
    _scaleBaseZ = 0;
    _scaleVarianceX = [0, 0];
    _scaleVarianceY = [0, 0];
    _scaleVarianceZ = [0, 0];
    _scaleLockAspect = false;
    _deathScaleBaseX = 1;
    _deathScaleBaseY = 1;
    _deathScaleBaseZ = 1;
    _deathScaleVarianceX = [0, 0];
    _deathScaleVarianceY = [0, 0];
    _deathScaleVarianceZ = [0, 0];
    _deathScaleLockAspect = false;
    _opacityBase = 1;
    _opacityVariance = [0, 0];
    _deathOpacityBase = 1;
    _deathOpacityVariance = [0, 0];
    _lifeBase = 1000;
    _lifeVariance = [0, 0];
    _velocityVector;
    _linearForceVector;
    _maxParticles = 1;
    _particlesPerTimeVector = 1;
    constructor() {
        super();
        // Set some defaults
                    ...
                    if (particleCount) {
                        while (particleCount--) {
                            ...
                            if (scaleProps.x || scaleProps.y || scaleProps.z) {
                                tweens.push(new IgeTween().targetObj(tempParticle._scale).properties(scaleProps).duration(life));
                            }
