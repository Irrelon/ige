...
export class b2ParticleBodyContact {
    ...
    body; // The body making contact.
    fixture; // The specific fixture making contact
...
export class b2ParticlePair {
    ...
    indexB = 0;
    flags = 0; // The logical sum of the particle flags. See the b2ParticleFlag enum.
...
export class b2ParticleTriad {
    ...
    flags = 0; // The logical sum of the particle flags. See the b2ParticleFlag enum.
    strength = 0.0; // The strength of cohesion among the particles.
    pa = new b2Vec2(0.0, 0.0); // Values used for calculation.
    pb = new b2Vec2(0.0, 0.0);
    pc = new b2Vec2(0.0, 0.0);
    ka = 0.0;
    kb = 0.0;
    kc = 0.0;
    s = 0.0;
...
export class b2ParticleSystem {
     ...
     */
    m_handleIndexBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_flagsBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_positionBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_velocityBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_forceBuffer = [];
    /**
     ...
     */
    m_depthBuffer = [];
    m_colorBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_groupBuffer = [];
    m_userDataBuffer = new b2ParticleSystem_UserOverridableBuffer();
    /**
     * Stuck particle detection parameters and record keeping
     */
    m_stuckThreshold = 0;
    m_lastBodyContactStepBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_bodyContactCountBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_consecutiveContactStepsBuffer = new b2ParticleSystem_UserOverridableBuffer();
    m_stuckParticleBuffer = new b2GrowableBuffer(() => 0);
    m_proxyBuffer = new b2GrowableBuffer(() => new b2ParticleSystem_Proxy());
    m_contactBuffer = new b2GrowableBuffer(() => new b2ParticleContact());
    m_bodyContactBuffer = new b2GrowableBuffer(() => new b2ParticleBodyContact());
    m_pairBuffer = new b2GrowableBuffer(() => new b2ParticlePair());
    m_triadBuffer = new b2GrowableBuffer(() => new b2ParticleTriad());
    /**
     ...
     * seconds.
     */
    m_expirationTimeBuffer = new b2ParticleSystem_UserOverridableBuffer();
    /**
     * List of particle indices sorted by expiration time.
     */
    m_indexByExpirationTimeBuffer = new b2ParticleSystem_UserOverridableBuffer();
    /**
    ...
    m_prev = null;
    m_next = null;
    static xTruncBits = 12;
    static yTruncBits = 12;
    static tagBits = 8 * 4; // 8u * sizeof(uint32);
    static yOffset = 1 << (b2ParticleSystem.yTruncBits - 1);
    static yShift = b2ParticleSystem.tagBits - b2ParticleSystem.yTruncBits;
    static xShift = b2ParticleSystem.tagBits - b2ParticleSystem.yTruncBits - b2ParticleSystem.xTruncBits;
    static xScale = 1 << b2ParticleSystem.xShift;
    static xOffset = b2ParticleSystem.xScale * (1 << (b2ParticleSystem.xTruncBits - 1));
    static yMask = ((1 << b2ParticleSystem.yTruncBits) - 1) << b2ParticleSystem.yShift;
    static xMask = ~b2ParticleSystem.yMask;
     ...
     */
    static k_pairFlags = b2ParticleFlag.b2_springParticle;
    /**
    ...
    static UpdatePairsAndTriads_s_dab = new b2Vec2();
    static UpdatePairsAndTriads_s_dbc = new b2Vec2();
    static UpdatePairsAndTriads_s_dca = new b2Vec2();
    ...
    UpdateBodyContacts_callback = null;
    Solve(step) {
    ...
    static RemoveSpuriousBodyContacts_s_n = new b2Vec2();
    static RemoveSpuriousBodyContacts_s_pos = new b2Vec2();
    static RemoveSpuriousBodyContacts_s_normal = new b2Vec2();
...
export class b2ParticleSystem_FixtureParticle {
    first;
    second = b2_invalidParticleIndex;
