"use strict";
class UiToolBox_ToolCreate extends IgeEventingClass {
    classId;
    editorOptions;
    init;
}
...
enabled: function (val) {
    if (val) {
        // Display menu
        var self = this, toolboxButton = $('#toolCreate'), position = toolboxButton.offset(), left = position.left + toolboxButton.width(), top = position.top, height = $('body').height();
