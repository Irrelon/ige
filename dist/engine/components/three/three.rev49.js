...
THREE.Projector = function () {
    ...
    var e, f, g = [], h, j, l = [], k, p, m = [], o, q = [], n, r, u = [], t, y, s = [], w = { objects: [], sprites: [], lights: [], elements: [] }, H = new THREE.Vector3(), E = new THREE.Vector4(), z = new THREE.Matrix4(), v = new THREE.Matrix4(), A = new THREE.Frustum(), J = new THREE.Vector4(), K = new THREE.Vector4();
    ...
    this.projectGraph = function (b, d) {
        ...
        var g = function (b) {
            if (b.visible !== false) {
                if ((b instanceof THREE.Mesh || b instanceof THREE.Line) &&
        ...
        for (H = w.sprites.length; a < H; a++) {
            ...
            if (O instanceof THREE.Particle) {
                ...
                if (E.z > 0 && E.z < 1) {
                    ...
                    t.scale.x =
                        O.scale.x *
                            Math.abs(t.x - (E.x + e.projectionMatrix.elements[0]) / (E.w + e.projectionMatrix.elements[12]));
                    t.scale.y =
                        O.scale.y *
                            Math.abs(t.y - (E.y + e.projectionMatrix.elements[5]) / (E.w + e.projectionMatrix.elements[13]));
...
THREE.Loader.prototype = {
    ...
    createMaterial: function (a, b) {
        ...
        var h = this, j = "MeshLambertMaterial", l = { color: 15658734, opacity: 1, map: null, lightMap: null, normalMap: null, wireframe: a.wireframe };
        if (a.shading) {
        ...
        a.mapSpecular &&
            b &&
            f(l, "specularMap", a.mapSpecular, a.mapSpecularRepeat, a.mapSpecularOffset, a.mapSpecularWrap);
        if (a.mapNormal) {
    ...
    f.onreadystatechange = function () {
        if (f.readyState == 4)
            f.status == 200 || f.status == 0
                ? THREE.BinaryLoader.prototype.createBinModel(f.response, b, d, a.materials)
...
THREE.SceneLoader.prototype.createScene = function (a, b, c) {
    ...
    function h() {
        j.callbackProgress({ totalModels: T, totalTextures: U, loadedModels: T - G, loadedTextures: U - i }, C);
        j.onLoadProgress();
        G == 0 && i == 0 && b(C);
    }
    ...
    for (q in D.cameras) {
        ...
        v.type == "perspective"
            ...
            : v.type == "ortho" && (R = new THREE.OrthographicCamera(v.left, v.right, v.top, v.bottom, v.near, v.far));
        w = v.position;
        y = v.target;
        v = v.up;
...
THREE.Mesh = function (a, b) {
    ...
    this.geometry = a;
    this.material =
        b !== void 0 ? b : new THREE.MeshBasicMaterial({ color: Math.random() * 16777215, wireframe: true });
    if (this.geometry) {
        this.geometry.boundingSphere || this.geometry.computeBoundingSphere();
        this.boundRadius = a.boundingSphere.radius;
...
THREE.LOD.prototype.update = function (a) {
    if (this.LODs.length > 1) {
        ...
        a = -(a.elements[2] * this.matrixWorld.elements[12] +
...
THREE.CanvasRenderer = function (a) {
    ...
    this.clear = function () {
        ...
        if (!Ba.isEmpty()) {
            ...
            Ba.inflate(2);
            u < 1 &&
                n.clearRect(Math.floor(Ba.getX()), Math.floor(Ba.getY()), Math.floor(Ba.getWidth()), Math.floor(Ba.getHeight()));
            if (u > 0) {
        ...
        function t(a, d, e, g, h, l, m, n) {
            ...
            if (n instanceof THREE.MeshBasicMaterial)
                if (n.map) {
                    ...
                    n.wireframe
                        ? Mb(n.color, n.wireframeLinewidth, n.wireframeLinecap, n.wireframeLinejoin)
                        : Eb(n.color);
        ...
        function u(a, d, e, g, h, l, n, m, o) {
            ...
            if (m.map || m.envMap) {
                ...
                if (m instanceof THREE.MeshBasicMaterial) {
                    y(D, M, G, i, T, U, C, Y);
                    m.wireframe
                        ? Mb(m.color, m.wireframeLinewidth, m.wireframeLinecap, m.wireframeLinejoin)
                        : Eb(m.color);
                }
                ...
                if (A instanceof THREE.RenderableParticle) {
                    ...
                    if (u.intersects(t)) {
                        ...
                        if (C instanceof THREE.LineBasicMaterial) {
                            K.setAttribute("style", "fill: none; stroke: " +
                    ...
                    if (u.intersects(t)) {
                        ...
                        if (C instanceof THREE.MeshBasicMaterial)
                            ...
                            C instanceof THREE.MeshNormalMaterial &&
                                s.setRGB(c(A.normalWorld.x), c(A.normalWorld.y), c(A.normalWorld.z));
                        C.wireframe
                            ? K.setAttribute("style", "fill: none; stroke: " +
                                s.getContextStyle() +
                                "; stroke-width: " +
                                ...
                                "; stroke-linejoin: " +
                                C.wireframeLinejoin)
                            : K.setAttribute("style", "fill: " + s.getContextStyle() + "; fill-opacity: " + C.opacity);
                        j.appendChild(K);
                    }
                }
...
THREE.WebGLRenderer = function (a) {
    ...
    function n(a, b, c, d, e) {
        ...
        if (h) {
            ...
            if (d instanceof THREE.MeshBasicMaterial ||
                ...
                (j.map.texture = d.map) &&
                    j.offsetRepeat.value.set(d.map.offset.x, d.map.offset.y, d.map.repeat.x, d.map.repeat.y);
            ...
            if (e.receiveShadow && !d._shadowPass && j.shadowMatrix) {
                ...
                for (k = b.length; h < k; h++) {
                    l = b[h];
                    if (l.castShadow &&
                        (l instanceof THREE.SpotLight || (l instanceof THREE.DirectionalLight && !l.shadowCascade))) {
    ...
    var a = a || {}, E = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"), z = a.precision !== void 0 ? a.precision : "highp", v = a.alpha !== void 0 ? a.alpha : true, A = a.premultipliedAlpha !== void 0 ? a.premultipliedAlpha : true, J = a.antialias !== void 0 ? a.antialias : false, K = a.stencil !== void 0 ? a.stencil : true, R = a.preserveDrawingBuffer !== void 0 ? a.preserveDrawingBuffer : false, P = a.clearColor !== void 0 ? new THREE.Color(a.clearColor) : new THREE.Color(0), D = a.clearAlpha !== void 0 ? a.clearAlpha : 0, M = a.maxLights !== void 0 ? a.maxLights : 4;
    this.domElement = E;
    this.context = null;
        ...
        if (d.visible !== false) {
            ...
            if (!d.morphTargets && b.position >= 0) {
                ...
                d.program.uniforms.morphTargetInfluences !== null &&
                    i.uniform1fv(d.program.uniforms.morphTargetInfluences, f.__webglMorphTargetInfluences);
            }
            if (a) {
    ...
    this.render = function (a, b, c, d) {
        ...
        for (e = m.length; d < e; d++) {
            ...
            f.render = false;
            if (k.visible &&
                (!(k instanceof THREE.Mesh || k instanceof THREE.ParticleSystem) || !k.frustumCulled || Wa.contains(k))) {
                r(k, b);
            ...
            if (!g.__webglActive) {
                if (g instanceof THREE.Mesh) {
                    ...
                    g instanceof THREE.ImmediateRenderObject || g.immediateRenderCallback
                        ? h.__webglObjectsImmediate.push({ object: g, opaque: null, transparent: null })
            ...
            bb instanceof THREE.Mesh ||
                ...
                : bb instanceof THREE.Sprite
                    ...
                    : bb instanceof THREE.LensFlare
                        ...
                        : (bb instanceof THREE.ImmediateRenderObject || bb.immediateRenderCallback) &&
        ...
        for (var ib = 0, Lb = a.__webglObjects.length; ib < Lb; ib++) {
            ...
            if (jb instanceof THREE.Mesh)
                ...
                if (ga.verticesNeedUpdate || ga.colorsNeedUpdate || ic) {
                    var Jb = ga, Zc = i.DYNAMIC_DRAW, zc = void 0, Ac = void 0, Nc = void 0, va = void 0, Oc = void 0, kd = Jb.vertices, ld = Jb.colors, yd = kd.length, zd = ld.length, Pc = Jb.__vertexArray, Qc = Jb.__colorArray, Ad = Jb.colorsNeedUpdate, $c = Jb.__webglCustomAttributesList, Rc = void 0, md = void 0, Ia = void 0, oc = void 0, Va = void 0, pa = void 0;
    ...
    merge: function (a, b) {
        ...
        for (q = l.length; o < q; o++) {
            ...
            g instanceof THREE.Face3
                ...
                : g instanceof THREE.Face4 && (r = new THREE.Face4(g.a + e, g.b + e, g.c + e, g.d + e));
            ...
            if (a.initialized !== true) {
                for (var c = 0; c < a.hierarchy.length; c++) {
                    for (var d = 0; d < a.hierarchy[c].keys.length; d++) {
                        ...
                        if (a.hierarchy[c].keys[d].rot !== void 0 &&
...
THREE.PathControls = function (a, b) {
    ...
    function e(a, b, c, d) {
        var e = { name: c, fps: 0.6, length: d, hierarchy: [] }, f, g = b.getControlPointsArray(), h = b.getLength(), r = g.length, u = 0;
        f = r - 1;
        b = { parent: -1, keys: [] };
    ...
    this.init = function () {
        ...
        if (this.createDebugDummy) {
            var a = new THREE.MeshLambertMaterial({ color: 30719 }), b = new THREE.MeshLambertMaterial({ color: 65280 }), c = new THREE.CubeGeometry(10, 10, 20), g = new THREE.CubeGeometry(2, 2, 10);
        ...
        if (this.createDebugPath) {
            var a = this.debugPath, b = this.spline, g = f(b, 10), c = f(b, 10), h = new THREE.LineBasicMaterial({ color: 16711680, linewidth: 3 }), g = new THREE.Line(g, h), c = new THREE.ParticleSystem(c, new THREE.ParticleBasicMaterial({ color: 16755200, size: 3 }));
            g.scale.set(1, 1, 1);
            a.add(g);
            c.scale.set(1, 1, 1);
            a.add(c);
...
THREE.FlyControls = function (a, b) {
    ...
    this.update = function (a) {
        ...
        this.tmpQuaternion
            .set(this.rotationVector.x * a, this.rotationVector.y * a, this.rotationVector.z * a, 1)
            .normalize();
            ...
            f !== -1 &&
                (f === 0 && !c.noRotate
                    ...
                    : f === 1 && !c.noZoom
                        ...
                        : f === 2 && !c.noPan && (m = c.getMouseOnScreen(a.clientX, a.clientY)));
        }
    }, false);
    this.domElement.addEventListener("mousedown", function (a) {
        if (c.enabled) {
            ...
            if (f === -1) {
                ...
                f === 0 && !c.noRotate
                    ...
                    : f === 1 && !c.noZoom
                        ? (l = k = c.getMouseOnScreen(a.clientX, a.clientY))
                        : this.noPan || (p = m = c.getMouseOnScreen(a.clientX, a.clientY));
            }
        }
    }, false);
    this.domElement.addEventListener("mouseup", function (a) {
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
    ...
    generateSideWallUV: function (a, b, c, d, e, f, g, h) {
        ...
        return Math.abs(c - j) < 0.01
            ? [new THREE.UV(b, e), new THREE.UV(d, f), new THREE.UV(l, g), new THREE.UV(p, a)]
            : [new THREE.UV(c, e), new THREE.UV(j, f), new THREE.UV(k, g), new THREE.UV(m, a)];
    }
};
...
(function (a) {
    ...
    a.Triangulate = function (a, d) {
        ...
        for (l = e - 1; e > 2;) {
            ...
            a: {
                m = a;
                var o = j, q = l, n = k, r = e, u = g, t = void 0, y = void 0, s = void 0, w = void 0, H = void 0, E = void 0, z = void 0, v = void 0, A = void 0, y = m[u[o]].x, s = m[u[o]].y, w = m[u[q]].x, H = m[u[q]].y, E = m[u[n]].x, z = m[u[n]].y;
...
THREE.PolyhedronGeometry = function (a, b, c, d) {
    ...
    function g(a, b) {
        ...
        c === void 0 &&
            (p[a.index][b.index] = p[b.index][a.index] = c = e(new THREE.Vector3().add(a, b).divideScalar(2)));
        return c;
    }
    function h(a, b, c) {
