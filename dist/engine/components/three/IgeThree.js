...
var IgeThree = IgeEventingClass.extend({
    ...
    IgeEntity_model: function (model) {
        if (model !== undefined) {
            ...
            this._threeObj = new THREE.Mesh(ige.three._geometryLoader.parse(model), this._material || new THREE.MeshFaceMaterial());
    ...
    IgeEntity_mesh: function (mesh) {
        if (mesh !== undefined) {
            this._threeObj = new THREE.Mesh(mesh, this._material || new THREE.MeshBasicMaterial({ color: 0x0000ff, wireframe: true }));
            return this;
        }
        return this._threeObj;
    },
