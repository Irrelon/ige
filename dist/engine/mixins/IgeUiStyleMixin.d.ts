...
import type { Mixin } from "../../types/Mixin.js"
export declare const WithUiStyleMixin: <BaseClassType extends Mixin<IgeObject>>(Base: BaseClassType) => {
    new (...args: any[]): {
        ...
        _specialProp: string[];
        _streamMode?: import("../../index").IgeStreamMode | undefined;
        ...
        _newBorn: boolean;
        _alive: boolean;
        _mountMode: import("../../index").IgeMountMode;
        _layer: number;
        _depth: number;
        _depthSortMode: import("../../index").IgeIsometricDepthSortMode;
        _inView: boolean;
        _managed: number;
        ...
        _processBehaviours(type: import("../../index").IgeBehaviourType, ...args: any[]): void;
        ...
        depthSortMode(): import("../../index").IgeIsometricDepthSortMode;
        depthSortMode(val: import("../../index").IgeIsometricDepthSortMode): any;
        ...
        addBehaviour<ParentType extends IgeObject = IgeObject>(type: import("../../index").IgeBehaviourType, id: string, behaviour: import("../../types/IgeEntityBehaviour").IgeEntityBehaviourMethod<ParentType>): any;
        removeBehaviour(type: import("../../index").IgeBehaviourType, id: string): any | undefined;
        hasBehaviour(type: import("../../index").IgeBehaviourType, id: string): boolean;
        ...
        streamMode(val: import("../../index").IgeStreamMode): any;
        streamMode(): import("../../index").IgeStreamMode;
        ...
        emit(eventName: string, ...data: any[]): import("../../index").IgeEventReturnFlag;
