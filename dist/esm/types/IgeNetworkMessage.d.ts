...
export type IgeNetworkServerSideRequestHandler<NetworkMessageRequestDataType = IgeNetworkMessageData, NetworkMessageResponseDataType = IgeNetworkMessageData> = (data: NetworkMessageRequestDataType, clientId: string, requestCallback: IgeNetworkRequestCallback<NetworkMessageResponseDataType>) => void;
