...
export class Client extends IgeBaseClass {
        ...
        switch (ige.client.data("cursorMode")) {
            ...
            case "move": {
                ...
                if (!ige.client.data("moveItem")) {
                    ...
                    // down now
                    const item = ige.client.data("moveItem"), moveX = item.data("lastMoveX"), moveY = item.data("lastMoveY");
    ...
    _mapOnPointerOver(event, evc) {
        ...
        switch (ige.client.data("cursorMode")) {
            ...
            case "move": {
                const item = ige.client.data("moveItem"), map = ige.client.tileMap1.map;
                if (item) {
