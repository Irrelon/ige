...
export declare const WithUiPositionMixin: <BaseClassType extends Mixin<IgeObject>>(
	...
	new (...args: any[]): {
		...
		_smartBackground?:
			| import("../../types/IgeSmartTexture").IgeSmartTexture<import("../core/IgeEntity").IgeEntity>
			| undefined;
		...
		localToWorld(
			...
			viewport?: import("../core/IgeViewport").IgeViewport | null | undefined,
			inverse?: boolean
		): void;
		localToWorldPoint(
			point: import("../core/IgePoint3d").IgePoint3d,
			viewport?: import("../core/IgeViewport").IgeViewport | null | undefined
		): void;
		...
		addBehaviour<ParentType extends IgeObject = IgeObject>(
			type: import("../../enums/IgeBehaviourType").IgeBehaviourType,
			id: string,
		...
		_eventListeners?:
			| Record<string, Record<string, import("../core/IgeEventingClass").IgeEventListenerCallback[]>>
			| undefined;
		...
		_once(
			eventName: string,
			id: string,
			listener: import("../core/IgeEventingClass").IgeEventListenerCallback
		): any;
		_off(
			eventName: string,
			id: string,
			listener?: import("../core/IgeEventingClass").IgeEventListenerCallback | undefined
		): any;
