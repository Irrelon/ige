import { vertexBufferLayoutByFormat } from "../utils/buffers.js"
const shaderSource = `
struct Uniforms {
...
export const getShaderModule = (device) => {
    return device.createShaderModule({
        code: shaderSource
    });
};
export const getPipeline = (device, textureFormat, pipelineLayout) => {
