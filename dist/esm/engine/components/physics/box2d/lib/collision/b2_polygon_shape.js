...
export class b2PolygonShape extends b2Shape {
    ...
    static Set_s_r = new b2Vec2();
    static Set_s_v = new b2Vec2();
    Set(...args) {
    ...
    static TestPoint_s_pLocal = new b2Vec2();
    TestPoint(xf, p) {
    ...
    static ComputeDistance_s_pLocal = new b2Vec2();
    static ComputeDistance_s_normalForMaxDistance = new b2Vec2();
    static ComputeDistance_s_minDistance = new b2Vec2();
    static ComputeDistance_s_distance = new b2Vec2();
    ...
    /// not defined.
    static RayCast_s_p1 = new b2Vec2();
    static RayCast_s_p2 = new b2Vec2();
    static RayCast_s_d = new b2Vec2();
    ...
    static ComputeAABB_s_v = new b2Vec2();
    ...
    static ComputeMass_s_center = new b2Vec2();
    static ComputeMass_s_s = new b2Vec2();
    static ComputeMass_s_e1 = new b2Vec2();
    static ComputeMass_s_e2 = new b2Vec2();
    ...
    static Validate_s_e = new b2Vec2();
    static Validate_s_v = new b2Vec2();
    Validate() {
        for (let i = 0; i < this.m_count; ++i) {
            const i1 = i;
    ...
    static ComputeSubmergedArea_s_normalL = new b2Vec2();
    static ComputeSubmergedArea_s_md = new b2MassData();
    static ComputeSubmergedArea_s_intoVec = new b2Vec2();
    static ComputeSubmergedArea_s_outoVec = new b2Vec2();
    static ComputeSubmergedArea_s_center = new b2Vec2();
    ...
    static ComputeCentroid_s_s = new b2Vec2();
    static ComputeCentroid_s_p1 = new b2Vec2();
    static ComputeCentroid_s_p2 = new b2Vec2();
    static ComputeCentroid_s_p3 = new b2Vec2();
    static ComputeCentroid_s_e1 = new b2Vec2();
    static ComputeCentroid_s_e2 = new b2Vec2();
