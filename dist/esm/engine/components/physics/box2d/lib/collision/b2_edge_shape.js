...
export class b2EdgeShape extends b2Shape {
    m_vertex1 = new b2Vec2();
    m_vertex2 = new b2Vec2();
    m_vertex0 = new b2Vec2();
    m_vertex3 = new b2Vec2();
    ...
    static ComputeDistance_s_v1 = new b2Vec2();
    static ComputeDistance_s_v2 = new b2Vec2();
    static ComputeDistance_s_d = new b2Vec2();
    static ComputeDistance_s_s = new b2Vec2();
    ...
    static RayCast_s_e = new b2Vec2();
    static RayCast_s_q = new b2Vec2();
    ...
    static ComputeAABB_s_v1 = new b2Vec2();
    static ComputeAABB_s_v2 = new b2Vec2();
