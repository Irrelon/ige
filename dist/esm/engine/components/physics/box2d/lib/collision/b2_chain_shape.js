...
export class b2ChainShape extends b2Shape {
    m_vertices = [];
    m_count = 0;
    m_prevVertex = new b2Vec2();
    m_nextVertex = new b2Vec2();
    constructor() {
    ...
    static ComputeDistance_s_edgeShape = new b2EdgeShape();
    ...
    // #endif
    /// Implement b2Shape.
    static RayCast_s_edgeShape = new b2EdgeShape();
    ...
    static ComputeAABB_s_lower = new b2Vec2();
    static ComputeAABB_s_upper = new b2Vec2();
