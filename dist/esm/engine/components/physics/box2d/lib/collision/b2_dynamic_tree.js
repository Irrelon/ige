...
export class b2DynamicTree {
    ...
    m_freeList = null;
    m_insertionCount = 0;
    m_stack = new b2GrowableStack(256);
    static s_r = new b2Vec2();
    static s_v = new b2Vec2();
    static s_abs_v = new b2Vec2();
    static s_segmentAABB = new b2AABB();
    static s_subInput = new b2RayCastInput();
    static s_combinedAABB = new b2AABB();
    static s_aabb = new b2AABB();
    ...
    static MoveProxy_s_fatAABB = new b2AABB();
    static MoveProxy_s_hugeAABB = new b2AABB();
