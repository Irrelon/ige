...
export class b2ContactEdge {
    ...
    contact; ///< the contact
    prev = null; ///< the previous contact edge in the body's contact list
    next = null; ///< the next contact edge in the body's contact list
    constructor(contact) {
...
export class b2Contact {
    ...
    m_prev = null;
    m_next = null;
    m_nodeA = new b2ContactEdge(this);
    m_nodeB = new b2ContactEdge(this);
    m_fixtureA;
    m_fixtureB;
    m_indexA = 0;
    m_indexB = 0;
    ...
    static ComputeTOI_s_input = new b2TOIInput();
    static ComputeTOI_s_output = new b2TOIOutput();
