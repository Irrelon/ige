...
export class b2DistanceJoint extends b2Joint {
    ...
    static Draw_s_c4 = new b2Color(0.4, 0.4, 0.4);
    static Draw_s_pRest = new b2Vec2();
    static Draw_s_pMin = new b2Vec2();
    static Draw_s_pMax = new b2Vec2();
    Draw(draw) {
