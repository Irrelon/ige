...
export class b2World {
    ...
    static Step_s_step = new b2TimeStep();
    static Step_s_stepTimer = new b2Timer();
    static Step_s_timer = new b2Timer();
    // #if B2_ENABLE_PARTICLE
    ...
    static DebugDraw_s_color = new b2Color(0, 0, 0);
    static DebugDraw_s_vs = b2Vec2.MakeArray(4);
    static DebugDraw_s_xf = new b2Transform();
    DebugDraw() {
        if (this.m_debugDraw === null) {
            return;
        }
    ...
    static QueryFixtureShape_s_aabb = new b2AABB();
    ...
    static RayCast_s_input = new b2RayCastInput();
    static RayCast_s_output = new b2RayCastOutput();
    ...
    static SolveTOI_s_subStep = new b2TimeStep();
    static SolveTOI_s_backup = new b2Sweep();
    static SolveTOI_s_backup1 = new b2Sweep();
    static SolveTOI_s_backup2 = new b2Sweep();
    static SolveTOI_s_toi_input = new b2TOIInput();
    static SolveTOI_s_toi_output = new b2TOIOutput();
    SolveTOI(step) {
        const island = this.m_island;
