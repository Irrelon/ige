...
export class b2Body {
    ...
    m_toiFlag = false;
    m_islandIndex = 0;
    m_xf = new b2Transform(); // the body origin transform
    // #if B2_ENABLE_PARTICLE
    m_xf0 = new b2Transform();
    // #endif
    ...
    /// @warning This function is locked during callbacks.
    static CreateFixtureShapeDensity_s_def = new b2FixtureDef();
    ...
    static SetMassData_s_oldCenter = new b2Vec2();
    ...
    static ResetMassData_s_localCenter = new b2Vec2();
    static ResetMassData_s_oldCenter = new b2Vec2();
    static ResetMassData_s_massData = new b2MassData();
    ResetMassData() {
    ...
    static SynchronizeFixtures_s_xf1 = new b2Transform();
    SynchronizeFixtures() {
        if (this.m_awakeFlag) {
