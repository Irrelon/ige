...
export class b2Island {
    m_listener;
    m_bodies = [ /*1024*/]; // TODO: b2Settings
    m_contacts = [ /*1024*/]; // TODO: b2Settings
    m_joints = [ /*1024*/]; // TODO: b2Settings
    m_positions = b2Position.MakeArray(1024); // TODO: b2Settings
    m_velocities = b2Velocity.MakeArray(1024); // TODO: b2Settings
    m_bodyCount = 0;
    m_jointCount = 0;
    m_contactCount = 0;
    m_bodyCapacity = 0;
    ...
    static s_timer = new b2Timer();
    static s_solverData = new b2SolverData();
    static s_contactSolverDef = new b2ContactSolverDef();
    static s_contactSolver = new b2ContactSolver();
    static s_translation = new b2Vec2();
  ...
  */
    ...
    static s_impulse = new b2ContactImpulse();
    Report(constraints) {
