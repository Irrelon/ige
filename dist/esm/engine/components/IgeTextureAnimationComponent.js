                ...
                for (i = 0; i < frames.length; i++) {
                    ...
                    if (typeof frame === "string") {
                        if (this._entity._texture) {
                            ...
                            this.log("You can increase the performance of id-based cell animations by specifying the animation.define AFTER you have assigned your sprite sheet to the entity on entity with ID: " +
                                this._entity.id(), "warning");
                            break;
                        }
                    }
                }
