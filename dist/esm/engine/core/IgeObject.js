import { arrPull, newIdHex, toIso } from "../../export/exports.js"
import { IgeDummyCanvas, IgeEventingClass, IgeMatrix2d, IgePoint2d, IgePoint3d, IgePoly2d, IgeRect } from "../../export/exports.js"
import { ige, isClient, isServer } from "../../export/exports.js"
import { IGE_NETWORK_STREAM_CREATE, IGE_NETWORK_STREAM_DESTROY, IgeIsometricDepthSortMode, IgeMountMode, IgeStreamMode } from "../../export/exports.js"
export class IgeObject extends IgeEventingClass {
    classId = "IgeObject";
    _id;
    _idRegistered = false;
    _categoryRegistered = false;
    _category = "";
    _drawBounds = false;
    _drawBoundsData = false;
    _drawMouse = false;
    _drawMouseData = false;
    _ignoreCamera = false;
    _parent = null;
    _children = [];
    ...
    _streamJustCreated;
    _streamEmitCreated;
    _streamSections = ["transform", "props"];
    _streamProperty = {};
    _streamSyncInterval;
    _streamSyncDelta = 0;
    _streamSyncSectionInterval = {}; // Holds minimum delta before the stream section is included in the next stream data packet
    _streamSyncSectionDelta = {}; // Stores the game time elapsed since the last time the section was included in a stream data packet
    _timeStreamCurrentInterpolateTime;
    _timeStreamDataDelta;
    _timeStreamOffsetDelta;
    _timeStreamPreviousData;
    _timeStreamNextData;
    _timeStream = []; // Holds an array of transform data for the object that was sent from the server
    _streamFloatPrecision = 2;
    _floatRemoveRegExp = new RegExp("\\.00,", "g");
    _compositeStream = false;
    _disableInterpolation = false;
    _streamControl;
    _newBorn = true;
    _alive = true;
    _mountMode = IgeMountMode.flat;
    _layer = 0;
    _depth = 0;
    _depthSortMode = IgeIsometricDepthSortMode.bounds3d;
    _inView = true;
    _managed = 1;
    _triggerPolygonFunctionName = "aabb";
    _compositeCache = false;
    _compositeParent = false;
    _anchor;
    _renderPos;
    _computedOpacity;
    _opacity;
    ...
    _oldBounds3d;
    _highlight;
    _pointerEventsActive;
    _pointerStateDown = false;
    _pointerStateOver = false;
    _pointerAlwaysInside = false;
    _pointerOut;
    _pointerOver;
    _pointerMove;
    _pointerWheel;
    ...
    _behaviours;
    _birthMount;
    _frameAlternatorCurrent = false;
    _backgroundPattern;
    _backgroundPatternRepeat = null;
    _backgroundPatternTrackCamera;
    _backgroundPatternIsoTile;
    _backgroundPatternFill;
    _bounds3dPolygonDirty = false;
    ...
    screenPosition() {
        ...
        return new IgePoint3d(Math.floor((this._worldMatrix.matrix[2] - ige.engine._currentCamera._translate.x) *
            ige.engine._currentCamera._scale.x +
            ige.engine._bounds2d.x2), Math.floor((this._worldMatrix.matrix[5] - ige.engine._currentCamera._translate.y) *
            ige.engine._currentCamera._scale.y +
            ige.engine._bounds2d.y2), 0);
    }
    /**
