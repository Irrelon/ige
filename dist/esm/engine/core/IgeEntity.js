...
export class IgeEntity extends IgeObject {
    ...
    rotateToPoint(point) {
        ...
        this.rotateTo(this._rotate.x, this._rotate.y, Math.atan2(worldPos.y - point.y, worldPos.x - point.x) - (this._parent?._rotate?.z ?? 0) + degreesToRadians(270));
        return this;
    }
