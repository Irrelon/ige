...
var ClientObjects = {
    ...
    SkyScraper: ClientItem.extend({
        ...
        addFloors: function (numFloors) {
            ...
            this.bounds3d(this._bounds2d.x, this._bounds2d.y, 12.5 + this.data("floors") * 25 * (this._parent._tileWidth / 40));
            return this;
        },
        /**
        ...
        _buildTick: function () {
            var currentFloors = this.data("floors"), buildFloors = this.data("buildFloors"), self = this;
