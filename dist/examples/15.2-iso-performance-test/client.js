        ...
        switch (ige.client.data("cursorMode")) {
            ...
            case "move":
                ...
                if (!ige.client.data("moveItem")) {
                    ...
                    var item = ige.client.itemAt(x, y), apiUrl;
                    if (item) {
                    ...
                    // down now
                    var item = ige.client.data("moveItem"), moveX = item.data("lastMoveX"), moveY = item.data("lastMoveY");
            ...
            case "delete":
                ...
                break;
            case "build":
                var item = ige.client.data("ghostItem"), tempItem, apiUrl;
    ...
    _mapOnMouseOver: function (x, y) {
        switch (ige.client.data("cursorMode")) {
            ...
            case "delete":
                ...
                break;
            case "move":
                var item = ige.client.data("moveItem"), map = ige.client.tileMap1.map;
                if (item) {
