...
var CharacterAi = Character.extend({
    ...
    newPath: function () {
        var self = this, currentTile, destTileX, destTileY, destTile, path = [], tileChecker = function (tileData, tileX, tileY) {
        ...
        if (!this.collisionMap.map._mapData[destTileY] ||
