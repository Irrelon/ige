        ...
        ige.on("texturesLoaded", function () {
            ...
            ige.start(function (success) {
                ...
                if (success) {
                    ...
                    ige.addComponent(IgeTiledComponent).tiled.loadJson(tiledExample1, function (layerArray, layersById) {
                        ...
                        var i, destTileX = -1, destTileY = -1, tileChecker = function (tileData, tileX, tileY) {
                        ...
                        self.pathFinder = new IgePathFinder().neighbourLimit(100); // Set a low limit to only accept simple paths
