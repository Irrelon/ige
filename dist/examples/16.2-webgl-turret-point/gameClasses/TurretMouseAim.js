...
var TurretMouseAim = function () {
    var projector = new THREE.Projector(), camera = ige.client.vp1.camera._threeObj, mousePoint = ige.mousePos(), mouseWorld, x = mousePoint.x + window.innerWidth / 2, y = mousePoint.y + window.innerHeight / 2, vector = new THREE.Vector3((x / window.innerWidth) * 2 - 1, -(y / window.innerHeight) * 2 + 1, 0.5), worldMatrix, directionVector, rotateZ, dir, distance;
