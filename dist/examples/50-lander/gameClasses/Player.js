...
var Player = IgeEntityBox2d.extend({
    ...
    init: function (id) {
        ...
        var triangles, fixDefs, collisionPoly = new IgePoly2d()
    ...
    carryOrb: function (orb, contact) {
        if (!this._oldOrb || this._oldOrb !== orb) {
            var distanceJointDef = new ige.box2d.b2DistanceJointDef(), bodyA = contact.m_fixtureA.m_body, bodyB = contact.m_fixtureB.m_body;
