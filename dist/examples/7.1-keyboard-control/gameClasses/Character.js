...
var Character = IgeEntity.extend({
    ...
    init: function () {
        ...
        // Setup the entity
        self.addComponent(IgeAnimationComponent).addComponent(IgeVelocityComponent).depth(1);
    ...
    setType: function (type) {
        switch (type) {
            ...
            case 3:
                this.animation
                    .define("walkDown", [10, 11, 12, 11], 8, -1)
            ...
            case 4:
                this.animation
                    .define("walkDown", [49, 50, 51, 50], 8, -1)
            ...
            case 5:
                this.animation
                    .define("walkDown", [52, 53, 54, 53], 8, -1)
            ...
            case 6:
                this.animation
                    .define("walkDown", [55, 56, 57, 56], 8, -1)
            ...
            case 7:
                this.animation
                    .define("walkDown", [58, 59, 60, 59], 8, -1)
     ...
     */
    walkTo: function (x, y) {
        var self = this, distX = x - this.translate().x(), distY = y - this.translate().y(), distance = Math.distance(this.translate().x(), this.translate().y(), x, y), speed = 0.1, time = distance / speed;
