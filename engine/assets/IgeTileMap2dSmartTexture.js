...
var IgeTileMap2dSmartTexture = {
    render: function (ctx, entity) {
        var tileWidth = entity._tileWidth, tileHeight = entity._tileHeight, bounds2d = entity.bounds2d(), gridSize = entity._gridSize, x = 0, y = 0;
        /*ctx.save();
        ...
        if (entity._drawGrid) {
            ...
            var gridMaxX = x + tileWidth * gridSize.x, gridMaxY = y + tileHeight * gridSize.y, index, gStart, gEnd;
            x = 0;
            y = 0;
        ...
        if (entity._drawMouse) {
            // Get mouse position
            var mousePos = entity.mousePos(), mouseTile = entity.mouseToTile(), tilePoint, text, textMeasurement;
