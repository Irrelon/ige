...
class IgeUiProgressBar extends IgeUiElement {
    ...
    render(ctx) {
        ...
        var min = this._min, max = this._max, progress = this._progress, interval = this._bounds2d.x / (max - min), barWidth = (progress - min) * interval;
