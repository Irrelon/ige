...
export const convoluteHelper = function (pixels: ImageData, weights: number[], opaque = false): ImageData | undefined {
...
igeFilters.registerHelper("convoluteHelper", convoluteHelper);
