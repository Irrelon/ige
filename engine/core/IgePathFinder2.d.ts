...
export declare class IgePathFinder extends IgeEventingClass {
    ...
    isTraversalAllowed(newX: number, newY: number, currentNode?: PathNode | null, x?: number | null, y?: number | null, dynamic?: boolean): boolean;
    getConnections(currentNode: PathNode, targetNode: PathNode): PathNode[];
    /**
     ...
     */
    generate(startPoint: PathNode, endPoint: PathNode, allowInvalidDestination?: boolean): PathNode[];
    /**
