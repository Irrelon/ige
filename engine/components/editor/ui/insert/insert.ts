...
appCore.module('UiTextureEditor', function ($ige, IgeEventingClass) {
	var UiTextureEditor = IgeEventingClass.extend({
		...
		init: function () {
			var self = this;
			$ige.engine.requireStylesheet(igeRoot + 'components/editor/ui/insert/insert.css');
		...
		ready: function () {
			...
			$ige.engine.editor.ui.menus.addMenuGroup('insertMenu', 'objects');
			$ige.engine.editor.ui.menus.addMenuItem('insertMenu', 'objects', {
				id: 'insertDialog',
				icon: 'none',
				text: 'Insert Object...',
			...
			$ige.engine.editor.ui.dialogs.create({
				...
				ready: function (err) {
					if (!err) {
						...
						$('.control.split').on('click', function () {
							self.splitImage();
						});
						...
						$('.control.animate').on('click', function () {
							self.toAnimationEditor();
						});
						$('.control.help').on('click', function () {
							self.help();
						});
