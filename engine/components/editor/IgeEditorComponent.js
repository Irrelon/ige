...
class IgeEditorComponent extends IgeComponent {
    ...
    constructor(entity, options) {
        ...
        this._mouseUpHandle = ige.engine.components.input.on("preMouseUp", (event) => {
        ...
        this._mouseDownHandle = ige.engine.components.input.on("preMouseDown", (event) => {
            if (this._enabled && this._interceptMouse) {
        ...
        this._mouseMoveHandle = ige.engine.components.input.on("preMouseMove", (event) => {
            if (this._enabled && this._interceptMouse) {
