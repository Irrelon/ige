...
export declare namespace Box2D.Common.Math {
...
export declare namespace Box2D.Collision.Shapes {
	...
	export class b2PolygonShape extends b2Shape {
		...
		/**
		 * Copy vertices. This assumes the vertices define a convex polygon.  It is assumed that the exterior is the right of each edge.
		 * @param vertices List of vertices to create the polygon shape from.
		 * @param vertexCount Number of vertices in the shape, default value is 0 and in the box2dweb.js code it is ignored.
		 * @return Convex polygon shape.
		 **/
		public SetAsArray (vertices: Pick<Box2D.Common.Math.b2Vec2, "x" | "y">[], vertexCount?: number): void;
...
export declare namespace Box2D.Dynamics.Contacts {
	...
	export class b2Contact {
		m_fixtureA: Box2D.Dynamics.b2Fixture;
		m_fixtureB: Box2D.Dynamics.b2Fixture;
		igeEntityA: () => IgeEntityBox2d;
		igeEntityB: () => IgeEntityBox2d;
		igeEitherId: (id1: string, id2: string) => boolean;
		igeEitherCategory: (category1: string, category2: string) => boolean;
		igeBothCategories: (category: string) => boolean;
		igeEntityByCategory: (category: string) => IgeEntityBox2d | undefined;
		igeEntityById: (id: string) => (IgeEntityBox2d | undefined);
		igeEntityByFixtureId: (id: string) => (IgeEntityBox2d | undefined);
		igeOtherEntity: (bodyEntity: IgeEntityBox2d) => (IgeEntityBox2d | undefined);
