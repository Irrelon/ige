...
NetIo.Class = typeof (IgeClass) !== 'undefined' ? IgeClass : (function () {
    ...
    Class.extend = function () {
        ...
        prop = arguments[arguments.length - 1], extensionArray = arguments[0], extensionItem, extensionOverwrite, extensionIndex, propertyIndex, propertyObject;
    ...
    emit: function (eventName, args) {
        if (this._eventListeners) {
            ...
            if (this._eventListeners[eventName]) {
                ...
                var eventCount = this._eventListeners[eventName].length, eventCount2 = this._eventListeners[eventName].length - 1;
                ...
                if (eventCount) {
                    ...
                    // Loop and emit!
                    var cancelFlag = false, eventIndex;
                    while (eventCount--) {
...
NetIo.Server = NetIo.EventingClass.extend({
    ...
    start: function (port, callback) {
        ...
        this._socketServer.on('request', function (request) {
            ...
            var connection = request.accept('netio1', request.origin), socket = new NetIo.Socket(connection);
