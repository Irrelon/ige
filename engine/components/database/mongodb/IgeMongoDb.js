...
var IgeMongoDb = {
    ...
    connect: function (callback) {
        ...
        var mongoServer = new this._mongo.Server(this._host, parseInt(this._port), {}), self = this;
        this.client = new this._mongo.Db(this._database, mongoServer, { native_parser: this._nativeParser });
