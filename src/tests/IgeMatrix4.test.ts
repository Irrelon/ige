...
describe("IgeMatrix4", () => {
	...
	describe("copy and clone", () => {
		it("can copy from another matrix", () => {
			const m1 = new IgeMatrix4();
			m1.translateTo(10, 20, 30);

			const m2 = new IgeMatrix4();
			m2.copy(m1);
	...
	describe("rotation", () => {
		it("rotates around X axis correctly", () => {
			...
			const point = new IgePoint3d(0, 1, 0);
		...
		it("rotates around Y axis correctly", () => {
			...
			const point = new IgePoint3d(1, 0, 0);
			m.transformVector(point);
	...
	describe("scale", () => {
		...
		it("can scale a point", () => {
			...
			const point = new IgePoint3d(1, 1, 1);
	...
	describe("matrix multiplication", () => {
		...
		it("combines scale and translation correctly", () => {
			...
			const point = new IgePoint3d(0, 0, 0);
			m.transformPoint(point);
	...
	describe("perspective projection", () => {
		...
		it("preserves points at different distances", () => {
			...
			const nearPoint = new IgePoint3d(0, 0, -1);
	...
	describe("lookAt", () => {
		it("creates a valid view matrix looking at origin", () => {
			const m = new IgeMatrix4();
			const eye = new IgePoint3d(0, 0, 5);
		...
		it("handles looking from different positions", () => {
			const m = new IgeMatrix4();
			const eye = new IgePoint3d(10, 10, 10);
			const target = new IgePoint3d(0, 0, 0);
			const up = new IgePoint3d(0, 1, 0);
			...
			const targetPoint = new IgePoint3d(0, 0, 0);
		...
		it("handles looking straight down", () => {
			const m = new IgeMatrix4();
			const eye = new IgePoint3d(0, 100, 0);
			const target = new IgePoint3d(0, 0, 0);
			const up = new IgePoint3d(0, 0, -1); // Use Z as up when looking down Y
	...
	describe("transformVector", () => {
		it("ignores translation", () => {
			...
			const vector = new IgePoint3d(1, 0, 0);
		...
		it("applies scale to vectors", () => {
			...
			const vector = new IgePoint3d(1, 1, 1);
			m.transformVector(vector);
