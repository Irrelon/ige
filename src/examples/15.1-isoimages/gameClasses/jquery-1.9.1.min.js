			...
			remove: function (e, t) {
				...
				for (; null != (n = this[r]); r++)
					(!e || b.filter(e, [n]).length > 0) &&
						...
						n.parentNode &&
							(t && b.contains(n.ownerDocument, n) && Mt(Ot(n, "script")), n.parentNode.removeChild(n)));
				return this;
			},
			empty: function () {
				var e,
		...
		return (
			n ||
				...
				("none" !== n && n) ||
					((Pt = (
						Pt ||
						b("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")
								...
								(r = function (e, i) {
									...
									try {
										if (r && (i || 4 === u.readyState))
											if (
												((r = t), a && ((u.onreadystatechange = b.noop), $n && delete Pn[a]), i)
											)
