	...
	update: function (t, i) {
		this._deathTime === void 0 || this._deathTime > ige._tickStart
			? this._bornTime !== void 0 && this._bornTime > ige._currentTime
				...
				this._timeStream.length && this._processInterpolate(ige._tickStart - ige.components.network.stream._renderLatency),
	...
	streamSectionData: function (t, i, e) {
		...
		case "transform":
			...
			this._disableInterpolation || e || this._streamJustCreated
				...
				this._timeStream.push([ige.components.network.stream._streamDataTime + ige.components.network._latency, o]),
...
var $i_61 = $i_60.extend({
	...
	init: function () {
		...
		this.on("mouseUp", function () {
			this._allowFocus ? (t.focus() ? ige.components.input.stopPropagation() : i()) : this._allowActive && i();
		}),
...
var PlayerBehaviour = function () {
		if (
			(ige.components.input.actionState("left")
