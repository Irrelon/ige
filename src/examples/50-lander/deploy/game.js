...
var $i_2 = (function () {
	var t = !1,
		...
		s = function (t, i) {
			var e = new t(this, i);
			return (
				(this[e.componentId] = e), (this._components = this._components || []), this._components.push(e), this
			);
		},
		n = function (t) {
			return (
	...
	return (
		(i.extend = function () {
			...
			if (igeClassStore[d.classId])
				throw (
					'Cannot create class with classId "' +
					d.classId +
...
var $i_6 = $i_2.extend({
	...
	_snip: function (t, i, e, o, s) {
		...
		for (n = 0; o > n; n++)
			if (n != t && n != i && n != e && ((r = this._poly[s[n]]), this._insideTriangle(a, h, l, r))) return !1;
		return !0;
	},
...
var $i_11 = $i_2.extend({
	...
	linearForceVector3: function (t, i, e) {
		var o = (this._linearForce = this._linearForce || new $i_5(0, 0, 0)),
			...
			r = t.z / 1e3;
		return (
			e ? ((o.x += s || 0), (o.y += n || 0), (o.z += r || 0)) : ((o.x = s || 0), (o.y = n || 0), (o.z = r || 0)),
			this._entity
		);
	},
...
var $i_12 = $i_2.extend({
	...
	_setupStep: function (t, i) {
		...
		this.log(
			'Cannot start tweening properties of the specified object "' + obj + '" because it does not exist!',
			"error"
		);
	},
	stop: function (t) {
	...
	(function () {
		...
		(h.b2AABB = function () {
			...
			(_.EdgeSeparation = function (t, i, e, o, s) {
				...
				n = s.R;
				for (
					var u = n.col1.x * _ + n.col1.y * m,
						p = n.col2.x * _ + n.col2.y * m,
						d = 0,
						y = Number.MAX_VALUE,
						x = 0;
					l > x;
			...
			(_.FindMaxSeparation = function (t, i, e, o, s) {
				...
				for (
					var m = l * e.R.col1.x + c * e.R.col1.y,
						u = l * e.R.col2.x + c * e.R.col2.y,
						p = 0,
						d = -Number.MAX_VALUE,
						y = 0;
					a > y;
				...
				for (;;) {
					if (
						((p = B == -1 ? (0 > C - 1 ? a - 1 : C - 1) : a > C + 1 ? C + 1 : 0),
			...
			(x.prototype.GetSupport = function (t) {
				for (
					var i = 0, e = this.m_vertices[0].x * t.x + this.m_vertices[0].y * t.y, o = 1;
					this.m_count > o;
					++o
				) {
			...
			(M.prototype.GetMetric = function () {
				switch (this.m_count) {
					...
					case 3:
						return s.CrossVV(
							s.SubtractVV(this.m_v2.w, this.m_v1.w),
							s.SubtractVV(this.m_v3.w, this.m_v1.w)
						);
					default:
						return o.b2Assert(!1), 0;
				}
	...
	(function () {
		...
		$i_22.Collision.b2SimplexVertex,
			...
			(n.prototype.RayCast = function (t, i, e) {
				...
				for (
					var _ = a * o.col1.x + h * o.col1.y,
						m = a * o.col2.x + h * o.col2.y,
						u = _ - l,
						p = m - c,
						d = parseInt(-1),
						y = 0;
	...
	(function () {
		...
		(t.b2Mat22 = function () {
			...
			(e.Clamp = function (t, i, e) {
				return (
					t === void 0 && (t = 0), i === void 0 && (i = 0), e === void 0 && (e = 0), i > t ? i : t > e ? e : t
				);
			}),
	...
	(function () {
		...
		$i_22.Dynamics.Joints.b2PulleyJointDef,
			...
			(y.prototype.SetMassData = function (i) {
				if (
					(n.b2Assert(this.m_world.IsLocked() == 0),
			...
			(y.prototype.ShouldCollide = function (t) {
				...
				for (var i = this.m_jointList; i; i = i.next)
					if (i.other == t && i.joint.m_collideConnected == 0) return !1;
				return !0;
			}),
			...
			(I.prototype.Solve = function (i, e, o) {
				...
				if ((this.Report(_.m_constraints), o)) {
					...
					if (g >= n.b2_timeToSleep)
						for (a = 0; this.m_bodyCount > a; ++a) (s = this.m_bodies[a]), s.SetAwake(!1);
				}
			}),
	...
	(function () {
		...
		$i_22.Collision.ClipVertex,
			...
			(n.prototype.Reset = function (t, i) {
				if (
					(t === void 0 && (t = null), i === void 0 && (i = null), (this.m_flags = n.e_enabledFlag), !t || !i)
				)
				...
				for (
					...
					if ((parseInt(g.pointCount), g.pointCount == 1))
						...
						for (i = g.K, q -= i.col1.x * E + i.col2.x * z, X -= i.col1.y * E + i.col2.y * z; ; ) {
							...
							if (
								((H = -F.normalMass * q), (K = 0), (j = 0), (U = g.K.col1.y * H + X), H >= 0 && U >= 0)
							) {
								(m = H - E),
									(u = K - z),
									(p = m * P),
							...
							if (
								((H = 0), (K = -G.normalMass * X), (j = g.K.col2.x * K + q), (U = 0), K >= 0 && j >= 0)
							) {
								(m = H - E),
									(u = K - z),
									(p = m * P),
			...
			(s.prototype.Step = function () {
				if (this.m_bodyList) {
					...
					for (var t = this.m_bodyList; t; t = t.nextBody) {
						...
						if (i.IsAwake() != 0) {
							for (
								var o = new e(), s = new e(), n = 0, r = 0, a = i.GetFixtureList();
								a;
								a = a.GetNext()
							) {
								var h = new e(),
							...
							if (((o.x /= n), (o.y /= n), (s.x /= r), (s.y /= r), n >= Number.MIN_VALUE)) {
								...
								m.Subtract(this.velocity),
									...
									i.ApplyForce(m, o),
									i.ApplyTorque(
										(-i.GetInertia() / i.GetMass()) * n * i.GetAngularVelocity() * this.angularDrag
									);
							}
						}
					}
			...
			(l.prototype.Step = function () {
				...
				if (this.invSqr)
					for (t = this.m_bodyList; t; t = t.nextBody)
						for (
							i = t.body, o = i.GetWorldCenter(), s = i.GetMass(), n = this.m_bodyList;
							n != t;
							n = n.nextBody
						)
							(r = n.body),
				...
				if (o > Number.MIN_VALUE) {
					...
					for (var s = this.m_bodyList; s; s = s.nextBody) {
						...
						if (n.IsAwake()) {
							...
							n.SetLinearVelocity(
								new e(n.GetLinearVelocity().x + r.x * o, n.GetLinearVelocity().y + r.y * o)
							);
						}
					}
				}
	...
	(function () {
		...
		$i_22.Dynamics.b2Body,
			...
			(w.prototype.GetReactionForce = function (t) {
				return (
					t === void 0 && (t = 0), new s(t * this.m_impulse * this.m_u2.x, t * this.m_impulse * this.m_u2.y)
				);
			}),
		...
		(t.b2DebugDraw = function () {
			...
			(t.prototype.DrawTransform = function (t) {
				...
				i.beginPath(),
					...
					i.lineTo(
						(t.position.x + this.m_xformScale * t.R.col1.x) * e,
						(t.position.y + this.m_xformScale * t.R.col1.y) * e
					),
					(i.strokeStyle = this._color(65280, this.m_alpha)),
					i.moveTo(t.position.x * e, t.position.y * e),
					i.lineTo(
						(t.position.x + this.m_xformScale * t.R.col2.x) * e,
						(t.position.y + this.m_xformScale * t.R.col2.y) * e
					),
					i.closePath(),
					i.stroke();
			});
...
var $i_53 = $i_3.extend({
	...
	id: function (t) {
		if (t !== void 0) {
			if (!ige._register[t])
				return (
					this._id && ige._register[this._id] && ige.unRegister(this),
					(this._id = t),
					ige.register(this),
					this
				);
			...
			this.log(
				'Cannot set ID of object to "' + t + '" because that ID is already in use by another object!',
				"error"
			);
		}
		return (
			this._id || ((this._id = this._url ? ige.newIdFromString(this._url) : ige.newIdHex()), ige.register(this)),
			this._id
		);
	},
	url: function (t) {
	...
	_textureFromCell: function (t, i) {
		...
		(e = typeof i == "string" ? this.cellIdToIndex(i) : i),
			this._cells[e]
				...
				: this.log(
						"Unable to create new texture from passed cell index (" +
							i +
							") because the cell does not exist!",
						"warning"
				  );
	},
	sizeX: function (t) {
	...
	resize: function (t, i, e) {
		this._originalImage &&
			(this._loaded
				...
				: this.log(
						"Cannot resize texture because the texture image (" +
							this._url +
		...
		if (i._cell !== null) {
			if (
				...
				if (e) {
					...
					this.log(
						"Cannot render texture using cell " +
							i._cell +
							" because the cell does not exist in the assigned texture!",
						"error"
					);
			}
	...
	pixelData: function (t, i) {
		if (this._loaded) {
			...
			this.log(
				"Cannot read pixel data, the texture you are trying to read data from has not yet loaded!",
				"error"
			);
		return this;
	},
...
var $i_55 = $i_53.extend({
	...
	_textureLoaded: function () {
		if (this.image) {
			...
			for (
				i ||
					(this.log(
						"No cell data provided for sprite sheet, attempting to automatically detect sprite bounds..."
					),
	...
	_pixelInRects: function (t, i, e) {
		var o,
			...
			n = t.length;
		for (o = 0; n > o; o++)
			if (((s = t[o]), !(s.x > i || i > s.x + s.width || s.y > e || e > s.y + s.height))) return !0;
		return !1;
	},
						...
						while (i--)
							s[i]
								? s[i]._newBorn ||
								  ...
								  t.restore())
								: this.log(
										"Object _children is undefined for index " + i + " and _id: " + this._id,
										"error"
								  );
					else
						while (i--)
...
var $i_59 = $i_58.extend({
	...
	rotateToPoint: function (t) {
		...
		return (
			this.rotateTo(
				this._rotate.x,
				this._rotate.y,
				Math.atan2(i.y - t.y, i.x - t.x) - this._parent._rotate.z + Math.radians(270)
			),
			this
		);
	},
	...
	screenPosition: function () {
		return new $i_5(
			Math.floor(
				(this._worldMatrix.matrix[2] - ige._currentCamera._translate.x) * ige._currentCamera._scale.x +
					ige._bounds2d.x2
			),
			Math.floor(
				(this._worldMatrix.matrix[5] - ige._currentCamera._translate.y) * ige._currentCamera._scale.y +
					ige._bounds2d.y2
			),
			0
		);
	...
	localAabb: function (t) {
		if (!this._localAabb || t) {
			var i = this.aabb();
			this._localAabb = new $i_7(
				-Math.floor(i.width / 2),
		...
		if (this._opacity > 0) {
			this._backgroundPattern &&
				(this._backgroundPatternFill ||
					(t &&
						(this._backgroundPatternFill = t.createPattern(
	...
	updateTransform: function () {
		if (
			...
			var t = (this._translateIso = new $i_5(
				this._translate.x,
				this._translate.y,
	...
	],
	{
		...
		_renderBackground: function (t) {
			...
			(this._backgroundColor || this._patternFill) &&
					...
					? (t.moveTo(i + this._borderTopLeftRadius, e),
					  ...
					  this._borderBottomRightRadius > 0 &&
							t.arcTo(
								i + o,
								e + s,
								i + o - this._borderBottomRightRadius,
								e + s,
								this._borderBottomRightRadius
							),
				...
				this._patternFill &&
					(t.translate(
						-((o / 2) | 0) + this._backgroundPosition.x,
						-((s / 2) | 0) + this._backgroundPosition.y
					),
		...
		cell: function (t) {
			...
			return (
				i === this && this._patternTexture && this.backgroundImage(this._patternTexture, this._patternRepeat), i
			);
		},
		mount: function (t) {
...
var $i_62 = $i_60.extend({
	...
	height: function (t, i, e, o) {
		return (
			t !== void 0 && this._bounds2d.y !== t && this.clearCache(), $i_60.prototype.height.call(this, t, i, e, o)
		);
	},
	text: function (t) {
		if (t !== void 0) {
...
var $i_66 = $i_59.extend({
	...
	tileToPoint: function (t, i) {
		...
		return (
			...
			this._mountMode === 1 &&
				((e = new $i_5(
					t * this._tileWidth + this._tileWidth / 2,
					i * this._tileHeight + this._tileHeight / 2,
					0
				)),
...
var $i_53Map = $i_66.extend({
	...
	negate: function (t) {
		if (t !== void 0) {
			var i,
				...
				s = this.map._mapData;
			for (e in o)
				if (o.hasOwnProperty(e)) for (i in o[e]) o[e].hasOwnProperty(i) && s[e] && s[e][i] && delete s[e][i];
		}
		return this;
	},
	...
	saveMap: function () {
		...
		for (e in r)
			if (r.hasOwnProperty(e)) for (i in r[e]) r[e].hasOwnProperty(i) && (s > i && (s = i), n > e && (n = e));
	...
	convertHorizontalData: function (t) {
		...
		for (i in t)
			if (t.hasOwnProperty(i))
				for (e in t[i]) t[i].hasOwnProperty(e) && ((o[e] = o[e] || []), (o[e][i] = t[i][e]));
		return o;
	},
	tick: function (t) {
		...
		if (this._autoSection > 0) {
			...
			for (e in f)
				if (f.hasOwnProperty(e))
					for (i in f[e]) f[e].hasOwnProperty(i) && ((l = f[e][i]), l && this._renderTile(t, i, e, l, g));
	},
...
var $i_66SmartTexture = {
		render: function (t, i) {
			...
			if (i._highlightTileRect)
				for (
					t.fillStyle = "#e4ff00", r = i._highlightTileRect.y;
					i._highlightTileRect.y + i._highlightTileRect.height > r;
					r++
				)
			...
			if (i._drawMouse) {
				...
				y.x >= 0 &&
					...
					i._drawMouseData &&
						...
						t.fillRect(
							Math.floor(d.x - p.width / 2 - 5),
							Math.floor(d.y - 40),
							Math.floor(p.width + 10),
							14
						),
						(t.fillStyle = "#ffffff"),
	...
	$i_70 = $i_59.extend({
		...
		trackTranslate: function (t, i, e) {
			return t !== void 0
				? (this.log(
						"Camera on viewport " + this._entity.id() + " is now tracking translation target " + t.id()
				  ),
		...
		trackRotate: function (t, i) {
			return t !== void 0
				? (this.log(
						"Camera on viewport " + this._entity.id() + " is now tracking rotation of target " + t.id()
				  ),
		...
		tick: function (t) {
			if (this._scene) {
				if (
					...
					t.translate(
						((this._bounds2d.x / 2) | 0) + ige._translate.x,
						((this._bounds2d.y / 2) | 0) + ige._translate.y
					),
							...
							(((s._classId !== "$i_72" && !this._drawBoundsLimitId && !this._drawBoundsLimitCategory) ||
								...
								n &&
									...
									this._drawBoundsData &&
										...
										t.fillText(
											"Num Children: " + s._children.length,
											n.x + n.width + 3,
											n.y + 40
										)))),
	...
	init: function (t, i) {
		ige._state !== 0 &&
			...
			(this.b2Contact.prototype.igeEntityA = function () {
				...
				return (
					(t._box2dOurContactFixture = this.m_fixtureA), (t._box2dTheirContactFixture = this.m_fixtureB), t
				);
			}),
			(this.b2Contact.prototype.igeEntityB = function () {
				var t = this.m_fixtureB.m_body._entity;
				return (
					(t._box2dOurContactFixture = this.m_fixtureB), (t._box2dTheirContactFixture = this.m_fixtureA), t
				);
			}),
			...
			while (t)
				t._entity &&
					...
					t.IsAwake() && t.m_type !== 0
						? ((e.updating = !0),
						  i.translateTo(
								t.m_xf.position.x * r._scaleRatio,
								t.m_xf.position.y * r._scaleRatio,
								i._translate.z
						  ),
...
var $i_90 = $i_61.extend({
	...
	$i_113 = $i_59.extend({
		...
		unRegister: function (t) {
			return (
				t !== void 0 && this._register[t.id()] && (delete this._register[t.id()], (t._registered = !1)), this
			);
		},
					...
					(t.style.width = o + "px"),
						i &&
							...
							(i.innerHTML =
								...
								" " +
								Math.floor(
									(100 / this._texturesTotal) * (this._texturesTotal - this._texturesLoading)
								) +
								"%"));
				}
			}
		...
		getClassDerivedList: function (t, i) {
			return (
				i ? t._classId && i.push(t._classId) : (i = []),
