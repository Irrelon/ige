...
export class Client extends IgeBaseClass implements IgeCanInit {
	...
	camera!: import("@/engine/core/IgeCamera").IgeCamera;
	...
	async init () {
		...
		const canvas = this.renderer.canvasElement() as HTMLCanvasElement;
