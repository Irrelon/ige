...
var Character = IgeEntityBox2d.extend({
	...
	init: function () {
		...
		// Setup the entity
		self.addComponent(IgeAnimationComponent).isometric(true).depth(1).bounds3d(20, 20, 40);
		...
		if (isClient) {
			...
			this._characterTexture.on(
				"loaded",
				function () {
					// Create a character entity as a child of this container
					self.texture(self._characterTexture).dimensionsFromCell().anchor(0, 8);
				},
				false,
				true
			);
