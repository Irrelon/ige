 ...
 */
export function readAllPixels (gl: WebGLRenderingContext, width: number, height: number): Uint8Array {
...
export function worldToScreen (
	worldPoint: IgePoint3d,
	viewMatrix: IgeMatrix4,
	projMatrix: IgeMatrix4,
	canvasWidth: number,
	canvasHeight: number
): { x: number; y: number } {
 ...
 */
export function displayResults (results: TestResult[], containerId: string = "results"): void {
