...
export class IgeWebGlStateManager extends IgeBaseClass {
	...
	protected _boundProgram: WebGLProgram | null = null;
	protected _boundVBO: WebGLBuffer | null = null;
	protected _boundIBO: WebGLBuffer | null = null;
	protected _boundVAO: WebGLVertexArrayObject | null = null;
	protected _boundFramebuffer: WebGLFramebuffer | null = null;
	protected _boundTextures: (WebGLTexture | null)[] = new Array(32).fill(null);
	protected _activeTextureUnit: number = 0;

	// State tracking
	protected _depthTestEnabled: boolean = true;
	protected _depthWriteEnabled: boolean = true;
	protected _depthFunc: number;
	protected _blendEnabled: boolean = true;
	protected _blendSrc: number;
	protected _blendDst: number;
	protected _cullFaceEnabled: boolean = false;
	protected _cullFace: number;
	protected _frontFace: number;

	// Viewport tracking
	protected _viewport: { x: number; y: number; width: number; height: number } = {
		x: 0,
		y: 0,
		width: 0,
		height: 0
	...
	protected _scissorTestEnabled: boolean = false;
	protected _scissorBox: { x: number; y: number; width: number; height: number } = {
		x: 0,
		y: 0,
		width: 0,
		height: 0
	 ...
	 */
	bindTexture(texture: WebGLTexture | null, unit: number = 0, forceRebind: boolean = false): void {
