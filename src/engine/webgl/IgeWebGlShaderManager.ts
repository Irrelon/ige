...
import { IgeWebGlProgram } from "@/engine/webgl/IgeWebGlProgram";

/**
 * Manages shader compilation, linking, and caching for WebGL renderer.
 */
export class IgeWebGlShaderManager extends IgeBaseClass {
	classId = "IgeWebGlShaderManager";
	...
	protected _programs: Map<string, IgeWebGlProgram> = new Map();
	...
	createProgram(
		...
		const programWrapper = new IgeWebGlProgram(this._gl, program);
