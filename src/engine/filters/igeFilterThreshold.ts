...
export const igeFilterThreshold: IgeSmartFilter = function (canvas, ctx, originalImage, texture, data) {
...
igeFilters.registerFilter("igeFilterThreshold", igeFilterThreshold);
