...
import type { IgeRgbaArray } from "@/types/IgeRgbaArray";
...
export const igeFilterColorReplace: IgeSmartFilter<IgeFilterColorReplaceData[]> = function (canvas, ctx, originalImage, texture, data: IgeFilterColorReplaceData[]) {
