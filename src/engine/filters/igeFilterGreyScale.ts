...
export const igeFilterGreyScale: IgeSmartFilter = function (canvas, ctx, originalImage, texture, data) {
...
igeFilters.registerFilter("igeFilterGreyScale", igeFilterGreyScale);
