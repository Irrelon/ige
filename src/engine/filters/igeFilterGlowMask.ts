...
export const igeFilterGlowMask: IgeSmartFilter = function (canvas, ctx, originalImage, texture, data) {
	const oneNinth = 1 / 9;
...
igeFilters.registerFilter("igeFilterGlowMask", igeFilterGlowMask);
