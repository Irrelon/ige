...
export const igeFilterEdgeEnhance: IgeSmartFilter = function (canvas, ctx, originalImage, texture, data) {
...
igeFilters.registerFilter("igeFilterEdgeEnhance", igeFilterEdgeEnhance);
