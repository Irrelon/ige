...
import type { IgeComponent } from "./IgeComponent";
import type { IgeDummyCanvas } from "./IgeDummyCanvas";
...
import type { IgeEngineState } from "@/enums/IgeEngineState";
...
export declare class IgeEngine extends IgeEntity {
	 ...
	 */
	removeCanvas(): void;
	createCanvas(options?: { smoothing: boolean; pixelRatioScaling: boolean }): {
	 ...
	 */
	getClass(id: string | GenericClass): any;
	/**
