		...
		(function (e, undefined) {
			...
			function ot(e, t, r, i) {
				...
				if (h && !i) {
					...
					if (n.qsa && (!d || !d.test(e))) {
						if (
							((m = g = v), (x = t), (w = 9 === u && e), 1 === u && "object" !== t.nodeName.toLowerCase())
						) {
							(f = gt(e)),
		...
		var t,
			...
			c = {
				...
				fireWith: function (e, t) {
					return (
						!a || (n && !u) || ((t = t || []), (t = [e, t.slice ? t.slice() : t]), r ? u.push(t) : l(t)),
						this
					);
				},
				fire: function () {
			...
			if (m && (u = m.events)) {
				...
				while (l--)
					if (((a = X.exec(t[l]) || []), (h = g = a[1]), (d = (a[2] || "").split(".").sort()), h)) {
						...
						s &&
							!f.length &&
							((p.teardown && p.teardown.call(e, d, m.handle) !== !1) || x.removeEvent(e, h, m.handle),
							delete u[h]);
			...
			on: function (e, t, n, r, i) {
				...
				if (
					(null == n && null == r
						? ((r = t), (n = t = undefined))
						: null == r &&
						  ("string" == typeof t ? ((r = n), (n = undefined)) : ((r = n), (n = t), (t = undefined))),
					r === !1)
				)
					r = Y;
