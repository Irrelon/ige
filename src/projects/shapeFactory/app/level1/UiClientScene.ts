...
export class UiClientScene extends IgeSceneGraph {
	async addGraph() {
		...
		new UiBuildItem(ige.textures.get("headquarters"), "Headquarters").id("uiCreateStorage").top(20).mount(buildUi);

		new UiBuildItem(ige.textures.get("factory1"), "Factory 1").id("uiCreateFactory1").top(90).mount(buildUi);

		new UiBuildItem(ige.textures.get("factory2"), "Factory 2").id("uiCreateFactory2").top(160).mount(buildUi);
