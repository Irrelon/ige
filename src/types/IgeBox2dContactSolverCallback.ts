import type { b2Manifold } from "@/engine/components/physics/box2d/lib/collision/b2_collision";
import type { b2Contact } from "@/engine/components/physics/box2d/lib/dynamics/b2_contact";
import type { b2ContactImpulse } from "@/engine/components/physics/box2d/lib/dynamics/b2_world_callbacks";
